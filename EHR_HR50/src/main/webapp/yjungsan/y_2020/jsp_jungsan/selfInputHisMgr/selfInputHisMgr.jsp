...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"정산구분|정산구분",		Type:"Combo",		Hidden:0, 	Width:70,	Align:"Center",	ColMerge:1,	SaveName:"adjust_type",		KeyField:0, Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 },			
		...
		addFileYn = ajaxCall("<%=jspPath%>/selfInputHisMgr/selfInputHisMgrRst.jsp?cmd=getCpnYeaAddFileYn", "", false);
        ...
        if(addFileYn.Data.std_cd_value == "N"){
        	$("#addFileYnDiv").hide();
    ...
    <div class="outer">
        ...
        <ul>
			...
			<span id="sheet2Btn" name="sheet2Btn">
				...
				<a href="javascript:doAction2('PDF');"	class="button authA">파일다운로드</a>
		</span>
            </li>
        </ul>
        </div>
