	...
	<div class="wrapper">
        ...
        <div class="popup_main">
			...
			<tr>
				...
				<td class="left" colspan="3"><input name="notax_train_mon" id="notax_train_mon" type="text" class="<%=textCss%> right" onFocus="this.select()" value="" maxlength="20" <%=readonly%> /></td>
