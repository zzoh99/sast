...
var isTarget = true;
    ...
    $(function() {
        ...
        initdata2.Cols = [
            ...
            {Header:"비과세or감면세액", Type:"Int",         Hidden:0,  Width:80,    Align:"Right",  ColMerge:0,   SaveName:"notax_mon",     KeyField:0,   CalcLogic:"",   Format:"",    PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 }
	...
	<div class="wrapper">
		...
		<div class="outer">
			<div class="sheet_title">
				<ul>
					<li class="txt">종전근무지관리 <span class="txt" style="color:red">※ 소득세 및
					...
					</span> <a href="javascript:doAction1('Down2Excel')" class="basic authR">다운로드</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="outer">
			<div class="sheet_title">
				<ul>
					...
					<li class="btn"><span id="btn_2"> <a
							href="javascript:doAction2('Insert')" class="basic authA">입력</a>
							<a href="javascript:doAction2('Copy')" class="basic authA">복사</a>
							<a href="javascript:doAction2('Save')" class="basic authA">저장</a>
					</span> <a href="javascript:doAction2('Down2Excel')" class="basic authR">다운로드</a>
					</li>
				</ul>
			</div>
		</div>
