				...
				<div>
					<table border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td class="left"><input type="text" id="searchPayActionNm"
								name="searchPayActionNm" value=""
								class="text w100p readonly transparent" readonly></td>
							<th class="left">대상자 찾기</th>
							<td class="left"><input id="findName" name="findName"
								type="text" class="text w150" onKeyUp="check_Enter();" /> <a
								onclick="javascript:findName();" onFocus="this.blur()"
								href="javascript:void(0);" class="button6"><img
									src="<%=imagePath%>/common/btn_search2.gif" /></a></td>
						</tr>
					</table>
				</div>
								...
								<div class="sheet_title">
									<ul>
										...
										<li class="btn"><a href="javascript:doAction1('Search')"
											class="basic authR">조회</a> <a
											href="javascript:doAction1('Save')" class="basic authA">저장</a>
											<a href="javascript:doAction1('Down2Excel')"
											class="basic authR">다운로드</a></li>
									</ul>
								</div>
