...
<%!
//연말정산 재계산 대상자 작업 조회
public List selectYeaCalcCreRePopupList(Map paramMap, String locPath) throws Exception {
...
//연말정산 재계산 대상자 작업 저장.
public int saveYeaCalcCreRePopup(Map paramMap, String locPath) throws Exception {
...
<%
	...
	if("selectYeaCalcCreRePopupList".equals(cmd)) {
		...
		try {
			listData = selectYeaCalcCreRePopupList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
		...
		try {
			int cnt = saveYeaCalcCreRePopup(mp, locPath);
