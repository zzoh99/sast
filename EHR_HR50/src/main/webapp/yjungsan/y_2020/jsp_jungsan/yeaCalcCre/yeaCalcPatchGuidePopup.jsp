...
<script type="text/javascript">
    ...
    $(function(){
    	...
    	initdata1.Cols = [
                        ...
                        {Header:"차수",    		Type:"Text",            Hidden:0,  Width:20,     Align:"Center",    ColMerge:1,   SaveName:"patch_seq_nm",  KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"패치일자",    	Type:"Text",            Hidden:0,  Width:40,     Align:"Center",    ColMerge:1,   SaveName:"patch_ymd",  	KeyField:0,   CalcLogic:"",   Format:"Ymd",     PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"업무명",     	Type:"Text",            Hidden:0,  Width:60,     Align:"Center",    ColMerge:1,   SaveName:"biz_nm",   		KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"패치내역",    	Type:"Text",            Hidden:0,  Width:250,    Align:"Left",    	ColMerge:0,   SaveName:"patch_desc",   	KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 }
        	...
        	<div class="popup_button"  style="clear: both;">
	            <ul>
	            	<li>
	                	...
	                	<!-- <span>&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" class="checkbox" id="popupChk" name="popupChk" value="Y" style="vertical-align:middle;"/> 오늘 하루 보지 않기</span>-->
	                </li>
	            </ul>
	        </div>
        </div>
