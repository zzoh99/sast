...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
	        ...
	        {Header:"연금저축구분",		Type:"Combo",     Hidden:0,  Width:102,   Align:"Left",    ColMerge:1,   SaveName:"saving_deduct_type",	KeyField:1,		CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
	        ...
	        {Header:"금융기관",			Type:"Combo",     Hidden:0,  Width:110,   Align:"Left",    ColMerge:1,   SaveName:"finance_org_cd",		KeyField:1,   	CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
	        {Header:"계좌번호",			Type:"Text",      Hidden:0,  Width:120,   Align:"Center",  ColMerge:1,   SaveName:"account_no",			KeyField:1,   	CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:200 },
	        {Header:"금액자료(직원용)",	Type:"AutoSum",       Hidden:1,  Width:80,    Align:"Right",   ColMerge:1,   SaveName:"input_mon",			KeyField:0,   	CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
	        ...
	        {Header:"공제금액",			Type:"Text",      Hidden:1,  Width:70,    Align:"Left",    ColMerge:1,   SaveName:"ded_mon",			KeyField:0,   	CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
	        {Header:"자료입력유형",		Type:"Combo",     Hidden:0,  Width:90,    Align:"Center",  ColMerge:1,   SaveName:"adj_input_type",		KeyField:1,   	CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 },
	       // {Header:"국세청\n자료여부",	Type:"CheckBox",  Hidden:0,  Width:70,    Align:"Center",  ColMerge:1,   SaveName:"nts_yn",				KeyField:0,   	CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1, TrueValue:"Y", FalseValue:"N" },
	        {Header:"납입횟수",			Type:"Text",      Hidden:1,  Width:10,    Align:"Left",    ColMerge:1,   SaveName:"paying_num_cd",		KeyField:0,   	CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
			{Header:"REG_DT",Type:"Text",		Hidden:1,	Width:60,	Align:"Left",	ColMerge:1,	SaveName:"reg_dt",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:40 },
		...
		//연금저축구분
        var savingDeductTypeList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&note1='2'&queryId=getCommonCodeNote1List", "C00317"), "" );
		//퇴직연금구분
	...
	function doAction1(sAction) {
        ...
        case "Down2Excel":
			...
			break;
		case "Down2Template":
			var param  = {DownCols:"5|6|9|10|11|12|13|15|17",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
