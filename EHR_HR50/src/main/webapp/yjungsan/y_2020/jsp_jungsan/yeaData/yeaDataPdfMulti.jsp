...
<script type="text/javascript">
	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"정산구분",				Type:"Combo",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,   SaveName:"adjust_type",		KeyField:0,   CalcLogic:"",   Format:"",		PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
    ...
    function doAction1(sAction) {
        ...
        case "Search":
			...
			sheet1.DoSearch( "<%=jspPath%>/yeaData/yeaDataPdfMultiRst.jsp", param );
        	break;
        case "Down2Excel":
