...
%>
		...
		initdata.Cols = [
			...
			{Header:"50세이상여부",					Type:"CheckBox",	Hidden:1,	Width:0,	Align:"Center",	ColMerge:1,	SaveName:"age_chk",				KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:0, TrueValue:"Y", FalseValue:"N" },
...
<div class="wrapper">
	...
	<div class="outer">
		...
		<ul>
			<li class="txt">연금
				...
				<a href="#layerPopup" class="cute_gray" id="InfoPlus"><b>연금 안내+</b></a>
	            <a href="#layerPopup" class="cute_gray" id="InfoMinus" style="display:none"><b>연금 안내-</b></a>
			</li>
		</ul>
		</div>
	</div>
	...
	<tr>
		...
		<th class="center">과학기술인공제 퇴직연금</th>
		<th class="center">퇴직연금납입금액</th>
		<th class="center">연금저축<br>(2001.1.1 이후 가입)</th>
	</tr>
	<tr>
		<td class="right hide">
        ...
        <ul>
            <li class="txt"> 50세이상확인
            	<span id="paytotMonViewYn">
                    <a href="javascript:paytotMonView();" class="basic authA"><b><font color="red">[총급여 1억2천만원 초과여부]</font></b></a>
                </span>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="default outer">
    	...
    	<tr>
    		...
    		<td>
    			...
    			&nbsp;&nbsp;&nbsp;
    			<font color='red'>☜ 총급여 1억2천이 초과하거나 금융소득 종합과세대상자(금융소득금액 2천만원 초과자)인 경우 적용 대상이 아닙니다.</font>
    		</td>
    	</tr>
    </table>
