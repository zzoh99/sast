...
<script type="text/javascript">
	function load_sheet1() {
		...
		initdata1.Cols = [
			...
			{Header:"월구간|월구간",			    Type:"Combo",	Hidden:0,   Width:60,   Align:"Center",   ColMerge:1, SaveName:"period_type",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100 },
			...
			{Header:"대중교통이용분|대중교통이용분",			Type:"AutoSum",	Hidden:0,   Width:80,   Align:"Center",   ColMerge:0, SaveName:"tot_bus_amt",	    KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
...
<script type="text/javascript">
	...
	function load_sheet2() {
		...
		initdata1.Cols = [
			...
			{Header:"월구간|월구간",				Type:"Combo",	    Hidden:0,   Width:80,  	Align:"Center", ColMerge:0, SaveName:"period_type",		    KeyField:1, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:200 },
			...
			{Header:"금액자료|직원용",				Type:"Float",	    Hidden:0,   Width:110,  Align:"Right",  ColMerge:0, SaveName:"use_mon",		    KeyField:0, Format:"#,###",  PointCount:0,   UpdateEdit:<%=inputEdit%>,   InsertEdit:<%=inputEdit%>,   EditLen:35 },
			{Header:"금액자료|담당자용",			Type:"Float",	    Hidden:0,   Width:110,  Align:"Right",  ColMerge:0, SaveName:"appl_mon",		KeyField:1, Format:"#,###",  PointCount:0,   UpdateEdit:<%=applEdit%>,	InsertEdit:<%=applEdit%>,	EditLen:35 },
...
<div class="wrapper">
	...
	<div class="outer">
		...
		<ul>
			<li class="txt"><span name="toYear" style="font-weight:bold;">2020</span> 신용카드<span class="txt"> ※ 총급여 25% 미만의 연간 총액은 공제금액이 발생하지 않습니다.(도서공연등사용분은 총급여 7천 이하자만 별도공제됨)</span>
