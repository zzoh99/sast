                	...
                	if(sheet2.GetCellValue(Row,"appl_mon") > 0){
						...
						if(sumData > 2000000){
                            ...
                            if(!confirm("산후조리원비 한도금액은 출산 1회당 200만원 입니다.\n"+
            				        "출산이 1회 초과인경우만 200만원 넘는 금액을 입력하셔야 합니다. (2회인경우 400한도)\n\n"+
            				        "현재 산후조리원비 입력 합계액 : "+sumData+"\n\n"+
            				        "정말 입력 하시겠습니까?")){
<%								if( "Y".equals(adminYn) ) {	%>
                        		sheet2.SetCellValue(Row,"appl_mon", temp) ;
<%                          	} else {	%>
                        		sheet2.SetCellValue(Row,"input_mon", temp) ;
<%                          	}	%>
                        		return;
                            }                            
                        }
...
<div class="wrapper">
    ...
    <div class="outer">
	    <div>
	    	<font size='2'>	
			    <font style="color:blue;">※ 안경구입비</font>는 의료증빙코드 "국세청제공 의료비 > 안경구입비" 또는 "기타의료비 영수증 > 안경구입비"  으로 선택하십시오.(개인별 50만원 한도)<br>
			    <font style="color:blue;">※ 실손의료보험금</font>은 의료증빙코드 "기타의료비 영수증 > 실손의료보험금" 으로 선택하십시오.<br>
			    <font style="color:blue;">※ 65세이상이면서 장기요양비</font>에 해당하는 경우 65세이상이 더 유리하여 적용됩니다.
		    </font>
	    </div>
        <div class="sheet_title">
        <ul>
