				...
				<tr>
					<td>
						...
						<span id="spanFeedBack" style="margin-left:2px;">
							<a href="javascript:void(0);" class="cute" style="background:rgb(58, 183, 198);" id="buttonPlus"><b>담당자 피드백+</b></a>
							<a href="javascript:void(0);" class="cute" style="background:rgb(58, 183, 198);display:none;" id="buttonMinus"><b>담당자 피드백-</b></a>
						</span>
					</td>
					<td>
					...
					<!-- <td><span id="span_paytotMonView" style="display:none"></span></td> -->
				</tr>
			</table>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function createTabFrame() {
		...
		.append("<li class='"+simYnHide+"'><a href='#tabs-18' id='tabs18'>세액계산/결과보기</a></li>")
