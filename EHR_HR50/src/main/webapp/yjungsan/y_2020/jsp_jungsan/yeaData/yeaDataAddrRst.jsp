...
<%!
//소득공제자료등록(주소사항)
public List selectYeaDataAddrList(Map paramMap, String locPath) throws Exception {
...
public Map selectYeaDataOrgAddr(Map paramMap, String locPath) throws Exception {
...
//소득공제자료등록(주소사항) 저장.
public int saveYeaDataAddr(Map paramMap, String locPath) throws Exception {
...
// 개인별원천징수세율 신청 확인
public Map selectITaxRateApp(Map paramMap, String locPath) throws Exception {
...
<%
	...
	if("selectYeaDataAddrList".equals(cmd)) {
		...
		try {
			listData = selectYeaDataAddrList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
		...
		try {
			mapData = selectYeaDataOrgAddr(mp, locPath);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
		...
		try {
			int cnt = saveYeaDataAddr(mp, locPath);
		...
		try {
			mapData = selectITaxRateApp(mp, locPath);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
