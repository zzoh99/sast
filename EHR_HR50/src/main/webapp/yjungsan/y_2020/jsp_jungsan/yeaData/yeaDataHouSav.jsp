			...
			if(Code == 1) {
				for(var i = sheet2.HeaderRows(); i <= sheet2.LastRow(); i++){
					...
					//중소기업창업투자조합(벤처등) 또는 중소기업창업투자조합(조합등) 로드시
					 if(sheet2.GetCellValue(i,"saving_deduct_type")=='55' || sheet2.GetCellValue(i,"saving_deduct_type")=='60'){
						//텍스트타입
						var info = {Type: "Text", Align: "Center", Edit: 0};
					    sheet2.InitCellProperty(i, "reg_dt", info);
    ...
    <div class="outer">
        ...
        <ul>
            <li class="txt">주택마련저축 
                ...
                <a href="#layerPopup" class="cute_gray" id="InfoPlus1"><b>주택마련저축 안내+</b></a>
	            <a href="#layerPopup" class="cute_gray" id="InfoMinus1" style="display:none"><b>주택마련저축 안내-</b></a>
    ...
    <div class="sheet_title outer">
        <ul>
            <li class="txt">개인연금저축 / 장기집합투자증권저축 / 중소기업창업투자조합 
                ...
                <a href="#layerPopup" class="cute_gray" id="InfoPlus2"><b>개인연금/장기집합저축 안내+</b></a>
	            <a href="#layerPopup" class="cute_gray" id="InfoMinus2" style="display:none"><b>개인연금/장기집합저축 안내-</b></a>
            </li>
            <li class="btn">
            <font color='blue'>중소기업창업투자조합 과세연도 변경시 "출력 탭>소득공제변경신청서" 참조</font>
