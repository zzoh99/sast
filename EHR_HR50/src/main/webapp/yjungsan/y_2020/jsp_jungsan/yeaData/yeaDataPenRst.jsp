...
<%!
//연금보험료 자료 조회
public List selectYeaDataPenList(Map paramMap, String locPath) throws Exception {
...
//50세이상확인 유무 저장
public int saveAgeChk(Map paramMap, String locPath) throws Exception {
...
// 50세이상 확인 유무 조회 
public Map getAgeChk(Map paramMap, String locPath) throws Exception {
...
<%
	...
	if("selectYeaDataPenList".equals(cmd)) {
		...
		try {
			listData = selectYeaDataPenList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
			...
			if(saveList != null && saveList.size() > 0) {
				for(int i = 0; i < saveList.size(); i++) {
					...
					if( "07".equals(adjInputType) && "D".equals(sStatus) ) {
						...
						type =  new String[]{"OUT","OUT","STR","STR","STR","STR"
						...
						param = new String[]{"","",sStatus,ssnEnterCd,workYy
								...
								,adjInputType,feedbackType,ssnSabun,regDt,docSeq,docSeqDetail};
