...
try {
    ...
    Log.Debug("ssnSabun ===== "+ssnSabun);
  	...
  	//쿼리 맵 가져오기
    Map queryMap = XmlQueryParser.getQueryMap(xmlPath+"/yeaData/yeaDataAddFileUploadPop.xml");
    ...
    for(int i = 0 ; i < v_fileCnt ; i++){
        ...
        // 파일 확장자 체크
        String[] arrExt = {"pdf","hwp","txt","doc","docx","ppt","xls","xlsx","zip","rar","alz","egg","7z","jpg","jpeg","gif","png","tiff","bmp"};
        boolean isExt = true;
