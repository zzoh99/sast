...
function doAction2(sAction) {
	...
	case "Search": 		//조회
		...
		break;
    case "Save":
    	sheet2.DoSave( "<%=jspPath%>/yeaData/yeaDataRst.jsp?cmd=saveUnusualPopup");
    	break;
    case "Insert":
...
function sheet1_OnSearchEnd(Code, Msg, StCode, StMsg) {
	try {
		for(var i = 1; i < sheet1.RowCount()+1; i++) {
            sheet1.SetCellValue(i,"btn_link","<a href=\"javascript:fn_moveLink('"+i+"')\" class='basic'>바로가기</a>");
...
<div id="progressCover" style="display:none;position:absolute;top:0;bottom:0;left:0;right:0;background:url(<%=imagePath%>/common/process.png) no-repeat 50% 50%; z-index:99;"></div>
	<div class="wrapper">
			...
			<input type="hidden" id="searchWorkYy" name="searchWorkYy" value="2020" />
					...
					<table>
						<tr>
							<td>
								...
								<select id="searchAdjustType" name ="searchAdjustType" onChange="javascript:showIframe(); doAction2('Search'); doAction1('Search'); " class="box"></select>
								<span id="span_clearYnCheck" style="margin-left:10px;"></span>
								<a href="javascript:void(0);" class="cute" id="buttonPlusNt"><b>특이사항+</b></a>
	            				<a href="javascript:void(0);" class="cute" id="buttonMinusNt" style="display:none"><b>특이사항-</b></a>
								<span id="span_feedback" style="margin-left:2px;"></span>
								<a href="javascript:void(0);" class="button authA" id="buttonPlus"><b>담당자 피드백+</b></a>
	            				<a href="javascript:void(0);" class="button authA" id="buttonMinus" style="display:none"><b>담당자 피드백-</b></a>
							</td>
							<td>
								<div class="inner" id="div_button">
									...
									<ul>
										<li class="right">
											...
											<span id="paytotMonViewYn"><a href="javascript:paytotMonView();" class="basic">총급여확인</a></span>
											<span id="span_paytotMonView" style="display:none;"></span>
											<span id="yeaCalcProcPop"><a href="javascript:openProcessStatus();" class="basic">작업현황</a></span>
											<span id="yeaCalcCreFaqPopup"><a href="javascript:openFaqPop();" class="basic">FAQ</a></span>
										</li>
									</ul>
									</div>
								</div>
				...
				<div class="outer" id="">
					<div class="sheet_title">
						<ul>
							...
							<li class="btn"><a href="javascript:setValue();" class="basic authA">저장</a></li>
						</ul>
					</div>
				</div>
...
<script type="text/javascript">
	...
	function paytotMonView() {
		//총급여 닫기
		$("#span_paytotMonView").css("display", "");
		if(paytotMonStr != ""){
	...
	function createTabFrame() {
		...
		.append("<li><a href='#tabs-18' id='tabs18'>세액계산/결과보기</a></li>")
	...
	function getYearDefaultInfoObj() {
		...
		*/
		...
		if(result.Result.Code == 1) {
			...
			if(result.Data.cnt19 > 0) result.Data.cnt19 = "<font color='red'>"+result.Data.cnt19+"</font>";
	...
	function getYeaCloseYn() {
		...
		if(yeaCloseInfo.Result.Code == 1) {
			...
			if(typeof yeaCloseInfo.Data.sabun == "undefined") {
				closeYn = "Y";
				$("#tdStatusView").html("<font class='close_1' size=2><b>[<font color=red>대상자가 아닙니다.</font>]</b></font>");
				...
				if(yeaCloseInfo.Data.final_close_yn == "Y"){
					closeYn = "Y";
					$("#tdStatusView").html("<font class='close_4' size=2><b>[현재 <font color=red>최종마감</font> 상태입니다.]</b></font>");
				} else if(yeaCloseInfo.Data.apprv_yn == "Y"){
					closeYn = "N";
					$("#tdStatusView").html("<font class='close_3' size=2><b>[현재 <font color=red>담당자마감</font> 상태입니다.]</b></font>");
					$("#spanMagamCancel").show();
				} else if(yeaCloseInfo.Data.input_close_yn == "Y"){
					closeYn = "N";
					$("#tdStatusView").html("<font class='close_2' size=2><b>[현재 <font color=red>본인마감</font> 상태입니다.]</b></font>");
					$("#spanMagam").show();
				}
			} else {
				closeYn = "N";
				$("#tdStatusView").html("<font class='close_0' size=2><b>[현재 <font color=red>본인 마감전</font> 상태입니다.]</b></font>");
				$("#spanMagam").show();
			}
		}
		return closeYn;
	...
	function openProcessStatus(){
		...
		args["searchAdjustType"]	= $("#searchAdjustType").val() ;//1 - 연말정산(3은 퇴직)
		args["searchBizPlaceCd"]	= $("#searchBusinessCd").text() ;//사업장
	...
	function getBizPlCd(){
	    ...
	    $("#searchBusinessCd").text(bizPlCd[0].business_place_cd);
	}
</script>
</html>