	...
	function doAction(sAction) {
		...
		case "Search":
			...
			if(data.Result.Code == 1) {
				...
				$("#btnLongSav > .pdfAmt").text( comma(map.long_sav_amt+map.venture_amt) );			$("#btnLongSav > .pdfCnt").text("반영("+ (parseInt(map.long_sav_cnt,10) + parseInt(map.venture_cnt,10)) +"), 미반영("+ (parseInt(map.long_sav_cnt_err,10) + parseInt(map.venture_cnt_err,10)) +")");
...
<div class="wrapper" id="topNav">
	...
	<div class="outer" id="infoLayer" style="display:none">
		<table>
			...
			<tr>
				<td style="padding:5px;"><img src="../../../common_jungsan/images/common/pdf_popup_2020.jpg" border="0" style="vertical-align:middle;width:100%;height:100%"></td>
			</tr>
			<tr>
		...
		<div class="sheet_title">
			...
			<ul>
				<li class="btn">
					...
					<font size='2' color='red'>[※ XREF 정보검색 오류, ByteRange 오류 발생시 국세청 PDF 원본 파일로 다운받아 재업로드 해주시기 바랍니다.]&nbsp;</font>
					<span id="btn_1">
		...
		<table style="width:100%;">
			...
			<tr>
				...
				<td style="padding:5px;">
					...
					<a href="javascript:doAction2('Search', 'G108M');" class="pdf" id="btnCreditCard"> <!-- 2020년 귀속만 사용 -->
				...
				<td style="padding:5px;">
					<!-- <a href="javascript:doAction2('Search', 'G307Y,G407Y');" class="pdf" id="btnCheckCard"> -->
					<a href="javascript:doAction2('Search', 'G308M,G408M');" class="pdf" id="btnCheckCard"> <!-- 2020년 귀속만 사용 -->
				...
				<td style="padding:5px;">
					...
					<a href="javascript:doAction2('Search', 'G208M');" class="pdf" id="btnCash"> <!-- 2020년 귀속만 사용 -->
			...
			<tr>
				<td style="padding:5px;">
					<a href="javascript:doAction2('Search', 'D101Y,E102Y,E101Y,F101Y,F102Y');" class="pdf" id="btnPen">
		...
		<ul>
			<li class="txt" style="font-weight:normal;">
				...
				<select id="formCd">
					...
					<option value="G307Y,G407Y">직불카드 등</option>
					<option value="G207M">현금영수증</option> -->
					<%-- <option value="G407Y">제로페이</option><!-- 2019-12-09. 제로페이 추가 --> <!-- 2020-12-02. 제로페이는 직불카드에 포함 --> --%>

					<!-- 2020년 귀속만 사용 START -->
					<option value="G108M">신용카드</option>
					<option value="G308M,G408M">직불카드 등</option>
					<option value="G208M">현금영수증</option>
					<!-- 2020년 귀속만 사용 END -->

					<option value="D101Y,E102Y,E101Y,F101Y,F102Y">개인연금저축/연금계좌</option>
