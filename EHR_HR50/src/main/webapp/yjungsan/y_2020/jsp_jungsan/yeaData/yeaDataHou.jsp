...
%>
    ...
    function loadSheet3() {
        ...
        initdata3.Cols = [
            ...
            {Header:"원리금|원리금",                       Type:"Int",     Hidden:0,   Width:80,   Align:"Right",  ColMerge:1, SaveName:"wonri_mon",       KeyField:1, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35, MinimumValue: 0 },
    ...
    function rentInputCheck(obj,gubun) {
        ...
        */
        ...
        if(gubun == "1"){
	        ...
	        if(houseOwnerYn != "Y") {
	       		if(confirm("무주택 세대의 세대원은 세대주가 모든 주택 관련 공제를 받지 않은 경우만 입력이 가능합니다. 입력하시겠습니까?")){
	       			return true;
	       		}
	       		else {
	       			return false;
...
<div class="wrapper">
    ...
    <div class="outer">
        ...
        <ul>
            <li class="txt">주택정보 ☞ <span id="houseInfo"></span>
                ...
                <a href="#layerPopup" class="cute_gray" id="InfoPlus"><b>주택자금 안내+</b></a>
	            <a href="#layerPopup" class="cute_gray" id="InfoMinus" style="display:none"><b>주택자금 안내-</b></a>
            </li>
        </ul>
        </div>
    </div>
    ...
    <tr>
        <th class="center" ><a href="#sheet1_title">임차차입금(대출기관) ☞ 이동</a></th>
        <th class="center" ><a href="#sheet3_title">임차차입금(거주자) ☞ 이동</a></th>
        <th class="center" ><a href="#sheet4_title">저당차입금 이자상환액  ☞ 이동</a></th>
        <th class="center yeaData2" ><a href="#sheet2_title">월세액  ☞ 이동</a></th>
    </tr>
    <tr>
        <td class="right">
   ...
   <table border="0" cellpadding="0" cellspacing="0" class="default outer">
    ...
    <div >
	<table border="0" cellpadding="0" cellspacing="0" class="default outer outer">
	    <colgroup>
	        <col width="11%" />
	        <col width="11%" />
	        <col width="11%" />
