...
<script type="text/javascript">
    ...
    $(document).ready(function(){
		...
		$("#openYeaDataPerBef_main").hide("fast");
		$("#createIBSheet").hide("fast");
		$('#searchWorkYear').val(yeaYear);
		//$("#sheet_search").hide("fast");

		$("#searchWorkYear").bind("keyup",function(event){
            makeNumber(this,"A");
            if( event.keyCode == 13){
                doAction2("Search");
                $(this).focus();
    	...
    	$("#buttonPlus").click(function(){
            ...
            $("#buttonPlus2").hide("fast");
            $("#buttonMinus2").show("fast");
            $("#openYeaDataPerBef_main").show("slow");
        });

    	//과거 인적공제 현황- 선택시 화면 숨김
    	$("#buttonMinus").click(function(){
    		$("#createIBSheet").hide("fast");
            $("#buttonPlus2").show("fast");
            $("#buttonMinus2").hide("fast");
            $("#openYeaDataPerBef_main").hide("fast");
        });
    	...
    	$(".buttonPlus3").click(function(){
    		//$("#createIBSheet").show("slow");
            $(".buttonPlus3").hide("fast");
            $(".buttonMinus3").show("fast");
            $("#hndcpRegInfo").show("slow");
    	...
    	$(".buttonMinus3").click(function(){
    		//$("#createIBSheet").hide("fast");
            $(".buttonPlus3").show("fast");
            $(".buttonMinus3").hide("fast");
            $("#hndcpRegInfo").hide("fast");
        });
    	...
    	$("#basicInfoPlus").live("click",function(){
	    		...
	    		if(btnId == "basicInfoPlus"){
	    			$("#basicInfoMinus").show("fast");
	    			$("#basicInfoPlus").hide("fast");
	    		}
    	});
    	...
    	$("#basicInfoMinus").live("click",function(){
	    		...
	    		if(btnId == "basicInfoMinus"){
	    			$("#basicInfoPlus").show("fast");
	    			$("#basicInfoMinus").hide("fast");
	    		}
		});
    	...
    	$("#addInfoPlus").live("click",function(){
	    		...
	    		if(btnId == "addInfoPlus"){
	    			$("#addInfoMinus").show("fast");
	    			$("#addInfoPlus").hide("fast");
	    		}
    	});
    	...
    	$("#addInfoMinus").live("click",function(){
	    		...
	    		if(btnId == "addInfoMinus"){
	    			$("#addInfoPlus").show("fast");
	    			$("#addInfoMinus").hide("fast");
	    		}
		});
    ...
    $(function() {
        ...
        initdata2.Cols = [
            ...
            {Header:"관계",                Type:"Combo",       Hidden:0,   Width:100,   Align:"Center", ColMerge:0, SaveName:"fam_cd",              KeyField:1, Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
            {Header:"성명",                Type:"Text",        Hidden:0,   Width:60,   Align:"Left",   ColMerge:0, SaveName:"fam_nm",              KeyField:1, Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100 },
            {Header:"주민등록번호",        Type:"Text",        Hidden:0,   Width:120,   Align:"Center", ColMerge:0, SaveName:"famres",              KeyField:1, Format:"IdNo",  PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:200, FullInput:1 },
            {Header:"주민등록번호\n체크",   Type:"Text",        Hidden:1,   Width:60,   Align:"Center", ColMerge:0, SaveName:"famresChk",              KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:200 },
        ...
        sheet2.SetColProperty("age_type", {ComboText:"|만18세미만|만20세미만|만60세이상", ComboCode:"|18-|20-|60+"} );
            ...
            */
            ...
            if(sheet1.ColSaveName(Col) == "dpndnt_yn" && (Value == "Y" || Value == "1")){
                if(sheet1.GetCellValue(Row,"hndcp_yn") == "Y") {
        			...
        			if(confirm(" 기본공제대상조건(도움말참조)이 아닌 인원에 대한 기본공제는 \n [장애인] 만 해당합니다. \n 기본공제대상여부를 확인바랍니다."
                ...
                if( sheet1.GetCellValue(Row,"add_child_yn") == "Y"){
                	if(age >= 7 && age <= 20) {
                		...
                		&& sheet1.GetCellValue(Row,"hndcp_yn") == "Y"){
                    		sheet1.SetCellEditable(Row,"add_child_yn", 1);	
                    		if(confirm('대상자의 연간소득금액 100만원 초과시에는 공제받으시면 안됩니다.')){
                    			sheet1.SetCellValue(Row,"add_child_yn", "Y");
    						}else{    						
...
//                                 }
	...
	function doAction3(sAction) {
		...
		case "Save":
            ...
            sheet3.DoSave( "<%=jspPath%>/yeaData/yeaDataPerRst.jsp?cmd=saveYeaDataHndcpRegDetail");
            break;
		case "Down2Excel":
...
<div class="wrapper">
    ...
    <div class="outer">
        ...
        <ul>
            <li class="txt">기본공제
                <a href="#layerPopup" class="cute_gray" id="basicInfoPlus"><b>기본공제 안내+</b></a>
	            <a href="#layerPopup" class="cute_gray" id="basicInfoMinus" style="display:none"><b>기본공제 안내-</b></a>
            </li>
            <li class="btn">
    ...
    <div class="outer">
        ...
        <ul>
            <li class="txt">추가공제
                ...
                <a href="#layerPopup" class="cute_gray" id="addInfoPlus"><b>추가공제 안내+</b></a>
	            <a href="#layerPopup" class="cute_gray" id="addInfoMinus" style="display:none"><b>추가공제 안내-</b></a>
            </li>
        </ul>
        </div>
    </div>
...
<!--         </td> -->
		...
		<div class="openYeaDataPerBef_main" id="openYeaDataPerBef_main" style="display:none;">
			<div class="sheet_title" id="openYeaDataPerBef">
				<ul>
				    ...
				    <li class="btn">
				    	<a href="javascript:void(0);" class="button authA" id="buttonPlus2"><b id="authText2">과거 인적공제 현황+</b></a>
			        	<a href="javascript:void(0);" class="button authA" id="buttonMinus2" style="display:none"><b id="authText3">과거 인적공제 현황-</b></a>
				    </li>
				</ul>
			</div>
		        ...
		        <div>
			        <table>
				        <tr>
				            <td>
				                <span>대상년도</span>
				                <input id="searchWorkYear" name ="searchWorkYear" type="text" class="text" maxlength="4" style="width:35px" value=""/>
				            </td>
				            <td><a href="javascript:doAction2('Search')" class="button">조회</a></td>
				        </tr>
			        </table>
		        </div>
			</div>
			<div class="outer" id="outer">
				<div class="sheet_title">
		        	<ul><li class="btn"><a href="javascript:doAction2('Down2Excel')" class="basic authR">다운로드</a></li></ul>
		        </div>
			</div>
		</div>
			...
			<div class="outer">
				<div class="sheet_title">
					<ul>
					    ...
					    <li class="btn">
					    	<span><font class="txt" style="color: red; text-overflow: ellipsis; white-space: nowrap;">&nbsp;현황은 참조용입니다. 실제 공제는 아래 장애인공제 체크를 하셔야 합니다.&nbsp;</font></span>
					    	<a href="javascript:void(0);" class="button authA buttonPlus3"><b>장애인등록증 현황+</b></a>
				        	<a href="javascript:void(0);" class="button authA buttonMinus3" style="display:none"><b>장애인등록증 현황-</b></a>
				        	<span id="btnDisplayYn02">
				        		<a href="javascript:doAction3('Save');"     class="basic authA" id="btnSaveHndcp">저장</a>
				        	</span>
    ...
    <div class="outer">
    	   <div>
	    	<font size='2'>
			    <font style="color:blue;">※ 귀속연도 중에 출생한 주민등록번호가 없는 내국인의 경우</font> 생년월일(YYMMDD:6자리)+남녀구분(남:3,여:4)+‘000000’<br>
		    </font>
	    </div>
        ...
        <ul>
            ...
            <li class="btn">
	            ...
	            <a href="javascript:void(0);" class="button authA buttonPlus3"><b>장애인등록증 현황+</b></a>
		        <a href="javascript:void(0);" class="button authA buttonMinus3" style="display:none"><b>장애인등록증 현황-</b></a>
	            <a href="javascript:void(0);" class="button authA" id="buttonPlus"><b>과거 인적공제 현황+</b></a>
	            <a href="javascript:void(0);" class="button authA" id="buttonMinus" style="display:none"><b>과거 인적공제 현황-</b></a>
