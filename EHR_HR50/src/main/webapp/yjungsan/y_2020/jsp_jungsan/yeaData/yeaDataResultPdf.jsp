...
var waitFlag = false;
//true: 세액계산 조회 활성, false: 세액계산 조회 비활성
//비정상적인 접근시 세액계산 버튼 조회 차단
	    ...
	    <div class="sheet_title">
	        <ul>
				...
				<%if("A".equals(request.getParameter("orgAuthPg") ) ) {%>
	            	<font color='blue'>[해당 화면에서의 계산은 시뮬레이션용 임시 데이터이며 실제 계산은 담당자가 '연말정산계산' 화면에서 세금계산 체크 후 작업 해야합니다.]</font>
	            <%}else{%>
	            	<font color='blue'>[해당 화면에서의 계산은 시뮬레이션용 임시 데이터이며 실제 계산에 영향은 없습니다.]</font>
	            <%}%>
	            	<a href="javascript:TaxCalcCheck();" class="cute" id="sheetCalc"><b>세액계산</b></a>
	            	<a href="javascript:IncomeCalc();" class="button">소득공제서</a>
	    		</li>
	        </ul>
	    </div>
	</div>
...
<%} %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="default outer" id="wkp_table" name="wkp_table">
		<colgroup>
	        <col width="15%" />
	        <col width="15%" />
	        <col width="15%" />
...
<% } %>
		...
		<% //2020년 추가 Start %>
        <tr>
            <th class="center" rowspan="2" >2020.1.1 ~ 2020.12.31</th>
            <th class="center" colspan="2">간접출자</th>
            <td class="right">
		...
		<tr>
			<th class="center" colspan="4">표준세액공제&nbsp;&nbsp;&nbsp;<font id="sht5_A099_01_font" color='blue'>(표준세액공제 적용시 특별세액공제 계산되지 않음)</font></th>
			<td class="right">
