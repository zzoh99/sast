...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"정산구분|정산구분",		    	Type:"Combo",      	Hidden:0,  Width:60,	Align:"Center",    	ColMerge:1,   SaveName:"adjust_type",	KeyField:0,   CalcLogic:"",   Format:"",    PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
    ...
    function doAction2(sAction) {
		...
		case "Search":
			...
			sheet2.DoSearch( "<%=jspPath%>/donationAdj/donationAdjEmpRst.jsp?cmd=selectDonationAdjEmpDetailList", param, 1); 
			break;
		case "Down2Excel":
