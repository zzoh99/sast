	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				...
				<li class="btn">
					<span><font class="txt" style="color: red; text-overflow: ellipsis; white-space: nowrap;">&nbsp;해당년도 원천징수영수증 데이터가 없을 경우 PDF파일로 대체하기 위한 화면입니다.</font></span>
				    <a href="javascript:openFileUploadPopup();" 	class="button authA">PDF등록</a>
