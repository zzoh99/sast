...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
	        ...
	        {Header:"월구간",     	Type:"Combo",     Hidden:0,  Width:100,    Align:"Center",  ColMerge:1,   SaveName:"period_type",		KeyField:1,   CalcLogic:"",   Format:"",     	PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
	...
	function doAction1(sAction) {
		...
		case "Down2Template":
			...
			var param  = {DownCols:"5|6|7|8|9|11|12|14|15|18|19|20",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"				
