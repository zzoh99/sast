...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"소득세(72-78)",                           Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"income_tax_mon",      KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"지방소득세(72-79)",                       Type:"AutoSum", Hidden:0,  Width:100,    Align:"Right",  ColMerge:0, SaveName:"inhbt_tax_mon",       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
    ...
    function doAction1(sAction) {
        ...
        case "Down2Excel":
            ...
            break;
        case "Down2Template":
            var param  = {DownCols:"sabun|enter_nm|napse_yn|enter_no|work_s_ymd|work_e_ymd|reduce_s_ymd|reduce_e_ymd|pay_mon|bonus_mon|etc_bonus_mon|stock_buy_mon|stock_union_mon|imwon_ret_over_mon|income_tax_mon|inhbt_tax_mon|rural_tax_mon|pen_mon|etc_mon1|etc_mon2|etc_mon3|etc_mon4|hel_mon|emp_mon|notax_abroad_mon|notax_work_mon|notax_baby_mon|notax_research_mon|notax_reporter_mon|notax_train_mon",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
	...
	function reduceDateCheck(){				
		...
		var reSYmd = "";	//감면기간시작일
		var reEYmd = "";	//감면기간종료일
		var subReSYmd = "";	//감면기간시작년도
		var subReEYmd = "";	//감면기간종료년도
		...
		for (i = 1; i < sheet1.RowCount()+1; i++){
	    	...
	    	subReSYmd = reSYmd.substring(0,4);
	    	subReEYmd = reEYmd.substring(0,4);	

	    	// 감면기간 시작,종료일이 존재할때
	    	if(reSYmd != "" || reEYmd != ""){
	    		// 감면기간 시작일의 연도가 귀속연도와 다를때 
	    		if(subReSYmd != $("#searchWorkYy").val()){
		    		sheet1.SetCellValue(i, "reduce_s_ymd", "");
		    		flag = false;
		    		rtn = false;
	    		}
	    		// 감면기간 종료일의 연도가 귀속연도와 다를때 
	    		if(subReEYmd != $("#searchWorkYy").val()){
		    		sheet1.SetCellValue(i, "reduce_e_ymd", "");
		    		flag = false;
		    		rtn = false;
	    		}
