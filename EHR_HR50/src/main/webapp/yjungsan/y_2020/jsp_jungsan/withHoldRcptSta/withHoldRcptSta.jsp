            ...
            <div>
                <table>
                    ...
                    <td>
						...
						<%}else{%>
							<input id="searchWorkYy" name ="searchWorkYy" type="text" class="text w40 readonly" readonly="readonly"/>
						<%}%>
                        <span>년</span>
                    ...
                    <td>
                        ...
                        <span style="margin-left:15px;">사대보험출력여부</span>
                    ...
                    <div class="sheet_title">
                        <ul>
                            ...
                            <li class="btn">
                                ...
                                <a href="javascript:print('print')"             class="cute">출력</a>
                                <a href="javascript:print('printEng')" id="rdEngBtn" name="rdEngBtn" class="cute" >출력(영문)</a>
