		    ...
		    <div class="sheet_title">
		        <ul>
		            ...
		            <li class="btn" id="viewYN" style="display:none;">
						<span id="confYN"><font color='blue'>※ <span id="baseYear"></span>년 연말정산 결과를 확인 하였으며 정산결과의 이상이 없음을 확인합니다.</span></font>
...
<% // 2015년 변경 start %>
 ...
 <% // 2015년 변경 end %>
		...
		<tr>
			<th class="center" colspan="4">표준세액공제&nbsp;&nbsp;&nbsp;<font id="sht5_A099_01_font" color='blue'>(표준세액공제 적용시 특별세액공제 계산되지 않음)</font></th></th>
			<td class="right">
