			...
			<td class="top center">
				<div class="sheet_title">
					<ul>
						...
						<span>&nbsp;<font color='blue'>[퇴직금이 발생한 인원들에 대해 계산. 작업일자는 퇴직금 급여일자로 자동 세팅됨. (퇴직자정산으로 해도 무방)]</font></span>
						</li>
					</ul>
				</div>
				<table border="0" cellpadding="0" cellspacing="0" class="default">
					...
					<tr>
						...
						<td class="left" colspan="3"> 
							...
							<a onclick="javascript:payActionSearchPopup();" href="javascript:void(0);" class="button6"><img src="<%=imagePath%>/common/btn_search2.gif"/></a> 
						</td>					
					</tr>
					<tr>
