	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"DOC_SEQ_DETAIL",Type:"Text",		Hidden:1,	Width:60,	Align:"Left",	ColMerge:1,	SaveName:"doc_seq_detail",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:40 },
   			...
   			// {Header:"사용연도",           Type:"Combo",      Hidden:1,  Width:60,    Align:"Center",  ColMerge:1,   SaveName:"use_yyyy",        KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:4 },
...
// 		sheet1.SetColProperty("period_type",		 {ComboText:"|"+periodType[0], ComboCode:"|"+periodType[1]} );
        var cardTypeList = stfConvCode(ajaxCall("<%=jspPath%>/cardHisMgr/cardHisMgrRst.jsp?cmd=selectDataCardType", "searchYyType=0", false).codeList, "전체");
		...
		sheet1.SetColProperty("use_yyyy", {ComboText:"2023", ComboCode:"2023"});
...
// 		templeteTitle1 += "월구간 : " + codeCdNm + "\n";
	...
	function doAction1(sAction) {
		...
		case "Down2Template":
			...
			var param  = {DownCols:"work_yy|adjust_type|sabun|famres|card_type|card_enter_nm|appl_mon|adj_input_type",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
				,TitleText:templeteTitle1,UserMerge :"0,0,1,9",menuNm:$(document).find("title").text()};
        ...
        case "prcYeaBpCardLoad":
           var confirmMsg = "귀속 2021년에 등록된 사업관련비용을"
        	   confirmMsg +=" 귀속 2022년, \n사용연도 2021년으로 불러옵니다.(근로자 본인만)"
        	   confirmMsg += "\n기존 귀속 2022년, 사용연도 2021년으로 등록된 사업관련 건들은"
        	   confirmMsg += "\n지우고 재생성됩니다. 진행하시겠습니까?";
			...
			for(var i = sheet1.HeaderRows(); i < sheet1.RowCount()+sheet1.HeaderRows(); i++){
				...
				if( sheet1.GetCellValue( i, "use_mon") < 0) {
					if(sheet1.GetCellValue( i, "card_type") == "3" || sheet1.GetCellValue( i, "card_type") == "4"){
						sheet1.SetCellValue( i, "use_mon","0");
						msgSts = true;
					}
				}
				if( sheet1.GetCellValue( i, "appl_mon") < 0) {
					if(sheet1.GetCellValue( i, "card_type") == "3" || sheet1.GetCellValue( i, "card_type") == "4"){
						sheet1.SetCellValue( i, "appl_mon","0");
						msgSts = true;
					}
				}
...
<!-- searchUseYyyy 2023.11.06 주석 처리 -->                
                 <td>
	                   <span>사용연도</span> 
...
<!-- 				<td> <a href="javascript:doAction1('Search')" id="btnSearch" class="button">조회</a> </td> -->
    ...
    <div class="outer">
        ...
        <ul>
            ...
            <li class="btn">
                <!--  <a href="javascript:doAction1('prcYeaBpCardLoad')" class="basic btn-white out-line authA" id="showBtn" style="display:none;">21년사업관련비용불러오기</a> -->
