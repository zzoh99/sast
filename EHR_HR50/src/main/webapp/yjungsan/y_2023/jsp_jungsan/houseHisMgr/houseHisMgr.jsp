...
<script type="text/javascript">
	...
	function doAction1(sAction) {
        ...
        case "Down2Excel":
			...
			break;
		case "Down2Template":
            var param  = {DownCols:"work_yy|adjust_type|sabun|house_dec_cd|con_s_ymd|con_e_ymd|repay_years|appl_mon|adj_input_type",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
