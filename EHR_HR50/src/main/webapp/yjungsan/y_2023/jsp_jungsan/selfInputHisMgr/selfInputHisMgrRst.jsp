...
//수기등록내역 조회
public List selectSelfInputHisMgrList(Map paramMap, String locPath, String ssnYeaLogYn) throws Exception {
	...
	if(searchFileType.trim().length() != 0){
		if(searchFileType.equals("5")) {
			if(srhEvidYn.equals("Y")) query.append(" AND PER_EVD_DOC_CNT != 0");
			else query.append(" AND PER_EVD_DOC_CNT = 0");
		}
        if(searchFileType.equals("10")) {
            if(srhEvidYn.equals("Y")) query.append(" AND INS_EVD_DOC_CNT != 0");
            else query.append(" AND INS_EVD_DOC_CNT = 0");
        }
        if(searchFileType.equals("15")) {
            if(srhEvidYn.equals("Y")) query.append(" AND HOUSE_EVD_DOC_CNT != 0");
            else query.append(" AND HOUSE_EVD_DOC_CNT = 0");
        }
        if(searchFileType.equals("20")) {
            if(srhEvidYn.equals("Y")) query.append(" AND SAV_EVD_DOC_CNT != 0");
            else query.append(" AND SAV_EVD_DOC_CNT = 0");
        }
        if(searchFileType.equals("25")) {
            if(srhEvidYn.equals("Y")) query.append(" AND PEN_EVD_DOC_CNT != 0");
            else query.append(" AND PEN_EVD_DOC_CNT = 0");
        }
        if(searchFileType.equals("30")) {
            if(srhEvidYn.equals("Y")) query.append(" AND MED_EVD_DOC_CNT != 0");
            else query.append(" AND MED_EVD_DOC_CNT = 0");
        }
        if(searchFileType.equals("35")) {
            if(srhEvidYn.equals("Y")) query.append(" AND EDU_EVD_DOC_CNT != 0");
            else query.append(" AND EDU_EVD_DOC_CNT = 0");
        }
        if(searchFileType.equals("40")) {
            if(srhEvidYn.equals("Y")) query.append(" AND DONA_EVD_DOC_CNT != 0");
            else query.append(" AND DONA_EVD_DOC_CNT = 0");
        }
        if(searchFileType.equals("42")) {
            if(srhEvidYn.equals("Y")) query.append(" AND CARD_EVD_DOC_CNT != 0");
            else query.append(" AND CARD_EVD_DOC_CNT = 0");
        }
        if(searchFileType.equals("45")) {
            if(srhEvidYn.equals("Y")) query.append(" AND BE_COM_EVD_DOC_CNT != 0");
            else query.append(" AND BE_COM_EVD_DOC_CNT = 0");
        }
        if(searchFileType.equals("50")) {
            if(srhEvidYn.equals("Y")) query.append(" AND ETC_EVD_DOC_CNT != 0");
            else query.append(" AND ETC_EVD_DOC_CNT = 0");
        }
	}
...
<%
	...
	if("selectSelfInputHisMgrList".equals(cmd)) {
		...
		try {
			listData = selectSelfInputHisMgrList(mp, locPath, ssnYeaLogYn);
		} catch(Exception e) {
			code = "-1";
