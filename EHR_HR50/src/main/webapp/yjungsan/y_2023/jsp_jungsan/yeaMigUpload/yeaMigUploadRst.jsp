...
public List getColDataList(Map paramMap, String locPath) throws Exception {
	//파라메터 복사.
	Map pm =  StringUtil.getParamMapData(paramMap);
	//xml 파서를 이용한 방법;
	Map queryMap = XmlQueryParser.getQueryMap(locPath);
...
//이관업로드 관리 (기본정보 조회)
public List selectMigInfoMgrList(Map paramMap, String locPath) throws Exception {
	//파라메터 복사.
	Map pm =  StringUtil.getParamMapData(paramMap);
	//xml 파서를 이용한 방법;
	Map queryMap = XmlQueryParser.getQueryMap(locPath);
...
//이관업로드 관리 (현근무지정보 조회)
public List selectMigCurWpMgrList(Map paramMap, String locPath) throws Exception {	
	//파라메터 복사.
	Map pm =  StringUtil.getParamMapData(paramMap);
	//xml 파서를 이용한 방법;
	Map queryMap = XmlQueryParser.getQueryMap(locPath);
...
//이관업로드 관리 (소득공제 조회)
public List selectIncomeDdctList(Map paramMap, String locPath) throws Exception {
	//파라메터 복사.
	Map pm =  StringUtil.getParamMapData(paramMap);
	//xml 파서를 이용한 방법;
	Map queryMap = XmlQueryParser.getQueryMap(locPath);
...
public List selectTaxReductDdctList(Map paramMap, String locPath) throws Exception {
	//파라메터 복사.
	Map pm =  StringUtil.getParamMapData(paramMap);
	//xml 파서를 이용한 방법;
	Map queryMap = XmlQueryParser.getQueryMap(locPath);
...
<%
	...
	if("selectHeaderList".equals(cmd)) {
		...
		try {
			listData = getColDataList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
		...
		try {
			listData = selectMigInfoMgrList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
		...
		try {
			listData = selectMigCurWpMgrList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
		...
		try {
			listData = selectIncomeDdctList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
		...
		try {
			listData = selectTaxReductDdctList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
