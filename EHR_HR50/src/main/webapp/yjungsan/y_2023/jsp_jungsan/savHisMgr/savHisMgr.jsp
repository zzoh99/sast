...
<script type="text/javascript">
	...
	function doAction1(sAction) {
				...
				for(var j = 0; j < insertArray.length; j++){
					...
					if(sheet1.GetCellValue(insertArray[j],"saving_deduct_type")=='55' || sheet1.GetCellValue(insertArray[j],"saving_deduct_type")=='60' || sheet1.GetCellValue(insertArray[j],"saving_deduct_type")=='65'){
						...
						if(!yearPattern.test(sheet1.GetCellValue(insertArray[j], "reg_dt"))) {
							alert("년도 형식이 다릅니다. ex)2021 ~ 2023");
							sheet1.SetCellValue(insertArray[j],"reg_dt", "");
							return;
						}
					}
		...
		case "Clear":
			...
			break;
		case "Down2Template":
			var param  = {DownCols:"work_yy|adjust_type|sabun|saving_deduct_type|finance_org_cd|reg_dt|mth_per|account_no|appl_mon|adj_input_type",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
