...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata1.Cols = [
            ...
            {Header:"급여구분|급여구분",          Type:"Text",    Hidden:0,   Width:100,  Align:"Center", ColMerge:1, SaveName:"pay_nm",              KeyField:0, CalcLogic:"",   Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100},
            ...
            {Header:"급여구분코드|급여구분코드",  Type:"Text",    Hidden:1,   Width:100,  Align:"Center", ColMerge:1, SaveName:"pay_cd",              KeyField:0, CalcLogic:"",   Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10},
            ...
            {Header:"마감여부|마감여부",          Type:"Text",    Hidden:0,   Width:45,   Align:"Center", ColMerge:1, SaveName:"final_close_yn",      KeyField:0, CalcLogic:"",   Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:8}
        ]; IBS_InitSheet(sheet1, initdata1);sheet1.SetEditable(false);sheet1.SetVisible(true);sheet1.SetCountPosition(4);

        var payCd = stfConvCode( ajaxCall("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&queryId=getRetirePayCdList3","",false).codeList, "");
    ...
    function doAction1(sAction) {
        switch (sAction) {
        case "Search":
            sheet1.DoSearch("<%=jspPath%>/yeaCalcRetire/yeaCalcRetirePayDayPopupRst.jsp?cmd=selectYeaCalcRetirePayDayPopupList2",$("#sheetForm").serialize());
            break;
        case "Down2Excel":
                ...
                <div class="sheet_search outer">
                    <div>
                        <table>
                            <tr>
                                <td><span>대상년월 </span>
                                    <input id="searchPayCd" name="searchPayCd" type="hidden" />
