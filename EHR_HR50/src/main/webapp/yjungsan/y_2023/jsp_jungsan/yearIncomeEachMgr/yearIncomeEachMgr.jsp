...
<script type="text/javascript">
	...
	var isReduceYmd = false; //감면기간 존재여부
		...
		initdata1.Cols = [
			...
			{Header:"정산구분",			Type:"Combo",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,   SaveName:"adjust_type",		KeyField:0,   CalcLogic:"",   Format:"",		PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
