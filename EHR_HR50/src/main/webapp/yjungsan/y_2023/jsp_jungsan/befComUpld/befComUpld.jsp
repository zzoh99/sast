...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"국외비과세\n(18)",                       Type:"AutoSum", Hidden:0,  Width:90,    Align:"Right",  ColMerge:0, SaveName:"notax_abroad_mon",    KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
