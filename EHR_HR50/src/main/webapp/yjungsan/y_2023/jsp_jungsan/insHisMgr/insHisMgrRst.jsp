	...
	if("selectInsHisMgrList".equals(cmd)) {
		...
		try {
			...
			for(int i = 0; i < listMap.size(); i++) {
				...
				//String preBabyYn     = (String)data.get("pre_baby_yn");  2022 추가된 미숙아여부 사용시 주석해제
				...
				String[] type =  new String[]{"OUT","OUT","STR","STR","STR"
						...
						,"STR","STR","STR","STR","STR","STR"};// 2022 추가된 미숙아여부 사용시 PRE_BABY_YN(미숙아여부)항목 추가로 파라미터 갯수 증가
				String[] param = new String[]{"","","E",ssnEnterCd,workYy
						...
						,feedback_type,"",nanim_yn,ssnSabun,docSeq,docSeqDetail}; //2022 추가된 미숙아여부 사용시 빈값에 preBabyYn 항목추가
