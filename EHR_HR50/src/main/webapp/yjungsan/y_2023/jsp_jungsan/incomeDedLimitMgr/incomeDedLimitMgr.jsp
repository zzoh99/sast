...
<!DOCTYPE html> <html class="hidden"><head> <title>소득공제한도차감업로드</title>
...
<script type="text/javascript">
	...
	$(function() {
        ...
        initdata1.Cols = [
            ...
            {Header:"대상연도",				Type:"Text",    	Hidden:0,  	Width:25,	Align:"Center", ColMerge:1, SaveName:"work_yy",			KeyField:1,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
            {Header:"정산구분",				Type:"Combo",    	Hidden:0,  	Width:30,	Align:"Center", ColMerge:1, SaveName:"adjust_type",		KeyField:1,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
            ...
            {Header:"한도차감금액",             Type:"AutoSum",    Hidden:0,   Width:50,   Align:"Right",  ColMerge:1, SaveName:"ded_mon",     		KeyField:0, 				  Format:"NullInteger",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35},
        ...
        var contributionCdList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&useYn=Y", "YEA300"), "" );
        var deductionCdList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&useYn=Y", "YEA300"), "" );
    ...
    function doAction1(sAction) {
		...
		case "Down2Template":
			var param  = {DownCols:"work_yy|adjust_type|sabun|fam_nm|deduction_cd|adj_element_cd|ded_mon|memo",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
...
<div class="wrapper">
    ...
    <div class="outer">
        ...
        <div>
	    	<font size='2' style="color: red; font-weight: bold;">
	    	<br/>
			    ※ 자료등록에 입력된 항목에서 해당 금액이 차감되어 반영되오니 금액이 정상적으로 등록됐는지 확인 부탁드립니다.<br/>
		    </font>
	    </div>
        <ul>
            <li class="btn">
