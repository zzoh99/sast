...
//기부금조정명세(개인별) 조회
public List selectDonationAdjEmpList(Map paramMap, String locPath, String ssnYeaLogYn) throws Exception {
...
<%
	...
	if("selectDonationAdjEmpList".equals(cmd)) {
		...
		try {
			listData = selectDonationAdjEmpList(mp, locPath, ssnYeaLogYn);
		} catch(Exception e) {
			code = "-1";
