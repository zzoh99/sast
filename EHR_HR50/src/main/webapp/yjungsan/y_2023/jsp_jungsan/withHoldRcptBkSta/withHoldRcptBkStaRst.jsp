...
//원천징수부 대상자 조회
public List selectWithHoldRcptBkStaList(Map paramMap, String locPath, String ssnYeaLogYn) throws Exception {
	...
	try{
		//쿼리 실행및 결과 받기.
		listData  = (queryMap == null) ? null : DBConn.executeQueryList(queryMap,"selectWithHoldRcptBkStaList",pm);
...
<%
	String locPath = xmlPath+"/withHoldRcptBkSta/withHoldRcptBkSta.xml";
	...
	if("selectWithHoldRcptBkStaList".equals(cmd)) {
		//원천징수부 대상자 조회
		...
		try {
			listData = selectWithHoldRcptBkStaList(mp, locPath, ssnYeaLogYn);
		} catch(Exception e) {
			code = "-1";
