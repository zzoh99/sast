  ...
  <div class="wrapper wid-outer">
    <div class="wid-27 hidebox">
      <div class="inner-padding">
        ...
        <input type="hidden" id="paramYear" name="paramYear" value="2023"/>
      ...
      <div class="inner-padding">
        ...
        <div class="upload-result hidebox">
          ...
          <!-- 
            ...
            <div class="upload-card item" onclick="changeClass(this)" id="btnIns">
            ...
            <a href="javascript:doAction2('Search', 'G111Y');">
            <div class="upload-card item" onclick="changeClass(this)">
            ...
            <a href="javascript:doAction2('Search', 'G311Y,G411Y');">
            <div class="upload-card item" onclick="changeClass(this)">
            ...
            <a href="javascript:doAction2('Search', 'G211M');">
            <div class="upload-card item" onclick="changeClass(this)">
