...
%>
        ...
        initdata2.Cols = [
            ...
            {Header:"건수|건수",                                   Type:"AutoSum",         Hidden:0,   Width:50,   Align:"Right",  ColMerge:1, SaveName:"cnt",             KeyField:1, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"금액자료|직원용",                             Type:"Int",     Hidden:0,   Width:60,   Align:"Right",  ColMerge:1, SaveName:"input_mon",       KeyField:0, Format:"#,###",      PointCount:0,   UpdateEdit:<%=inputEdit%>,   InsertEdit:<%=inputEdit%>,   EditLen:35, MinimumValue: 0 },
            {Header:"금액자료|담당자용",                           Type:"Int",     Hidden:0,   Width:60,   Align:"Right",  ColMerge:1, SaveName:"appl_mon",        KeyField:1, Format:"#,###",      PointCount:0,   UpdateEdit:<%=applEdit%>,    InsertEdit:<%=applEdit%>,    EditLen:35, MinimumValue: 0 },
            ...
            {Header:"미숙아ㆍ선천성이상아\n해당여부|미숙아ㆍ선천성이상아\n해당여부",   Type:"CheckBox",    Hidden:0,   Width:140,   Align:"Center", ColMerge:1, SaveName:"pre_baby_yn",        KeyField:0, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1, TrueValue:"Y", FalseValue:"N", HeaderCheck: 0 },
            {Header:"난임시술비\n해당여부|난임시술비\n해당여부",   Type:"CheckBox",    Hidden:0,   Width:80,   Align:"Center", ColMerge:1, SaveName:"nanim_yn",        KeyField:0, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1, TrueValue:"Y", FalseValue:"N", HeaderCheck: 0 },
        ...
        try {
            ...
            if (Code == 1) {
                ...
                for(var i = sheet2.HeaderRows(); i <= sheet2.LastRow(); i++){
                    ...
                    if(sheet2.GetCellText(i,"special_yn") == "본인" || sheet2.GetCellText(i,"special_yn") == "65세이상" 
...
/*
  ...
  */          	
            ...
            if(sheet2.GetCellValue(Row,"nanim_yn") == 'Y' && sheet2.GetCellValue(Row,"pre_baby_yn") == 'Y' ) {
            	alert("난임시술비해당여부와 난임시술비해당여부를 동시에 선택할 수 없습니다.");
...
<div class="wrapper">
    ...
    <tr>
        <th class="center">본인/65세이상 대상 의료비</th>
    ...
    <div class="outer">
	    <div>
	    	...
	    	<font size='2'>
			    ...
			    <font class="red">※ 총급여액 7천만원을 초과</font>시 <font class="red">산후조리원</font> 금액은 세금계산에서 제외됩니다.<br>
