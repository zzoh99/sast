		...
		// 신용카드구분이 2013 일 경우(명의인:본인, 반기구분:2013 전체)
			...
			if ($("#searchWorkYy").val() != shtObj.GetCellValue(Row, "use_yyyy")) {
				...
				alert("근로제공기간 이외 신용카드등 사용액의 대상은"
						+ "\n다음과 같습니다."
						+ "\n * 종전근무지를 포함하여 2023.1.1 ~ 2023.12.31 기간중 "
						+ "\n   근로하지 아니한 기간에 사용한 본인 신용카드등 사용액");
...
<script type="text/javascript">
	function load_sheet1() {
		...
		initdata1.Cols = [
			...
			{Header:"도서공연등사용분|도서공연등사용분",			Type:"AutoSum",	Hidden:1,   Width:60,   Align:"Right",   ColMerge:0, SaveName:"tot_book_amt",		KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			...
			{Header:"전통시장사용분|전통시장사용분",			Type:"AutoSum",	Hidden:1,   Width:80,   Align:"Right",   ColMerge:0, SaveName:"tot_market_amt",		KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			...
			{Header:"2023 합계\n(사업관련비용제외)|2023 합계\n(사업관련비용제외)",	Type:"AutoSum",	Hidden:0,   Width:70,	Align:"Right",   ColMerge:0, SaveName:"tot_amt",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			...
			{Header:"2022 합계\n(사업관련비용제외)|2022 합계\n(사업관련비용제외)",  Type:"AutoSum", Hidden:1,   Width:70,   Align:"Center",   ColMerge:0, SaveName:"tot_amt_2022",  KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			//{Header:"2022 합계\n(사업관련비용제외)|전체",                 	Type:"AutoSum", Hidden:0,   Width:60,   Align:"Center",   ColMerge:0, SaveName:"tot_amt_2022",       KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			//{Header:"2022 합계\n(사업관련비용제외)|전통시장",                 Type:"AutoSum", Hidden:0,   Width:60,   Align:"Center",   ColMerge:0, SaveName:"tot_market_amt_2022",       KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
...
<script type="text/javascript">
	...
	function load_sheet2() {
		...
		initdata1.Cols = [
            ...
            {Header:"사용연도|사용연도",           Type:"Combo",      Hidden:1,  Width:60,    Align:"Center",  ColMerge:1,   SaveName:"use_yyyy",        KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:4 },
...
// 		sheet2.SetColProperty("period_type",		 {ComboText:"|"+periodType[0], ComboCode:"|"+periodType[1]} );
		...
		sheet2.SetColProperty("use_yyyy", {ComboText:"2023", ComboCode:"2023"});
	  	//양식다운로드 title 정의
	  	templeteTitle2 = "업로드시 이 행은 삭제 합니다\n\n";
		var codeCdNm = "", codeCd = "", codeNm = "";
...
<!-- 				</select> -->
                <!-- 사용연도 추가 (2021.11.12) -->
                <div style="display:none"><!-- 사용연도 숨김처리 (2023.11.27) -->
                <span>사용연도</span>
                <select id="searchUseYyyy" name="searchUseYyyy" onchange="javascript:doAction2('Search');">
                    <option value="2023" selected="selected">2023</option>
                    <!-- 2023.11.01 - 전년도 값 보여주는 부분 주석 <option value="2022">2022</option> -->
                </select>
                </div>
				<span>&nbsp;&nbsp;신용카드 구분</span>
