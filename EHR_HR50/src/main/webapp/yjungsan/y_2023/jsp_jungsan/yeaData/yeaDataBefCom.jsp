...
var curRow = "";
    $(function() {
        ...
        initdata1.Cols = [
            ...
            {Header:"소득세(73-79)",                           Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"income_tax_mon",      KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35, MinimumValue: 0 },
            {Header:"지방소득세(73-80)",                       Type:"AutoSum", Hidden:0,  Width:100,    Align:"Right",  ColMerge:0, SaveName:"inhbt_tax_mon",       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35, MinimumValue: 0 },
            {Header:"농특세(73-81)",                           Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"rural_tax_mon",       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35, MinimumValue: 0 },
            ...
            {Header:"식대비과세",                   Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"notax_food_mon",      KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35, MinimumValue: 0 },
            ...
            {Header:"결정세액(72)",             Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"fin_tot_tax_mon",       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35, MinimumValue: 0 },
        ...
        initdata2.Cols = [
            ...
            {Header:"총액",		Type:"Int",		Hidden:0,  Width:80,   Align:"Right",  ColMerge:0,   SaveName:"mon",				KeyField:0,   CalcLogic:"",   Format:"Integer", PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35, MinimumValue: 0 },
...
--%>
    ...
    function openBefComMgrPopup(Row) {
		...
		args["fin_tot_tax_mon"]		= sheet1.GetCellValue(Row, "fin_tot_tax_mon"); /* 2023.01.09.결정세액 */
	...
	function getReturnValue(returnValue) {
		...
		if ( pGubun == "befComMgrPopup" ){
			...
			sheet1.SetCellValue(Row, "fin_tot_tax_mon", rv["fin_tot_tax_mon"] ); /* 2023.01.09.결정세액 */
...
<div class="wrapper" >
    ...
    <div class="outer">
        ...
        <ul>
            ...
            <span class="txt red">※ 소득세 및 지방소득세는 결정세액을 입력하여 주십시오.(차감징수세액 아님)</span>
            </li>
            <li class="btn">
