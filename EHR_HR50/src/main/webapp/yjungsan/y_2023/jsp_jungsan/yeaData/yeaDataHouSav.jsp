...
//         doAction2("Search");
    ...
    function sheetSet(){
        ...
        if(comSheet.RowCount() > 0){
			...
			var intMon = 0 ;
			intMon = intMon + comSheet.GetCellValue(comSheet.FindText("adj_element_cd", "A100_81"),"input_mon") ; // 중소기업창업투자2021(조합1)
			intMon = intMon + comSheet.GetCellValue(comSheet.FindText("adj_element_cd", "A100_82"),"input_mon") ; // 중소기업창업투자2021(조합2)
			intMon = intMon + comSheet.GetCellValue(comSheet.FindText("adj_element_cd", "A100_83"),"input_mon") ; // 장기집합투자저축2021(벤처)
...
<script type="text/javascript">
	function loadSheet3() {
		...
		var feedbackTypeList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList","C00329"), "");
		var retPenTypeList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList","C00318"), "");
		var savingDeductTypeList2 = stfConvCode( ajaxCall("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&queryId=getSavingDeductList","searchGubun=10",false).codeList, "");
