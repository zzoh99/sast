	...
	function sheet1_OnSearchEnd(Code, Msg, StCode, StMsg) {
		try {
			...
			for(var i = 1; i < sheet1.RowCount()+1; i++) {
			    ...
			    %>
			    var type = "";
				var filePath = "<%=wfsUploadPath%>"+sheet1.GetCellValue(i,"file_path")+"/"+sheet1.GetCellValue(i,"file_name");
				<%
				}
				%>
				/*************************************************************************************************************/
				sheet1.SetCellValue(i,"file_link","<a href=\"javascript:openPdfViewPopup('"+type+"','"+filePath+"')\" class='basic btn-white out-line ico-popup'>보기</a>");
				if(sheet1.GetCellValue(i, "fileapply") == "N") {
					sheet1.SetCellValue(i,"delfile_link","<a href=\"javascript:deletePdf('"+i+"', '"+filePath+"')\" class='basic btn-white'>삭제</a>");
				} else {
