...
--%>
	...
	function sheetToZipCode(){
		if(sheet1.RowCount() == 0){
			...
			$("input[name='tax_ins_yn']:input[value='"+sheet1.GetCellValue(sheet1.LastRow(),"tax_ins_yn")+"']").attr("checked",true);
...
<div class="wrapper">
	...
	<tr id="tr_tax_ins_yn">
		<th>분납신청 여부</th>
		<td class="left">
			<input type="radio" class="radio <%=disabled%>" name="tax_ins_yn" id="tax_ins_yn_2" value = "N" <%=disabled%>>&nbsp;미신청
			<input type="radio" class="radio <%=disabled%>" name="tax_ins_yn" id="tax_ins_yn_1" value = "Y" <%=disabled%> checked >&nbsp;신청
		</td>
	</tr>
	<tr id="tr_tax_rate">
		<th>원천징수세액 선택</th>
