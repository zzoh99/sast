...
<%} %>
	...
	<tr>
		...
		<td class="right"> 
			<input id="B010_30" name="B010_30" type="text" class="text w90 right" /> 원 
		</td>
		<td class="left" > 
	...
	<tr>
		...
		<td class="right"> 
			<input id="B010_31" name="B010_31" type="text" class="text w90 right" /> 원 
		</td>
		<td class="left" > 
	...
	<tr>
		...
		<td class="right"> 
			<input id="B010_32" name="B010_32" type="text" class="text w90 right" /> 원 
		</td>
		<td class="left" > 
			&nbsp;2016.01.01일 이후 입사한 조세특례제한법 제 30조에 해당하는 중소기업 취업자의 감면 대상 소득 <br>
			&nbsp;<font style="color: red; ">(한도 150만원)</font>		
		</td>
	</tr>
