...
<%
//자료등록 화면에서 타인 검색이 필요한 경우 아래 ENTER_CD 등록
if( "WC".equals(session.getAttribute("ssnEnterCd")) || 
	 "11".equals(session.getAttribute("ssnEnterCd")) || 
	 "21".equals(session.getAttribute("ssnEnterCd")) || 
	 "31".equals(session.getAttribute("ssnEnterCd")) || 
	 "ISU_CM".equals(session.getAttribute("ssnEnterCd")) || 
	 "ISU_PS".equals(session.getAttribute("ssnEnterCd")) || 
	 "ISU_EXBD".equals(session.getAttribute("ssnEnterCd")) || 
	 "SDME".equals(session.getAttribute("ssnEnterCd")) 
){
%>
	<%@ include file="../common/include/employeeHeaderYtax.jsp"%>
<%
...
%>
	<jsp:include page="../common/include/employeeHeaderYtax.jsp" flush="true">
	...
	function doAction(sAction) {
		...
		case "TaxCalc":
			...
			if(yeaDefaultInfo.Data.apprv_yn == "Y") {
				...
				if(confirm('담당자마감된 자료는  담당자가 서류검토를 진행하여 \n데이터를 조정할 수 있어서 기존 결과와 다를수 있습니다.\n 세액/계산 결과보기를 진행 하시겠습니까?')){
