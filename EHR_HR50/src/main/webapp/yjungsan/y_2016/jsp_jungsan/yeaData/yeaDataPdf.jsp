...
%>	
		...
		initdata1.Cols = [
			...
			{Header:"마지막 등록일시",			Type:"Text",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"chkdate",			KeyField:0,	Format:"YmdHms",PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100},
			{Header:"파일 수",			Type:"Text",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"cnt",			KeyField:0,	Format:"",PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100},
			{Header:"PDF확인",			Type:"Html",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"file_link",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100}
		...
		initdata2.Cols = [
			...
			{Header:"처리결과",		Type:"Text",		Hidden:0,	Width:120,	Align:"Center",	ColMerge:1,	SaveName:"error_log",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4000 },
			...
			{Header:"반영제외자",		Type:"Combo",		Hidden:0,	Width:50,	Align:"Center",	ColMerge:1,	SaveName:"except_gubun",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 }			
	...
	function doAction(sAction) {
		...
		case "Search":
			...
			if(data.Result.Code == 1) {
				...
				$("#btnLongSav > .pdfAmt").text( comma(map.long_sav_amt) );			$("#btnLongSav > .pdfCnt").text("반영("+ map.long_sav_cnt +"), 미반영("+ map.long_sav_cnt_err +")");
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			sheet1.DoSearch( "<%=jspPath%>/yeaData/yeaDataPdfRst.jsp?cmd=selectYeaDataPdfInfo", $("#sheetForm").serialize() ); 
			break;
		}
	}	
		...
		try {
			...
			if(Code == 1) {
				for(var i = 1; i < sheet1.RowCount()+1; i++) {
					...
					var filePath = "<%=jspPath%>/yeaData/yeaPdfListPopup.jsp?&authPg=A";
					sheet1.SetCellValue(i,"file_link","<a href=\"javascript:openPdfViewPopup('"+filePath+"')\" class='basic'>확인</a>");
				}	
	...
	function openPdfUploadPopup(){
		...
		if(!isPopup()) {return;}
		pGubun = "pdfUploadPop";
		var rv = openPopup("<%=jspPath%>/common/pdfUploadPop.jsp",args,"750","570");
	...
	function openPdfViewPopup(url){
		...
		var rv = openPopup(url,args,"700","400");
	}
	...
	<div class="outer">
		...
		<table style="width:100%;">
			...
			<tr>
				...
				<td style="padding:5px;">
					<a href="javascript:doAction2('Search', 'C101Y,C202Y,C301Y');" class="pdf" id="btnEdu">
				...
				<td style="padding:5px;">
					<a href="javascript:doAction2('Search', 'G104Y');" class="pdf" id="btnCreditCard">
						<span class="pdfItem">신용카드</span>
						<span class="pdfAmt"></span>
						<span class="pdfCnt"></span>
						<font color="blue" >['14년~'16년 전체 금액]</font>
					</a>
				</td>
				<td style="padding:5px;">
					<a href="javascript:doAction2('Search', 'G304Y');" class="pdf" id="btnCheckCard">
				...
				<td style="padding:5px;">
					<a href="javascript:doAction2('Search', 'G205M');" class="pdf" id="btnCash">
			...
			<tr>
				...
				<td style="padding:5px;">
					<a href="javascript:doAction2('Search', 'N101Y');" class="pdf" id="btnLongSav">
						<span class="pdfItem">장기집합투자증권저축</span>
						<span class="pdfAmt"></span>
						<span class="pdfCnt"></span>
					</a>
				</td>
