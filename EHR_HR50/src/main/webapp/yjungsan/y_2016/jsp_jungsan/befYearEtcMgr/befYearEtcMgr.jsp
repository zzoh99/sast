...
<script type="text/javascript">
    ...
    $(function() {  
        ...
        initdata.Cols = [
            ...
            {Header:"비과세액",        Type:"AutoSum",     Hidden:0,  Width:110,   Align:"Right",  ColMerge:1,   SaveName:"notax_mon",         KeyField:0,   CalcLogic:"",   Format:"Integer", PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:160 }
