...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
	        ...
	        {Header:"반기구분",        	Type:"Combo",     Hidden:0,  Width:95,    Align:"Center",  ColMerge:1,   SaveName:"half_gubun",		KeyField:1,   CalcLogic:"",   Format:"",     	PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
	...
	function doAction1(sAction) {
        ...
        case "Down2Excel":
			...
			break;
		case "Down2Template":
			var param  = {DownCols:"5|6|7|8|12|13|14|17|18|19",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
...
<div class="wrapper">
    ...
    <div class="sheet_search outer">
        ...
        <table>
			<tr>
			    <td><span>반기구분</span>
					<select id="searchHalfGubun" name ="searchHalfGubun" onChange="javascript:doAction1('Search')" class="box"></select> 
				</td>
				<td><span>카드구분</span>
