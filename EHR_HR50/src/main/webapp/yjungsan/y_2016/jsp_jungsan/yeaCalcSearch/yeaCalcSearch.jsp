...
<script type="text/javascript">
    ...
    $(function() {  
        ...
        initdata.Cols = [
                        ...
                        {Header:"귀속시작일",                            Type:"Text",            Hidden:0,  Width:100,    Align:"Center",    ColMerge:1,   SaveName:"adj_s_ymd",                       KeyField:0,   CalcLogic:"",   Format:"Ymd",     PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"귀속종료일",                            Type:"Text",            Hidden:0,  Width:100,    Align:"Center",    ColMerge:1,   SaveName:"adj_e_ymd",                       KeyField:0,   CalcLogic:"",   Format:"Ymd",     PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
