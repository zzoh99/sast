	...
	function shtToCtl(){		 
		if(sheet1.RowCount() > 0){
			for (i = 1; i < sheet1.RowCount()+1; i++){
				...
				} else if(sheet1.GetCellValue(i,"std_cd")=="CPN_YEA_PAYTOT_YN"){   //연간소득 및 종전근무지 탭 사용 여부
	...
	<div class="wrapper">
		...
		<div>
			<table border="0" cellpadding="0" cellspacing="0" class="default outer">
				...
				<tr>
					<td class="left">
						<b>[연간소득 및 종전근무지 탭 사용 여부]</b><br>
						&nbsp;자료등록 메뉴에서 연간소득 및 종전근무지 탭 사용 유무를 선택할 수 있습니다.(자료등록(관리자)에는 영향을 미치지 않습니다.)<br>
						&nbsp;YES : 연간소득 및 종전근무지 탭을 오픈하여 사용합니다.<br>
						&nbsp;NO : 연간소득 및 종전근무지 탭을 숨깁니다.<br>
					</td>
					<td align="left">
