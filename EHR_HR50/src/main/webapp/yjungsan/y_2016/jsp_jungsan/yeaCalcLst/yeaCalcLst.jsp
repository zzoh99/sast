...
<script type="text/javascript">
	...
	function getLoad(){
		if(sheet3.GetCellValue(1, "final_close_yn") == "Y" || sheet3.GetCellValue(1, "apprv_yn") == "Y"){
	...
	function print(){
		...
		var pageChk = "";
		var enterCdCk = '<%=removeXSS(session.getAttribute("ssnEnterCd"), "1")%>';
		
		if(enterCdCk == 'SH' || enterCdCk == 'GT'){
			pageChk = "3";
		...
		<div class="outer">
		    <div class="sheet_title">
		        <ul>
		            ...
		            <li class="btn" >
		            	<span id="viewYN" style="display:none;">
