		...
		try {
			...
			if(Code == 1) {
				for(var i = 1; i < sheet1.RowCount()+1; i++) {
					...
					sheet1.SetCellValue(i,"file_link","<a href=\"javascript:openPdfViewPopup('"+sheet1.GetCellValue(i,"sabun")+"')\" class='basic'>확인</a>");
				}	
			}
...
// 	}
	...
	function empIncomeDeductionDeclarationPopup(sabuns, sortSabuns, sortNos){
		...
		args["rdParam"] = "[<%=removeXSS(session.getAttribute("ssnEnterCd"), "1")%>] ["+$("#searchWorkYy").val()+"] ["+$("#searchAdjustType").val()+"]"+
		                  ...
		                  "[4] ["+sortSabuns+"] ["+sortNos+"] ["+printYmd+"]" + "[" + $("#searchPageLimit").val() + "]"; //rd파라매터 JSG
