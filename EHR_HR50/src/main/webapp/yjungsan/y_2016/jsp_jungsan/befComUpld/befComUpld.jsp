...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"년도",                  Type:"Text",      Hidden:0,  Width:40,    Align:"Left",   ColMerge:0, SaveName:"work_yy",             KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            {Header:"정산구분",              Type:"Combo",     Hidden:0,  Width:60,    Align:"Left",   ColMerge:0, SaveName:"adjust_type",         KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            ...
            {Header:"급여액(13)",                           Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"pay_mon",             KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"상여액(14)",                           Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"bonus_mon",           KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"인정상여(15)",                         Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"etc_bonus_mon",       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            ...
            {Header:"소득세(64)",                           Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"income_tax_mon",      KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"지방소득세(64)",                       Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"inhbt_tax_mon",       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"농특세(64)",                           Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"rural_tax_mon",       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            ...
            {Header:"별정우체국연금",                       Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"etc_mon4",            KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            ...
            {Header:"국외비과세(18)",                       Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"notax_abroad_mon",    KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"생산직비과세(18-1)",                   Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"notax_work_mon",      KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            ...
            {Header:"취재수당\n비과세(18-6)",                     Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"notax_reporter_mon",  KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"수련보조수당\n비과세(19)",             Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"notax_etc_mon",       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 }
    ...
    function doAction1(sAction) {
        ...
        case "Save":
            ...
            sheet1.DoSave( "<%=jspPath%>/befComUpld/befComUpldRst.jsp?cmd=saveBefComUpld"); 
            break;
        case "Insert":
        ...
        case "Down2Excel":
            ...
            break;
        case "Down2Template":
            var param  = {DownCols:"sabun|enter_nm|napse_yn|enter_no|work_s_ymd|work_e_ymd|reduce_s_ymd|reduce_e_ymd|pay_mon|bonus_mon|etc_bonus_mon|stock_buy_mon|stock_union_mon|imwon_ret_over_mon|income_tax_mon|inhbt_tax_mon|rural_tax_mon|pen_mon|etc_mon1|etc_mon2|etc_mon3|etc_mon4|hel_mon|emp_mon|notax_abroad_mon|notax_work_mon|notax_baby_mon|notax_research_mon|notax_etc_mon",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
...
<div class="wrapper">
    ...
    <div class="sheet_search outer">
        ...
        <table>
            <tr>
                <td><span>년도</span>
                <input id="searchWorkYy" name ="searchWorkYy" type="text" class="text readonly" maxlength="4" style="width:35px" readonly/> </td>
