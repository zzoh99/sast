...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"정산구분",               Type:"Text",      Hidden:1,  Width:70,  Align:"Center",  ColMerge:1,   SaveName:"adjust_type",      KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
        ...
        var adjElementCdLst2 = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&searchWorkYy="+$("#searchWorkYy").val(),"getEtcDdctUpldAdjElementCdLst") , "");
    ...
    function doAction1(sAction) {
        ...
        case "Save":
            ...
            sheet1.DoSave( "<%=jspPath%>/etcDdctUpld/etcDdctUpldRst.jsp?cmd=saveEtcDdctUpld"); 
            break;
        case "Insert":
        ...
        case "Down2Excel":
            ...
            break;
        case "Down2Template":
        	var param  = {DownCols:"sabun|input_mon",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"};
            sheet1.Down2Excel(param); 
            break;
        case "LoadExcel":  
