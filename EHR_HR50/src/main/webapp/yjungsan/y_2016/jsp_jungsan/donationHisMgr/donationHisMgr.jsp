...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
	        ...
	        {Header:"기부장려금신청금액",	Type:"AutoSum",       Hidden:0,  Width:90,	Align:"Right",   ColMerge:1,   SaveName:"contribution_sup_mon",			KeyField:0,   CalcLogic:"",   Format:"",     	PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:35 },
	        {Header:"기부금액(전체)",		Type:"AutoSum",       Hidden:0,  Width:90,	Align:"Right",   ColMerge:1,   SaveName:"sum_mon",			KeyField:0,   CalcLogic:"",   Format:"",     	PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:35 },
