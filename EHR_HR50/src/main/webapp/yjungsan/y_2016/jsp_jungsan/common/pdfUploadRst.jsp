                                ...
                                */
                                ...
                                for(int dataIndex = 0; dataIndex < childList2.size(); dataIndex++ ) {
                                    ...
                                    for(int insuIndex = 0; insuIndex < childList3.size(); insuIndex++) {
                                        ...
                                        dataEtcValue = ((Element)childList3.get(insuIndex)).getValue();
                                        if("sum".equals(dataEtcName)) {
                                            dataMap.put("A4",((Element)childList3.get(insuIndex)).getAttributeValue("spym")); //추납보험료납부금액
                                            dataMap.put("A5",((Element)childList3.get(insuIndex)).getAttributeValue("jlc")); //기부장려금신청금액
                                            dataMap.put("A6",((Element)childList3.get(insuIndex)).getAttributeValue("ntf")); //직장가입자 고지금액 합계
                                            dataMap.put("A7",((Element)childList3.get(insuIndex)).getAttributeValue("pmt")); //지역가입자 등 납부금액 합계
                                            dataMap.put("A8",dataEtcValue); //총합계
                                        }
                                    }
