...
<script type="text/javascript">
	...
	$(function() {	
		...
		initdata1.Cols = [
			...
			{Header:"급여계산여부",	Type:"Text",	Hidden:1,  Width:0,    Align:"Center",   ColMerge:0,   SaveName:"cpn205Yn",     	KeyField:0,   CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 },     
	...
	function sheet1_OnSearchEnd(Code, Msg, StCode, StMsg) {
		try { 
			...
			for(var Row = sheet1.HeaderRows(); Row <= sheet1.LastRow(); Row++) {
				//급여일자가 지워졌거나 205에 계산내역이 있으면 지울 수 없다.
				if ( sheet1.GetCellValue(Row, "pay_action_nm") == "" || sheet1.GetCellValue(Row, "cpn205Yn") == "Y" ) {
    ...
    function sheet1_OnPopupClick(Row, Col){
        try{
        	var colName = sheet1.ColSaveName(Col);
     		...
     		if(colName == "sDelete" && sheet1.GetCellValue(Row, "cpn205Yn") == "Y" ) {
     			alert("급여계산된 자료이므로 삭제가 불가능 합니다.") ;
     		}
