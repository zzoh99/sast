...
// 	        // 자료생성
<%-- 	        var data = ajaxCall("<%=jspPath%>/simplePymtBsnsIncpMgr/simplePymtBsnsIncpMgrRst.jsp?cmd=P_CPN_SMPPYM_EMP",$("#sheet1Form").serialize(),false);			 --%>
// 		}else{
// 			//2021년 하반기부터 P_CPN_SMPPYM_EMP_2021 호출
<%-- 	        var data = ajaxCall("<%=jspPath%>/simplePymtBsnsIncpMgr/simplePymtBsnsIncpMgrRst.jsp?cmd=P_CPN_SMPPYM_EMP_2021",$("#sheet1Form").serialize(),false);			 --%>
// 		}
		var data = ajaxCall("<%=jspPath%>/simplePymtBsnsIncpMgr/simplePymtBsnsIncpMgrRst.jsp?cmd=P_CPN_SMPPYM_EMP_2022",$("#sheet1Form").serialize(),false);
