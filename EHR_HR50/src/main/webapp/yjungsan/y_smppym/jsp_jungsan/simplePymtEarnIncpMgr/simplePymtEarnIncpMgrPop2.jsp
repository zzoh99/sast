...
<script type="text/javascript">
    ...
    $(function(){
        ...
        //작업일자 sheet
        var payCdList = stfConvCode( ajaxCall("<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=getPayCdList","",false).codeList, "전체");        
        ...
        //인정상여설정 sheet
        var elementCd = stfConvCode( ajaxCall("<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=selectElementCd&searchYMD="+$("#searchYMD").val(),"",false).codeList, "");
    ...
    function doAction1(sAction) {
        switch (sAction) {
            case "Search":
                ...
                sheet1.DoSearch( "<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=selectPayAction", $("#sheet1Form").serialize() ); 
                break;
            case "Save":
                var ym  = "";
                var ym2 = "";
                ...
                sheet1.DoSave( "<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=saveEtcBouns", $("#sheet1Form").serialize());
                break;
            case "Down2Excel":
    ...
    function doAction2(sAction) {
        switch (sAction) {
            case "Search":
                sheet2.DoSearch( "<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=selectEtcBouns", $("#sheet1Form").serialize() );                 
                break;
            case "Insert":
            ...
            case "Save":
                ...
                sheet2.DoSave( "<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=updateEtcBouns", $("#sheet1Form").serialize());
                break;
        }
    }
    // 조회 후 에러 메시지
    ...
    function getPayCdChkCnt(){
        var payCdChkCnt = ajaxCall("<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=getPayCdChkCnt", $("#sheet1Form").serialize(), false);
    ...
    function callProcPop() {
        ...
        var data = ajaxCall("<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=P_CPN_SMPPYM_EMP_2022",$("#sheet1Form").serialize(),false);
