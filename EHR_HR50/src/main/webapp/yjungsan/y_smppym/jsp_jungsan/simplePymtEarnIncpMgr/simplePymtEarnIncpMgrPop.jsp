...
<script type="text/javascript">
	...
	function callProc() {
        ...
        if(workYy == "2021" && halfType == "2"){
        	...
        	var data = ajaxCall("<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=P_CPN_SMPPYM_EMP_2021 ",$("#sheet1Form").serialize(),false);
        }else if(workYy > "2021"){
        	//2022년 부터  P_CPN_SMPPYM_EMP_2021 호출
        	var data = ajaxCall("<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=P_CPN_SMPPYM_EMP_2021 ",$("#sheet1Form").serialize(),false);
        }else{
            // 자료생성
            var data = ajaxCall("<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=P_CPN_SMPPYM_EMP",$("#sheet1Form").serialize(),false);
        }
		...
		<td class="">
			<div class="inner">
				<table class="table w100p" style="margin-top: 5px;">
                    ...
                    <tr>
                       <td style="font-size: 13px;" colspan="2" align="left"><span style="color: red">12월 귀속 다음해 1월 지급분은 <b>하반기</b> 신고에 포함됩니다</span></td>
                    </tr>
				</table>
			</div>
		</td>
