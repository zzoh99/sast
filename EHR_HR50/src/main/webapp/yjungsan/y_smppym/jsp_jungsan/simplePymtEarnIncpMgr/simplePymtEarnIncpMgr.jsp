...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata0.Cols = [
                ...
                {Header:"사번|사번",		            Type:"Text",      	Hidden:0,  	Width:60,		Align:"Center",    	ColMerge:0,   	SaveName:"sabun",   			KeyField:1,   	CalcLogic:"",   Format:"",     		PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:500 },
                {Header:"성명|성명",  			        Type:"Popup",		Hidden:0,  	Width:70,   	Align:"Center",		ColMerge:0,   	SaveName:"name",				KeyField:1,   	CalcLogic:"",   Format:"",      	PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100 },
                ...
                {Header:"사업장|사업장",		        Type:"Combo",      	Hidden:0,  	Width:100,		Align:"Center",    	ColMerge:0,   	SaveName:"business_place_cd", 	KeyField:1,   	CalcLogic:"",   Format:"",    		PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:500 },
                {Header:"입사일|입사일",			    Type:"Date",      	Hidden:0,  	Width:80,   	Align:"Center",  	ColMerge:0,   	SaveName:"emp_ymd",				KeyField:0,   	CalcLogic:"",   Format:"Ymd",   	PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:8 },
                {Header:"퇴사일|퇴사일",			    Type:"Date",      	Hidden:0,  	Width:80,   	Align:"Center",  	ColMerge:0,   	SaveName:"ret_ymd",				KeyField:0,   	CalcLogic:"",   Format:"Ymd",   	PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:8 },
                ...
                {Header:"전화번호|전화번호",		        Type:"Text",      	Hidden:1,  	Width:110,		Align:"Center",    	ColMerge:0,   	SaveName:"tel_no",   			KeyField:0,   	CalcLogic:"",   Format:"PhoneNo", 	PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:11 },
				...
				{Header:"합계|급여 등",		    Type:"AutoSum",		Hidden:0,  	Width:100,		Align:"Right",    	ColMerge:1,   	SaveName:"tax_mon",   			KeyField:0,   	CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 },
				{Header:"합계|인정상여",	    Type:"AutoSum",		Hidden:0,  	Width:100,		Align:"Right",    	ColMerge:1,   	SaveName:"etc_bonus_mon",   	KeyField:0,   	CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 },
				{Header:"합계|소득합계",	    Type:"AutoSum",		Hidden:0,  	Width:100,		Align:"Right",		ColMerge:0,   	SaveName:"tax_mon_total",		KeyField:0,     CalcLogic:"",   Format:"Integer",	PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:35, CalcLogic:"|tax_mon|+|etc_bonus_mon|" },
				{Header:"대상년도|대상년도",		Type:"Text",		Hidden:1,  	Width:0,		Align:"Left",    	ColMerge:0,   	SaveName:"work_yy",   			KeyField:0,   	CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 },
				{Header:"반기구분코드|반기구분코드",Type:"Text",		Hidden:1,  	Width:0,		Align:"Left",    	ColMerge:0,   	SaveName:"half_type",   		KeyField:0,   	CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 },
				...
				{Header:"소득구분|소득구분",		Type:"Text",		Hidden:1,  	Width:0,		Align:"Left",    	ColMerge:0,   	SaveName:"income_type",   		KeyField:0,   	CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 },
...
// 	        	sheet1.ShowSubSum(info);
	        	//sheet1.DoSearch( "<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=getSimplePymtEarnIncpMgr", $("#mySheetForm").serialize() );
	        	break;
	        ...
	        case "Save":
		        ...
		        <%-- dupChk() 사용으로 변경 - 2020.01.14.
 				for(var j=1; j<=sheet1.LastRow()+1; j++) {
		        	...
		        	if(sheet1.GetCellValue(j, "sStatus") == "I") {
						...
						var data = ajaxCall("<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=getSabunChk", param,false);
	        	...
	        	sheet1.DoSave( "<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=saveSimplePymtEarnIncpMgr", $("#mySheetForm").serialize());
	        	break;
					...
					for(var i=1; i <= sheet1.LastRow(); i++){
						if(sheet1.GetCellValue(i, "final_close_yn") != "1"){
							...
							if($("#searchHalfType").val() == "1"){
								sheet1.SetCellEditable(i, "tax_mon_1",true);
								sheet1.SetCellEditable(i, "tax_mon_2",true);
								sheet1.SetCellEditable(i, "tax_mon_3",true);
								sheet1.SetCellEditable(i, "tax_mon_4",true);
								sheet1.SetCellEditable(i, "tax_mon_5",true);
								sheet1.SetCellEditable(i, "tax_mon_6",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_1",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_2",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_3",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_4",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_5",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_6",true);
							}else{
                                sheet1.SetCellEditable(i, "tax_mon_7",true);
                                sheet1.SetCellEditable(i, "tax_mon_8",true);
                                sheet1.SetCellEditable(i, "tax_mon_9",true);
                                sheet1.SetCellEditable(i, "tax_mon_10",true);
                                sheet1.SetCellEditable(i, "tax_mon_11",true);
                                sheet1.SetCellEditable(i, "tax_mon_12",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_7",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_8",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_9",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_10",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_11",true);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_12",true);
							}
						}else{
                            ...
                            if($("#searchHalfType").val() == "1"){
                                sheet1.SetCellEditable(i, "tax_mon_1",false);
                                sheet1.SetCellEditable(i, "tax_mon_2",false);
                                sheet1.SetCellEditable(i, "tax_mon_3",false);
                                sheet1.SetCellEditable(i, "tax_mon_4",false);
                                sheet1.SetCellEditable(i, "tax_mon_5",false);
                                sheet1.SetCellEditable(i, "tax_mon_6",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_1",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_2",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_3",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_4",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_5",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_6",false);
                            }else{
                                sheet1.SetCellEditable(i, "tax_mon_7",false);
                                sheet1.SetCellEditable(i, "tax_mon_8",false);
                                sheet1.SetCellEditable(i, "tax_mon_9",false);
                                sheet1.SetCellEditable(i, "tax_mon_10",false);
                                sheet1.SetCellEditable(i, "tax_mon_11",false);
                                sheet1.SetCellEditable(i, "tax_mon_12",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_7",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_8",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_9",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_10",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_11",false);
                                sheet1.SetCellEditable(i, "etc_bonus_mon_12",false);
                            }
						}
					}
				}
	...
	function callProcPop() {
		...
		var url 	= "<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrPop.jsp";
        var args = new Array();
    ...
    function callProcPopNew(Row) {
        ...
        var url     = "<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrPop2.jsp";
	...
	function finalCloseYnChk(val){
		...
		if(val == "C"){
			confirmMsg = "[ "+$("#searchYear").val()+"년 / "+$('#searchHalfType option:selected').text()+" / 사업장("+$('#searchBusinessPlace option:selected').text()+") ]"+" 전체 마감하시겠습니까?";
			closeYn    = "Y";
		}else{
			confirmMsg = "[ "+$("#searchYear").val()+"년 / "+$('#searchHalfType option:selected').text()+" / 사업장("+$('#searchBusinessPlace option:selected').text()+") ]"+" 전체 마감 취소하시겠습니까?";
			closeYn    = "N";
		}
		if(confirm(confirmMsg)){
			var params = $("#mySheetForm").serialize()+"&final_close_yn="+closeYn;
			ajaxCall("<%=jspPath%>/simplePymtEarnIncpMgr/simplePymtEarnIncpMgrRst.jsp?cmd=updateSimplePymtEarnIncpMgr",params,false);
			doAction1("Search");
		}
	}
	...
	function searchTitleList() {
		...
		if($("#halfDivFlag").val() == "true"){
			...
			initdata1.Cols = [];
			initdata1.Cols[v++] = {Header:"No|No",             Type:"<%=sNoTy%>",  Hidden:Number("<%=sNoHdn%>"),   Width:"<%=sNoWdt%>",    Align:"Center", ColMerge:0, SaveName:"sNo" };
			initdata1.Cols[v++] = {Header:"삭제|삭제",            Type:"<%=sDelTy%>", Hidden:Number("<%=sDelHdn%>"),  Width:"<%=sDelWdt%>",   Align:"Center", ColMerge:0, SaveName:"sDelete", Sort:0 };
			initdata1.Cols[v++] = {Header:"상태|상태",            Type:"<%=sSttTy%>", Hidden:Number("<%=sDelHdn%>"),  Width:"<%=sSttWdt%>",   Align:"Center", ColMerge:0, SaveName:"sStatus", Sort:0 };
			initdata1.Cols[v++] = {Header:"마감\n여부|마감\n여부",          Type:"CheckBox",    Hidden:0,   Width:50,       Align:"Center",     ColMerge:0,     SaveName:"final_close_yn",      KeyField:0,     CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:160};
			initdata1.Cols[v++] = {Header:"사번|사번",                   Type:"Text",        Hidden:0,   Width:60,       Align:"Center",     ColMerge:0,     SaveName:"sabun",               KeyField:1,     CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:500 };
			initdata1.Cols[v++] = {Header:"성명|성명",                   Type:"Popup",       Hidden:0,   Width:70,       Align:"Center",     ColMerge:0,     SaveName:"name",                KeyField:1,     CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100 };
			initdata1.Cols[v++] = {Header:"신고\n구분|신고\n구분",          Type:"Combo",       Hidden:0,   Width:60,       Align:"Center",     ColMerge:0,     SaveName:"send_type",           KeyField:1,     CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100 };
			initdata1.Cols[v++] = {Header:"사업장|사업장",                 Type:"Combo",       Hidden:0,   Width:100,      Align:"Center",     ColMerge:0,     SaveName:"business_place_cd",   KeyField:1,     CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:500 };
			initdata1.Cols[v++] = {Header:"입사일|입사일",                 Type:"Date",        Hidden:0,   Width:80,       Align:"Center",     ColMerge:0,     SaveName:"emp_ymd",             KeyField:0,     CalcLogic:"",   Format:"Ymd",       PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:8 };
			initdata1.Cols[v++] = {Header:"퇴사일|퇴사일",                 Type:"Date",        Hidden:0,   Width:80,       Align:"Center",     ColMerge:0,     SaveName:"ret_ymd",             KeyField:0,     CalcLogic:"",   Format:"Ymd",       PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:8 };
			...
			if($("#searchHalfType").val() == "1"){
			    //상반기
                initdata1.Cols[v++]  = {Header:"합계|급여 등",     Type:"AutoSum",  Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon",               KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
                initdata1.Cols[v++]  = {Header:"합계|인정상여",    Type:"AutoSum",  Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon",         KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
                initdata1.Cols[v++]  = {Header:"합계|소득합계",    Type:"AutoSum",  Hidden:0,   Width:100,      Align:"Right",      ColMerge:0,     SaveName:"tax_mon_total",         KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:35, CalcLogic:"|tax_mon|+|etc_bonus_mon|" };
			    initdata1.Cols[v++]  = {Header:"1월|급여 등",     Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_1",             KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"1월|인정상여",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_1",       KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"2월|급여 등",     Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_2",             KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"2월|인정상여",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_2",       KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"3월|급여 등",     Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_3",             KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"3월|인정상여",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_3",       KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"4월|급여 등",     Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_4",             KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"4월|인정상여",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_4",       KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"5월|급여 등",     Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_5",             KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"5월|인정상여",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_5",       KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"6월|급여 등",     Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_6",             KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"6월|인정상여",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_6",       KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
                initdata1.Cols[v++]  = {Header:"합계|급여 등",     Type:"Int",      Hidden:1,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"total_tax_mon_1",       KeyField:0,     CalcLogic:"|tax_mon_1|+|tax_mon_2|+|tax_mon_3|+|tax_mon_4|+|tax_mon_5|+|tax_mon_6|",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
                initdata1.Cols[v++]  = {Header:"합계|인정상여",    Type:"Int",      Hidden:1,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"total_etc_bonus_mon_1", KeyField:0,     CalcLogic:"|etc_bonus_mon_1|+|etc_bonus_mon_2|+|etc_bonus_mon_3|+|etc_bonus_mon_4|+|etc_bonus_mon_5|+|etc_bonus_mon_6|",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			}else{
			    //하반기
                initdata1.Cols[v++]  = {Header:"합계|급여 등",     Type:"AutoSum", Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon",               KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
                initdata1.Cols[v++]  = {Header:"합계|인정상여",    Type:"AutoSum", Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon",         KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
                initdata1.Cols[v++]  = {Header:"합계|소득합계",    Type:"AutoSum", Hidden:0,   Width:100,      Align:"Right",      ColMerge:0,     SaveName:"tax_mon_total",         KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:0,   EditLen:35, CalcLogic:"|tax_mon|+|etc_bonus_mon|" };
			    initdata1.Cols[v++]  = {Header:"7월|급여 등",     Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_7",             KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"7월|인정상여",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_7",       KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"8월|급여 등",     Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_8",             KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"8월|인정상여",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_8",       KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"9월|급여 등",     Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_9",             KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"9월|인정상여",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_9",       KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"10월|급여 등",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_10",            KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"10월|인정상여",   Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_10",      KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"11월|급여 등",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_11",            KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"11월|인정상여",   Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_11",      KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"12월|급여 등",    Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"tax_mon_12",            KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			    initdata1.Cols[v++]  = {Header:"12월|인정상여",   Type:"Int",     Hidden:0,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"etc_bonus_mon_12",      KeyField:0,     CalcLogic:"",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
                initdata1.Cols[v++]  = {Header:"합계|급여 등",     Type:"Int",     Hidden:1,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"total_tax_mon_2",       KeyField:0,     CalcLogic:"|tax_mon_7|+|tax_mon_8|+|tax_mon_9|+|tax_mon_10|+|tax_mon_11|+|tax_mon_12|",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
                initdata1.Cols[v++]  = {Header:"합계|인정상여",    Type:"Int",     Hidden:1,   Width:100,      Align:"Right",      ColMerge:1,     SaveName:"total_etc_bonus_mon_2", KeyField:0,     CalcLogic:"|etc_bonus_mon_7|+|etc_bonus_mon_8|+|etc_bonus_mon_9|+|etc_bonus_mon_10|+|etc_bonus_mon_11|+|etc_bonus_mon_12|",   Format:"Integer",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			}
			initdata1.Cols[v++] = {Header:"대상년도|대상년도",       Type:"Text",     Hidden:1,   Width:0,        Align:"Left",       ColMerge:0,     SaveName:"work_yy",             KeyField:0,     CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			initdata1.Cols[v++] = {Header:"반기구분코드|반기구분코드", Type:"Text",     Hidden:1,   Width:0,        Align:"Left",       ColMerge:0,     SaveName:"half_type",           KeyField:0,     CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
			initdata1.Cols[v++] = {Header:"소득구분|소득구분",       Type:"Text",     Hidden:1,   Width:0,        Align:"Left",       ColMerge:0,     SaveName:"income_type",         KeyField:0,     CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500 };
	         initdata1.Cols[v++] = {Header:"전화번호|전화번호",              Type:"Text",        Hidden:1,   Width:110,      Align:"Center",     ColMerge:0,     SaveName:"tel_no",              KeyField:0,     CalcLogic:"",   Format:"PhoneNo",   PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:11 };
