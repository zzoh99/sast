...
<%
	...
	try {
	    ...
	    if(nfsFilePath != null && nfsFilePath.length() > 0) {
	    	serverFilePath = nfsFilePath+StringUtil.getPropertiesValue("HRFILE.PATH")+"/NTS_FILES/"+ssnEnterCd;
	    } else {
	    	serverFilePath = StringUtil.getPropertiesValue("WAS.PATH")+StringUtil.getPropertiesValue("HRFILE.PATH")+"/NTS_FILES/"+ssnEnterCd; //저장위치
	    }
