...
//보안체크
    try{
        ...
        if ( "/jsp_jungsan/common/".equals(commPageYjungsan)
            ...
            //20231228 보안옵션을 사용하는 사이트 개별 소스 수정 ([ 시스템사용기준관리 ] SECURITY_CHECK = Y)
            ...
            if( mrdYjungsan != null && mrdYjungsan.length() != 0) {
            	mrdYjungsan = mrdYjungsan.substring(mrdYjungsan.lastIndexOf("/")+1);
            }
        ...
        Log.Error("[securityMgr]" + e.getMessage());
        return "에러";
    }
    return "";
}
