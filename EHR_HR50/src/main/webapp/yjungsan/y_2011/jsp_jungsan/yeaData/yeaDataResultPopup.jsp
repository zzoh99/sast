...
<script type="text/javascript">
	...
	$(function(){
		...
		initdata3.Cols = [
			...
			{Header:"a02009", 		Type:"Int",	    Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a020_09", 		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"a02011", 		Type:"Int",	    Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a020_11", 		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"a02012", 		Type:"Int",	    Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a020_12", 		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			...
			{Header:"a04001", 		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a040_01", 		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"a04008",      	Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a040_08",      KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"a04009",      	Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a040_09",      KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"a04010",      	Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a040_10",      KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			...
			{Header:"b01016_inp", 	Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"b010_16_inp", 	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			...
			{Header:"a02009_cnt",	Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a020_09_cnt",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"a02012_cnt",	Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a020_12_cnt",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"a02011_cnt",	Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a020_11_cnt",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			...
			{Header:"a10019",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a100_19",			KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			...
			{Header:"a010_sum",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a010_sum",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
...
function sht2ToCtl(){
	if(yeaResultSht2.RowCount() > 0){
		...
		$("#sht2_PreNotaxWorkMon").val( 		yeaResultSht2.GetCellText(1, "curr_notax_work_mon"));//종전근무지야간근로수당비과세
...
function sht5ToCtl(){
	if(yeaResultSht5.RowCount() > 0){
		$("#sht5_A000_01").val( yeaResultSht5.GetCellText(1, "a000_01") );//근로소득공제
		$("#sht5_A010_01").val( yeaResultSht5.GetCellText(1, "a010_01"));//본인기본공제
		$("#sht5_A010_03").val( yeaResultSht5.GetCellText(1, "a010_03"));//배우자공제
		$("#sht5_A010_11_CNT").val( yeaResultSht5.GetCellText(1, "a010_11_cnt"));//부양가족인원수
		$("#sht5_A010_11").val( yeaResultSht5.GetCellText(1, "a010_11"));//부양가족공제
		$("#sht5_A020_04").val( yeaResultSht5.GetCellText(1, "a020_04"));//경로우대공제
		$("#sht5_A020_05").val( yeaResultSht5.GetCellText(1, "a020_05"));//장애자공제
		$("#sht5_A020_07").val( yeaResultSht5.GetCellText(1, "a020_07"));//부녀자공제
		$("#sht5_A020_09").val( yeaResultSht5.GetCellText(1, "a020_09"));//자녀양육공제
		$("#sht5_A020_11").val( yeaResultSht5.GetCellText(1, "a020_11"));//다자녀추가공제
		$("#sht5_A020_12").val( yeaResultSht5.GetCellText(1, "a020_12"));//다자녀추가공제
		$("#sht5_A030_01").val( yeaResultSht5.GetCellText(1, "a030_01"));//국민연금보험료공제
		$("#sht5_A030_02").val( yeaResultSht5.GetCellText(1, "a030_02"));//기타연금보험료공제
		$("#sht5_A030_03").val( yeaResultSht5.GetCellText(1, "a030_03"));//퇴직연금보험료공제
		$("#sht5_A040_01").val( yeaResultSht5.GetCellText(1, "a040_01"));//보험료공제-건강보험료
        $("#sht5_A040_08").val( yeaResultSht5.GetCellText(1, "a040_08"));//보험료공제-고용보험료
        $("#sht5_A040_09").val( yeaResultSht5.GetCellText(1, "a040_09"));//보험료공제-보장성보험
        $("#sht5_A040_10").val( yeaResultSht5.GetCellText(1, "a040_10"));//보험료공제-장애인전용
		$("#sht5_A050_01").val( yeaResultSht5.GetCellText(1, "a050_01"));//의료비공제
		$("#sht5_A060_01").val( yeaResultSht5.GetCellText(1, "a060_01"));//교육비공제
		$("#sht5_A060_11").val( yeaResultSht5.GetCellText(1, "a060_11"));//장애인교육비공제
		$("#sht5_A070_14").val( yeaResultSht5.GetCellText(1, "a070_14"));//임차차입금 원리금공제(대출기관)
		$("#sht5_A070_21").val( yeaResultSht5.GetCellText(1, "a070_21"));//임차차입금 원리금공제(거주자)
		$("#sht5_A070_17").val( yeaResultSht5.GetCellText(1, "a070_17"));//장기주택저당차입금이자상환액입금(2011년 이전(15년미만)                )
		$("#sht5_A070_15").val( yeaResultSht5.GetCellText(1, "a070_15"));//장기주택저당차입금이자상환액입금(2011년 이전(15년~29년)               )
		$("#sht5_A070_16").val( yeaResultSht5.GetCellText(1, "a070_16"));//장기주택저당차입금이자상환액입금(2011년 이전(30년이상)                )
		$("#sht5_A070_22").val( yeaResultSht5.GetCellText(1, "a070_22"));//장기주택저당차입금이자상환액입금(2012년 이후(고정금리/비거치상환 대출))
		$("#sht5_A070_23").val( yeaResultSht5.GetCellText(1, "a070_23"));//장기주택저당차입금이자상환액입금(2012년 이후(기타 대출)               )
		$("#sht5_A080_01").val( yeaResultSht5.GetCellText(1, "a080_01"));//기부금공제계
		$("#sht5_A100_03").val( yeaResultSht5.GetCellText(1, "a100_03"));//개인연금저축공제  
		$("#sht5_A100_05").val( yeaResultSht5.GetCellText(1, "a100_05"));//연금저축공제 
		$("#sht5_A100_07").val( yeaResultSht5.GetCellText(1, "a100_07"));//투조출자공제 
		$("#sht5_A100_21").val( yeaResultSht5.GetCellText(1, "a100_21"));//우리사주공제
		$("#sht5_A100_23").val( yeaResultSht5.GetCellText(1, "a100_23"));//신용카드공제   
		$("#sht5_A100_29").val( yeaResultSht5.GetCellText(1, "a100_29"));//주식형펀드공제   
		$("#sht5_A100_30").val( yeaResultSht5.GetCellText(1, "a100_30"));//소기업소상공인   
		$("#sht5_A100_35").val( yeaResultSht5.GetCellText(1, "a100_35"));//주택마련공제   
		$("#sht5_A100_37").val( yeaResultSht5.GetCellText(1, "a100_37"));//임금삭감액공제   
		$("#sht5_B000_01").val( yeaResultSht5.GetCellText(1, "b000_01"));//근로세액공제
		$("#sht5_B010_01").val( yeaResultSht5.GetCellText(1, "b010_01"));//납세조합공제
		$("#sht5_B010_03").val( yeaResultSht5.GetCellText(1, "b010_03"));//주택자금세액공제
		$("#sht5_B010_05").val( yeaResultSht5.GetCellText(1, "b010_05"));//기부금세액공제 
		$("#sht5_B010_07").val( yeaResultSht5.GetCellText(1, "b010_07"));//외국납부공제			
        $("#sht5_B010_14").val( yeaResultSht5.GetCellText(1, "b010_14"));//소득세법		               
        $("#sht5_B010_15").val( yeaResultSht5.GetCellText(1, "b010_15"));//조세특례제한법(제30조 제외)
        $("#sht5_B010_16").val( yeaResultSht5.GetCellText(1, "b010_16"));//조세특례제한법 제30조		   
        $("#sht5_B010_17").val( yeaResultSht5.GetCellText(1, "b010_17"));//조세조약		               
        $("#sht5_B010_14_INP").val( yeaResultSht5.GetCellText(1, "b010_14_inp"));  	//소득세법		               
        $("#sht5_B010_15_INP").val( yeaResultSht5.GetCellText(1, "b010_15_inp"));  	//조세특례제한법(제30조 제외)
        $("#sht5_B010_16_INP").val( yeaResultSht5.GetCellText(1, "b010_16_inp"));  	//조세특례제한법 제30조		   
        $("#sht5_B010_17_INP").val( yeaResultSht5.GetCellText(1, "b010_17_inp"));  	//조세조약		               
        $("#sht5_B010_13").val( yeaResultSht5.GetCellText(1, "b010_13"));			//세액감면 계		             
		$("#sht5_A020_03_CNT").val( yeaResultSht5.GetCellText(1,"a020_03_cnt"));		//경로우대인원수
		$("#sht5_A020_05_CNT").val( yeaResultSht5.GetCellText(1,"a020_05_cnt"));		//장애인원수
		$("#sht5_A020_09_CNT").val( yeaResultSht5.GetCellText(1,"a020_09_cnt"));		//자녀양육비인원수
		$("#sht5_A020_12_CNT").val( yeaResultSht5.GetCellText(1,"a020_12_cnt"));		//출산입양인원수
		$("#sht5_A020_11_CNT").val( yeaResultSht5.GetCellText(1,"a020_11_cnt"));		//다자녀인원수
		$("#sht5_A030_01_INP").val( yeaResultSht5.GetCellText(1,"a030_01_inp"));		//국민연금보험료
		$("#sht5_A030_02_INP").val( yeaResultSht5.GetCellText(1,"a030_02_inp"));		//기타연금보험료
		$("#sht5_A030_03_INP").val( yeaResultSht5.GetCellText(1,"a030_03_inp"));		//퇴직연금소득
		$("#sht5_A040_03").val( yeaResultSht5.GetCellText(1,"a040_03"));				//건강보험공제
		$("#sht5_A040_04").val( yeaResultSht5.GetCellText(1,"a040_04"));				//고용보험공제
		$("#sht5_A040_05").val( yeaResultSht5.GetCellText(1,"a040_05"));				//보장성보험공제
		$("#sht5_A040_07").val( yeaResultSht5.GetCellText(1,"a040_07"));				//장애인전용보험공제
		$("#sht5_A050_05").val( yeaResultSht5.GetCellText(1,"a050_05"));				//본인/장애/경로의료비
		$("#sht5_A050_03").val( yeaResultSht5.GetCellText(1,"a050_03"));				//일반의료비
		$("#sht5_A050_07").val( yeaResultSht5.GetCellText(1,"a050_07"));				//장기요양비(재가급여)
		$("#sht5_A050_09").val( yeaResultSht5.GetCellText(1,"a050_09"));				//장기요양비(시설급여)
		$("#sht5_A060_03").val( yeaResultSht5.GetCellText(1,"a060_03"));				//본인교육비
		$("#sht5_A060_05_CNT").val( yeaResultSht5.GetCellText(1,"a060_05_cnt"));			//취학전아동인원수
		$("#sht5_A060_05").val( yeaResultSht5.GetCellText(1,"a060_05"));				//취학전아동교육비
		$("#sht5_A060_07_CNT").val( yeaResultSht5.GetCellText(1,"a060_07_cnt"));		//초중고교육비인원수
		$("#sht5_A060_07").val( yeaResultSht5.GetCellText(1,"a060_07"));				//초중고교육비
		$("#sht5_A060_09_CNT").val( yeaResultSht5.GetCellText(1,"a060_09_cnt"));		//대학생인원수
		$("#sht5_A060_09").val( yeaResultSht5.GetCellText(1,"a060_09"));			//대학생교육비
		$("#sht5_A060_11_CNT").val( yeaResultSht5.GetCellText(1,"a060_11_cnt"));		//장애인인원수
		$("#sht5_A070_13").val( yeaResultSht5.GetCellText(1,"a070_13"));				//주택임차차입금원리금상환액(대출기관)
		$("#sht5_A070_19").val( yeaResultSht5.GetCellText(1,"a070_19"));				//주택임차차입금원리금상환액(거주자)
		$("#sht5_A070_10_INP").val( yeaResultSht5.GetCellText(1,"a070_10_inp"));		//월세액
		$("#sht5_A070_10").val( yeaResultSht5.GetCellText(1,"a070_10"));				//월세액공제
		$("#sht5_A070_17_INP").val( yeaResultSht5.GetCellText(1,"a070_17_inp"));		//이자상환액(차입금상환기간 2011년 이전(15년미만)                )
		$("#sht5_A070_15_INP").val( yeaResultSht5.GetCellText(1,"a070_15_inp"));		//이자상환액(차입금상환기간 2011년 이전(15년~29년)               )
		$("#sht5_A070_16_INP").val( yeaResultSht5.GetCellText(1,"a070_16_inp"));		//이자상환액(차입금상환기간 2011년 이전(30년이상)                )
		$("#sht5_A070_22_INP").val( yeaResultSht5.GetCellText(1,"a070_22_inp"));		//이자상환액(차입금상환기간 2012년 이후(고정금리/비거치상환 대출))
		$("#sht5_A070_23_INP").val( yeaResultSht5.GetCellText(1,"a070_23_inp"));		//이자상환액(차입금상환기간 2012년 이후(기타 대출)               )
		$("#sht5_A099_01").val( 	yeaResultSht5.GetCellText(1,"a099_01"));			//표준공제
		$("#sht5_A100_03_INP").val( yeaResultSht5.GetCellText(1,"a100_03_inp"));		//개인연금저축소득
		$("#sht5_A100_05_INP").val( yeaResultSht5.GetCellText(1,"a100_05_inp"));		//연금저축소득
		$("#sht5_A100_30_INP").val( yeaResultSht5.GetCellText(1,"a100_30_inp"));		//소기업·소상공인 공제부금
		$("#sht5_A100_34").val( yeaResultSht5.GetCellText(1,"a100_34"));				//주택청약저축
		$("#sht5_A100_31").val( yeaResultSht5.GetCellText(1,"a100_31"));				//주택청약종합저축
		$("#sht5_A100_32").val( yeaResultSht5.GetCellText(1,"a100_32"));				//장기주택마련저축
		$("#sht5_A100_33").val( yeaResultSht5.GetCellText(1,"a100_33"));				//근로자주택마련저축
        $("#sht5_A100_11").val( yeaResultSht5.GetCellText(1,"a100_11"));             //투자조합출자(2011년 이전 출자)
        $("#sht5_A100_08").val( yeaResultSht5.GetCellText(1,"a100_08"));             //투자조합출자(2012년 이후 출자(벤처기업 투자분 제외)) 
        $("#sht5_A100_10").val( yeaResultSht5.GetCellText(1,"a100_10"));             //투자조합출자(2012년 이후 출자(벤처기업 투자분))
		$("#sht5_A100_15").val( yeaResultSht5.GetCellText(1,"a100_15"));				//신용카드
		$("#sht5_A100_19").val( yeaResultSht5.GetCellText(1,"a100_19"));				//학원비지로납부
		$("#sht5_A100_13").val( yeaResultSht5.GetCellText(1,"a100_13"));				//현금영수증
		$("#sht5_A100_22").val( yeaResultSht5.GetCellText(1,"a100_22"));				//전통시장사용분
		$("#sht5_A100_14").val( yeaResultSht5.GetCellText(1,"a100_14"));				//직불(선불)카드
		$("#sht5_A100_17").val( yeaResultSht5.GetCellText(1,"a100_17"));				//사업관련비용
		$("#sht5_A100_21_INP").val( yeaResultSht5.GetCellText(1,"a100_21_inp"));		//우리사주조합출연금
		$("#sht5_A100_26").val( yeaResultSht5.GetCellText(1,"a100_26"));				//1년차불입
		$("#sht5_A100_27").val( yeaResultSht5.GetCellText(1,"a100_27"));				//2년차불입
		$("#sht5_A100_28").val( yeaResultSht5.GetCellText(1,"a100_28"));				//3년차불입
		$("#sht5_A100_37_INP").val( yeaResultSht5.GetCellText(1,"a100_37_inp"));		//고용유지중소기업근로자
		$("#sht5_A010_SUM").val( yeaResultSht5.GetCellText(1,"a010_sum"));			//그밖의소득공제계
		$("#sht5_B010_01_INP").val( yeaResultSht5.GetCellText(1,"b010_01_inp"));		//납세조합공제
		$("#sht5_B010_03_INP").val( yeaResultSht5.GetCellText(1,"b010_03_inp"));		//주택자금이자
		$("#sht5_B010_05_INP").val( yeaResultSht5.GetCellText(1,"b010_05_inp"));		//정치자금기부금
		$("#sht5_B010_09").val( yeaResultSht5.GetCellText(1,"b010_09"));				//국외근로소득
		$("#sht5_B010_11").val( yeaResultSht5.GetCellText(1,"b010_11"));				//외국납부세액
		
	}else{
		$("#sht5_A000_01").val( "0");//근로소득공제 
		$("#sht5_A010_01").val( "0");//본인기본공제 
		$("#sht5_A010_03").val( "0");//배우자공제 
		$("#sht5_A010_11").val( "0");//부양가족공제 
		$("#sht5_A010_11_CNT").val( "0");//부양가족인원수
		$("#sht5_A020_04.val").val( "0");//경로우대공제
		$("#sht5_A020_05").val( "0");//장애자공제 
		$("#sht5_A020_07").val( "0");//부녀자공제 
		$("#sht5_A020_09").val( "0");
		$("#sht5_A020_11").val( "0");
		$("#sht5_A020_12").val( "0");
		$("#sht5_A030_01").val( "0");
        ...
        $("#sht5_B010_16").val( "0");
        $("#sht5_B010_17").val( "0");
        $("#sht5_B010_14_INP").val( "0");//소득세법		               
        $("#sht5_B010_15_INP").val( "0");//조세특례제한법(제30조 제외)
        $("#sht5_B010_16_INP").val( "0");//조세특례제한법 제30조		   
        $("#sht5_B010_17_INP").val( "0");//조세조약		               
        $("#sht5_B010_13").val( "0" );//세액감면 계		             
		$("#sht5_A020_03_CNT").val( "0");//경로우대인원수
		$("#sht5_A020_05_CNT").val( "0");//장애인원수
		$("#sht5_A020_09_CNT").val( "0");//자녀양육비인원수
		$("#sht5_A020_12_CNT").val( "0");//출산입양인원수
		$("#sht5_A020_11_CNT").val( "0");//다자녀인원수
		$("#sht5_A030_01_INP").val( "0");//국민연금보험료
		$("#sht5_A030_02_INP").val( "0");//기타연금보험료
		$("#sht5_A030_03_INP").val( "0");//퇴직연금소득
		$("#sht5_A040_03").val( "0");//건강보험공제
		$("#sht5_A040_04").val( "0");//고용보험공제
		$("#sht5_A040_05").val( "0");//보장성보험공제
		$("#sht5_A040_07").val( "0");//장애인전용보험공제
		$("#sht5_A050_05").val( "0");//본인/장애/경로의료비
		$("#sht5_A050_03").val( "0");//일반의료비
		$("#sht5_A050_07").val( "0");//장기요양비(재가급여)
		$("#sht5_A050_09").val( "0");//장기요양비(시설급여)
		$("#sht5_A060_03").val( "0");//본인교육비
		$("#sht5_A060_05_CNT").val( "0");//취학전아동인원수
		$("#sht5_A060_05").val( "0");//취학전아동교육비
		$("#sht5_A060_07_CNT").val( "0");//초중고교육비인원수
		$("#sht5_A060_07").val( "0");//초중고교육비
		$("#sht5_A060_09_CNT").val( "0");//대학생인원수
		$("#sht5_A060_09").val( "0");//대학생교육비
		$("#sht5_A060_11_CNT").val("0");//장애인인원수
		$("#sht5_A070_13").val( "0");//주택임차차입금원리금상환액(대출기관)
		$("#sht5_A070_19").val( "0");//주택임차차입금원리금상환액(거주자)
		$("#sht5_A070_10_INP").val( "0");//월세액
		$("#sht5_A070_10").val( "0");//월세액공제
		$("#sht5_A070_17_INP").val( "0");//이자상환액(차입금상환기간 2011년 이전(15년미만)                )
		$("#sht5_A070_15_INP").val( "0");//이자상환액(차입금상환기간 2011년 이전(15년~29년)               )
		$("#sht5_A070_16_INP").val( "0");//이자상환액(차입금상환기간 2011년 이전(30년이상)                )
		$("#sht5_A070_22_INP").val( "0");//이자상환액(차입금상환기간 2012년 이후(고정금리/비거치상환 대출))
		$("#sht5_A070_23_INP").val( "0");//이자상환액(차입금상환기간 2012년 이후(기타 대출)               )
		$("#sht5_A099_01").val( "0");//표준공제
		$("#sht5_A100_03_INP").val( "0");//개인연금저축소득
		$("#sht5_A100_05_INP").val( "0");//연금저축소득
		$("#sht5_A100_30_INP").val( "0");//소기업·소상공인 공제부금
		$("#sht5_A100_34").val( "0");//주택청약저축
		$("#sht5_A100_31").val( "0");//주택청약종합저축
		$("#sht5_A100_32").val( "0");//장기주택마련저축
		$("#sht5_A100_33").val( "0");//근로자주택마련저축
        $("#sht5_A100_11").val( "0");//투자조합출자(2011년 이전 출자)
        $("#sht5_A100_08").val( "0");//투자조합출자(2012년 이후 출자(벤처기업 투자분 제외) )
        $("#sht5_A100_10").val( "0");//투자조합출자(2012년 이후 출자(벤처기업 투자분))
		$("#sht5_A100_15").val( "0");//신용카드
		$("#sht5_A100_19").val( "0");//학원비지로납부
		$("#sht5_A100_13").val( "0");//현금영수증
		$("#sht5_A100_22").val( "0");//직불(선불)카드
		$("#sht5_A100_14").val( "0");//전통시장사용분
		$("#sht5_A100_17").val( "0");//사업관련비용
		$("#sht5_A100_21_INP").val( "0");//우리사주조합출연금
		$("#sht5_A100_26").val( "0");//1년차불입
		$("#sht5_A100_27").val( "0");//2년차불입
		$("#sht5_A100_28").val( "0");//3년차불입
		$("#sht5_A100_37_INP").val( "0");//고용유지중소기업근로자
		$("#sht5_A010_SUM").val( "0");//그밖의소득공제계
		$("#sht5_B010_01_INP").val( "0");//납세조합공제
		$("#sht5_B010_03_INP").val( "0");//주택자금이자
		$("#sht5_B010_05_INP").val( "0");//정치자금기부금
		$("#sht5_B010_09").val( "0");//국외근로소득
		$("#sht5_B010_11").val( "0");//외국납부세액
	}
}	
...
<div class="wrapper" style="overflow:scroll;">
	...
	<tr>
		<th class="center" colspan="4">구분</th>
		<th class="center">입력금액</th>
		<th class="center">공제금액</th>
	</tr>
	<tr>
		<th class="center" colspan="4">총 급 여( 과세대상급여 )</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" colspan="4">근로소득공제</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" colspan="4">근로소득금액</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" rowspan="5">추가공제</th>
	...
	<tr>
		<th class="center" colspan="2">자녀양육비(6세이하)</th>
		<td class="right"> 
			<input id="sht5_A020_09_CNT" name="sht5_A020_09_CNT" type="text" class="text w100p right" readOnly />
		</td>
		<th class="center"></th>
		<td class="right"> 
			<input id="sht5_A020_09" name="sht5_A020_09" type="text" class="text w100p right" readOnly />
		</td>	
	</tr>
	<tr>
		<th class="center" colspan="2">출산ㆍ입양자</th>
		<td class="right"> 
			<input id="sht5_A020_12_CNT" name="sht5_A020_12_CNT" type="text" class="text w100p right" readOnly />
		</td>
		<th class="center"></th>
		<td class="right"> 
			<input id="sht5_A020_12" name="sht5_A020_12" type="text" class="text w100p right" readOnly />
		</td>	
	</tr>
	<tr>
		<th class="center" colspan="3">다자녀추가공제</th>
		<td class="right"> 
			<input id="sht5_A020_11_CNT" name="sht5_A020_11_CNT" type="text" class="text w100p right" readOnly />
		</td>
		<th class="center"></th>
		<td class="right"> 
			<input id="sht5_A020_11" name="sht5_A020_11" type="text" class="text w100p right" readOnly />
		</td>	
	</tr>
	<tr>
		<th class="center" rowspan="3">연금보험료<br>공제</th>
		<th class="center" colspan="2">국민연금보험료</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" colspan="2">기타연금보험료</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" colspan="2">퇴직연금소득공제</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" rowspan="23">특별공제</th>
		...
		<td class="right"> 
			<input id="sht5_A040_01" name="sht5_A040_01" type="text" class="text w100p right" readOnly />
		</td>	
	</tr>
	<tr>
		...
		<td class="right"> 
			<input id="sht5_A040_08" name="sht5_A040_08" type="text" class="text w100p right" readOnly />
		</td>	
	</tr>
	<tr>
		<th class="center" >보장성보험</th>
		<th class="center"></th>
		<td class="right"> 
			<input id="sht5_A040_05" name="sht5_A040_05" type="text" class="text w100p right" readOnly />
		</td>
		<td class="right"> 
			<input id="sht5_A040_09" name="sht5_A040_09" type="text" class="text w100p right" readOnly />
		</td>	
	</tr>
	<tr>
		<th class="center" >장애인전용</th>
		<th class="center"></th>
		<td class="right"> 
			<input id="sht5_A040_07" name="sht5_A040_07" type="text" class="text w100p right" readOnly />
		</td>
		<td class="right"> 
			<input id="sht5_A040_10" name="sht5_A040_10" type="text" class="text w100p right" readOnly />
		</td>	
	</tr>
	<tr>
		<th class="center" rowspan="4">의료비</th>
		<th class="center">본인ㆍ65세이상자ㆍ장애인</th>
		<th class="center"></th>
		<td class="right"> 
			<input id="sht5_A050_05" name="sht5_A050_05" type="text" class="text w100p right" readOnly />
		</td>
	...
	<tr>
		<th class="center">그 밖의 공제대상자</th>
		<th class="center"></th>
		<td class="right"> 
			<input id="sht5_A050_03" name="sht5_A050_03" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center">노인장기요양(재가급여)</th>
		<th class="center"></th>
		<td class="right"> 
			<input id="sht5_A050_07" name="sht5_A050_07" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center">노인장기요양(시설급여)</th>
		<th class="center"></th>
		<td class="right"> 
			<input id="sht5_A050_09" name="sht5_A050_09" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center" rowspan="5">교육비</th>
		<th class="center">본인</th>
		<th class="center"></th>
		<td class="right"> 
			<input id="sht5_A060_03" name="sht5_A060_03" type="text" class="text w100p right" readOnly />
		</td>
		<td class="right" rowspan="5"> 
	...
	<tr>
		...
		<td class="right"> 
			<input id="sht5_A060_05_CNT" name="sht5_A060_05_CNT" type="text" class="text w100p right" readOnly />
		</td>
		<td class="right"> 
			<input id="sht5_A060_05" name="sht5_A060_05" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center">초ㆍ중ㆍ고</th>
		<td class="right"> 
			<input id="sht5_A060_07_CNT" name="sht5_A060_07_CNT" type="text" class="text w100p right" readOnly />
		</td>
		<td class="right"> 
			<input id="sht5_A060_07" name="sht5_A060_07" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center">대학생</th>
		<td class="right"> 
			<input id="sht5_A060_09_CNT" name="sht5_A060_09_CNT" type="text" class="text w100p right" readOnly />
		</td>
		<td class="right"> 
			<input id="sht5_A060_09" name="sht5_A060_09" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center">장애인</th>
		<td class="right"> 
			<input id="sht5_A060_11_CNT" name="sht5_A060_11_CNT" type="text" class="text w100p right" readOnly />
		</td>
		<td class="right"> 
			<input id="sht5_A060_11" name="sht5_A060_11" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center" rowspan="8">주택자금</th>
		<th class="center" rowspan="2">주택임차차입금</th>
		<th class="center" >원리금상환액(대출기관)</th>
		<td class="right"> 
	...
	<tr>
		...
		<th class="center">2011년 이전(15년미만)</th>
		<td class="right"> 
	...
	<tr>
		<th class="center">2011년 이전(15년~29년)</th>
		<td class="right"> 
	...
	<tr>
		<th class="center">2011년 이전(30년이상)</th>
		<td class="right"> 
	...
	<tr>
		<th class="center">2012년 이후(고정금리/비거치상환)</th>
		<td class="right"> 
	...
	<tr>
		<th class="center">2012년 이후(기타 대출)</th>
		<td class="right"> 
	...
	<tr>
		<th class="center" colspan="2">기부금</th>
		<td class="center" ></td>
		<td class="center" ></td>
		<td class="right"> 
			<input id="sht5_A080_01" name="sht5_A080_01" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center" colspan="4">계 (또는 표준공제)</th>
		<td class="right"> 
			<input id="sht5_A099_01" name="sht5_A099_01" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center" colspan="5">차감소득금액</th>
		<td class="right"> 
			<input id="sht2_BlnceIncomeMon" name="sht2_BlnceIncomeMon" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center" rowspan="21">그 밖의<br>소득공제</th>
		<th class="center" rowspan="2">연금저축</th>
		<th class="center" >개인연금저축</th>
		<td class="center" ></td>
		<td class="right"> 
	...
	<tr>
		<th class="center" rowspan="4">주택마련저축</th>
		...
		<td class="right" rowspan="4"> 
			<input id="sht5_A100_35" name="sht5_A100_35" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<th class="center" >장기주택마련저축</th>
		<td class="center" ></td>
		<td class="right"> 
			<input id="sht5_A100_32" name="sht5_A100_32" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<th class="center" rowspan="3">투자조합 출자공제</th>
		<th class="center" >2011년 이전 출자</th>
		<td class="center" ></td>
		<td class="right"> 
			<input id="sht5_A100_11" name="sht5_A100_11" type="text" class="text w100p right" readOnly />
		</td>
	...
	<tr>
		<th class="center" >2012년 이후 출자(벤처기업 투자분 제외)</th>
		<td class="center" ></td>
		<td class="right"> 
	...
	<tr>
		<th class="center" >2012년 이후 출자(벤처기업 투자분)</th>
		<td class="center" ></td>
		<td class="right"> 
			<input id="sht5_A100_10" name="sht5_A100_10" type="text" class="text w100p right" readOnly />
		</td>
	...
	<tr>
		<th class="center" >학원비 지로납부</th>
		<td class="center" ></td>
		<td class="right"> 
			<input id="sht5_A100_19" name="sht5_A100_19" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<th class="center" colspan="2">우리사주조합 소득공제</th>
		<td class="center" ></td>
		<td class="right"> 
	...
	<tr>
		<th class="center" rowspan="3">장기주식형저축소득공제</th>
		<th class="center" >납입 1년차</th>
		<td class="center" ></td>
		<td class="right"> 
			<input id="sht5_A100_26" name="sht5_A100_26" type="text" class="text w100p right" readOnly />
		</td>
		<td class="right" rowspan="3"> 
			<input id="sht5_A100_29" name="sht5_A100_29" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center" >납입 2년차</th>
		<td class="center" ></td>
		<td class="right"> 
			<input id="sht5_A100_27" name="sht5_A100_26" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center" >납입 3년차</th>
		<td class="center" ></td>
		<td class="right"> 
			<input id="sht5_A100_28" name="sht5_A100_28" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<th class="center" colspan="5">그 밖의 소득공제 계</th>
		<td class="right"> 
			<input id="sht5_A010_SUM" name="sht5_A010_SUM" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center" colspan="5">종합소득 과세표준</th>
		<td class="right"> 
			<input id="sht2_TaxBaseMon" name="sht2_TaxBaseMon" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center" colspan="5">산출세액</th>
		<td class="right"> 
	...
	<tr>
		...
		<td class="center" ></td>
		<td class="right"> 
			<input id="sht5_B010_16_INP" name="sht5_B010_16_INP" type="text" class="text w100p right" readOnly />
		</td>
		<td class="right"> 
	...
	<tr>
		<th class="center" colspan="2">기부정치자금</th>
		<td class="center" ></td>
		<td class="right"> 
			<input id="sht5_B010_05_INP" name="sht5_B010_05_INP" type="text" class="text w100p right" readOnly />
		</td>
		<td class="right"> 
