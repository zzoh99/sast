...
<!DOCTYPE html> <html class="hidden"><head> <title>급여명세서(계산방법 포함)</title>
...
// 		{Header:"수당항목",	Type:"Text",		Hidden:0,	Width:80,	Align:"Left",		ColMerge:0,		SaveName:"element_nm",	KeyField:0,		Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:0 },
// 		{Header:"계산방법",	Type:"Text",		Hidden:0,	Width:150,	Align:"Left",		ColMerge:0,		SaveName:"formula",		KeyField:0,		Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:0 },
// 		{Header:"금액",		Type:"Int",			Hidden:0,	Width:60,	Align:"Right",		ColMerge:0,		SaveName:"result_mon",	KeyField:0,		Format:"Integer",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:0 }
// 	]; 
...
// 	initdata2.Cols = [
<%-- 		{Header:"No",       Type:"<%=sNoTy%>",    Hidden:0, Width:"<%=sNoWdt%>",  Align:"Center", ColMerge:0, SaveName:"sNo" }, --%>
// 		{Header:"공제항목",	Type:"Text",		Hidden:0,	Width:80,	Align:"Left",		ColMerge:0,		SaveName:"element_nm",	KeyField:0,		Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:0 },
// 		{Header:"계산방법",	Type:"Text",		Hidden:0,	Width:150,	Align:"Left",		ColMerge:0,		SaveName:"formula",		KeyField:0,		Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:0 },
// 		{Header:"금액",		Type:"Int",			Hidden:0,	Width:60,	Align:"Right",		ColMerge:0,		SaveName:"result_mon",	KeyField:0,		Format:"Integer",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:0 }
// 	]; 
...
function doAction(sAction) {
	switch (sAction) {
		case "Search":
			// 급여명세서조회
 			var listViewInfo = ajaxCall( "<%=jspPath%>/perPayPartiPopStaFormula/perPayPartiPopStaFormulaRst.jsp?cmd=getPerPayPartiPopStaBasicMap", $("#sheet1Form").serialize(), false);
			...
			var listEtcInfo = ajaxCall( "<%=jspPath%>/perPayPartiPopStaFormula/perPayPartiPopStaFormulaRst.jsp?cmd=getPerPayPartiPopStaEtc", $("#sheet1Form").serialize(), false);
        	...
        	$("#elementType").val("A");
			var listFormulaA = ajaxCall( "<%=jspPath%>/perPayPartiPopStaFormula/perPayPartiPopStaFormulaRst.jsp?cmd=getPerPayPartiPopStaFormila", $("#sheet1Form").serialize(), false);
			...
			$("#formulaTableA").append(insFormulaA);	
	       	...
	       	$("#elementType").val("D");
			var listFormulaB = ajaxCall( "<%=jspPath%>/perPayPartiPopStaFormula/perPayPartiPopStaFormulaRst.jsp?cmd=getPerPayPartiPopStaFormila", $("#sheet1Form").serialize(), false);
        ...
        case "Search2":
        	$("#elementType").val("A");
            sheet1.DoSearch( "<%=jspPath%>/perPayPartiPopStaFormula/perPayPartiPopStaFormulaRst.jsp?cmd=getPerPayPartiPopStaFormila", $("#sheet1Form").serialize() ); 
            $("#elementType").val("D");
            sheet2.DoSearch( "<%=jspPath%>/perPayPartiPopStaFormula/perPayPartiPopStaFormulaRst.jsp?cmd=getPerPayPartiPopStaFormila", $("#sheet1Form").serialize() ); 
            break;			
	}
}
...
<body>
<div id="content" class="wrap_print popup_scroll">
