...
<%
	...
	if("1".equals(chkSysVersion)) {
		//if(session.getAttribute("ssnEnterCd") == null || session.getAttribute("ssnEnterCd").toString().length() == 0) {
			...
			if("GSS".equals(session.getAttribute("SESSION_ENTER_CD"))) {
				if(!"10".equals(session.getAttribute("SESSION_AUTHORITY_GROUP"))&&!"37".equals(session.getAttribute("SESSION_AUTHORITY_GROUP"))){
	...
	<%@ include file="../../../../common_jungsan/jsp/security/securityMgr.jsp" %>
	<%
		String authPg = "";
