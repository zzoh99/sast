...
<%@ include file="../../../../common_jungsan/jsp/sessionProc/sessionScript.jsp" %>
<!--   IBSHEET	 -->
...
<script src="../../../common_jungsan/plugin/IBLeaders/Sheet/js/ibsheet_patch_chrome61.js" type="text/javascript" charset="<%=StringUtil.getPropertiesValue("SYS.ENC")%>"></script>
