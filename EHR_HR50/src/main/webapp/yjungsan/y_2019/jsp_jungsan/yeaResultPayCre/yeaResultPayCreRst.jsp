		...
		try{
			for(int i = 0; i < list.size(); i++ ) {
				...
				if("D".equals(sStatus)) {
					...
					//입력 중복체크
					Map dupMap = DBConn.executeQueryMap(conn, queryMap,"selectYeaResultPayCreCnt",mp);
...
<%
	...
	if("selectYeaResultPayCreList".equals(cmd)) {
		...
		String[] type =  new String[]{"OUT","OUT","STR","STR","STR","STR","STR","STR","STR","STR"};
		String[] param = new String[]{"","",ssnEnterCd,workYy,adjustType,bizPlaceCd,payApplyCd,jobGubun,monthSeq,ssnSabun};
