        ...
        try {
            ...
            if(Code == 1) {
                for(var i = 1; i < sheet1.RowCount()+1; i++) {
                    ...
                    // 2018-08-08 연말정산계산결과 테이블에 사원이 존재하는 경우에만 귀속시작일, 귀속종료일 수정
                    if( sheet1.GetCellValue(i, "adj_sabun") != "") {
                    	sheet1.SetCellEditable(i,"adj_s_ymd", 1);
                    	sheet1.SetCellEditable(i,"adj_e_ymd", 1);
                    }
                            ...
                            <div class="sheet_title">
                                <ul>
                                    ...
                                    <li class="btn">
                                        ...
                                        <a onclick="javascript:findName();" onFocus="this.blur()" href="javascript:void(0);" class="button6"><img src="<%=imagePath%>/common/btn_search2.gif"/></a>
