...
<%!
//연말정산 옵션 조회
public List selectYeaCalcCreOptionPopupList(Map paramMap, String locPath) throws Exception {
...
//연말정산 옵션 조회
public List selectYeaCalcCreOptionPopupBfList(Map paramMap, String locPath) throws Exception {
...
//연말정산 옵션 저장.
public int saveYeaCalcCreOptionPopup(Map paramMap, String locPath) throws Exception {
...
<%
	...
	if("selectYeaCalcCreOptionPopupList".equals(cmd)) {
		...
		try {
			listData = selectYeaCalcCreOptionPopupList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
		...
		try {
			listData = selectYeaCalcCreOptionPopupBfList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
		...
		try {
			int cnt = saveYeaCalcCreOptionPopup(mp, locPath);
