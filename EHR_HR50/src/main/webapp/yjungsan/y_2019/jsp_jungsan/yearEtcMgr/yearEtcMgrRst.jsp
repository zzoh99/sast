...
<%!
//연말정산 기타소득 검색
public List selectYearEtcMgr(Map paramMap, String locPath) throws Exception {
...
//연말정산 기타소득 저장.
public int saveYearEtcMgr(Map paramMap, String locPath) throws Exception {
...
<%
	...
	if("search".equals(cmd)) {
		...
		try {
			listData = selectYearEtcMgr(mp, locPath);
		} catch(Exception e) {
			code = "-1";
		...
		try {
			int cnt = saveYearEtcMgr(mp, locPath);
