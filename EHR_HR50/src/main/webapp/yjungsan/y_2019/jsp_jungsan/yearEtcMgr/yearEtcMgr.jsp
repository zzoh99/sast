		...
		try { 
			...
			for (i = 1; i < sheet1.RowCount()+1; i++){
        		if(sheet1.GetCellValue(i, "adj_element_cd") == "C010_20" ||
        			...
        			sheet1.SetCellEditable(i, "notax_mon", false);
				}
        	}
	...
	function sheet1_OnChange(Row, Col, Value) {
		try{
			...
			if(sheet1.ColSaveName(Col) == "adj_element_cd"){
				if(sheet1.GetCellValue(Row, "adj_element_cd") == "C010_20" ||
						sheet1.GetCellValue(Row, "adj_element_cd") == "C010_22" ||
						sheet1.GetCellValue(Row, "adj_element_cd") == "C010_15" ){
					sheet1.SetCellEditable(Row, "notax_mon", false);
				}else{
					sheet1.SetCellEditable(Row, "notax_mon", true);
				}
			}
