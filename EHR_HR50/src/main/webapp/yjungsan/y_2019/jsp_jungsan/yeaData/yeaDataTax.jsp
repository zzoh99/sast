...
<script type="text/javascript">
	...
	function sheetSet(){
		...
		if(comSheet.RowCount() > 0){
			...
			$("#B010_40").val(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "B010_40"),"input_mon"));
			$("#B010_42").val(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "B010_42"),"input_mon"));
...
<%} %>
	...
	-->
	<tr>
		<th class="left" rowspan=3>조세특례제한법 제30조</th><!-- 2019-11-14. 100% 감면대상소득 삭제로 인해 추가 -->
	...
	<tr>  
		...
		<td class="left"> 
			&nbsp;<font style="color: red; ">[성과공유 중소기업의 경영성과급 세액공제](총급여 7천만원이하 적용)</font><br>
			&nbsp;조세특례제한법 제 27조의2에 해당하는 중소기업에서 2019.01.01 이후 지급분부터 지급분에 대한 소득세 감면
		</td>
	</tr>
	<tr>  
		<th class="left">조세특례제한법 제29조의6</th>
		<th class="center">대상소득</th>
		<td class="right"> 
			<input id="B010_42" name="B010_42" type="text" class="text w90 right" readonly disabled /> 원 
		</td>
		<td class="left"> 
			&nbsp;<font style="color: red; ">[중소기업 핵심인력 성과보상기금 소득세 감면]</font><br>
			&nbsp;조세특례제한법 제 29조의6에 해당하는 중소기업에서 2021.12.31 까지 가입한 근로자에 대한 소득세 감면
		</td>
	</tr>	
	<tr>  
