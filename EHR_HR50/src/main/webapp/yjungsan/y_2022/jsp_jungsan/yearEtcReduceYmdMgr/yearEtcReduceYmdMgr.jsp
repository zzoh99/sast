...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
	        ...
	        {Header:"정산구분",	Type:"Combo",      	Hidden:0,  Width:50,    Align:"Center", ColMerge:1,   SaveName:"adjust_type",		KeyField:1,   CalcLogic:"",   Format:"",   PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
	        ...
	        {Header:"사업장",	    Type:"Combo",      	Hidden:0,  Width:50,   Align:"Center",	ColMerge:1,   SaveName:"business_place_cd",	KeyField:0,   CalcLogic:"",   Format:"",   PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100 },
	        ...
	        {Header:"소득구분코드",    Type:"Text",    Hidden:1,  Width:100,   Align:"Center", ColMerge:1,   SaveName:"adj_element_cd",      KeyField:0,   CalcLogic:"",   Format:"",   PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:8 }
		...
		templeteTitle1 += "감면기간 시작/종료일 : YYYY-MM   예)"+$("#srchYear").val()+"-01 \n";
	});
	...
	function doAction1(sAction) {
        ...
        case "Down2Excel":
			...
			break;
       case "Down2Template":
			var param  = {DownCols:"2|3|5|8|9",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
