   ...
   <table border="0" cellpadding="0" cellspacing="0" class="default line outer">
    ...
    <tr>
        ...
        <td class="center">
			...
			<input id="A070_I28_1" name="A070_I28_1" type="text" class="text" />
        </td>
        <td class="center">
            <!-- <input id="A070_I28_2" name="A070_I28_2" type="text" class="date" readOnly /> -->
            <input id="A070_I28_2" name="A070_I28_2" type="text" class="text" />
        </td>
        <td class="right">
