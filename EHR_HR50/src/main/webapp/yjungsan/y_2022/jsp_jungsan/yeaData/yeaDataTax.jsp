    ...
    <div class="sheet_title">
        <ul>
            <li class="txt"> 세액감면
            	...
            	<font width="90%" class="title red" style="font-size: 13px;">
...
<%} %>
	...
	<tr>
		...
		<td class="left" >
			&nbsp;<font class="red">[청년 이외의 자에 대한 소득] (한도 150만원)</font><br>
	...
	<tr>
		...
		<td class="left" >
			&nbsp;<font class="red">[청년에 대한 소득] (한도 150만원)</font><br>
			&nbsp;2016.01.01일 이후 입사한 조세특례제한법 제 30조에 해당하는 중소기업 취업자의 감면 대상 소득<br>
		</td>
	</tr>
	<tr>
    ...
    <tr>
		<th class="left" rowspan="2">조세특례제한법 제29조의6</th>
        <th class="center">30% 감면 대상소득</th>
        <td class="right">
        ...
        <td class="left">
            ...
            &nbsp;조세특례제한법 제 29조의6에 해당하는 중견기업에서 2021.12.31 까지 가입한 근로자에 대한 소득세 감면
        </td>
    </tr>
	<tr>
		<th class="center">50% 감면 대상소득</th>
		<td class="right">
