...
--%>
    ...
    $(function() {
        ...
        sheet1.SetColProperty("finance_org_cd",     {ComboText:"|"+financeOrgCdList[0]+"|kk", ComboCode:"|"+financeOrgCdList[1]+"|ZZZ"} );
        ...
        <ul>
            <li class="txt">주택마련저축
	            ...
	            <a href="#layerPopup" class="basic btn-white ico-question" id="InfoMinus1" style="display:none"><b>주택마련저축 안내-</b></a>
               	<font class="red" size="2" >주택정보 ▶ <span id="houseInfo"></span></font>
            </li>
            <li class="btn">
    ...
    <div class="sheet_title outer">
        <ul>
            <li class="txt">개인연금저축 / 장기집합투자증권저축 / 중소기업창업투자조합
                ...
                <a href="#layerPopup" class="basic btn-white ico-question" id="InfoPlus2"><b>개인연금/장기집합저축 안내+</b></a>
