...
public int deleteYeaDataPdfFile(Map paramMap, String locPath) throws Exception {
    ...
    if (conn != null) {
	    try {
	    	...
	    	rstCnt = (queryMap == null) ? null : DBConn.executeUpdate(conn, queryMap, "deleteYeaDataPdfFile", paramMap);
				...
				if(rstStr[0] != null && "1".equals(rstStr[0])) {
					...
					try {
						...
						message = "반영= "+ String.valueOf(mapData.get("status_a")) +" 건"
								...
								+" ,반영제외= "+ String.valueOf(mapData.get("status_c")) +" 건"
								+" ,오류= "+ String.valueOf(mapData.get("status_d")) +" 건";
					} catch(Exception e) {
						Log.Error("[Exception] " + e);
					}
