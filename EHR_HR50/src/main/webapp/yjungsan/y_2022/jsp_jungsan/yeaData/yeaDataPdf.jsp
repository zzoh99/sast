	...
	<div class="outer new" id="infoLayer" style="display:none">
		<table>
			...
			<tr>
				<td>
					<div class="img-wrap">
						<img src="../../../common_jungsan/images/common/pdf_popup_2021.jpg" border="0" style="vertical-align:middle;width:100%;height:100%">
					</div>
				</td>
			</tr>
			<tr>
				<td>
					...
					<ul>
						<li>PDF파일은 각 인적공제 인원별로 최종 자료만 업로드 됩니다.(각 인원단위 삭제 후 덮어쓰기 개념)</li>
						<li><span class="under-line">본인+배우자 업로드 후 본인의 PDF자료만 재 업로드 시 본인의 데이터만 삭제후 업로드 됩니다.</span></li>
						<li><span class="under-line">본인의 모든 자료(보험료/신용카드 등) 업로드 후 보험료 PDF만 다시 받아 재 업로드 시 본인 자료 삭제 후 보험료 데이터만 업로드 됩니다.</span></li>
					</ul>
				</td>
			</tr>
		</table>
		...
		<div class="sheet_title">
			...
			<ul>
	            <li class="btn">
					...
					<font class="txt"><strong>※ XREF 정보검색 오류, ByteRange 오류 발생시 국세청 PDF 원본 파일로 다운받아 재업로드 해주시기 바랍니다.</strong>&nbsp;</font>
					<span id="btn_1">
	...
	<div class="outer">
		<table class="table-pdf">
			...
			<tr>
				...
				<td>
					<a href="javascript:doAction2('Search', 'G109Y');" class="pdf" id="btnCreditCard">
				...
				<td>
					<a href="javascript:doAction2('Search', 'G309Y,G409Y');" class="pdf" id="btnCheckCard">
				...
				<td>
					<a href="javascript:doAction2('Search', 'G209M');" class="pdf" id="btnCash">
			...
			<tr>
				...
				<td>
					<a href="javascript:doAction2('Search', 'N101Y,Q101Y,Q201Y,Q301Y');" class="pdf" id="btnLongSav">
		...
		<ul>
			<li class="txt" style="font-weight:normal;">
				...
				<select id="formCd">
					...
					<option value="G109Y">신용카드</option>
					<option value="G309Y,G409Y">직불카드 등</option>
					<option value="G209M">현금영수증</option>
					...
					<option value="N101Y,Q101Y,Q201Y,Q301Y">장기집합투자증권저축/벤처기업투자신탁</option><!-- 2019-11-28. 벤처기업투자신탁 추가 -->
