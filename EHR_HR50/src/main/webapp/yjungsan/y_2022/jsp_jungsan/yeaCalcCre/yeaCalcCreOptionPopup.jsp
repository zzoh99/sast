			...
			<table border="0" cellpadding="0" cellspacing="0" class="default outer line">
				...
				<tr>
					...
					<td align="left">
						...
						<input type="radio" class="radio" name="cpn_yea_paytot_yn" id="cpn_yea_paytot_yn2" value = "N" > <label for="cpn_yea_paytot_yn2">NO</label>
					</td>
				</tr>
				...
				<tr>
					...
					<td align="left">
						...
						<input type="radio" class="radio" name="cpn_yea_prework_yn" id="cpn_yea_prework_yn2" value = "N" > <label for="cpn_yea_prework_yn2">NO</label>
					</td>
				</tr>
