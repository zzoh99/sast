...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata1.Cols = [
            ...
            {Header:"사업장",                Type:"Combo",         Hidden:0,  Width:100,  Align:"Left",          ColMerge:0,   SaveName:"business_place_cd",               KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0 ,  InsertEdit:1,   EditLen:4 },
            {Header:"사업장명",              Type:"Combo",         Hidden:1,  Width:100,  Align:"Left",          ColMerge:0,   SaveName:"business_place_nm",               KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0 ,  InsertEdit:1,   EditLen:4 },
            ...
            {Header:"시작일",                Type:"Date",          Hidden:0,  Width:100,  Align:"Center",        ColMerge:0,   SaveName:"sdate",                           KeyField:1,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
            {Header:"종료일",                Type:"Date",          Hidden:0,  Width:100,  Align:"Center",         ColMerge:0,   SaveName:"edate",                           KeyField:1,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 }
    ...
    function doAction1(sAction) {
        ...
        case "Search":      //조회
            ...
            break;
        case "Save":        //저장
        	if (!dupChk(sheet1, "business_place_cd|sdate", true, true)) {break;}
    ...
    function sheet1_OnValidation(Row, Col, Value) {
        try {
            ...
            var arrCol = sheet1.ColValueDupRows("business_place_cd|sub_regino|sdate", false, true).split("|");

            if (arrCol[1] && arrCol[1] != "") {
            	alert("사업장, 종 사업자일련번호, 시작일자가 중복되었습니다.");
            	sheet1.ValidateFail(2);
            }
        } catch (ex) {
