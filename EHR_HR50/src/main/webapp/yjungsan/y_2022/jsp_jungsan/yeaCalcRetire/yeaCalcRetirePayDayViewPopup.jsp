...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var payCd = stfConvCode( ajaxCall("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&queryId=getRetirePayCdList","",false).codeList, "");
        // 급여코드
        //sheet1.SetColProperty("pay_cd", {ComboText : "|퇴직자정산|퇴직금|퇴직금중간정산",ComboCode : "|Y3|S1|S2"});
...
<!--                                     	<option value='Y3'>퇴직자정산</option> -->
<!--                                     	<option value='S1'>퇴직금</option> -->
<!--                                     	<option value='S2'>퇴직금중간정산</option> -->
                                    </select>
                                </td>
                                <td><span>대상년월 </span>
