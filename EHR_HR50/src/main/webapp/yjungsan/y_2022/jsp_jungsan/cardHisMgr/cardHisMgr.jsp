	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"DOC_SEQ_DETAIL",Type:"Text",		Hidden:1,	Width:60,	Align:"Left",	ColMerge:1,	SaveName:"doc_seq_detail",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:40 },
   			...
   			{Header:"사용연도",           Type:"Combo",      Hidden:0,  Width:60,    Align:"Center",  ColMerge:1,   SaveName:"use_yyyy",        KeyField:1,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:4 },
...
// 		sheet1.SetColProperty("period_type",		 {ComboText:"|"+periodType[0], ComboCode:"|"+periodType[1]} );
		...
		sheet1.SetColProperty("use_yyyy", {ComboText:"2021|2020", ComboCode:"2021|2020"});
...
// 		templeteTitle1 += "월구간 : " + codeCdNm + "\n";
	...
	function doAction1(sAction) {
		...
		case "Down2Template":
			...
			var param  = {DownCols:"5|6|7|8|9|10|12|13|15|18|19|20",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
        ...
        case "prcYeaBpCardLoad":
           var confirmMsg = "귀속 2020년에 등록된 사업관련비용을"
        	   confirmMsg +=" 귀속 2021년, \n사용연도 2020년으로 불러옵니다.(근로자 본인만)"
        	   confirmMsg += "\n기존 귀속 2021년, 사용연도 2020년으로 등록된 사업관련 건들은"
        	   confirmMsg += "\n지우고 재생성됩니다. 진행하시겠습니까?";
...
<!-- 				<td> <a href="javascript:doAction1('Search')" id="btnSearch" class="button">조회</a> </td> -->
    ...
    <div class="outer">
        ...
        <ul>
            ...
            <li class="btn">
                <a href="javascript:doAction1('prcYeaBpCardLoad')" class="basic btn-white out-line authA" id="showBtn" style="display:none;">20년사업관련비용불러오기</a>
