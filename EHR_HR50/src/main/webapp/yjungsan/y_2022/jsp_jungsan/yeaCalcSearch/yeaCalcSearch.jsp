...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var initdata = {};
        initdata.Cfg = {SearchMode:smLazyLoad,MergeSheet:msHeaderOnly, Page:22, FrozenCol:10, DataRowMerge:0};
        initdata.HeaderMode = {Sort:1,ColMove:1,ColResize:1,HeaderCheck:0};
        initdata.Cols = [
                        {Header:"No",       Type:"<%=sNoTy%>",  Hidden:Number("<%=sNoHdn%>"),   Width:"<%=sNoWdt%>",    Align:"Center", ColMerge:0, SaveName:"sNo" },
                        {Header:"년도",                              Type:"Text",            Hidden:1,  Width:60,     Align:"Center",    ColMerge:1,   SaveName:"work_yy",                       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"계산상태",                          Type:"Combo",           Hidden:0,  Width:100,     Align:"Center",    ColMerge:1,   SaveName:"pay_people_status",                   KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"신고\n제외여부",                       Type:"Combo",           Hidden:0,  Width:60,     Align:"Center",    ColMerge:1,   SaveName:"except_yn",                   KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        ...
                        {Header:"급여명",                             Type:"Text",           Hidden:0,  Width:120,     Align:"Center",    ColMerge:1,   SaveName:"pay_action_nm",                         KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"귀속년월",                             Type:"Date",           Hidden:1,  Width:80,     Align:"Center",    ColMerge:1,   SaveName:"pay_ym",                         KeyField:0,   CalcLogic:"",   Format:"Ym",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"지급일자",                             Type:"Date",           Hidden:1,  Width:100,     Align:"Center",    ColMerge:1,   SaveName:"payment_ymd",                         KeyField:0,   CalcLogic:"",   Format:"Ymd",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        ...
                        {Header:"직위",                              Type:"Text",            Hidden:0,  Width:70,    Align:"Center",    ColMerge:1,   SaveName:"jikwee_nm",                        KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"직급",                              Type:"Text",            Hidden:0,  Width:70,    Align:"Center",    ColMerge:1,   SaveName:"jikgub_nm",                        KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        ...
                        {Header:"식대비과세_현(미신고대상)",                     Type:"AutoSum",         Hidden:0,  Width:150,    Align:"Right",     ColMerge:1,   SaveName:"notax_food_mon",			     KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"차량비과세_현(미신고대상)",                     Type:"AutoSum",         Hidden:0,  Width:150,    Align:"Right",     ColMerge:1,   SaveName:"notax_car_mon",		         KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        ...
                        {Header:"수련보조수당비과세_현",                     Type:"AutoSum",         Hidden:0,  Width:100,    Align:"Right",     ColMerge:1,   SaveName:"notax_train_mon",		         KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"일직료비과세_현(미신고대상)",                   Type:"AutoSum",         Hidden:0,  Width:150,    Align:"Right",     ColMerge:1,   SaveName:"notax_nightduty_mon",		     KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"취재수당비과세_현",                     Type:"AutoSum",         Hidden:0,  Width:100,    Align:"Right",     ColMerge:1,   SaveName:"notax_reporter_mon",		         KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"기타비과세_현",                     Type:"AutoSum",         Hidden:0,  Width:100,    Align:"Right",     ColMerge:1,   SaveName:"notax_etc_mon",		         KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        ...
                        {Header:"신고대상_비과세계",                          Type:"AutoSum",         Hidden:0,  Width:170,    Align:"Right",     ColMerge:1,   SaveName:"notax_tot_mon_nts",                 KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"신고대상_감면소득계",                          Type:"AutoSum",         Hidden:0,  Width:170,    Align:"Right",     ColMerge:1,   SaveName:"b010_13_nts",                 KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"신고대상_총급여",                            Type:"AutoSum",         Hidden:0,  Width:170,    Align:"Right",     ColMerge:1,   SaveName:"taxable_pay_mon",               KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        ...
                        <%//2015년 추가 사항 end%>
                        {Header:"소득공제_기부금(이월분)",                    Type:"AutoSum",         Hidden:0,  Width:100,    Align:"Right",     ColMerge:1,   SaveName:"a080_20",                       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        ...
                        {Header:"조세특례제한법_(제30조 제외)",      Type:"AutoSum",         Hidden:1,  Width:170,    Align:"Right",     ColMerge:1,   SaveName:"b010_15",                       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"조세특례제한법_(제30조 제외)",      Type:"AutoSum",         Hidden:0,  Width:170,    Align:"Right",     ColMerge:1,   SaveName:"ex_b010_16",                       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        ...
                        */
                        ...
                        {Header:"작업일자",                          Type:"Text",            Hidden:0,  Width:100,    Align:"Center",    ColMerge:1,   SaveName:"chk_date",                      KeyField:0,   CalcLogic:"",   Format:"Ymd",     PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                        {Header:"작업자사번",                        Type:"Text",            Hidden:0,  Width:100,    Align:"Center",    ColMerge:1,   SaveName:"chkid",                         KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 }
