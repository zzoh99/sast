            	...
            	if (chkInputExists(i, sabun, adjType)) {
       			...
       			if (pay_action_cd[1] != "") {
       				...
       				if (acts != null && acts.length > 0) {
       					sheet3.SetCellValue2(i,"pay_action_cd",acts[0], 0);
       				}
       			}

            	sheet3.SetCellValue2(i, "loadXlsYn", "Y", 0) ;  //change 이벤트 발생 제외	 
            	sheet3.SetCellValue2(i, "adjust_type", adjType, 0) ;
            	sheet3.SetCellValue2(i, "adjust_type_orig", adjType, 0) ;
            	sheet3.SetCellValue2(i, "gubun", "F", 0) ;
            	sheet3.SetCellValue2(i, "pay_people_status", "PM", 0) ;
            	sheet3.SetCellValue2(i, "final_close_yn", "N", 0) ;
