...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"년도",            Type:"Text",        Hidden:1,  Width:50,    Align:"Center", ColMerge:1,   SaveName:"work_yy",           KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:4 },
            {Header:"정산구분",        Type:"Combo",       Hidden:0,  Width:100,    Align:"Center", ColMerge:1,   SaveName:"adjust_type",       KeyField:1,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:160 },
            ...
            {Header:"비과세액or감면세액", Type:"AutoSum",     Hidden:0,  Width:90,   Align:"Right",  ColMerge:1,   SaveName:"notax_mon",         KeyField:0,   CalcLogic:"",   Format:"Integer", PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:160 },
	        {Header:"과세액",		Type:"AutoSum",     Hidden:0,  Width:80,   Align:"Right",  ColMerge:1,   SaveName:"tax_mon",         KeyField:0,   CalcLogic:"",   Format:"Integer", PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:160 }
    ...
    function doAction1(sAction) {
        switch (sAction) {
        case "Search":
            var param = "cmd=selectBefYearEtcMgr&"+$("#srchFrm").serialize();
        ...
        case "Save":
            ...
            sheet1.DoSave( "<%=jspPath%>/befYearEtcMgr/befYearEtcMgrRst.jsp","cmd=saveBefYearEtcMgr");
            break;
        case "Insert":
