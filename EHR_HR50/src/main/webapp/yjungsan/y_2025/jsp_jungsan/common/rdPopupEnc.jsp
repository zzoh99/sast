...
<%
	...
	************************************************************************* */
	...
	{ */
        ...
        out.println(" $('#sKey').val('"  + removeXSS(request.getAttribute("sKey"), "1")  + "') ; ");
        out.println(" $('#gKey').val('"  + removeXSS(request.getAttribute("gKey"), "1") + "') ; ");
        out.println(" $('#sType').val('" + removeXSS(request.getAttribute("sType"), "1") + "') ; ");
        out.println(" $('#qId').val('"   + removeXSS(request.getAttribute("qId"), "1") + "') ; ");
