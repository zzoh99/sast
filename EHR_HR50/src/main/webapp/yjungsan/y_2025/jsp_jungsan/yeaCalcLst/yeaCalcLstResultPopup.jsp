...
<script type="text/javascript">
    ...
    $(function(){
        ...
        //start yeaResultShtBk2

        var initdataBk1 = {};
        initdataBk1.Cfg = {SearchMode:smLazyLoad,Page:22};
        initdataBk1.HeaderMode = {Sort:1,ColMove:1,ColResize:1,HeaderCheck:0};
        initdataBk1.Cols = [
            {Header:"work_yy",                  Type:"Text",    Hidden:0,   Width:60,   Align:"Center", ColMerge:0, SaveName:"work_yy",                 KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
            {Header:"adjust_type",              Type:"Text",    Hidden:0,   Width:60,   Align:"Center", ColMerge:0, SaveName:"adjust_type",             KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
            {Header:"sabun",                    Type:"Text",    Hidden:0,   Width:60,   Align:"Center", ColMerge:0, SaveName:"sabun",                   KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
            ...
            {Header:"limit_over_mon",           Type:"Int",     Hidden:0,   Width:60,   Align:"Center", ColMerge:0, SaveName:"limit_over_mon",          KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
            {Header:"temp",                     Type:"Int",     Hidden:0,   Width:60,   Align:"Center", ColMerge:0, SaveName:"temp",                    KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 }
        ]; IBS_InitSheet(yeaResultShtBk2, initdataBk1);yeaResultShtBk2.SetEditable(false);yeaResultShtBk2.SetVisible(true);yeaResultShtBk2.SetCountPosition(4);
        ...
        // start yeaResultSht5
        var initdataBk3 = {};
        initdataBk3.Cfg = {SearchMode:smLazyLoad,Page:22};
        initdataBk3.HeaderMode = {Sort:1,ColMove:1,ColResize:1,HeaderCheck:0};
        initdataBk3.Cols = [
                {Header:"a00001",       Type:"Int",     Hidden:0,   Width:60,   Align:"Center", ColMerge:0, SaveName:"a000_01",         KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
                {Header:"a01001",       Type:"Int",     Hidden:0,   Width:60,   Align:"Center", ColMerge:0, SaveName:"a010_01",         KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
                {Header:"a01003",       Type:"Int",     Hidden:0,   Width:60,   Align:"Center", ColMerge:0, SaveName:"a010_03",         KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
                ...
                {Header:"a03002_inp",   Type:"Int",     Hidden:0,   Width:60,   Align:"Center", ColMerge:0, SaveName:"a030_02_inp",     KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
                {Header:"a03013_inp",   Type:"Int",     Hidden:0,   Width:60,   Align:"Center", ColMerge:0, SaveName:"a030_13_inp",     KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 }
            ]; IBS_InitSheet(yeaResultShtBk5, initdataBk3);yeaResultShtBk5.SetEditable(false);yeaResultShtBk5.SetVisible(true);yeaResultShtBk5.SetCountPosition(4);
       ...
       // end yeaResultSht5
        ...
        yeaResultShtBk2.DoSearch( "<%=jspPath%>/yeaData/yeaDataRst.jsp?cmd=selectRes2List871", $("#yeaResultShtForm").serialize() );
        yeaResultShtBk5.DoSearch( "<%=jspPath%>/yeaData/yeaDataRst.jsp?cmd=selectRes5List873", $("#yeaResultShtForm").serialize() );
    ...
    /**
     * 연말정산 Back 계산결과 시트를 각 항목에 입력 temp : TCPN871
     */
    function shtBk2ToCtl(){
        if(yeaResultShtBk2.RowCount() > 0){

            //bk start
            $("#shtBk2_FinIncomeTax").val(    yeaResultShtBk2.GetCellText(1, "fin_income_tax"));//결정소액(소득세)
            $("#shtBk2_FinInbitTaxMon").val(  yeaResultShtBk2.GetCellText(1, "fin_inbit_tax_mon"));//결정세액(주민세)
            $("#shtBk2_FinAgrclTaxMon").val(  yeaResultShtBk2.GetCellText(1, "fin_agrcl_tax_mon"));//결정세액(농어촌특별세)
            $("#shtBk2_FinSum").val(          yeaResultShtBk2.GetCellText(1, "fin_tot_tax_mon"));//결정세액계
            $("#shtBk2_PreIncomeTax").val(    yeaResultShtBk2.GetCellText(1, "pre_income_tax_mon")) ;//종(전)근무지(소득세)
            $("#shtBk2_PreInbitTaxMon").val(  yeaResultShtBk2.GetCellText(1, "pre_inbit_tax_mon"));//종(전)근무지(주민세)
            $("#shtBk2_PreAgrclTaxMon").val(  yeaResultShtBk2.GetCellText(1, "pre_agrcl_tax_mon"));//종(전)근무지(농어촌특별세)
            $("#shtBk2_PreSum").val(          yeaResultShtBk2.GetCellText(1, "pre_tot_tax_mon"));//종(전)근무지계
            $("#shtBk2_CurrIncomeTax").val(   yeaResultShtBk2.GetCellText(1, "curr_income_tax_mon")) ;//주(현)근무지(소득세)
            $("#shtBk2_CurrInbitTaxMon").val( yeaResultShtBk2.GetCellText(1, "curr_inbit_tax_mon"));//주(현)근무지(주민세)
            $("#shtBk2_CurrAgrclTaxMon").val( yeaResultShtBk2.GetCellText(1, "curr_agrcl_tax_mon"));//주(현)근무지(농어촌특별세)
            $("#shtBk2_CurrSum").val(         yeaResultShtBk2.GetCellText(1, "curr_tot_tax_mon"));//주(현)근무지계
            $("#shtBk2_SpcIncomeTaxMon").val( yeaResultShtBk2.GetCellText(1, "spc_income_tax_mon"));//납부특례세액(소득세)
            $("#shtBk2_SpcInbitTaxMon").val(  yeaResultShtBk2.GetCellText(1, "spc_inbit_tax_mon"));//납부특례세액(주민세)
            $("#shtBk2_SpcAgrclTaxMon").val(  yeaResultShtBk2.GetCellText(1, "spc_agrcl_tax_mon"));//납부특례세액(농어촌특별세)
            $("#shtBk2_SpcSum").val(          yeaResultShtBk2.GetCellText(1, "spc_tot_tax_mon"));//납부특례세액계
            $("#shtBk2_BlcIncomeTax").val(    yeaResultShtBk2.GetCellText(1, "blc_income_tax_mon")) ;//차감징수세액(소득세)
            $("#shtBk2_BlcInbitTaxMon").val(  yeaResultShtBk2.GetCellText(1, "blc_inbit_tax_mon"));//차감징수세액(주민세)
            $("#shtBk2_BlcAgrclTaxMon").val(  yeaResultShtBk2.GetCellText(1, "blc_agrcl_tax_mon"));//차감징수세액(농어촌특별세)
            $("#shtBk2_BlcSum").val(          yeaResultShtBk2.GetCellText(1, "blc_tot_tax_mon"));//차감징수세액계


            $("#shtBk2_TaxablePayMon").val(   yeaResultShtBk2.GetCellText(1, "taxable_pay_mon"));//과세대상급여총액
            $("#shtBk2_IncomeMon").val(       yeaResultShtBk2.GetCellText(1, "income_mon"));//근로소득금액
            $("#shtBk2_BlnceIncomeMon").val(  yeaResultShtBk2.GetCellText(1, "blnce_income_mon")) ;//차감소득금액
            $("#shtBk2_LIMIT_OVER_MON").val(  yeaResultShtBk2.GetCellText(1,"limit_over_mon"));//특별공제 종합한도 초과액
            $("#shtBk2_TaxBaseMon").val(      yeaResultShtBk2.GetCellText(1, "tax_base_mon")) ;//과세표준액
            $("#shtBk2_ClclteTaxMon").val(    yeaResultShtBk2.GetCellText(1, "clclte_tax_mon"));//산출세액
            $("#shtBk2_TotTaxDeductMon").val( yeaResultShtBk2.GetCellText(1, "tot_tax_deduct_mon"));//세액공제액
            $("#shtBk2_FinIncomeTax2").val(   yeaResultShtBk2.GetCellText(1, "fin_income_tax"));//결정소액(소득세)
            //bk end

        } else{

            //bk start
            $("#shtBk2_FinIncomeTax").val(    "0");//결정소액(소득세)
            $("#shtBk2_FinInbitTaxMon").val(  "0");//결정세액(주민세)
            $("#shtBk2_FinAgrclTaxMon").val(  "0");//결정세액(농어촌특별세)
            $("#shtBk2_FinSum").val(          "0");//결정세액계
            $("#shtBk2_PreIncomeTax").val(    "0") ;//종(전)근무지(소득세)
            $("#shtBk2_PreInbitTaxMon").val(  "0");//종(전)근무지(주민세)
            $("#shtBk2_PreAgrclTaxMon").val(  "0");//종(전)근무지(농어촌특별세)
            $("#shtBk2_PreSum").val(          "0");//종(전)근무지계
            $("#shtBk2_CurrIncomeTax").val(   "0") ;//주(현)근무지(소득세)
            $("#shtBk2_CurrInbitTaxMon").val( "0");//주(현)근무지(주민세)
            $("#shtBk2_CurrAgrclTaxMon").val( "0");//주(현)근무지(농어촌특별세)
            $("#shtBk2_CurrSum").val(         "0");//주(현)근무지계
            $("#shtBk2_SpcIncomeTaxMon").val( "0");//납부특례세액(소득세)
            $("#shtBk2_SpcInbitTaxMon").val(  "0");//납부특례세액(주민세)
            $("#shtBk2_SpcAgrclTaxMon").val(  "0");//납부특례세액(농어촌특별세)
            $("#shtBk2_SpcSum").val(          "0");//납부특례세액계
            $("#shtBk2_BlcIncomeTax").val(    "0") ;//차감징수세액(소득세)
            $("#shtBk2_BlcInbitTaxMon").val(  "0");//차감징수세액(주민세)
            $("#shtBk2_BlcAgrclTaxMon").val(  "0");//차감징수세액(농어촌특별세)
            $("#shtBk2_BlcSum").val(          "0");//차감징수세액계


            $("#shtBk2_TaxablePayMon").val(   "0");//과세대상급여총액
            $("#shtBk2_IncomeMon").val(       "0");//근로소득금액
            $("#shtBk2_BlnceIncomeMon").val(  "0") ;//차감소득금액
            $("#shtBk2_LIMIT_OVER_MON").val(  "0");//특별공제 종합한도 초과액
            $("#shtBk2_TaxBaseMon").val(      "0") ;//과세표준액
            $("#shtBk2_ClclteTaxMon").val(    "0");//산출세액
            $("#shtBk2_TotTaxDeductMon").val( "0");//세액공제액
            $("#shtBk2_FinIncomeTax2").val(   "0");//결정소액(소득세)
            //bk end

            // [ 재계산 결정세액 차액 ]
            $("#shtBk2_SubBlcIncomeTax").val(  "0");//차감징수세액(소득세) 차액
            $("#shtBk2_SubBlcInbitTaxMon").val("0");//차감징수세액(주민세) 차액
            $("#shtBk2_SubBlcAgrclTaxMon").val("0");//차감징수세액(농어촌특별세) 차액
            $("#shtBk2_SubBlcSum").val(        "0");//차감징수세액계 차액
            $("#shtBk2_SubFinIncomeTax2").val( "0");//결정소액(소득세) 차액
        }
    }
	 ...
	 * 재계산 차액검색 항목 세팅
	 */
    function setRecalValue(){
        // [ 재계산 결정세액 차액 ]
        //차감징수세액(소득세) 차액
        yeaResultShtBk2.SetCellValue(1, "temp", yeaResultSht2.GetCellValue(1, "blc_income_tax_mon") - yeaResultShtBk2.GetCellValue(1, "blc_income_tax_mon"));
        $("#shtBk2_SubBlcIncomeTax").val(yeaResultShtBk2.GetCellText(1, "temp"));
        //차감징수세액(주민세) 차액
        yeaResultShtBk2.SetCellValue(1, "temp", yeaResultSht2.GetCellValue(1, "blc_inbit_tax_mon")  - yeaResultShtBk2.GetCellValue(1, "blc_inbit_tax_mon"));
        $("#shtBk2_SubBlcInbitTaxMon").val(yeaResultShtBk2.GetCellText(1, "temp"));
        //차감징수세액(농어촌특별세) 차액
        yeaResultShtBk2.SetCellValue(1, "temp", yeaResultSht2.GetCellValue(1, "blc_agrcl_tax_mon")  - yeaResultShtBk2.GetCellValue(1, "blc_agrcl_tax_mon"));
        $("#shtBk2_SubBlcAgrclTaxMon").val(yeaResultShtBk2.GetCellText(1, "temp"));
        //차감징수세액계 차액
        yeaResultShtBk2.SetCellValue(1, "temp", yeaResultSht2.GetCellValue(1, "blc_tot_tax_mon")    - yeaResultShtBk2.GetCellValue(1, "blc_tot_tax_mon"));
        $("#shtBk2_SubBlcSum").val(yeaResultShtBk2.GetCellText(1, "temp"));
        //결정소액(소득세) 차액
        yeaResultShtBk2.SetCellValue(1, "temp", yeaResultSht2.GetCellValue(1, "fin_income_tax")     - yeaResultShtBk2.GetCellValue(1, "fin_income_tax"));
        $("#shtBk2_SubFinIncomeTax2").val(yeaResultShtBk2.GetCellText(1, "temp"));
    }
     ...
     */
     ...
     /**
      * 연말정산 Back 계산결과 상세시트를 각 항목에 입력 temp : TCPN873
      */
      function shtBk5ToCtl(){
         if(yeaResultShtBk5.RowCount() > 0){
             for(var i = 0 ; i < $("input").length; i++) {
                 if(($("input")[i].id).indexOf("shtBk5") > -1) {
                     var shtValueName = (($("input")[i].id).toLowerCase()).replace("shtbk5_","");

                     $("#"+$("input")[i].id).val( yeaResultShtBk5.GetCellText(1, shtValueName) );
                 }
             }
         }else{
             for(var i = 0 ; i < $("input").length; i++) {
    ...
    function yeaResultSht2_OnSearchEnd(Code, Msg, StCode, StMsg) {
    	...
    	/*
    	 * 재계산 차액검색 항목 세팅 => 모두 로딩된 후 하여야 하므로 간혹 팝업에 차액세팅이 안되는 경우 이 때문이라 일단 SearchEnd에 모두 때려박아둔다
    	 */
        setRecalValue();
    }
  ...
  //조회 후 에러 메시지
    function yeaResultShtBk2_OnSearchEnd(Code, Msg, StCode, StMsg) {
        try {
    ...
    //조회 후 에러 메시지
    function yeaResultShtBk5_OnSearchEnd(Code, Msg, StCode, StMsg) {
        try {
...
<div class="wrapper" style="overflow:scroll;">
    ...
    <tr>
        ...
        <th class="center">소득세<br/><B>(이전)</B></th>
        <th class="center">지방소득세</th>
        <th class="center">지방소득세<br/><B>(이전)</B></th>
        <th class="center">농어촌특별세</th>
        <th class="center">농어촌특별세<br/><B>(이전)</B></th>
        <th class="center">계</th>
        <th class="center">계<br/><B>(이전)</B></th>
    </tr>
    <tr>
        ...
        <td class="right">
            <input id="shtBk2_FinIncomeTax"    name="shtBk2_FinIncomeTax" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_FinInbitTaxMon"    name="sht2_FinInbitTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="shtBk2_FinInbitTaxMon"  name="shtBk2_FinInbitTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_FinAgrclTaxMon"    name="bk_sht2_FinAgrclTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="shtBk2_FinAgrclTaxMon"  name="shtBk2_FinAgrclTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_FinSum"            name="sht2_FinSum" type="text" class="text w100p right" readOnly/>
        </td>
        <td class="right">
            <input id="shtBk2_FinSum"          name="shtBk2_FinSum" type="text" class="text w100p right" readOnly/>
        </td>
    </tr>
    <tr>
        ...
        <td class="right">
            <input id="shtBk2_PreIncomeTax"   name="shtBk2_PreIncomeTax" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_PreInbitTaxMon"   name="sht2_PreInbitTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="shtBk2_PreInbitTaxMon" name="shtBk2_PreInbitTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_PreAgrclTaxMon"   name="sht2_PreAgrclTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="shtBk2_PreAgrclTaxMon" name="shtBk2_PreAgrclTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_PreSum"           name="sht2_PreSum" type="text" class="text w100p right" readOnly/>
        </td>
        <td class="right">
            <input id="shtBk2_sht2_PreSum"    name="shtBk2_PreSum" type="text" class="text w100p right" readOnly/>
        </td>
    </tr>
    <tr>
        ...
        <td class="right">
            <input id="shtBk2_CurrIncomeTax"   name="shtBk2_CurrIncomeTax" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_CurrInbitTaxMon"   name="sht2_CurrInbitTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="shtBk2_CurrInbitTaxMon" name="shtBk2_CurrInbitTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_CurrAgrclTaxMon"   name="sht2_CurrAgrclTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="shtBk2_CurrAgrclTaxMon" name="shtBk2_CurrAgrclTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_CurrSum"           name="sht2_CurrSum" type="text" class="text w100p right" readOnly/>
        </td>
        <td class="right">
            <input id="shtBk2_CurrSum"         name="shtBk2_CurrSum" type="text" class="text w100p right" readOnly/>
        </td>
    </tr>
    <tr>
        ...
        <td class="right">
            <input id="shtBk2_SpcIncomeTaxMon" name="shtBk2_SpcIncomeTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_SpcInbitTaxMon"    name="sht2_SpcInbitTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="shtBk2_SpcInbitTaxMon"  name="shtBk2_SpcInbitTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_SpcAgrclTaxMon"    name="sht2_SpcAgrclTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="shtBk2_SpcAgrclTaxMon"  name="shtBk2_SpcAgrclTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_SpcSum"            name="sht2_SpcSum" type="text" class="text w100p right" readOnly/>
        </td>
        <td class="right">
            <input id="shtBk2_SpcSum"          name="shtBk2_SpcSum" type="text" class="text w100p right" readOnly/>
        </td>
    </tr>
    <tr>
        ...
        <td class="right">
            <input id="shtBk2_BlcIncomeTax"   name="shtBk2_BlcIncomeTax" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_BlcInbitTaxMon"   name="sht2_BlcInbitTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="shtBk2_BlcInbitTaxMon" name="shtBk2_BlcInbitTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_BlcAgrclTaxMon"   name="sht2_BlcAgrclTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="shtBk2_BlcAgrclTaxMon" name="shtBk2_BlcAgrclTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right">
            <input id="sht2_BlcSum"           name="sht2_BlcSum" type="text" class="text w100p right" readOnly/>
        </td>
        <td class="right">
            <input id="shtBk2_BlcSum"         name="shtBk2_BlcSum" type="text" class="text w100p right" readOnly/>
        </td>
    </tr>
    <tr>
        <th class="right" colspan="2"><b>[ 재계산 차액 ]</b></th>
        <td class="right" colspan="2">
            <input id="shtBk2_SubBlcIncomeTax"     name="sht2_SubBlcIncomeTax" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right" colspan="2">
            <input id="shtBk2_SubBlcInbitTaxMon"   name="sht2_SubBlcInbitTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right" colspan="2">
            <input id="shtBk2_SubBlcAgrclTaxMon"   name="sht2_SubBlcAgrclTaxMon" type="text" class="text w100p right" readOnly />
        </td>
        <td class="right" colspan="2">
            <input id="shtBk2_SubBlcSum"           name="sht2_SubBlcSum" type="text" class="text w100p right" readOnly/>
        </td>
    </tr>
    </table>
    <!-- table4 big! -->
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="default outer">
        ...
        <tr>
            ...
            <th class="center">공제금액<B>(이전)</B></th>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk2_TaxablePayMon" name="shtBk2_TaxablePayMon" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A000_01" name="shtBk5_A000_01" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk2_IncomeMon" name="shtBk2_IncomeMon" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A010_01" name="shtBk5_A010_01" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A010_03" name="shtBk5_A010_03" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A010_11" name="shtBk5_A010_11" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A020_04" name="shtBk5_A020_04" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A020_05" name="shtBk5_A020_05" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A020_07" name="shtBk5_A020_07" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A020_14" name="shtBk5_A020_14" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A030_01" name="shtBk5_A030_01" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A030_11" name="shtBk5_A030_11" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A030_12" name="shtBk5_A030_12" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A030_02" name="shtBk5_A030_02" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A030_13" name="shtBk5_A030_13" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A040_03" name="shtBk5_A040_03" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A040_04" name="shtBk5_A040_04" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A070_14" name="shtBk5_A070_14" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A070_21" name="shtBk5_A070_21" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A070_17" name="shtBk5_A070_17" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center" colspan="2">2011년 이전(15년이상)</th>
            <td class="right">
            ...
            <td class="right">
                <input id="shtBk5_A070_15" name="shtBk5_A070_15" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A070_16" name="shtBk5_A070_16" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A070_22" name="shtBk5_A070_22" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A070_23" name="shtBk5_A070_23" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A070_24" name="shtBk5_A070_24" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center" colspan="2">2015년 이후(15년이상 고정/비거치 상환)</th>
            ...
            <td class="right">
                <input id="shtBk5_A070_25" name="shtBk5_A070_25" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A070_26" name="shtBk5_A070_26" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A070_27" name="shtBk5_A070_27" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <% // 2015년 변경 end %>
        ...
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A080_20" name="shtBk5_A080_20" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A099_02" name="shtBk5_A099_02" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk2_BlnceIncomeMon" name="shtBk2_BlnceIncomeMon" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center" rowspan="23">그 밖의<br>소득공제</th>
            ...
            <td class="right">
                <input id="shtBk5_A100_03" name="shtBk5_A100_03" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A100_30" name="shtBk5_A100_30" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A100_34" name="shtBk5_A100_34" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A100_31" name="shtBk5_A100_31" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A100_33" name="shtBk5_A100_33" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center" rowspan="8">투자조합 출자공제</th>
            ...
            <td class="right" rowspan="8">
                <input id="sht5_A100_07" name="sht5_A100_07" type="text" class="text w100p right" readOnly />
            </td>
            <td class="right" rowspan="8">
                <input id="shtBk5_A100_07" name="shtBk5_A100_07" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
        ...
        <% //2015년 추가 Start %>
        <tr>
            <th class="center" rowspan="2" >2015.1.1 ~ 2014.12.31</th>
            <th class="center" colspan="2">간접출자</th>
            <td class="right">
        ...
        <tr>
            ...
            <td class="right" rowspan="6">
                <input id="shtBk5_A100_23" name="shtBk5_A100_23" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A100_21" name="shtBk5_A100_21" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A100_37" name="shtBk5_A100_37" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A100_38" name="shtBk5_A100_38" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A100_40" name="shtBk5_A100_40" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A100_99" name="shtBk5_A100_99" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk2_LIMIT_OVER_MON" name="shtBk2_LIMIT_OVER_MON" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk2_TaxBaseMon" name="shtBk2_TaxBaseMon" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk2_ClclteTaxMon" name="shtBk2_ClclteTaxMon" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B010_14" name="shtBk5_B010_14" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B010_15" name="shtBk5_B010_15" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B010_16" name="shtBk5_B010_16" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B010_17" name="shtBk5_B010_17" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B010_13" name="shtBk5_B010_13" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center" rowspan="37">세액공제</th>
            ...
            <td class="right">
                <input id="shtBk5_B000_01" name="shtBk5_B000_01" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B000_10" name="shtBk5_B000_10" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B001_20" name="shtBk5_B001_20" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B001_30" name="shtBk5_B001_30" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A030_04_STD" name="shtBk5_A030_04_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A030_04" name="shtBk5_A030_04" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A030_03_STD" name="shtBk5_A030_03_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center" colspan="2">세액공제액</th>
            ...
            <td class="right">
                <input id="shtBk5_A030_03" name="shtBk5_A030_03" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A100_05_STD" name="shtBk5_A100_05_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center" colspan="2">세액공제액</th>
            ...
            <td class="right">
                <input id="shtBk5_A100_05" name="shtBk5_A100_05" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A040_05_STD" name="shtBk5_A040_05_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A040_05" name="shtBk5_A040_05" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A040_07_STD" name="shtBk5_A040_07_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center">세액공제액</th>
            ...
            <td class="right">
                <input id="shtBk5_A040_07" name="shtBk5_A040_07" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <%//2015-04-23 end %>
        ...
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A050_01_STD" name="shtBk5_A050_01_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center" colspan="2">세액공제액</th>
            ...
            <td class="right">
                <input id="shtBk5_A050_01" name="shtBk5_A050_01" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A060_01_STD" name="shtBk5_A060_01_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center" colspan="2">세액공제액</th>
            ...
            <td class="right">
                <input id="shtBk5_A060_01" name="shtBk5_A060_01" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B010_05_STD" name="shtBk5_B010_05_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center">세액공제액</th>
            <td class="right">
             ...
             <td class="right">
                <input id="shtBk5_B010_05" name="shtBk5_B010_05" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A080_05_STD" name="shtBk5_A080_05_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center">세액공제액</th>
            ...
            <td class="right">
                <input id="shtBk5_A080_05" name="shtBk5_A080_05" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A080_03_STD" name="shtBk5_A080_03_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center">세액공제액</th>
            ...
            <td class="right">
                <input id="shtBk5_A080_03" name="shtBk5_A080_03" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A080_09_STD" name="shtBk5_A080_08_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center">세액공제액</th>
            ...
            <td class="right">
                <input id="shtBk5_A080_09" name="shtBk5_A080_09" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A080_13_STD" name="shtBk5_A080_13_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center">세액공제액</th>
            ...
            <td class="right">
                <input id="shtBk5_A080_13" name="shtBk5_A080_13" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B013_01" name="shtBk5_B013_01" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A099_01" name="shtBk5_A099_01" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B010_01" name="shtBk5_B010_01" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_B010_03" name="shtBk5_B010_03" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right" rowspan="2">
                <input id="shtBk5_B010_07" name="shtBk5_B010_07" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="right">
                <input id="shtBk5_A070_10_STD" name="shtBk5_A070_10_STD" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center" colspan="2">세액공제액</th>
            ...
            <td class="right">
                <input id="shtBk5_A070_10" name="shtBk5_A070_10" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk2_TotTaxDeductMon" name="shtBk2_TotTaxDeductMon" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            ...
            <td class="right">
                <input id="shtBk2_FinIncomeTax2" name="shtBk2_FinIncomeTax2" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        <tr>
            <th class="center" colspan="6"><b>[ 재계산 결정세액 차액 ]</b></th>
            <td class="right" colspan="2">
                <input id="shtBk2_SubFinIncomeTax2" name="shtBk2_SubFinIncomeTax2" type="text" class="text w100p right" readOnly />
            </td>
        </tr>
        </table>
    </form>
    ...
    <span class="hide">
        ...
        <script type="text/javascript">createIBSheet("yeaResultShtBk2", "100%", "100%"); </script>
        <script type="text/javascript">createIBSheet("yeaResultShtBk5", "100%", "100%"); </script>
    </span>
    </div>
</div>
