	...
	if("selectYeaDataPdfList".equals(cmd)) {
        ...
        try {
        	if(fileUploadType.equals("1")){
				...
				String filePath = StringUtil.getPropertiesValue("WAS.PATH")
						+ StringUtil.getPropertiesValue("HRFILE.PATH")
						+ "/YEA_PDF/" + ssnEnterCd + "/" + paramYear + "/SUM";
        ...
        try{
        	downloadPdfToS3(filePath, fileName, fileId, response);
        } catch(Exception e){
        	code = "-1";
