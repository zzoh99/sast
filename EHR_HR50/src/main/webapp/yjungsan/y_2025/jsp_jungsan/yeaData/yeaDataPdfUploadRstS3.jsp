        ...
        try{
    		...
    		if(perList != null && perList.size() > 0) {
    			...
    			for(int j=0; j<perList.size(); j++) {
                    ...
                    String famNm = null;
                    if(perList.get(j).get("famres") != null)
                        famNm = chkPerMap.get(perList.get(j).get("famres"));
                    ...
                    if(perList.get(j).get("famres") != null
                            && perList.get(j).get("fam_nm") != null
                            && ! "".equals(perList.get(j).get("famres"))
                            && ! "".equals(perList.get(j).get("fam_nm"))
                    )
