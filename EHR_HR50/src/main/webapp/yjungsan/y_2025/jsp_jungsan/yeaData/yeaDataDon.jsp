...
<%-- 			{Header:"금액자료|담당자용",					Type:"AutoSum",			Hidden:0,	Width:80,	Align:"Right",	ColMerge:1,	SaveName:"appl_mon",		KeyField:1,	Format:"",			PointCount:0,	UpdateEdit:<%=applEdit%>,	InsertEdit:<%=applEdit%>,	EditLen:35 }, --%>
		...
		var contributionCdList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&useYn=Y&searchYear="+<%=yeaYear%>,"C00307"), "");
...
<%--         sheet1.SetRangeBackColor(0,0,1, sheet1.LastCol(),"<%=headerColorA%>") ; --%>
		...
		initdata12.Cols = [
            ...
            {Header:"이월금액",   			Type:"Int",      Hidden:0,  Width:100,  Align:"Right",    	ColMerge:0,   SaveName:"carried_mon",  		KeyField:0,   CalcLogic:"",   Format:"",     PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100, BackColor:"#feffad", FontColor:"#1717ff" }
...
<div class="wrapper">
	...
	<div class="outer">
		<div class="sheet_title">
			<ul>
				<li class="txt"><font class="red">※ 노조비는 해당 노조와 상급단체 / 총연단체(1000명 미만인 경우)가 회계 공시한 경우만 기재하십시오. (소법59조4-시행령80조)</font></li>
				<li class="btn">
