...
--%>
		...
		$("#searchYyType").bind("change", function(){
			...
			// 반기구분 코드 조회
			var halfGubunList = stfConvCode(ajaxCall("<%=jspPath%>/yeaData/yeaDataCardsRst.jsp?cmd=selectYeaDataCardsHalfGubun&searchYear="+<%=yeaYear%>, "searchYyType="+ $(this).val(), false).codeList, "");
			//신용카드구분 코드 조회
			var cardTypeList = stfConvCode(ajaxCall("<%=jspPath%>/yeaData/yeaDataCardsRst.jsp?cmd=selectYeaDataCardCardType&searchYear="+<%=yeaYear%>, "searchYyType="+ $(this).val(), false).codeList, "");
...
*/
		...
		// 신용카드구분이 2013 일 경우(명의인:본인, 반기구분:2013 전체)
			...
			if ($("#searchWorkYy").val() != shtObj.GetCellValue(Row, "use_yyyy")) {
				...
				alert("근로제공기간 이외 신용카드등 사용액의 대상은"
						+ "\n다음과 같습니다."
						+ "\n * 종전근무지를 포함하여 2024.1.1 ~ 2024.12.31 기간중 "
						+ "\n   근로하지 아니한 기간에 사용한 본인 신용카드등 사용액");
	...
	function initDefaultData() {
		...
		var result1 = ajaxCall("<%=jspPath%>/common/commonSelect.jsp?cmd=commonSelectMap",param1+"&adjProcessCd=A072",false);
		...
		//총급여 확인 버튼 유무
		var result2 = ajaxCall("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&searchStdCd=CPN_YEA_MON_SHOW_YN&searchWorkYy="+$("#searchWorkYy").val(), "queryId=getYeaSystemStdData",false).codeList;
	...
	function paytotMonView(){
		...
		var result = ajaxCall("<%=jspPath%>/common/commonSelect.jsp?cmd=commonSelectMap",param+"&searchNumber=0.25",false);
...
<script type="text/javascript">
	function load_sheet1() {
		...
		initdata1.Cols = [
			...
			{Header:"신용카드|신용카드",			    		Type:"AutoSum",	Hidden:0,   Width:60,   Align:"Right",   ColMerge:0, SaveName:"card_amt",			KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"직불카드등|직불카드등",               	Type:"AutoSum", Hidden:0,   Width:80,   Align:"Right",   ColMerge:0, SaveName:"tot_check_amt",     	KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"현금영수증|현금영수증",					Type:"AutoSum",	Hidden:0,   Width:60,   Align:"Right",   ColMerge:0, SaveName:"cash_amt",			KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			...
			{Header:"도서공연등사용분|도서공연등사용분",			Type:"AutoSum",	Hidden:0,   Width:60,   Align:"Right",   ColMerge:0, SaveName:"tot_book_amt",		KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			// {Header:"도서공연등사용분|1월 ~ 3월",				Type:"AutoSum",	Hidden:0,   Width:70,   Align:"Right",   ColMerge:0, SaveName:"tot_book_amt1",		KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			// {Header:"도서공연등사용분|4월 ~ 12월",			Type:"AutoSum",	Hidden:0,   Width:70,   Align:"Right",   ColMerge:0, SaveName:"tot_book_amt2",		KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"전통시장사용분|전통시장사용분",			Type:"AutoSum",	Hidden:0,   Width:80,   Align:"Right",   ColMerge:0, SaveName:"tot_market_amt",		KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			// {Header:"전통시장사용분|1월 ~ 3월",				Type:"AutoSum",	Hidden:0,   Width:70,   Align:"Right",   ColMerge:0, SaveName:"tot_market_amt1",	KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			// {Header:"전통시장사용분|4월 ~ 12월",				Type:"AutoSum",	Hidden:0,   Width:70,   Align:"Right",   ColMerge:0, SaveName:"tot_market_amt2",	KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"대중교통이용분|대중교통이용분",			Type:"AutoSum",	Hidden:0,   Width:70,   Align:"Right",   ColMerge:0, SaveName:"tot_bus_amt",	    KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			//{Header:"대중교통이용분|1월 ~ 6월",				Type:"AutoSum",	Hidden:1,   Width:80,   Align:"Cen",   ColMerge:0, SaveName:"tot_bus_amt1",	    	KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			//{Header:"대중교통이용분|7월 ~ 12월",			Type:"AutoSum",	Hidden:1,   Width:80,   Align:"Cen",   ColMerge:0, SaveName:"tot_bus_amt2",	    	KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"사업관련비용|사업관련비용",				Type:"AutoSum",	Hidden:0,   Width:60,	Align:"Right",   ColMerge:0, SaveName:"business_amt",  		KeyField:0, Format:"#,##0",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"2024 합계\nmax(0,사업관련비조정합계)|2024 합계\nmax(0,사업관련비조정합계)",	Type:"AutoSum",	Hidden:0,   Width:75,	Align:"Right",   ColMerge:0, SaveName:"tot_amt",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			//{Header:"2024 합계\n(사업관련비용제외)|전체",				    Type:"AutoSum",	Hidden:0,   Width:60,	Align:"Center",   ColMerge:0, SaveName:"tot_amt",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			//{Header:"2024 합계\n(사업관련비용제외)|전통시장",				    Type:"AutoSum",	Hidden:0,   Width:60,	Align:"Center",   ColMerge:0, SaveName:"tot_market_amt_2024",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"2023 합계\nmax(0,사업관련비조정합계)|2023 합계\nmax(0,사업관련비조정합계)",  Type:"AutoSum", Hidden:0,   Width:75,   Align:"Right",   ColMerge:0, SaveName:"tot_amt_2023",  KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			//{Header:"2023 합계\n(사업관련비용제외)|전체",                 	Type:"AutoSum", Hidden:0,   Width:60,   Align:"Center",   ColMerge:0, SaveName:"tot_amt_2023",       KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			//{Header:"2023 합계\n(사업관련비용제외)|전통시장",                 Type:"AutoSum", Hidden:0,   Width:60,   Align:"Center",   ColMerge:0, SaveName:"tot_market_amt_2023",       KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
		...
		// 반기구분 코드 조회
		var halfGubunList = stfConvCode(ajaxCall("<%=jspPath%>/yeaData/yeaDataCardsRst.jsp?cmd=selectYeaDataCardsHalfGubun&searchYear="+<%=yeaYear%>, "searchYyType=", false).codeList, "");
...
// 			{Header:"월구간|월구간",				Type:"Combo",	    Hidden:1,   Width:80,  	Align:"Center", ColMerge:0, SaveName:"period_type",		    KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:200 },
			{Header:"신용카드\n구분|신용카드\n구분",Type:"Combo",	    Hidden:0,   Width:145,   Align:"Center", ColMerge:0, SaveName:"card_type",	    KeyField:1, Format:"",  PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 },
			...
			{Header:"금액자료|직원용",				Type:"Int",	    Hidden:0,   Width:110,  Align:"Right",  ColMerge:0, SaveName:"use_mon",		    KeyField:0, Format:"#,###",  PointCount:0,   UpdateEdit:<%=inputEdit%>,   InsertEdit:<%=inputEdit%>,   EditLen:35, MinimumValue: 0 },
			{Header:"금액자료|담당자용",			    Type:"Int",	    Hidden:0,   Width:110,  Align:"Right",  ColMerge:0, SaveName:"appl_mon",		KeyField:1, Format:"#,###",  PointCount:0,   UpdateEdit:<%=applEdit%>,	InsertEdit:<%=applEdit%>,	EditLen:35, MinimumValue: 0 },
			...
			{Header:"회사지원금|회사지원금",			  	Type:"AutoSum",		Hidden:1,   Width:60,   Align:"Right",  ColMerge:0, SaveName:"co_deduct_mon",   KeyField:0, Format:"",  PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
		...
		// 반기구분 코드 조회
		var halfGubunList = stfConvCode(ajaxCall("<%=jspPath%>/yeaData/yeaDataCardsRst.jsp?cmd=selectYeaDataCardsHalfGubun&searchYear="+<%=yeaYear%>, "searchYyType=0", false).codeList, "");
		//신용카드구분 코드 조회
		var cardTypeList = stfConvCode(ajaxCall("<%=jspPath%>/yeaData/yeaDataCardsRst.jsp?cmd=selectYeaDataCardCardType&searchYear="+<%=yeaYear%>, "searchYyType=0", false).codeList, "");

		var cardTypeList2 = stfConvCode(ajaxCall("<%=jspPath%>/yeaData/yeaDataCardsRst.jsp?cmd=selectYeaDataCardCardType&searchYear="+<%=yeaYear%>, "searchYyType=0", false).codeList, "전체");
...
// 		sheet2.SetColProperty("period_type",		 {ComboText:"|"+periodType[0], ComboCode:"|"+periodType[1]} );
		...
		sheet2.SetColProperty("use_yyyy", {ComboText:"2024|2023", ComboCode:"2024|2023"});
	  	//양식다운로드 title 정의
	  	templeteTitle2 = "업로드시 이 행은 삭제 합니다\n\n";
		var codeCdNm = "", codeCd = "", codeNm = "";
...
// 		templeteTitle2 += "월구간 : " + codeCdNm + "\n";
	...
	//		 var info =[{StdCol:"card_type", SumCols:sumColsInfo, ShowCumulate:0, CaptionCol:3}];
		...
		case "Copy":
			...
			sheet2.SetCellValue( newRow, "use_mon", ""); // 금액자료|직원용
			sheet2.SetCellValue( newRow, "appl_mon", ""); // 금액자료|담당자용
		...
		case "Down2Template":
			...
			var DownCols = "";
			if ( $("#searchYyType").val() == "0" || $("#searchYyType").val() == "-99") {
				DownCols = "9|10|12|13"+monTmp+"|19"+feedbackTmp;
			}else{
				DownCols = "10|12|13"+monTmp+"|19"+feedbackTmp;
			}

            var param  = {DownCols:DownCols, SheetDesign:1,Merge:1,DownRows:'0|1',ExcelFontSize:"9"
                ,TitleText:templeteTitle2,UserMerge :"0,0,1,7",menuNm:$(document).find("title").text()};
			sheet2.Down2Excel(param);
			break;
	...
	function sheet2_OnLoadExcel(result) {
		...
		try {
			...
			for(var i = sheet2.HeaderRows(); i < sheet2.RowCount()+sheet2.HeaderRows(); i++){
				...
				sheet2.SetCellValue2( i, "work_yy", 		$("#searchWorkYy").val() );
				sheet2.SetCellValue2( i, "adjust_type", 	$("#searchAdjustType").val() );
				sheet2.SetCellValue2( i, "sabun", 		$("#searchSabun").val() );

				if ( orgAuthPg=="A" ) { //담당자용
					sheet2.SetCellValue2( i, "adj_input_type", "02" );
					sheet2.SetCellEditable(i, "feedback_type", 1);

				} else {
					sheet2.SetCellValue2( i, "adj_input_type", "01" );
					sheet2.SetCellValue2( i, "appl_mon", sheet2.GetCellValue(i, "use_mon") );
					sheet2.SetCellEditable(i, "feedback_type", 0);
				}

				// 전년도, 전전년도 인 경우 본인만 등록가능
				if ( $("#searchYyType").val() != "0" && $("#searchYyType").val() != "-99" ) {
					sheet2.SetCellValue2( i, "famres", 		gOwnFamCd );
				}
				...
				if( sheet2.GetCellValue( i, "use_mon") < 0) {
					if(sheet2.GetCellValue( i, "card_type") == "3" || sheet2.GetCellValue( i, "card_type") == "4"){
						sheet2.SetCellValue2( i, "use_mon","0");
						msgSts = true;
					}
				}
				if( sheet2.GetCellValue( i, "appl_mon") < 0) {
					if(sheet2.GetCellValue( i, "card_type") == "3" || sheet2.GetCellValue( i, "card_type") == "4"){
						sheet2.SetCellValue2( i, "appl_mon","0");
						msgSts = true;
					}
				}
			}
...
// 					sheet2.SetCellValue(Row_1, "use_yyyy", use_yyyy);
	...
	function chagneSearchYyType(value) {
		...
		// 반기구분 코드 조회
		var halfGubunList = stfConvCode(ajaxCall("<%=jspPath%>/yeaData/yeaDataCardsRst.jsp?cmd=selectYeaDataCardsHalfGubun&searchYear="+<%=yeaYear%>, "searchYyType="+ $("#searchYyType").val(), false).codeList, "");
		//신용카드구분 코드 조회
		var cardTypeList = stfConvCode(ajaxCall("<%=jspPath%>/yeaData/yeaDataCardsRst.jsp?cmd=selectYeaDataCardCardType&searchYear="+<%=yeaYear%>, "searchYyType="+ $("#searchYyType").val(), false).codeList, "");
...
// 		templeteTitle2 += "월구간 : " + codeCdNm + "\n";
    ...
    function getCardMonInput(){		
		//신용카드구분이 "사업관련비용일 경우, 합계금액에서 제외 20231127    	
    	var totalUseMon = 0;
    	var totalApplMon = 0;
    	
    	sheet2.SetCellValue(sheet2.LastRow(),"use_mon","0");
    	sheet2.SetCellValue(sheet2.LastRow(),"appl_mon","0");

    	for(var i = sheet2.HeaderRows(); i <= sheet2.LastRow(); i++){
			if(sheet2.GetCellValue(i,"appl_mon") != ""){
				if(sheet2.GetCellValue(i,"card_type") != "3" && sheet2.GetCellValue(i,"card_type") != "4"){ // 3 사업관련비용(신용카드), 4 사업관련비용(직불/선불카드)
					totalApplMon = totalApplMon + parseInt(sheet2.GetCellValue(i,"appl_mon"), 10);
				} else {
					totalApplMon = totalApplMon - parseInt(sheet2.GetCellValue(i,"appl_mon"), 10);
				}
			}
			if(sheet2.GetCellValue(i,"use_mon") != ""){
				if(sheet2.GetCellValue(i,"card_type") != "3" && sheet2.GetCellValue(i,"card_type") != "4"){ // 3 사업관련비용(신용카드), 4 사업관련비용(직불/선불카드)
					totalUseMon = totalUseMon + parseInt(sheet2.GetCellValue(i,"use_mon"), 10);
				} else {
					totalUseMon = totalUseMon - parseInt(sheet2.GetCellValue(i,"use_mon"), 10);
				}
			}
    	...
    	sheet2.SetCellValue(sheet2.LastRow(),"use_mon",comma(totalUseMon));
