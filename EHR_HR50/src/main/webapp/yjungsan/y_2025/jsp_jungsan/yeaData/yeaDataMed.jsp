...
<!DOCTYPE html> <html><head> <title>의료비</title>
    ...
    <script type="text/javascript">
        ...
        var yeaMonShowYn;
        //총급여
        var paytotMonStr;  //총급여 3%
        var paytotMonTemp; //총급여

        var applMonArr = []; //금액자료(담당자)
        var overFlag = true; //알람 창 중복 방지

        //     $("#medMonInput1").mask('000,000,000,000,000', {reverse: true});
        //     $("#medMonInput2").mask('000,000,000,000,000', {reverse: true});
        ...
        $(function() {
            ...
            paytotMonTemp = $("#paytotMonTemp", parent.document).val();
    ...
    --%>
            ...
            initdata2.Cols = [
                ...
                {Header:"구분|구분",                                   Type:"Combo",       Hidden:0,   Width:105,  Align:"Center", ColMerge:1, SaveName:"special_yn",      KeyField:0, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1, EditLen:10 },
                ...
                {Header:"관계|관계",                                   Type:"Combo",       Hidden:0,   Width:95,   Align:"Center", ColMerge:1, SaveName:"adj_fam_cd",      KeyField:0, Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:200 },
                {Header:"의료비\n증빙코드|의료비\n증빙코드",               Type:"Combo",       Hidden:0,   Width:135,   Align:"Left",   ColMerge:1, SaveName:"medical_imp_cd",  KeyField:1, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 },
                ...
                {Header:"사업자번호|사업자번호",                       Type:"Text",        Hidden:0,   Width:90,   Align:"Center", ColMerge:1, SaveName:"enter_no",        KeyField:0, Format:"SaupNo",PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
                ...
                {Header:"건수|건수",                                   Type:"AutoSum",         Hidden:0,   Width:35,   Align:"Right",  ColMerge:1, SaveName:"cnt",             KeyField:1, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
                {Header:"금액자료|직원용",                             Type:"Int",     Hidden:0,   Width:65,   Align:"Right",  ColMerge:1, SaveName:"input_mon",       KeyField:0, Format:"#,###",      PointCount:0,   UpdateEdit:<%=inputEdit%>,   InsertEdit:<%=inputEdit%>,   EditLen:35, MinimumValue: 0 },
                {Header:"금액자료|담당자용",                           Type:"Int",     Hidden:0,   Width:65,   Align:"Right",  ColMerge:1, SaveName:"appl_mon",        KeyField:1, Format:"#,###",      PointCount:0,   UpdateEdit:<%=applEdit%>,    InsertEdit:<%=applEdit%>,    EditLen:35, MinimumValue: 0 },
                ...
                {Header:"미숙아\n선천성\n이상아|미숙아\n선천성\n이상아",   Type:"CheckBox",    Hidden:0,   Width:40,   Align:"Center", ColMerge:1, SaveName:"pre_baby_yn",        KeyField:0, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1, TrueValue:"Y", FalseValue:"N", HeaderCheck: 0 },
                {Header:"난임\n시술비|난임\n시술비",   Type:"CheckBox",    Hidden:0,   Width:40,   Align:"Center", ColMerge:1, SaveName:"nanim_yn",        KeyField:0, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1, TrueValue:"Y", FalseValue:"N", HeaderCheck: 0 },
                {Header:"국세청\n자료여부|국세청\n자료여부",           Type:"CheckBox",    Hidden:0,   Width:45,   Align:"Center", ColMerge:1, SaveName:"nts_yn",          KeyField:0, Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:1, TrueValue:"Y", FalseValue:"N" },
                {Header:"인적공재장애인여부|인적공재장애인여부",                       Type:"Text",        Hidden:1,   Width:60,   Align:"Left",   ColMerge:1, SaveName:"hndcp_yn",        KeyField:0, Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
            ...
            var medicalImpCdList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&searchYear=<%=yeaYear%>","C00308"), "");
            var restrictCdList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&searchYear=<%=yeaYear%>","C00340"), "");
            ...
            var specialYn = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&searchYear=<%=yeaYear%>","C00337"), "");

            sheet2.SetColProperty("special_yn",     {ComboText:"|" + specialYn[0], ComboCode:"|" + specialYn[1]} );
            ...
            switch (sAction) {
                ...
                case "Save":
                    ...
                    for( var i = 2; i < sheet2.LastRow()+2; i++) {
                        ...
                        if( sheet2.GetCellValue(i, "sStatus") == "U" ||
                            ...
                            if( sheet2.GetCellValue(i, "medical_imp_cd") != "1" ) {
                                ...
                                //실손의료보험금일 경우 사업자 번호 체크 제외 - 2020.01.15
                                if( fResNo == "" && sheet2.GetCellValue(i,"restrict_cd") != "30" ) {
                                    alert("사업자 번호를 입력해 주십시오.") ;
                                    sheet2.SelectCell(i, "enter_no") ;
                                    return ;
                                }

                                //실손의료보험금일 경우 체크 제외 - 2020.01.15
                                if( sheet2.GetCellValue(i, "firm_nm") == "" && sheet2.GetCellValue(i,"restrict_cd") != "30" ) {
                                    alert("상호를 입력해 주십시오.") ;
                    ...
                    for( var i = 2; i < sheet2.LastRow()+2; i++) {
                        ...
                        if( sheet2.GetCellValue(i, "sStatus") == "U" && sheet2.GetCellText(i,"medical_imp_cd") == "국세청제공 의료비" ){
                            if( sheet2.GetCellValue(i, "nts_yn") == "Y") {
                                sheet2.SetCellValue(i, "adj_input_type", "07") ;  //구분 싱크를 위해서 기존 PDF데이터도 수정하는데 이때 연만정산기초입력자료유형이 07(PDF)자료에서 변경되지 않기 하기 위함 2023.01.11
                            }
                        }
                    }
                    */
                ...
                case "Insert":
                    ...
                    //sheet2.SetCellBackColor(newRow, "sStatus", "#FF0000");
                    //sheet2.SetCellBackColor(newRow, "sStatus", "#ADFF2F");
            ...
            try {
                ...
                if (Code == 1) {
                    ...
                    for(var i = sheet2.HeaderRows(); i <= sheet2.LastRow(); i++){
                        ...
                        /* 20241210 
                        건강보험산정특례자는 누구든 지정할 수 있기 때문에 수정 가능 상태로 둔다.
                        단, 본인/6세이하/65세이상/장애인 자동 세팅은 진행. 
                        if(sheet2.GetCellText(i,"special_yn") == "본인"
                            || sheet2.GetCellText(i,"special_yn") == "65세이상"
                            || sheet2.GetCellText(i,"special_yn") == "6세이하" // 24.10.23 의료비 대상자 6세 이하 추가
                            || (sheet2.GetCellText(i,"special_yn") == "장애인" && sheet2.GetCellValue(i, "hndcp_yn") == "Y")
                        ) {
                            sheet2.SetCellEditable(i,"special_yn", 0);
                        }else{
                            sheet2.SetCellEditable(i,"special_yn", 1);
                        ...
                        if ( rtn == false ) {
                            ...
                            if ( sheet2.GetCellValue(i, "adj_input_type") == "07" ) {
                                ...
                                sheet2.SetCellEditable(i,"pre_baby_yn", 1) ;
                            }
                        } else {
                            if(sheet2.GetCellValue(i,"medical_imp_cd") == "1"){
                            ...
                            if( sheet2.GetCellValue(i, "medical_imp_cd") == "5" ) {
                                ...
                                if(sheet2.GetCellValue(i,"restrict_cd") == "30") {
                                    sheet2.SetCellEditable(i,"enter_no", 0);
                                    sheet2.SetCellEditable(i,"firm_nm", 0);
                                }
                        ...
                        //2019-11-08. 금액자료(담당자) 조회시 값 저장
                        if(i != sheet2.LastRow()) {
                            applMonArr.push(sheet2.GetCellValue(i, "appl_mon"));
                        }

                        if(sheet2.GetCellValue(i, "seq") < 0) {
                ...
                sheetResize();
//             sheet2_OnSearchEnd_Check();
            } catch (ex) {
                alert("OnSearchEnd Event Error : " + ex);
            }
        }

        function sheet2_OnSearchEnd_Check(){

            var sumData = 0;
            for(var i = sheet2.HeaderRows(); i <= sheet2.LastRow(); i++){

                for(var j=1; j < sheet2.LastRow()+1; j++){
                    if((sheet2.GetCellValue(i,"fam_nm") == sheet2.GetCellValue(j,"fam_nm")) && (sheet2.GetCellValue(i,"restrict_cd") == sheet2.GetCellValue(j,"restrict_cd"))){
                        sumData = sumData + parseInt(sheet2.GetCellValue(j,"appl_mon"), 10);
                    }
                }

                if(sumData > 500000){
                    alert(sheet2.GetCellValue(i,"fam_nm")+"||"+sheet2.GetCellValue(i,"famres")  +"의 안경구입비 한도금액이 초과되었습니다\n한도금액 500000원에 맞춰주세요.");
        ...
        function sheet2_OnChange(Row, Col, Value) {
            try{
                ...
                if(sheet2.ColSaveName(Col) == "fam_nm") {
                    ...
                    /* 2022.12.19 -  입력시 기존 입력된 구분값으로 세팅 */
                    var sVal1 = "";
                    for (var i = 2; i < sheet2.RowCount()+2; i++) {
                        if(sheet2.GetCellValue(Row, "fam_nm") == sheet2.GetCellValue(i,"fam_nm")){
                            if(Row != i && sheet2.GetCellValue(i,"special_yn") != ""){
                                sVal1 = sheet2.GetCellValue(i,"special_yn");
                            }
                        }
                    }
                    ...
                    "의료비 : 이름 선택 후 구분에 나오는 체크로직 확인(구분의 editable 불가)
                              ...
                              => (24.10.23) 인적공제의 장애구분 코드가 선택 안된 사람이 본인이 아닌데, 6세 이하면 ""6세이하""가 선택되도록 수정
                    */
                    if(sht1HndcpType != ""){
                        ...
                        if(sht1FamCd == "0"){
                            sheet2.SetCellText(Row, "special_yn", "본인") ;
                            /* 20241210 
                            건강보험산정특례자는 누구든 지정할 수 있기 때문에 수정 가능 상태로 둔다.
                            단, 본인/6세이하/65세이상/장애인 자동 세팅은 진행.
                            sheet2.SetCellEditable(Row,"special_yn", 0);
                            */
                            ...
                            else if( age <= 6 && sheet2.GetCellValue(Row,"famres") != "" ) {
                                sheet2.SetCellText(Row, "special_yn", "6세이하") ;
                                /* 20241210 
                                건강보험산정특례자는 누구든 지정할 수 있기 때문에 수정 가능 상태로 둔다.
                                단, 본인/6세이하/65세이상/장애인 자동 세팅은 진행.
                                sheet2.SetCellEditable(Row,"special_yn", 0);
                    ...
                    /* 구분- 기존 입력된 대상자에 대한 구분값 동일하게 세팅 */
                    if(sVal1 != ""){
                        sheet2.SetCellValue(Row, "special_yn", sVal1) ;
                    }
//                 else {
//                     sheet2.SetCellValue(Row, "special_yn", "") ;
//                 }
                ...
                /*
                if(sheet2.GetCellText(Row,"special_yn") == "본인" || sheet2.GetCellText(Row,"special_yn") == "65세이상"
                    || (sheet2.GetCellText(Row,"special_yn") == "장애인" && sheet2.GetCellValue(Row, "hndcp_yn") == "Y")){
                sheet2.SetCellEditable(Row,"special_yn", 0);
                }else{
                sheet2.SetCellEditable(Row,"special_yn", 1);
                }
                */
                ...
                "의료비 :
                         ...
                         => (24.10.23) 6세이하를 선택할 때, 나이가 6세 이하가 아닌 자는 다음 ""인적공제에 등록된 대상자의 나이가 6세 이하가 아닙니다."" 멘트가 나오면서 선택 불가"
                ...
                */
                if(sheet2.ColSaveName(Col) == "special_yn"){
                    ...
                    */
                    ...
                    /* 2022.12.19 - special_yn_old 주석처리
                        - 구분값 선택 시 같은 대상자 row에 동일값 세팅
                           -> 세팅 시 중복 알람 호출로 overFlag값으로 중복방지
                    */
                    if(overFlag){
...
// 	                    return false;
                            overFlag = false;
                        } else if (sheet2.GetCellText(Row, "special_yn") == "6세이하" && !( age <= 6 && sheet2.GetCellValue(Row,"famres") != "" ) ) {
                            alert("인적공제에 등록된 대상자의 나이가 6세 이하가 아닙니다.");
                            sheet2.SetCellText(Row, "special_yn", "") ;
                            /* 20241210 
                            건강보험산정특례자는 누구든 지정할 수 있기 때문에 수정 가능 상태로 둔다.
                            단, 본인/6세이하/65세이상/장애인 자동 세팅은 진행.
                            ...
                            */
                            ...
                            if ( sheet2.GetCellText(Row, "special_yn") == "장애인" && sht1HndcpType == "" ) {
                                //alert("인적공제의 장애구분이 등록된 대상자에 한해 선택 가능합니다.");
                                if(!confirm("대상자는 인적공제의 장애인으로 등록되어있지 않습니다. \n구분을 장애인으로 등록하시겠습니까?")){
                                    overFlag = false;
                                    sheet2.SetCellText(Row, "special_yn", "") ;
                                }else{
                                    overFlag = false;
                                }
                            }else if(sht1FamCd != "0" && sheet2.GetCellText(Row, "special_yn") == "본인" ){
                                overFlag = false;
...
// 	               			return false;
                    ...
                    /* 2022.12.29 - 최종적으로 선택한 구분값으로 세팅 */
                    var sVal2 = sheet2.GetCellValue(Row, "special_yn");

                    for (var i = 2; i < sheet2.RowCount()+2; i++) {
                        if(sheet2.GetCellValue(Row, "fam_nm") == sheet2.GetCellValue(i,"fam_nm")){
                            if(Row != i){
                                sheet2.SetCellValue(i,"special_yn",sVal2);
                            }
                        }
                    }
                }
                 ...
                 *
                 * 2019-11-06. 수정사항
                 * 국세청제공의료비를 선택했을때, 안경구입비와 산후조리비 선택 가능
                 */
                if(sheet2.ColSaveName(Col) == "medical_imp_cd" || sheet2.ColSaveName(Col) == "restrict_cd"){
                    if ( sheet2.GetCellValue(Row,"medical_imp_cd") == "1" && !(sheet2.GetCellValue(Row,"restrict_cd") == "" || sheet2.GetCellValue(Row,"restrict_cd") == "10"  || sheet2.GetCellValue(Row,"restrict_cd") == "20") ) {
                        alert("국세청제공의료비는 안경구입비, 산후조리비 여부만 선택해 주시면 됩니다. 안경구입비, 산후조리비 이외의 국세청 자료는 상세구분을 선택하지 않으셔도 됩니다");
                        sheet2.SetCellValue(Row,"restrict_cd", "") ;
                    }
                }
                ...
                //안경구입비 50만원 한도계산
                //2019-11-06. 상세구분란에 산후조리원비 추가 및 7천이상자는 체크 불가 메세지 및 한도체크
                    ...
                    if(sheet2.GetCellValue(Row,"restrict_cd") == "10"){
                        if(sheet2.GetCellValue(Row,"appl_mon") > 0){
                            ...
                            if(sumData > 500000){
                                ...
                                <%--                        if(orgAuthPg == "A"){	--%>
                                <%							if( "Y".equals(adminYn) ) {	%>
                                sheet2.SetCellValue(Row,"appl_mon", "") ;
//                                 sheet2.SetCellValue(Row,"restrict_cd", "") ;
                                <%                          } else {	%>
                                sheet2.SetCellValue(Row,"input_mon", "") ;
//                                 sheet2.SetCellValue(Row,"restrict_cd", "") ;
                                <%                          }	%>
                                return;
                            }
                    ...
                    if(sheet2.ColSaveName(Col) == "restrict_cd" && sheet2.GetCellValue(Row, "medical_imp_cd") == "5"){
                        sheet2.SetCellEditable(Row,"enter_no", 1);
                        sheet2.SetCellEditable(Row,"firm_nm", 1);
                    }

                    //산후조리비, 실손의료비
                    if(sheet2.GetCellValue(Row,"restrict_cd") == "20"||sheet2.GetCellValue(Row,"restrict_cd") == "30"||sheet2.GetCellValue(Row,"restrict_cd") == "10"){

                        //난임시술비가 체크되어 있으면 선택불가
                        if(sheet2.GetCellValue(Row,"nanim_yn") == 'Y') {
                            alert("난임시술비가 체크되어 있으면\n산후조리비와 실손의료비, 안경구입비는 선택하실 수 없습니다.");
                            sheet2.SetCellValue(Row,"restrict_cd", "") ;
                            return;
                        }

                        if(sheet2.GetCellValue(Row,"pre_baby_yn") == 'Y') {
                            alert("미숙아ㆍ선천성이상여부가 체크되어 있으면\n산후조리비와 실손의료비, 안경구입비는 선택하실 수 없습니다.");
                            sheet2.SetCellValue(Row,"restrict_cd", "") ;
                            return;
                        }

                        //실손의료비인 경우 사업자번호, 상호 항목 비활성화 - 2020.01.29
                        if(sheet2.GetCellValue(Row,"restrict_cd") == "30") {
                            sheet2.SetCellValue(Row,"enter_no", "");
                            sheet2.SetCellValue(Row,"firm_nm", "");
                            sheet2.SetCellEditable(Row,"enter_no", 0);
                            sheet2.SetCellEditable(Row,"firm_nm", 0);
                    ...
                    if(sheet2.GetCellValue(Row,"restrict_cd") == "20"){
                        //7천이상자는 체크 불가
                        // (24.10.24) 24년 귀속부터 산후조리원 총급여 한도 요건 사라짐에 따라 아래 로직 주석처리
                        /*if(paytotMonTemp > 70000000){
                            alert("산후조리원비용은 총급여 7천만원 이하 대상자만 해당됩니다.");
                            sheet2.SetCellValue(Row,"restrict_cd", "") ;
                            return;
                        }*/

                        //안경구입비는 인원별로 합계금액을 계산해 한도를 체크하나 산후조리원비는 한도 체크시 인원별이 아닌 전체에서 합계금액을 구한다.
                        if(sheet2.GetCellValue(Row,"appl_mon") > 0){
                            var sumData = 0;
                            for(var i=1; i < sheet2.LastRow()+1; i++){
                                if(sheet2.GetCellValue(Row,"restrict_cd") == sheet2.GetCellValue(i,"restrict_cd")){
                                    sumData = sumData + parseInt(sheet2.GetCellValue(i,"appl_mon"), 10);
                                }
                            }
                            if(sumData > 2000000){
                                var temp = 0;
                                if(applMonArr[parseInt(sheet2.GetCellValue(Row,"sNo"), 10)-1]) {
                                    temp = applMonArr[parseInt(sheet2.GetCellValue(Row,"sNo"), 10)-1];
                                }
                                if(!confirm("산후조리원비 한도금액은 출산 1회당 200만원 입니다.\n"+
                                    "출산이 1회 초과인 경우만 200만원 초과 금액을 입력할 수 있습니다.\n(출산 2회인 경우 400만원 한도)\n\n"+
                                    "현재 산후조리원비 입력 합계액 : "+comma(sumData)+"\n\n"+
                                    "정말 입력 하시겠습니까?")){
                                    <%								if( "Y".equals(adminYn) ) {	%>
                                    sheet2.SetCellValue(Row,"appl_mon", temp, 0) ;
                                    <%                          	} else {	%>
                                    sheet2.SetCellValue(Row,"input_mon", temp, 0) ;
                                    <%                          	}	%>
                                    return;
                                }
                            }
                ...
                if(sheet2.GetCellValue(Row,"medical_imp_cd") == "4"){
                    ...
                    if(sheet2.GetCellValue(Row,"nanim_yn") == 'Y') {
                        alert("의료비 증빙코드가 장기요양급여비용 명세서일때\n난임시술비해당여부를 선택할 수 없습니다.");
                        sheet2.SetCellValue(Row,"nanim_yn", "N") ;
                        return;
                    }

                    if(sheet2.GetCellValue(Row,"pre_baby_yn") == 'Y') {
                        alert("의료비 증빙코드가 장기요양급여비용 명세서일때\n미숙아ㆍ선천성이상여부를 선택할 수 없습니다.");
                        sheet2.SetCellValue(Row,"pre_baby_yn", "N") ;
                        return;
                    }
                }
                ...
                /*
                            if(sheet2.ColSaveName(Col) == "nanim_yn" && sheet2.GetCellValue(Row,"nanim_yn") == 'Y') {

                                for( var i = 2; i < sheet2.LastRow()+2; i++) {

                                    if( sheet2.GetCellValue(i,"pre_baby_yn") == 'Y' && (sheet2.GetCellValue(i,"fam_nm") == sheet2.GetCellValue(Row,"fam_nm")) && (sheet2.GetCellValue(i,"restrict_cd") == sheet2.GetCellValue(Row,"restrict_cd")) ) {
                                        alert("대상자가 난임이면서 미숙아ㆍ선천성이상아를 선택할수 없습니다.\n다른 데이터의 미숙아ㆍ선천성이상아 선택 해제 부탁드립니다.");
                                        sheet2.SetCellValue(Row,"nanim_yn", "N") ;
                                        return;
                                    }
                            ...
                            if(sheet2.ColSaveName(Col) == "pre_baby_yn" && sheet2.GetCellValue(Row,"pre_baby_yn") == 'Y') {

                                for( var i = 2; i < sheet2.LastRow()+2; i++) {

                                    if( sheet2.GetCellValue(i,"nanim_yn") == 'Y' && (sheet2.GetCellValue(i,"fam_nm") == sheet2.GetCellValue(Row,"fam_nm")) && (sheet2.GetCellValue(i,"restrict_cd") == sheet2.GetCellValue(Row,"restrict_cd")) ) {
                                        alert("대상자가 미숙아ㆍ선천성이상아이면서 난임을 선택할수 없습니다.\n다른 데이터의 난임 선택 해제 부탁드립니다.");
                                        sheet2.SetCellValue(Row,"pre_baby_yn", "N") ;
                                        return;
                                    }
                ...
                if(sheet2.ColSaveName(Col) == "nanim_yn") {
                    //상세구분이 산후조리비와 실손의료비일때 난임시술비해당여부를 체크하지 못하도록 수정
                    if(sheet2.GetCellValue(Row,"nanim_yn") == 'Y' && (sheet2.GetCellValue(Row,"restrict_cd") == "20" || sheet2.GetCellValue(Row,"restrict_cd") == "30"  || sheet2.GetCellValue(Row,"restrict_cd") == "10")) {
                        alert("상세구분이 산후조리비와 실손의료비일때\n난임시술비해당여부를 선택할 수 없습니다.");
                        sheet2.SetCellValue(Row,"nanim_yn", "N") ;
                        return;
                    }

                    if(sheet2.GetCellValue(Row,"nanim_yn") == 'Y' && sheet2.GetCellValue(Row, "medical_imp_cd") == "4") {
                        alert("의료비 증빙코드가 장기요양급여비용 명세서일때\n난임시술비해당여부를 선택할 수 없습니다.");
                        sheet2.SetCellValue(Row,"nanim_yn", "N") ;
                        return;
                    }
                ...
                if(sheet2.ColSaveName(Col) == "pre_baby_yn") {
                    //상세구분이 산후조리비와 실손의료비일때 미숙아ㆍ선천성이상여부를 체크하지 못하도록 수정
                    if(sheet2.GetCellValue(Row,"pre_baby_yn") == 'Y' && (sheet2.GetCellValue(Row,"restrict_cd") == "20" || sheet2.GetCellValue(Row,"restrict_cd") == "30" || sheet2.GetCellValue(Row,"restrict_cd") == "10")) {
                        alert("상세구분이 산후조리비와 실손의료비일때\n미숙아ㆍ선천성이상여부를 선택할 수 없습니다.");
                        sheet2.SetCellValue(Row,"pre_baby_yn", "N") ;
                        return;
                    }

                    if(sheet2.GetCellValue(Row,"pre_baby_yn") == 'Y' && sheet2.GetCellValue(Row, "medical_imp_cd") == "4") {
                        alert("의료비 증빙코드가 장기요양급여비용 명세서일때\n미숙아ㆍ선천성이상여부를 선택할 수 없습니다.");
                        sheet2.SetCellValue(Row,"pre_baby_yn", "N") ;
                        return;
                    }
                ...
                if(sheet2.GetCellValue(Row,"nanim_yn") == 'Y' && sheet2.GetCellValue(Row,"pre_baby_yn") == 'Y' ) {
                    alert("미숙아ㆍ선천성이상여부와 난임시술비해당여부를 동시에 선택할 수 없습니다.");
                    sheet2.SetCellValue(Row,sheet2.ColSaveName(Col), "N") ;
                    return;

                }

                if(Row != sheet2.LastRow()) {
                    getMedMonInput();
                }
                overFlag = true; // 초기화(구분값 선택 시 같은 대상자 row에 동일값 세팅)
                if(sheet2.GetCellValue(Row,"sStatus") == "U"){
                    //sheet2.SetCellBackColor(Row, "sStatus", "#FFFF00");
                }
            } catch(ex){
        ...
        //입력 데이터 삭제시 체크 (2023.01.10)
        function sheet2_OnBeforeCheck(Row, Col) {
            if(sheet2.ColSaveName(Col) == "sDelete" && sheet2.GetCellValue(Row,"sStatus") == "I") {
                if(!confirm("입력중인 모든 데이터가 삭제됩니다.\n 삭제하시겠습니까?")){
                    sheet2.SetAllowCheck(0);
                }else{
                    sheet2.SetAllowCheck(1);
                    doAction2("Search");
                }
            }
        }
        ...
        function getMedMonInput(){
            ...
            sheet2.SetCellValue(sheet2.LastRow(),"input_mon","0");
            sheet2.SetCellValue(sheet2.LastRow(),"appl_mon","0");

            for(var i = sheet2.HeaderRows(); i <= sheet2.LastRow(); i++){
                if(sheet2.GetCellValue(i,"appl_mon") != ""){
                    if(sheet2.GetCellValue(i,"restrict_cd") == "20"){
                        mon1 = mon1 + parseInt(sheet2.GetCellValue(i,"appl_mon"), 10);	/* 산후조리원비 */
                    }else if(sheet2.GetCellValue(i,"restrict_cd") == "30"){
                        mon2 = mon2 + parseInt(sheet2.GetCellValue(i,"appl_mon"), 10);	/* 실손의료보험금 */
                    }

                    if(sheet2.GetCellValue(i,"restrict_cd") != "30"){
                        totalApplMon = totalApplMon + parseInt(sheet2.GetCellValue(i,"appl_mon"), 10);
                    }
                }
                if(sheet2.GetCellValue(i,"input_mon") != ""){
                    if(sheet2.GetCellValue(i,"restrict_cd") != "30"){
                        totalInputMon = totalInputMon + parseInt(sheet2.GetCellValue(i,"input_mon"), 10);
                    }
                }
            }

            //총급여기 7천만원 초과일때 산후조리원비 금액을 0으로 처리
//         if(mon1 != "" && mon1 != "0" && paytotMonTemp <= 70000000){
//     		$("#medMonInput1").val(comma(mon1));
//     	}else{
//     		$("#medMonInput1").val("0");
//     	}

//     	if(mon2 != "" && mon2 != "0"){
//     		$("#medMonInput2").val(comma(mon2));
//     	}else{
//     		$("#medMonInput2").val("0");
//     	}

            totalCalcMon = parseInt(totalApplMon)-parseInt(mon2);
            sheet2.SetCellValue(sheet2.LastRow(),"input_mon",comma(totalInputMon));
            sheet2.SetCellValue(sheet2.LastRow(),"appl_mon",comma(totalApplMon));
        }
        ...
        function sheetSet(){
            ...
            if(comSheet.RowCount() > 0){
                ...
                //본인 일반의료비(본인 장기요양비(재가,시설) 포함) + 본인 장애인의료비 + 본인외 본인장애인의료비
                $("#A050_05").val( comma(parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_05") ,"input_mon").replace(/,/gi,'')) + parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_06") ,"input_mon").replace(/,/gi,''))
                    + parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_061") ,"input_mon").replace(/,/gi,''))
                    + parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_062") ,"input_mon").replace(/,/gi,''))
                    + parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_07") ,"input_mon").replace(/,/gi,'')) + parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_09") ,"input_mon").replace(/,/gi,''))) ) ; //본인의료비 + 본인 장애인의료비 + 본인외 본인장애인의료비 + 본인 장기요양비(재가급여) +

                // 본인 건강보험특례자 + 본인외 건강보험특례자
                $("#A050_04").val( comma(parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_04") ,"input_mon").replace(/,/gi,'')) + parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_041") ,"input_mon").replace(/,/gi,''))) );

                //본인 장애인의료비 + 본인외 장애인의료비
                $("#A050_02").val( comma(parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_02") ,"input_mon").replace(/,/gi,'')) + parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_021") ,"input_mon").replace(/,/gi,''))) );

                //본인외 일반의료비 (본인외 장기요양비(재가,시설) 포함)
                $("#A050_03").val( comma(parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_03") ,"input_mon").replace(/,/gi,''))));

                // 미숙아, 선천성 이상아 / 난임시술비 / 실손의료보험금
                $("#A050_10").val( comma(parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_10") ,"input_mon").replace(/,/gi,'')) + parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_101") ,"input_mon").replace(/,/gi,''))) );
                $("#A050_11").val( comma(parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_11") ,"input_mon").replace(/,/gi,'')) + parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_111") ,"input_mon").replace(/,/gi,''))) );

                $("#A050_13").val( comma(parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_13") ,"input_mon").replace(/,/gi,'')))  );

                /* 2022 부터 사용안함 jy
                - A050_15(본인외 실비) 경우에는  A050_13코드자체에서 본인+본인외값이 있기 때문
                - A050_07와 A050_09는 위의 A050_03에 합산
                $("#A050_15").val( comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_15") ,"input_mon"));
                $("#A050_07").val( parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_07") ,"input_mon").replace(/,/gi,'')) + parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_071") ,"input_mon").replace(/,/gi,'')) );
                $("#A050_09").val( parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_09") ,"input_mon").replace(/,/gi,'')) + parseInt(comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_091") ,"input_mon").replace(/,/gi,'')) );
                */
...
//          $("#A050_09").val("0");
        ...
        function paytotMonView(){
            ...
            var result = ajaxCall("<%=jspPath%>/common/commonSelect.jsp?cmd=commonSelectMap",param+"&searchNumber=0.03",false);
...
<div class="wrapper">
    ...
    <div class="outer">
        <div class="sheet_title">
            <ul>
                <li class="txt">의료비
                    <span class="blue">※ 총급여 3% 미만의 연간 의료비총액은 공제금액이 발생하지 않습니다.</span>
                    <span id="paytotMonViewYn">
                	<a href="javascript:paytotMonView();" class="basic btn-red-outline authA">총급여 3%확인</a>
	            </span>
                    <span id="span_paytotMonView"></span>
                    <!-- <a href="javascript:yeaDataExpPopup('의료비', helpText, 300);" class="cute_gray authR">의료비 안내 원본</a> -->
                    <a href="#layerPopup" class="basic btn-white ico-question" id="buttonInfoPlus"><b>의료비 안내+</b></a>
                    <a href="#layerPopup" class="basic btn-white ico-question" id="buttonInfoMinus" style="display:none"><b>의료비 안내-</b></a><br>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="default line outer">
        ...
        <tr>
            <th class="center">본인/65세이상/6세이하 대상 의료비</th>
            <th class="center">건강보험산정특례자 대상 의료비</th>
            <th class="center">장애인 대상 의료비</th>
            <th class="center">그 외 대상 의료비</th>
        </tr>
        <tr>
            <td class="right">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="default line outer">
        ...
        <tr>
            <th class="center">미숙아ㆍ선천성이상아 의료비</th>
            <th class="center">난임시술비 의료비</th>
            <th class="center">총 실손의료보험금</th>
            <!--         <th class="center">장기요양급여비(재가급여)</th> -->
            <!--         <th class="center">장기요양급여비(시설급여)</th> -->
            <!--         <th class="center">산후조리원비</th> -->

        </tr>
        <tr>
            <td class="right">
                <input id="A050_10" name="A050_10" type="text" class="text w50p right transparent" readOnly /> 원
            </td>
            <td class="right">
                <input id="A050_11" name="A050_11" type="text" class="text w50p right transparent"  readonly /> 원
            </td>
            <td class="right">
                <input id="A050_13" name="A050_13" type="text" class="text w50p right transparent"  readonly /> 원
            </td>
            <!--         <td class="right"> -->
            ...
            <!--         </td> -->
            <!--         <td class="right"> -->
            <!--             <input id="medMonInput1" name="medMonInput1" type="text" class="text w50p right transparent"  readonly /> 원 -->
            <!--         </td> -->
        </tr>
    </table>
    ...
    <div class="outer">
        <div>
            ...
            <font size='2'>
                ※ 위 표의 금액은<font class="red"> 산후조리원비 대상여부, 안경구입비 50만원</font> <b>한도 적용전</b> 대상자별, 특이사항별 <font class="blue"><b>단순 합산 금액</b></font>입니다.</font><br>
            <font class="blue">※ 안경구입비</font>는 의료증빙코드 "국세청제공 의료비 > 안경구입비" 또는 "기타의료비 영수증 > 안경구입비"  으로 선택하십시오.(개인별 50만원 한도)<br>
            <font class="blue">※ 실손의료보험금</font>은 의료증빙코드 "기타의료비 영수증 > 실손의료보험금" 으로 선택하십시오.<br>
            <font class="blue">※ 65세이상이면서 장기요양비</font>에 해당하는 경우 65세이상이 더 유리하여 적용됩니다.<br>
            <font class="red">※ 50만원 한도 초과</font>분에 대한 <font class="red">안경구입비</font> 금액은 세금계산에서 제외됩니다.
            </font>
        </div>
