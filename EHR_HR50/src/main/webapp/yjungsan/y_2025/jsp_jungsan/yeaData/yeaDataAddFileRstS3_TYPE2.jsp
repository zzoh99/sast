		...
		if(jsonArr == null || jsonArr.length() == 0) {
			...
			for(int i=0; i<jsonArr.length(); i++) {
			    ...
			    String fileType = jsonObj.getString("fileType");
			  	...
			  	//20250213 HMM S3 TYPE2 File Delete - 데이터만 지웁니다.
		  		param.put("fileUploadType", "2");
