    ...
    $(function() {
        ...
        initdata.Cols = [
          ...
          <%// 20250502. 시트 7.0.0.0-20131223-17 버전에서는 SetColProperty 로 DefaultValue가 지원되지 않음. => initdata 세팅으로 조정
            ...
            {Header:"년도",                  Type:"Text",      Hidden:1,  Width:40,    Align:"Left",   ColMerge:0, SaveName:"work_yy",             KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100, DefaultValue:"<%=yeaYear%>" },
        ...
        templeteTitle1 += "정산구분 : 연말정산 / 퇴직정산 \n";
        templeteTitle1 += "근무기간 : yyyy-mm-dd \n"; <%//20250502 패키지4.x는 하이픈이 있어야 자료가 시트에 로드됨. 패키지 5.x는 무관.%>
        templeteTitle1 += "감면기간 : yyyy-mm-dd \n";
