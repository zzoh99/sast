		...
		initdata.Cols = [
			...
			{Header:"DOC_SEQ_DETAIL",Type:"Text",		Hidden:1,	Width:60,	Align:"Left",	ColMerge:1,	SaveName:"doc_seq_detail",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:40 },
	          <%// 20250502. 시트 7.0.0.0-20131223-17 버전에서는 SetColProperty 로 DefaultValue가 지원되지 않음. => initdata 세팅으로 조정
   			...
   			{Header:"대상\n년도",				Type:"Text",      Hidden:0,  Width:40,  Align:"Center",  ColMerge:1,   SaveName:"work_yy",			KeyField:1,   CalcLogic:"",   Format:"",     	PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:4, DefaultValue:"<%=yeaYear%>" },
	...
	function doAction1(sAction) {
		...
		case "Down2Template":
			...
			var param  = {DownCols:"adjust_type"
                                    +"|sabun|famres|enter_no|firm_nm|contribution_cd|contribution_sup_mon|donation_type|sum_mon|appl_mon|adj_input_type"
