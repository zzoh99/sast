...
<script type="text/javascript">
    ...
    $(function(){
    	...
    	initdata1.Cols = [
                        ...
                        {Header:"PDF제출여부",	Type:"Text",            Hidden:1,  Width:60,    Align:"Center",      ColMerge:0,   SaveName:"pdf_yn",		KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 }
	...
	function getProcessStatus(){
		...
		//제외대상
		var exceptCnt = nvl(processStatusData.Data.except_cnt,"");
		$("#searchExceptCnt").html(comma(nvl(processStatusData.Data.except_cnt,"")));
		$("#searchExceptCnt").next(".cnt").html("/"+comma(nvl(processStatusData.Data.tot_man_cnt,"")));
	...
	function clickBtnView(id) {
		...
		if(id == "clickBtn_payActionNm") {
		...
		} else if(id == "clickBtn_exceptCnt") {
			//신고제외 대상자
			queryId = "selectExceptTargetList";
			title = "신고제외 대상자";
			menu = "연말정산 > 정산계산/결과 > 연말정산 > 대상자정보";
			message = " 신고제외 대상으로 등록된 인원입니다.";
			...
			sheet1.SetColHidden("pdf_yn",0);
			sheet1.SetColWidth("pdf_yn", 130);
    ...
    <div class="wrapper">
        ...
        <div class="outer" style="margin:0; padding:1px 10px 20px;">
        	...
        	<ul class="statusList">
        		...
        		<li class="list-item">
        			<span class="item-title">신고제외 대상</span>
        			<span class="number blue" id="searchExceptCnt"></span><span class="cnt"></span><span class="cnt"></span>
        			<span class="btn-wrap right">
        				<a href="javascript:clickBtnView('clickBtn_exceptCnt');" class="basic btn-white" id="clickBtn_exceptCnt">대상자 확인</a>
        			</span>
        		</li>
        		<li class="list-item">
        			<span class="item-title">신고 대상 (총인원)</span>
