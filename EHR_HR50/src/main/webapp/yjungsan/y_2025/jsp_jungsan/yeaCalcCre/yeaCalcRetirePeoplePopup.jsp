...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata1.Cols = [
            ...
            {Header:"마감\n여부",         Type:"CheckBox",  Hidden:0,  Width:50,   Align:"Center",        ColMerge:0,   SaveName:"final_close_yn",        KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:1, TrueValue:"Y", FalseValue:"N"},
	                    ...
	                    <td class="top">
	                        <div class="outer">
	                            <div class="sheet_title">
	                                <ul>
	                                    <li id="strSheetTitle">
											대상자&nbsp;&nbsp;&nbsp;<span class="blue" style="font-size: 12px;"><b><font>세금계산은 퇴직/퇴직자정산계산에서 해주시기 바랍니다.</font></b></span>
										</li>
										<li class="txt">
											<b style="margin-top: 5px; color: red;">* 신고 마감일 이후에는 작업 마감된 건만 신고파일에 반영됩니다.</b>
										</li>
	                                    <li class="btn">
	                                        <span>사번/이름 </span>
