...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
	        ...
	        {Header:"년도",		Type:"Text",      	Hidden:0,  Width:50,    Align:"Center", ColMerge:1,   SaveName:"work_yy",			KeyField:1,   CalcLogic:"",   Format:"",   PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:4, DefaultValue:"<%=yeaYear%>" },
	...
	function doAction1(sAction) {
       ...
       case "Down2Template":
			var param  = {DownCols:"adjust_type"
                                     +"|sabun|reduce_s_ymd|reduce_e_ymd",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
						    ,TitleText:templeteTitle1,UserMerge :"0,0,1,4",menuNm:$(document).find("title").text()
