        ...
        try {
        	if(sheet1.RowCount() != 0) {
	        	for(var i = 1; i < sheet1.RowCount()+1; i++) {
					...
					sheet1.SetCellValue2(i,"adjust_type", $("#searchAdjustType").val());
					sheet1.SetCellValue2(i,"file_link","<a href=\"javascript:openPdfViewPopup('"+sheet1.GetCellValue(i,"sabun")+"','" + $("#searchAdjustType").val() + "')\" class='basic'>보기</a>");
				}
        	}
        } catch(ex) {
