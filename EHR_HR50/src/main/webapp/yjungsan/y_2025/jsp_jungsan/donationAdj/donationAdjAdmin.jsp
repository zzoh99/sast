...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"정산구분|정산구분",		    	Type:"Combo",	Hidden:0,  Width:90,Align:"Center",    ColMerge:1,   SaveName:"adjust_type",		KeyField:0,   CalcLogic:"",   Format:"",           PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
    ...
    function doAction1(sAction) {
        ...
        case "Search":
        	...
        	sheet1.DoSearch( "<%=jspPath%>/donationAdj/donationAdjAdminRst.jsp?cmd=selectDonationAdjAdminList", $("#sheetForm").serialize());
        	break;
        case "Down2Excel":
    ...
    function doAction2(sAction) {
		...
		case "Search":
			...
			sheet2.DoSearch( "<%=jspPath%>/donationAdj/donationAdjAdminRst.jsp?cmd=selectDonationAdjAdminDetailList", param);
       	   	break;
		case "Save":
