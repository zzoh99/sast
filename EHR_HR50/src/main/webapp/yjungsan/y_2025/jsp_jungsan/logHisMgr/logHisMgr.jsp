...
var bFlag = false;
    $(function() {
        ...
        var logYn     = ajaxCall("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&searchStdCd=CPN_YEA_LOG_YN&searchWorkYy="+$("#searchYear").val(), "queryId=getYeaSystemStdData",false).codeList;
        var fileLogYn = ajaxCall("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&searchStdCd=CPN_YEA_FILE_LOG_YN&searchWorkYy="+$("#searchYear").val(), "queryId=getYeaSystemStdData",false).codeList;
        var rdLogYn   = ajaxCall("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&searchStdCd=CPN_YEA_RD_LOG_YN&searchWorkYy="+$("#searchYear").val(), "queryId=getYeaSystemStdData",false).codeList;
