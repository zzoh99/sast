	...
	<div class="outer">
		...
		<table style="width:100%;">
			...
			<tr>
				...
				<td style="padding:5px;">
					<a href="javascript:doAction2('Search', 'G106Y');" class="pdf" id="btnCreditCard">
				...
				<td style="padding:5px;">
					<a href="javascript:doAction2('Search', 'G306Y');" class="pdf" id="btnCheckCard">
				...
				<td style="padding:5px;">
					<a href="javascript:doAction2('Search', 'G206M');" class="pdf" id="btnCash">
		...
		<ul>
			<li class="txt" style="font-weight:normal;">
				...
				<select id="formCd">
					...
					<option value="G106Y">신용카드</option>
					<option value="G306Y">직불카드</option>
					<option value="G206M">현금영수증</option>
