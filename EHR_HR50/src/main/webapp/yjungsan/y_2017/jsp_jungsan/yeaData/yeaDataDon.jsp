...
--%>
		...
		initdata1.Cols = [
			...
			{Header:"기부금액\n(전체)|기부금액\n(전체)",	Type:"AutoSum",		Hidden:0,	Width:80,	Align:"Right",	ColMerge:1,	SaveName:"sum_mon",		KeyField:1,	Format:"Integer",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:35 },
			{Header:"기부장려금\n신청금액|기부장려금\n신청금액",	Type:"AutoSum",		Hidden:0,	Width:80,	Align:"Right",	ColMerge:1,	SaveName:"contribution_sup_mon",		KeyField:0,	Format:"Integer",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:35 },
