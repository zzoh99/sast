...
%>
    ...
    function loadSheet2() {
        ...
        initdata2.Cols = [
            ...
            {Header:"계약기간\n전체\n월세액|계약기간\n전체\n월세액",Type:"Int",     Hidden:0,   Width:80,   Align:"Right",  ColMerge:1, SaveName:"rent_mon",        KeyField:1, Format:"Integer", UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            ...
            {Header:"월세대상금액|직원용",                          Type:"AutoSum", Hidden:0,   Width:80,   Align:"Right",  ColMerge:1, SaveName:"input_mon",       KeyField:0, Format:"Integer",        UpdateEdit:<%=inputEdit%>,   InsertEdit:<%=inputEdit%>,   EditLen:35 },
            {Header:"월세대상금액|담당자용",                        Type:"AutoSum", Hidden:0,   Width:80,   Align:"Right",  ColMerge:1, SaveName:"appl_mon",        KeyField:1, Format:"Integer",        UpdateEdit:<%=applEdit%>,    InsertEdit:<%=applEdit%>,    EditLen:35 },
    ...
    function loadSheet3() {
        ...
        initdata3.Cols = [
            ...
            {Header:"차입금\n이자율|차입금\n이자율",           Type:"Float",   Hidden:0,   Width:50,   Align:"Right",  ColMerge:1, SaveName:"chaib_rate",      KeyField:1, Format:"",      PointCount:2,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"원리금|원리금",                       Type:"Int",     Hidden:0,   Width:80,   Align:"Right",  ColMerge:1, SaveName:"wonri_mon",       KeyField:1, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"이자|이자",                           Type:"Int",     Hidden:0,   Width:60,   Align:"Right",  ColMerge:1, SaveName:"ija_mon",         KeyField:0, Format:"Float", PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"원리금상환액계|직원용",               Type:"AutoSum", Hidden:0,   Width:80,   Align:"Right",  ColMerge:1, SaveName:"input_mon",       KeyField:0, Format:"#,###",      PointCount:0,   UpdateEdit:<%=inputEdit%>,   InsertEdit:<%=inputEdit%>,   EditLen:35 },
            {Header:"원리금상환액계|담당자용",             Type:"AutoSum", Hidden:0,   Width:80,   Align:"Right",  ColMerge:1, SaveName:"appl_mon",        KeyField:1, Format:"#,###",      PointCount:0,   UpdateEdit:<%=applEdit%>,    InsertEdit:<%=applEdit%>,    EditLen:35 },
