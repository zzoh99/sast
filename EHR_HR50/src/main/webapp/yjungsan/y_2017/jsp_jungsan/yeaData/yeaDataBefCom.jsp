...
var pGubun = "";
    ...
    $(function() {
        ...
        initdata1.Cols = [
            ...
            {Header:"세부\n내역",  			Type:"Image",     Hidden:"<%=hideDet%>",  Width:50,   Align:"Center",  ColMerge:0, SaveName:"select_img",           KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1, Cursor:"Pointer" },
            ...
            {Header:"소득세(79)",                           Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"income_tax_mon",      KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"지방소득세(80)",                       Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"inhbt_tax_mon",       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"농특세(81)",                           Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"rural_tax_mon",       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            ...
            {Header:"국외\n비과세(18)",                       Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"notax_abroad_mon",    KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"생산직\n비과세(18-1)",                   Type:"AutoSum", Hidden:0,  Width:80,    Align:"Right",  ColMerge:0, SaveName:"notax_work_mon",      KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
...
--%>
    ...
    function openBefComMgrPopup(Row) {
		...
		args["notax_etc_mon"]		= sheet1.GetCellValue(Row, "notax_etc_mon");
	...
	function getReturnValue(returnValue) {
		...
		if ( pGubun == "befComMgrPopup" ){
			...
			sheet1.SetCellValue(Row, "notax_etc_mon", rv["notax_etc_mon"] );
		}
	}
</script>
</head>
