...
<script type="text/javascript">
	function load_sheet1() {
		...
		initdata1.Cols = [
			{Header:"년도",				    Type:"Text",	Hidden:0,   Width:60,   Align:"Center",   ColMerge:1, SaveName:"yy",			KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"반기구분",			    Type:"Combo",	Hidden:1,   Width:60,   Align:"Center",   ColMerge:1, SaveName:"half_gubun",	KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"구분",				    Type:"Combo",	Hidden:0,   Width:60,   Align:"Center",   ColMerge:0, SaveName:"use_type",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"사용자",			    Type:"Text",	Hidden:0,   Width:60,   Align:"Center",   ColMerge:0, SaveName:"fam_nm",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"신용카드",			    Type:"AutoSum",	Hidden:0,   Width:60,   Align:"Center",   ColMerge:0, SaveName:"card_amt",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"현금영수증",			Type:"AutoSum",	Hidden:0,   Width:60,   Align:"Center",   ColMerge:0, SaveName:"cash_amt",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"직불카드등",			Type:"AutoSum",	Hidden:0,   Width:80,  	Align:"Center",   ColMerge:0, SaveName:"check_amt",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"전통시장사용분",		Type:"AutoSum",	Hidden:0,   Width:80,   Align:"Center",   ColMerge:0, SaveName:"market_amt",	KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"대중교통이용분",		Type:"AutoSum",	Hidden:0,   Width:80,   Align:"Center",   ColMerge:0, SaveName:"bus_amt",	    KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"사업관련비용",			Type:"AutoSum",	Hidden:0,   Width:60,	Align:"Center",   ColMerge:0, SaveName:"business_amt",  KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"합계",				    Type:"AutoSum",	Hidden:0,   Width:60,	Align:"Center",   ColMerge:0, SaveName:"tot_amt",  KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
...
<div class="wrapper">
	...
	<div class="outer">
		...
		<ul>
			<li class="txt"><span name="toYear" style="font-weight:bold;">2017</span> 신용카드<span class="txt"> ※ 총급여 25% 미만의 연간 총액은 공제금액이 발생하지 않습니다.</span>
