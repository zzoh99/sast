...
//기부금 내역 조회
public List selectEtcDdctUpldList(Map paramMap, String locPath) throws Exception {
...
//프로그램관리 저장.
public int saveEtcDdctUpld(Map paramMap, String locPath) throws Exception {
...
<%
	...
	if("selectEtcDdctUpldList".equals(cmd)) {
		...
		try {
			listData = selectEtcDdctUpldList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
...
//프로그램관리 저장
        ...
        try {
            int cnt = saveEtcDdctUpld(mp, locPath);
