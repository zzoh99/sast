...
//기부금 내역 조회
public List selectDonationHisMgrList(Map paramMap, String locPath) throws Exception {
...
<%
	...
	if("selectDonationHisMgrList".equals(cmd)) {
		...
		try {
			listData = selectDonationHisMgrList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
		...
		try {
			...
			for(int i = 0; i < listMap.size(); i++) {
				...
				String[] param = new String[]{"","",sStatus,ssnEnterCd,workYy
						...
						,ntsYn,feedbackType,ssnSabun,contributionSupMon,sumMon,docSeq,docSeqDetail};
