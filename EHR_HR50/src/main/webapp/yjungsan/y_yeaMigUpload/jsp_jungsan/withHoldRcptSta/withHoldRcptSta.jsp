...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var adjustTypeList  = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&searchYear="+$("#searchWorkYy").val(),"C00303"), "전체");
        var purposeCdList   = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&searchYear="+$("#searchWorkYy").val(),"C00315"), "");
    ...
    function print(printGbn) {
        ...
        if(sheet1.RowCount() != 0) {
            ...
            //call RD!
            withHoldRcptStaPopup(sabuns, sortSabuns, sortNos, stamps, printGbn) ;
        } else {
     ...
     * by JSG
     */
    function withHoldRcptStaPopup(sabuns, sortSabuns, sortNos, stamps, printGbn){
        var w       = 800;
        var h       = 600;
        ...
        if($("#searchWorkYy").val() != null && $("#searchWorkYy").val() >= "2022"){
        	...
        	if(sheet1.RowCount() > 0 ){
                ...
                var result = ajaxCall("<%=jspPath%>/withHoldRcptSta/withHoldRcptStaRst.jsp?cmd=selectMigExistCnt",params,false);
