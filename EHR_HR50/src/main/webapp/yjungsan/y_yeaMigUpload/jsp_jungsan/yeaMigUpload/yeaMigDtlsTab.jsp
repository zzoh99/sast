...
<!DOCTYPE html> <html><head> <title>상세정보</title>
...
<script type="text/javascript">
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "<%=jspPath%>/yeaMigUpload/yeaMigUploadRst.jsp?cmd=selectMigDtlsMgrList", $("#sheetForm").serialize()+"&colCnt="+colCnt );
			break;
		case "Save":
...
<div class="wrapper">
    ...
    <input type="hidden" id="tabNum"  name="tabNum"  value="7"/>
