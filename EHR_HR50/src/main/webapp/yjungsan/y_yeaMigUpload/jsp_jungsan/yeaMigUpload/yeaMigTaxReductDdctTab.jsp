...
<!DOCTYPE html> <html><head> <title>세액감면세액공제</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		if (headerList != null && headerList.Data != null) {
			...
			for(var i=0; i<titleList["headerListNm"].length; i++){
				var h = i+1;
				if(titleList["headerListNm"][i].split(".")[1] == "실효세율"){
					initdata.Cols[v++]  = { Header:titleList["headerListNm"][i],	Type:"Float",	Hidden:0,	Width:150,	Align:"Right",	ColMerge:0,	SaveName:titleList["headerColNm"][i],	KeyField:0,	Format:"",	PointCount:1,	UpdateEdit:1,	InsertEdit:1,	EditLen:1000 };
				}else{
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "<%=jspPath%>/yeaMigUpload/yeaMigUploadRst.jsp?cmd=selectTaxReductDdctList", $("#sheetForm").serialize()+"&colCnt="+colCnt );
			break;
		case "Save":
