...
<!DOCTYPE html> <html><head> <title>현/종전근무지정보</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols[v++] = {Header:"정산구분",					Type:"Combo",			Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"adjust_type",		KeyField:1,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 };
		...
		initdata.Cols[v++] = {Header:"근무지유형",					Type:"Combo",			Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"work_cd",			KeyField:1,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 };
		initdata.Cols[v++] = {Header:"9.근무처명",					Type:"Text",			Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"enter_nm",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 };
		initdata.Cols[v++] = {Header:"10.사업자등록번호",			Type:"Text",			Hidden:0,	Width:150,	Align:"Center",	ColMerge:0,	SaveName:"regino",			KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:10  };
		...
		sheet1.SetColProperty("work_cd",  	  {ComboText:"현|종전1|종전2|납세조합", 		ComboCode:"A|B|C|D"});
		doAction1("Search");
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			$("#searchWorkCd").val(parent.searchWorkCd.value);
			sheet1.DoSearch( "<%=jspPath%>/yeaMigUpload/yeaMigUploadRst.jsp?cmd=selectMigCurWpMgrList", $("#sheetForm").serialize()+"&colCnt="+colCnt );
			break;
		case "Save":
		...
		case "Down2Template":
			...
			titleText += " 근무지유형 : A-현, B-종전1, C-종전2, D-납세조합 \n";
			titleText += " 시작일,종료일 : YYYY-MM-DD   예)"+$("#searchWorkYy").val()+"-01-01";
...
<div class="wrapper">
    ...
    <input type="hidden" id="tabNum"  name="tabNum"  value="3"/>
    <input type="hidden" id="searchWorkYy"  	name="searchWorkYy"  	 value=""/>
    <input type="hidden" id="searchAdjustType"  name="searchAdjustType"  value=""/>
    <input type="hidden" id="searchSbNm"  		name="searchSbNm"  		 value=""/>
    <input type="hidden" id="searchWorkCd"  	name="searchWorkCd"  	 value=""/>
    </form>
    <div class="outer">
        <div class="sheet_title">
        <ul>
            <li class="txt">현/종전근무지정보</li>
            <li class="btn">
