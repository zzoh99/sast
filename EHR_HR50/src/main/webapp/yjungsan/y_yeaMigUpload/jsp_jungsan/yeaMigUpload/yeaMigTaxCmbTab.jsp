...
<!DOCTYPE html> <html><head> <title>납세조합</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		var adjustTypeList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&searchYear="+parent.$("#searchWorkYy").val(),"C00303"), ""); //작업구분(C00303)
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "<%=jspPath%>/yeaMigUpload/yeaMigUploadRst.jsp?cmd=selectMigTaxCmbMgrList", $("#sheetForm").serialize()+"&colCnt="+colCnt );
			break;
		case "Save":
...
<div class="wrapper">
    ...
    <input type="hidden" id="tabNum"  name="tabNum"  value="6"/>
