...
public List selectGrpCdList(Map paramMap, String locPath) throws Exception {
	...
	try{
		//쿼리 실행및 결과 받기.
		list = DBConn.executeQueryList(queryMap,"selectGrpCdList",pm);
	} catch (Exception e) {
...
public List selectAthGrpMenuMgrList(Map paramMap, String locPath) throws Exception {
	...
	try{
		//쿼리 실행및 결과 받기.
		list = DBConn.executeQueryList(queryMap,"selectAthGrpMenuMgrList",pm);
	} catch (Exception e) {
		Log.Error("[Exception] " + e);
		throw new Exception("조회에 실패하였습니다.");
	} finally {
...
public List selectAthGrpMenuMgrRegPopList(Map paramMap, String locPath) throws Exception {
	...
	try{
		//쿼리 실행및 결과 받기.
		list = DBConn.executeQueryList(queryMap,"selectAthGrpMenuMgrRegPopList",pm);
	} catch (Exception e) {
		Log.Error("[Exception] " + e);
		throw new Exception("조회에 실패하였습니다.");
	} finally {
...
public List selectPrgMgrPopList(Map paramMap, String locPath) throws Exception {
	...
	try{
		//쿼리 실행및 결과 받기.
		list = DBConn.executeQueryList(queryMap,"selectPrgMgrPopList",pm);
	} catch (Exception e) {
		Log.Error("[Exception] " + e);
		throw new Exception("조회에 실패하였습니다.");
	} finally {
