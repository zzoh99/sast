...
<div class="wrapper">
	...
	<tr>
		<th class="left" rowspan=2>조세특례제한법 제30조</th>
		<th class="center">100% 감면대상소득</th>
		<td class="right"> 
			<input id="B010_30" name="B010_16" type="text" class="text w90 right" /> 원 
		</td>
		<td class="left" > 
	...
	<tr>
		...
		<td class="right"> 
			<input id="B010_31" name="B010_16" type="text" class="text w90 right" /> 원 
		</td>
		<td class="left" > 
