	...
	<form id="mainForm" name="mainForm">
		...
		<tr>
			<td>
				...
				<span id="span_clearYnCheck" style="margin-left:20px;"></span>
...
<script type="text/javascript">
	...
	function createTabFrame() {
		...
		.append("<li><a href='#tabs-6' id='tabs6'>의료</a></li>")
		.append("<li><a href='#tabs-7' id='tabs7'>교육</a></li>")
		.append("<li><a href='#tabs-8' id='tabs8'>주택자금</a></li>")
		.append("<li><a href='#tabs-9' id='tabs9'>기부</a></li>")
		.append("<li><a href='#tabs-10' id='tabs10'>저축</a></li>")
		.append("<li><a href='#tabs-11' id='tabs11'>카드등</a></li>")
		.append("<li><a href='#tabs-12' id='tabs12'>기타공제</a></li>")
		.append("<li><a href='#tabs-13' id='tabs13'>세액감면/기타세액공제</a></li>");
	...
	function doReport(report_type){
		...
		args["rdTitle"] = popupTitle ;//rd Popup제목
		args["rdMrd"] = "<%=cpnYearEndPath%>/"+rdFileNm;//( 공통경로 /html/report/는 공통에서 처리)업무경로+rd파일명
		args["rdParam"] = "[<%=session.getAttribute("ssnEnterCd")%>] ["+$("#searchWorkYy").val()+"] ["+$("#searchAdjustType").val()+"] ['"+$("#searchSabun").val()+"'] [00000] [ALL]";//rd파라매터
		args["rdParamGubun"] = "rp" ;//파라매터구분(rp/rv)
		args["rdToolBarYn"] = "Y" ;//툴바여부
		args["rdZoomRatio"] = "100" ;//확대축소비율
