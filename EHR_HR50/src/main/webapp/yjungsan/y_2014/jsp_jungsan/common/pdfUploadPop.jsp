    ...
    <div class="wrapper">
		...
		<div class="outer">
			<table>
				...
				<tr>
					<td style="padding:5px;"><img src="../../../common_jungsan/images/common/pdf_popup.jpg" border="0" style="vertical-align:middle;width:100%;height:100%"></td>
				</tr>
				<tr>
					<td style="padding:20px 5px 5px 5px;">&nbsp;&nbsp;<font color="red">* PDF 자료를 국세청에서 다운받을 때 비밀번호를 설정하였을 경우, 해당 비밀번호를 입력하셔야 합니다.</font></td>
				</tr>
				<tr>
					<td style="padding:5px;" align="right">비밀번호:<input type="text" id="paramPwd" name="paramPwd" value="" class="required"/></td>
				</tr>
				<tr>
					<td style="padding:5px;">&nbsp;&nbsp;* 찾아보기 버튼을 클릭하여 PDF파일을 선택하신 후, 업로드 버튼을 클릭하여 주시기 바랍니다.</td>
				</tr>
				<tr>
