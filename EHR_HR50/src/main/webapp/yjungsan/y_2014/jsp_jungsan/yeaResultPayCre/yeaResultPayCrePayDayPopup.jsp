...
<script type="text/javascript">
	...
	$(function() {
		...
		// 급여코드
        var payCdList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList","getCpnPayCdList") , "전체");
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			sheet1.DoSearch("<%=jspPath%>/yeaResultPayCre/yeaResultPayCreRst.jsp?cmd=selectYeaResultPayCrePayDayPopupList",$("#sheetForm").serialize());
			break;
		case "Down2Excel":
