...
<div class="wrapper" style="overflow-y: auto; overflow-x: auto;">
	<%@ include file="../common/include/employeeHeaderYtax_KABANG.jsp"%>
	...
	<tr>
		<th class="center" colspan="3">2015.12.31. 이전 계산방법</th>
		<th class="center">중간지급 등</th>
		<th class="center">최 종</th>
		<th class="center">정 산</th>
		<th class="center" colspan="5">2016.1.1. 이후 계산방법</th>
	</tr>
	<tr>
		<th colspan="3">퇴직소득</th>
		<td class="center"> <input id="pre1_ret_mon" name="pre1_ret_mon" type="text" class="text w100p right transparent" /> </td>
		<td class="center"> <input id="ret_mon" name="ret_mon" type="text" class="text w100p right transparent" /> </td>
		<td class="center"> <input id="tot_ret_mon" name="tot_ret_mon" type="text" class="text w100p right transparent" /> </td>
		<th colspan="4">정산퇴직소득</th>
		<td class="center"> <input id="tot_ret_mon_2016" name="tot_ret_mon_2016" type="text" class="text w100p right transparent" readonly/> </td>
	</tr>
	<tr>
		<th colspan="3">퇴직소득정률공제</th>
		<td class="center" style="background:#ebeef0;"> </td>
		<td class="center" style="background:#ebeef0;"> </td>
		<td class="center"> <input id="income_ded_rate_mon" name="income_ded_rate_mon" type="text" class="text w100p right transparent" readonly/> </td>
		<th colspan="4">근속연수공제</th>
	...
	<tr>
		<th colspan="3">근속연수공제</th>
		<td class="center" style="background:#ebeef0;"> </td>
		<td class="center" style="background:#ebeef0;"> </td>
		<td class="center"> <input id="income_ded_year_mon" name="income_ded_year_mon" type="text" class="text w100p right transparent" readonly/> </td>
		<th colspan="4">환산급여</th>
	...
	<tr>
		<th colspan="3" rowspan="2">퇴직소득과세표준</th>
		<td class="center" style="background:#ebeef0;" rowspan="2"> </td>
		<td class="center" style="background:#ebeef0;" rowspan="2"> </td>
		<td class="center" rowspan="2"> <input id="tax_base_mon" name="tax_base_mon" type="text" class="text w100p right transparent" readonly/> </td>
		<th colspan="4">환산급여별공제</th>
	...
	<tr>
		<th class="center" colspan="3">2015.12.31. 이전 계산방법</th>
		<th class="center">12.12.31.<br>이전</th>
		<th class="center">13.1.1.<br>이후</th>
		<th class="center">합계</th>
		<th class="center" colspan="5">2016.1.1. 이후 계산방법</th>
	</tr>
	<tr>
		<th colspan="3" rowspan="2">과세표준안분</th>
		<td class="center" rowspan="2"> <input id="tax_base_mon_2012" name="tax_base_mon_2012" type="text" class="text w100p right transparent" /> </td>
		<td class="center" rowspan="2"> <input id="tax_base_mon_2013" name="tax_base_mon_2013" type="text" class="text w100p right transparent" /> </td>
		<td class="center" rowspan="2"> <input id="tax_base_mon" name="tax_base_mon" type="text" class="text w100p right transparent" /> </td>
		<th colspan="4">환산산출세액</th>
	...
	<tr>
		<th colspan="3">연평균과세표준</th>
		<td class="center"> <input id="ytax_base_mon_2012" name="ytax_base_mon_2012" type="text" class="text w100p right transparent" /> </td>
		<td class="center"> <input id="ytax_base_mon_2013" name="ytax_base_mon_2013" type="text" class="text w100p right transparent" /> </td>
		<td class="center" style="background:#ebeef0;"> </td>
		<th class="center" colspan="5" >세액계산 특례</th>
	</tr>
	<tr>
		<th colspan="3">환산과세표준</th>
		<td class="center" style="background:#ebeef0;"> </td>
	...
	<tr>
		<th colspan="3">연평균산출세액</th>
		<td class="center"> <input id="ycal_tax_mon_2012" name="ycal_tax_mon_2012" type="text" class="text w100p right transparent" /> </td>
		<td class="center"> <input id="ycal_tax_mon_2013" name="ycal_tax_mon_2013" type="text" class="text w100p right transparent" /> </td>
		<td class="center"> <input id="ycal_tax_mon" name="ycal_tax_mon" type="text" class="text w100p right transparent" /> </td>
		<th colspan="4">기납부(또는 기과세이연) 세액</th>
		<td class="center"> <input id="paid_tax_mon" name="paid_tax_mon" type="text" class="text w100p right transparent" readonly/> </td>
	</tr>
	<tr>
		<th colspan="3">산출세액</th>
		<td class="center"> <input id="cal_tax_mon_2012" name="cal_tax_mon_2012" type="text" class="text w100p right transparent" /> </td>
		<td class="center"> <input id="cal_tax_mon_2013" name="cal_tax_mon_2013" type="text" class="text w100p right transparent" /> </td>
		<td class="center"> <input id="cal_tax_mon" name="cal_tax_mon" type="text" class="text w100p right transparent" /> </td>
		<th colspan="4">신고대상세액</th>
	...
	<tr>
		<td class="center" rowspan="2"> <input id="a_declare_itax_mon" name="a_declare_itax_mon" type="text" class="text w100p right transparent" readonly/> </td>
		...
		<td class="center" rowspan="2"> <input id="a_ret_mon" name="a_ret_mon" type="text" class="text w100p right transparent" readonly/> </td>
		<td class="center" rowspan="2"> <input id="k_cal_defer_tax_mon" name="k_cal_defer_tax_mon" type="text" class="text w100p right transparent" readonly /> </td>
	</tr>
	<!-- 
	<tr>
		<td class="center"> <input id="input_ccc1" name="input_ccc1" type="text" maxlength="30" class="text w100p center" /> </td>
		<td class="center"> <input id="input_ccc2" name="input_ccc2" type="text" maxlength="30" class="text w100p center" /> </td>
		<td class="center"> <input id="input_ccc3" name="input_ccc3" type="text" maxlength="30" class="text w100p center" /> </td>
		<td class="center"> <input id="input_ccc4" name="input_ccc4" type="text" class="text w100p center" /> </td>
		<td class="center"> <input id="input_ccc5" name="input_ccc5" type="text" class="text w100p right" /> </td>
	</tr>
	<tr>
		<th class="center" colspan="4"> 합계 </th>
		<td class="center"> <input id="tot_input_k_cur_defer_mon" name="tot_input_k_cur_defer_mon" type="text" class="text w100p right transparent" readonly/> </td>
	</tr>
	 -->
	</table>
	<!-- table5 -->
