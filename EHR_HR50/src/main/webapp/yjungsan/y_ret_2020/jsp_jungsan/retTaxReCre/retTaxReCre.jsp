...
<script type="text/javascript">
	...
	$(function(){
		...
		initdata1.Cols = [
            ...
            {Header:"<%=colIdx++%>",		Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"k_bank_nm2",  			KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"k_bank_enter_no2",  		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"k_bank_account2",  		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Date",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"k_defer_ymd2",  			KeyField:0,	Format:"Ymd",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"k_cur_defer_mon2",  		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"k_cur_defer_mon_tot",  	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			...
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"pre1_ret_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"ret_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"tot_ret_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"re_tot_ret_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"income_ded_rate_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"income_ded_year_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"tax_base_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"tax_base_mon_2012", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"tax_base_mon_2013", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"ytax_base_mon_2012", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"ytax_base_mon_2013", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"ytax_base_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"conv_base_mon_2013", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"conv_base_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"conv_tax_mon_2013", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"conv_tax_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"ycal_tax_mon_2012", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"ycal_tax_mon_2013", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"ycal_tax_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"cal_tax_mon_2012", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"cal_tax_mon_2013", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"cal_tax_mon", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }

			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"tot_ret_mon_2016",        KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"income_ded_year_mon_2016",KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"re_income_ded_year_mon_2016",KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"conv_base_mon_2016", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"re_conv_base_mon_2016", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"income_ded_conv_mon_2016",KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"re_income_ded_conv_mon_2016",KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"tax_base_mon_2016", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"re_tax_base_mon_2016", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"conv_tax_mon_2016", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"re_conv_tax_mon_2016", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"cal_tax_mon_2016", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"re_cal_tax_mon_2016", 		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"tax_year", 		        KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"spc_cal_tax_mon_2016", 	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"paid_tax_mon", 	        KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"re_paid_tax_mon", 	        KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"declare_itax_mon", 	    KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"re_declare_itax_mon", 	    KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"add_tax_ded_mon", 	    KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
			,{Header:"<%=colIdx++%>",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"re_add_tax_ded_mon", 	    KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 }
	...
	$(function(){
		...
		$("#input_k_defer_ymd2").datepicker2({showtarget:false});
		...
		$('#input_k_cur_defer_mon2').mask('000,000,000,000,000', {reverse: true});
		$('#input_add_tax_ded_mon').mask('000,000,000,000,000', {reverse: true});
		$('#input_re_add_tax_ded_mon').mask('000,000,000,000,000', {reverse: true});
		...
		$('#input_k_bank_nm2').keyup(function(){chkDefer()});
		$('#input_k_defer_ymd2').keyup(function(){chkDefer()});
		$('#input_k_bank_enter_no2').keyup(function(){chkDefer()});
		$('#input_k_bank_account2').keyup(function(){chkDefer()});
		$('#input_k_cur_defer_mon2').keyup(function(){chkDefer()});
	});
	
	function chkDefer() {
		if($("#input_k_bank_nm2").val() != ""
				|| $("#input_k_defer_ymd2").val() != ""
				|| $("#input_k_bank_enter_no2").val() != ""
				|| $("#input_k_bank_account2").val() != ""
				|| $("#input_k_cur_defer_mon2").val() != ""
				) {
			if($("#input_k_bank_nm").val() == ""
					|| $("#input_k_defer_ymd").val() == ""
					|| $("#input_k_bank_enter_no").val() == ""
					|| $("#input_k_bank_account").val() == ""
					|| $("#input_k_cur_defer_mon").val() == ""
					) {
				alert("첫번째 연금계좌 입금내역을 먼저 입력하여 주십시오.");
				
				$("#input_k_bank_nm2").val("");
				$("#input_k_defer_ymd2").val("");
				$("#input_k_bank_enter_no2").val("");
				$("#input_k_bank_account2").val("");
				$("#input_k_cur_defer_mon2").val("");
	...
	function doAction1(sAction) {
		...
		case "Save":
			...
			*/
			...
			if($("#input_k_cur_defer_mon").val() != ""
				&& $("#input_k_cur_defer_mon").val() != 0) {
				if($("#input_k_bank_nm").val() == ""
				 ||$("#input_k_defer_ymd").val() == ""
				 ||$("#input_k_bank_enter_no").val() == ""
				 ||$("#input_k_bank_account").val() == "") {
					alert("첫번째 연금계좌 입금내역을 모두 입력하여 주십시오.");
					return;
				}
			}
			
			if($("#input_k_cur_defer_mon2").val() != ""
			   && $("#input_k_cur_defer_mon2").val() != 0) {
				if($("#input_k_bank_nm2").val() == ""
				 ||$("#input_k_defer_ymd2").val() == ""
				 ||$("#input_k_bank_enter_no2").val() == ""
				 ||$("#input_k_bank_account2").val() == "") {
					alert("두번째 연금계좌 입금내역을 모두 입력하여 주십시오.");
					return;
				}
			}
			sheet1.DoSave("<%=jspPath%>/retTaxReCre/retTaxReCreRst.jsp?cmd=saveRetTaxReCre", $("#srchFrm").serialize());
       	break;
		}
	}
	...
	function sheet1_OnSearchEnd(Code, Msg, StCode, StMsg) {
		try { 									
			...
			if(flag != false){
				// 신고대상세액 체크
				if(Number($("#declare_itax_mon").val().replace(',','')) > Number($("#re_declare_itax_mon").val().replace(',','')) && $("#re_declare_itax_mon").val().length >0){
					alert("특례적용전 신고대상세액이 더 낮습니다. 확인해주시기 바랍니다.");
					flag = false;
				}		
			}
		} catch(ex) {
	...
	//중간정산 버튼 활성화
	function setMidJungsanBtn(){
		
		var rmidYn		= ajaxCall("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&searchStdCd=CPN_RMID_LOAD_TYPE", "queryId=getSystemStdData",false).codeList;			
		// 카운트 쿼리 조회 
		var taxReCreCnt = ajaxCall("<%=jspPath%>/retTaxReCre/retTaxReCreRst.jsp?cmd=selectRetTaxReCreCntS2", $("#srchFrm").serialize(),false);

		if(rmidYn[0].code_nm == "Y" && taxReCreCnt.Data.cnt > 0) {
			$("#midJungsan").show();
			$("#re_td").show();
			$("#re_td2").show();
		} else {
	...
	// 퇴직일자 onchange - flag값 false set 
	function doActionPre(sAction){
		flag = false;
		doAction1("Search");
	}
	
	// 중간정산 불러오기
	function getMidJungsanData(){		

		//P_CPN_SEP_RMID_LOAD 실행 
		ajaxCall("<%=jspPath%>/retTaxReCre/retTaxReCreRst.jsp?cmd=getMiJungsan",$("#srchFrm").serialize(),true);
		flag = false;
...
<div class="wrapper" style="overflow-y: auto; overflow-x: auto;">
	...
	<div class="sheet_search outer">
        ...
        <tr>
            <td><span>퇴직일자</span>
				<select id="searchPayActionCd" name="searchPayActionCd" onChange="javascript:doActionPre('Search');"> </select>
				<input type="hidden" id="searchSabun" name="searchSabun"/>
				<a href="javascript:taxReCre();" class="basic right authA">퇴직세액 재계산</a>
				<a href="javascript:getMidJungsanData();" id="midJungsan" class="basic right authA">중간정산 불러오기</a>
            </td>
            <td class="right">
	...
	<table border="0" cellspacing="0" cellpadding="0" class="sheet_main">
		...
		<tr>
			<td id="or_td" class="sheet_left">
			    ...
			    <table id="aft_table" name="aft_table" border="0" cellpadding="0" cellspacing="0" class="table inner">
				<colgroup>
					<col width="15%" />
					<col width="40%" />
					<col width="40%" />
				...
				<tr>
					<th class="center" rowspan="6">과세<br>표준<br>계산</th>
					<th class="center">계 산 내 용</th>
					<th class="center">금 액</th>
				</tr>
				<tr>
					<th>퇴직소득</th>
					<td class="center"><input id="tot_ret_mon" name="tot_ret_mon" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>근속연수공제</th>
					<td class="center"><input id="income_ded_year_mon_2016" name="income_ded_year_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>환산급여</th>
					<td class="center"><input id="conv_base_mon_2016" name="conv_base_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>환산급여별공제</th>
					<td class="center"><input id="income_ded_conv_mon_2016" name="income_ded_conv_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>퇴직소득과세표준</th>
					<td class="center"><input id="tax_base_mon_2016" name="tax_base_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				</table>
			</td>
			
			<td id="re_td" class="sheet_right">
				<div class="outer">
			    <div class="sheet_title">
			        <ul>
			            <li class="txt">[특례적용 전 과세표준계산]
			            </li>
			            <li class="btn">
			    		</li>
			        </ul>
				...
				<tr>
					<th>퇴직소득</th>
					<td class="center"><input id="re_tot_ret_mon" name="re_tot_ret_mon" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>근속연수공제</th>
					<td class="center"><input id="re_income_ded_year_mon_2016" name="re_income_ded_year_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>환산급여</th>
					<td class="center"><input id="re_conv_base_mon_2016" name="re_conv_base_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>환산급여별공제</th>
					<td class="center"><input id="re_income_ded_conv_mon_2016" name="re_income_ded_conv_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>퇴직소득과세표준</th>
					<td class="center"><input id="re_tax_base_mon_2016" name="re_tax_base_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				</table>
			</td>
		</tr>
	...
	<table id="or_td2" border="0" cellspacing="0" cellpadding="0" class="sheet_main">
		<tr>
			<td class="sheet_left">
				<div class="outer">
			    <div class="sheet_title">
			        <ul>
			            <li class="txt">[퇴직소득 세액계산]
			            </li>
			            <li class="btn">
			    		</li>
			        </ul>
				...
				<tr>
					<th class="center" rowspan="6">퇴직<br>소득<br>세액<br>계산</th>
					<th class="center">계 산 내 용</th>
					<th class="center">금 액</th>
				</tr>
				<tr>
					<th>환산산출세액</th>
					<td class="center"><input id="conv_tax_mon_2016" name="conv_tax_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>퇴직소득 산출세액</th>
					<td class="center"><input id="cal_tax_mon_2016" name="cal_tax_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>세액공제</th>
					<td class="center"><input id="input_add_tax_ded_mon" name="input_add_tax_ded_mon" type="text" class="text w100p right" /></td>
				<tr>
					<th>기납부(또는 기과세이연) 세액</th>
					<td class="center"><input id="paid_tax_mon" name="paid_tax_mon" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>신고대상세액</th>
					<td class="center"><input id="declare_itax_mon" name="declare_itax_mon" type="text" class="text w100p right transparent" readonly/></td>
				</tr>	
				</table>
			</td>

			<td id="re_td2" class="sheet_right">
				<div class="outer">
			    <div class="sheet_title">
			        <ul>
			            <li class="txt">[특례적용 전 퇴직소득 세액계산]
			            </li>
			            <li class="btn">
			    		</li>
			        </ul>
				...
				<tr>
					<th>환산산출세액</th>
					<td class="center"><input id="re_conv_tax_mon_2016" name="re_conv_tax_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>퇴직소득 산출세액</th>
					<td class="center"><input id="re_cal_tax_mon_2016" name="re_cal_tax_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>세액공제</th>
					<td class="center"><input id="input_re_add_tax_ded_mon" name="input_re_add_tax_ded_mon" type="text" class="text w100p right"/></td>
				</tr>
				<tr>
					<th>기납부(또는 기과세이연) 세액</th>
					<td class="center"><input id="re_paid_tax_mon" name="re_paid_tax_mon" type="text" class="text w100p right transparent" readonly/></td>
				</tr>
				<tr>
					<th>신고대상세액</th>
					<td class="center"><input id="re_declare_itax_mon" name="re_declare_itax_mon" type="text" class="text w100p right transparent" readonly/></td>
				</tr>	
				</table>
			</td>	
		</tr>
	...
	<tr>
		<td class="center" rowspan="4"> <input id="a_declare_itax_mon" name="a_declare_itax_mon" type="text" class="text w100p right transparent" readonly/> </td>
		...
		<td class="center" rowspan="4"> <input id="a_ret_mon" name="a_ret_mon" type="text" class="text w100p right transparent" readonly/> </td>
		<td class="center" rowspan="4"> <input id="k_cal_defer_tax_mon" name="k_cal_defer_tax_mon" type="text" class="text w100p right transparent" readonly /> </td>
	</tr>
	<tr>
		<td class="center"> <input id="input_k_bank_nm2" name="input_k_bank_nm2" type="text" maxlength="30" class="text w100p center" /> </td>
		<td class="center"> <input id="input_k_bank_enter_no2" name="input_k_bank_enter_no2" type="text" maxlength="30" class="text w100p center" /> </td>
		<td class="center"> <input id="input_k_bank_account2" name="input_k_bank_account2" type="text" maxlength="30" class="text w100p center" /> </td>
		<td class="center"> <input id="input_k_defer_ymd2" name="input_k_defer_ymd2" type="text" class="text w100p center" /> </td>
		<td class="center"> <input id="input_k_cur_defer_mon2" name="input_k_cur_defer_mon2" type="text" class="text w100p right" /> </td>
	</tr>
	<tr>
		<td class="center" colspan="4"> 합계 </td>
		<td class="center"> <input id="input_k_cur_defer_mon_tot" name="input_k_cur_defer_mon_tot" type="text" class="text w100p right transparent" readonly/> </td>
	</tr>
	</table>
