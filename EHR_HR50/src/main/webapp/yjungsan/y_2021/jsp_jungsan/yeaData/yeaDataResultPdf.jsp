    ...
    <div class="outer">
        <div class="sheet_title">
            <ul>
                ...
                <%}else{%>
                    <font class='blue'>해당 화면은 모의계산이며 실제 계산에 영향은 없습니다.</font>
                <%}%>
...
<% } %>
        ...
        <tr>
            ...
            <input type="checkbox" class="checkbox" style="vertical-align:middle;" id="ageChkYn" name="ageChkYn" onclick="f_ageChkYn($(this)); return false;"></th>
