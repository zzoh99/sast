        ...
        <ul>
            ...
            <li class="btn">
            	<span id="btnDisplayYn01">
            		<a href="javascript:doAction1('confirm');" class="basic btn-white out-line authA" id="authTextA"><b id="authText">확정</b></a>
            	</span>
            </li>
        </ul>
        </div>
			...
			<div class="outer">
				<div class="sheet_title">
					<ul>
					    ...
					    <li class="btn">
					    	<span><font class="txt red" style="text-overflow: ellipsis; white-space: nowrap;">&nbsp;현황은 참조용입니다. 실제 공제는 아래 장애인공제 체크를 하셔야 합니다.&nbsp;</font></span>
