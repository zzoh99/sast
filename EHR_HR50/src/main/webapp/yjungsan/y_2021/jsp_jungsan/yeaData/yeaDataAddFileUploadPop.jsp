...
<!--
	...
	$(function(){
        ...
        initdata.Cols = [
                        ...
                        {Header:"대상자성명",  Type:"Text",            Hidden:0,  Width:40,     Align:"Center",    ColMerge:0,   SaveName:"nm_txt",     KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
    ...
    function saveNmTxt(){
        ...
        sheet1.DoSave( "<%=jspPath%>/yeaData/yeaDataAddFileUploadPopRst.jsp?cmd=saveNmTxt",param);
    }
    ...
    function sheet1_OnChange(Row, Col, Value) {
        ...
        try{
        	if( sheet1.ColSaveName(Col) == "nm_txt" ) {
