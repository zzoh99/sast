...
<%                          }	%>
                ...
                //산후조리비, 실손의료비
                if(sheet2.GetCellValue(Row,"restrict_cd") == "20"||sheet2.GetCellValue(Row,"restrict_cd") == "30"){

                	//난임시술비가 체크되어 있으면 선택불가
                	if(sheet2.GetCellValue(Row,"nanim_yn") == 'Y') {
                		alert("난임시술비가 체크되어 있으면\n산후조리비와 실손의료비는 선택하실 수 없습니다.");
    					sheet2.SetCellValue(Row,"restrict_cd", "") ;
    					return;
                	}
...
<%                          	}	%>
            ...
            if(sheet2.ColSaveName(Col) == "nanim_yn") {
            	...
            	if(sheet2.GetCellValue(Row,"nanim_yn") == 'Y' && (sheet2.GetCellValue(Row,"restrict_cd") == "20" || sheet2.GetCellValue(Row,"restrict_cd") == "30")) {
    ...
    function sheetSet(){
        ...
        if(comSheet.RowCount() > 0){
            ...
            $("#A050_13").val( comSheet.GetCellText(comSheet.FindText("adj_element_cd", "A050_13") ,"input_mon"));
...
<div class="wrapper">
    ...
    <div class="outer">
        ...
        <ul>
            <li class="txt">의료비
	            ...
	            <a href="#layerPopup" class="basic btn-white ico-question" id="buttonInfoMinus" style="display:none"><b>의료비 안내-</b></a>
            </li>
        </ul>
        </div>
    </div>
    ...
    <tr>
        ...
        <td class="right">
            <input id="medMonInput2" name="medMonInput2" type="text" class="text w50p right transparent"  readonly /> 원
        </td>
    </tr>
    </table>
    ...
    <div class="outer">
	    <div>
	    	<font size='2'>
			    ...
			    <font class="blue">※ 65세이상이면서 장기요양비</font>에 해당하는 경우 65세이상이 더 유리하여 적용됩니다.
		    </font>
	    </div>
        <div class="sheet_title">
        <ul>
