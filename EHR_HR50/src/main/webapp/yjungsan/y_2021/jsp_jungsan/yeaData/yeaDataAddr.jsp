...
<script type="text/javascript">
	...
	function houseInfo(){
		...
		if($("input[name='house_cnt']:checked").val() == "0" || $("input[name='house_cnt']:checked").val() == "2") {
			$("#house_get_ymd").val("") ;
			$("#house_area").val("") ;
			$("#official_price").val("") ;
			$("#houseinfo1").hide() ;
	...
	<table border="0" cellpadding="0" cellspacing="0" class="default outer">
				...
				<ul>
					...
					<li class="btn">
						<span id="btnDisplayYn01">
						  ...
						  <a href="javascript:initZipCode();" class="basic btn-white authA" id="btnInit">초기화</a>
						  &nbsp;&nbsp;&nbsp;
						  <a href="javascript:saveConfirmYn('Confirm');" class="basic btn-white out-line authA" id="authTextA"><b id="authText">확정</b></a>
						</span>
					</li>
				</ul>
			</div>
		...
		<tr id='houseinfo2' style="display:none;">
			...
			<td class="left">
				...
				<a href='http://www.realtyprice.kr/notice/' target='_blank'><font class='blue'><u>☞ 전용면적 및 공시지가 조회(국토해양부) 바로가기</u></font></a>
			</td>
		</tr>
		<tr id='houseinfo3' style="display:none;">
			...
			<td class="left">
				...
				<font class='red'>☜ 취득일자, 전용면적, 공시지가는 참조용이며 세금계산과 연계되지 않습니다.</font>
			</td>
		</tr>
	</table>
