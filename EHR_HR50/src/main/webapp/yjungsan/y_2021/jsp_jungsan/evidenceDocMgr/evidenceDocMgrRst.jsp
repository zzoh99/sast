...
public int updateStatusCd(Map paramMap, String locPath, String ssnYeaLogYn) throws Exception {
    ...
    if(list != null && list.size() > 0 && conn != null) {
        ...
        String searchBizPlaceCd  = (String)pm.get("searchBizPlaceCd");
        String searchSbNm        = (String)pm.get("searchSbNm");
        String searchFileType    = (String)pm.get("searchFileType");
        String searchStatusCd    = (String)pm.get("searchStatusCd");
        ...
        try{
            for(int i = 0; i < list.size(); i++ ) {
                ...
                mp.put("searchSbNm"      , searchSbNm      );
                mp.put("searchFileType"  , searchFileType  );
                mp.put("searchStatusCd"  , searchStatusCd  );
