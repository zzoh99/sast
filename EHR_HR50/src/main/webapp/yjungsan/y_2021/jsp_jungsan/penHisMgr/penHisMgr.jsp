...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"DOC_SEQ_DETAIL|DOC_SEQ_DETAIL",Type:"Text",		Hidden:1,	Width:60,	Align:"Left",	ColMerge:1,	SaveName:"doc_seq_detail",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:40 },
   			{Header:"대상년도|대상년도",			Type:"Text",      Hidden:0,  Width:60,    Align:"Center",  ColMerge:1,   SaveName:"work_yy",			KeyField:1,   	CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:4 },
	        {Header:"정산구분|정산구분",			Type:"Combo",     Hidden:0,  Width:70,    Align:"Center",  ColMerge:1,   SaveName:"adjust_type",		KeyField:1,   	CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
	        ...
	        {Header:"ISA계좌 금액| 담당자용",	Type:"AutoSum",		  Hidden:0,  Width:90,    Align:"Right",   ColMerge:1,   SaveName:"appl_mon_isa",			KeyField:1,   	CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
	...
	function doAction1(sAction) {
        ...
        case "Down2Excel":
			...
			break;
		case "Down2Template":
			var param  = {DownCols:"5|6|9|10|11|12|13|15|18|20",SheetDesign:1,Merge:1,DownRows:"0|1",ExcelFontSize:"9"
