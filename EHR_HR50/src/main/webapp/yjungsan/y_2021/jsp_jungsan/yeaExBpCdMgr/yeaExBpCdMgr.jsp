...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata0.Cols = [
				...
				{Header:"작업구분",		Type:"Text",		Hidden:1,  	Width:0,		Align:"Left",    	ColMerge:0,   	SaveName:"adjust_type",   	KeyField:0,   	CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:500 },
    ...
    function doAction1(sAction) {
        switch (sAction) {
	        ...
	        case "Down2Template":
	            ...
	            var param  = {DownCols:"sabun|chg_bp_cd|adj_s_ymd|adj_e_ymd|chg_chk|cancel_chk|bigo",SheetDesign:1,Merge:1,DownRows:0,FileName:'Template',SheetName:'sheet1',UserMerge:"0,0,1,6",TitleText:titleText, ExcelRowHeight:100 ,menuNm:$(document).find("title").text()};
