...
//연말정산 기타소득 검색
public List selectPdfRegMgr(Map paramMap, String locPath, String ssnYeaLogYn) throws Exception {
	...
	try{
		//쿼리 실행및 결과 받기.
		list = (queryMap == null) ? null : DBConn.executeQueryList(queryMap,"selectPdfRegMgr",pm);
...
//연말정산 기타소득 저장.
public int savePdfRegMgr(Map paramMap, String orgAuthPg, String locPath, String ssnYeaLogYn) throws Exception {
...
<%
	String locPath = xmlPath+"/pdfRegMgr/pdfRegMgr.xml";
	...
	if("selectPdfRegMgr".equals(cmd)) {
		...
		try {
			listData = selectPdfRegMgr(mp, locPath, ssnYeaLogYn);
		} catch(Exception e) {
			code = "-1";
...
//pdf 파일 상세 저장.
        ...
        try {
            int cnt = savePdfRegMgr(paramMap, orgAuthPg, locPath, ssnYeaLogYn);
