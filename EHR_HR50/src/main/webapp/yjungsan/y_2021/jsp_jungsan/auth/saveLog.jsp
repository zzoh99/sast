			   ...
			   if(mp2.containsKey("srchBizPlaceCd")    || mp2.containsKey("searchBizPlaceCd")      || mp2.containsKey("searchStdBpCd") || mp2.containsKey("biz_place_cd")
			    ...
			    if(mp2.containsKey("searchFormCd")){
			        if(chkNull(mp2.get("searchFormCd")) > 0) {
			            ...
			            if(formCd.equals("N101Y,Q101Y,Q201Y"))        mp2.put("업무구분" , "장기집합투자증권저축/벤처기업투자신탁");
                        ...
                        if(formCd.equals("G109Y"))                    mp2.put("업무구분" , "신용카드");
                        if(formCd.equals("G209M"))                    mp2.put("업무구분" , "현금영수증");
                        if(formCd.equals("G309Y"))                    mp2.put("업무구분" , "직불카드");
                        if(formCd.equals("G409Y"))                    mp2.put("업무구분" , "제로페이");
			    ...
			    if(chkNull(mp2.get("notax_baby_mon"))         > 0) mp2.put("출산보육비과세"                        ,mp2.remove("notax_baby_mon"             ));else mp2.remove("notax_baby_mon");
			    ...
			    if(chkNull(mp2.get("sht2_CurrNotaxBabyMon"))  > 0) mp2.put("주(현) 출산보육"                           ,mp2.remove("sht2_CurrNotaxBabyMon"         ));else mp2.remove("sht2_CurrNotaxBabyMon");
			    ...
			    if(chkNull(mp2.get("sht2_PreNotaxBabyMon"))   > 0) mp2.put("종(전) 출산보육"                           ,mp2.remove("sht2_PreNotaxBabyMon"          ));else mp2.remove("sht2_PreNotaxBabyMon");
			    ...
			    if(chkNull(mp2.get("sht5_A070_15_INP"))       > 0) mp2.put("2011년 이전(15년~29년)(입력)"                       ,mp2.remove("sht5_A070_15_INP"             ));else mp2.remove("sht5_A070_15_INP");
			    if(chkNull(mp2.get("sht5_A070_15"))           > 0) mp2.put("2011년 이전(15년~29년)(공제)"                       ,mp2.remove("sht5_A070_15"                 ));else mp2.remove("sht5_A070_15");
			    ...
			    if(chkNull(mp2.get("sht5_A070_22_INP"))       > 0) mp2.put("2012년 이후(고정금리/비거치상환)(입력)"             ,mp2.remove("sht5_A070_22_INP"             ));else mp2.remove("sht5_A070_22_INP");
			    if(chkNull(mp2.get("sht5_A070_22"))           > 0) mp2.put("2012년 이후(고정금리/비거치상환)(공제)"             ,mp2.remove("sht5_A070_22"                 ));else mp2.remove("sht5_A070_22");
			    if(chkNull(mp2.get("sht5_A070_23_INP"))       > 0) mp2.put("2012년 이후(기타 대출)(입력)"                       ,mp2.remove("sht5_A070_23_INP"             ));else mp2.remove("sht5_A070_23_INP");
			    if(chkNull(mp2.get("sht5_A070_23"))           > 0) mp2.put("2012년 이후(기타 대출)(공제)"                       ,mp2.remove("sht5_A070_23"                 ));else mp2.remove("sht5_A070_23");
			    if(chkNull(mp2.get("sht5_A070_24_INP"))       > 0) mp2.put("2015년 이후(15년이상 고정&비거치 상환)(입력)"       ,mp2.remove("sht5_A070_24_INP"             ));else mp2.remove("sht5_A070_24_INP");
			    if(chkNull(mp2.get("sht5_A070_24"))           > 0) mp2.put("2015년 이후(15년이상 고정&비거치 상환)(공제)"       ,mp2.remove("sht5_A070_24"                 ));else mp2.remove("sht5_A070_24");
			    if(chkNull(mp2.get("sht5_A070_25_INP"))       > 0) mp2.put("2015년 이후(15년이상 고정/비거치 상환)(입력)"       ,mp2.remove("sht5_A070_25_INP"             ));else mp2.remove("sht5_A070_25_INP");
			    if(chkNull(mp2.get("sht5_A070_25"))           > 0) mp2.put("2015년 이후(15년이상 고정/비거치 상환)(공제)"       ,mp2.remove("sht5_A070_25"                 ));else mp2.remove("sht5_A070_25");
			    if(chkNull(mp2.get("sht5_A070_26_INP"))       > 0) mp2.put("2015년 이후(15년이상 기타대출)(입력)"               ,mp2.remove("sht5_A070_26_INP"             ));else mp2.remove("sht5_A070_26_INP");
			    if(chkNull(mp2.get("sht5_A070_26"))           > 0) mp2.put("2015년 이후(15년이상 기타대출)(공제)"               ,mp2.remove("sht5_A070_26"                 ));else mp2.remove("sht5_A070_26");
			    if(chkNull(mp2.get("sht5_A070_27_INP"))       > 0) mp2.put("2015년 이후(10년이상 고정/비거치 상환)(입력)"       ,mp2.remove("sht5_A070_27_INP"             ));else mp2.remove("sht5_A070_27_INP");
			    if(chkNull(mp2.get("sht5_A070_27"))           > 0) mp2.put("2015년 이후(10년이상 고정/비거치 상환)(공제)"       ,mp2.remove("sht5_A070_27"                 ));else mp2.remove("sht5_A070_27");
			    if(chkNull(mp2.get("sht5_A080_20"))           > 0) mp2.put("기부금(이월분.2013년이전기부금)"           ,mp2.remove("sht5_A080_20"                  ));else mp2.remove("sht5_A080_20");
