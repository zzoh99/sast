...
<div class="wrapper">
	...
	<div class="outer" >
		...
		<tr>
			<th class="center" rowspan="25">그 밖의<br>소득공제</th>
		...
		<tr>
			<th class="center" rowspan="38">세액공제</th>
		...
		<tr>
            <th class="center" rowspan="8">연금계좌<br><br>50세 이상&nbsp;
                <input type="checkbox" class="checkbox" style="vertical-align:middle;" id="ageChkYn" name="ageChkYn" onclick="f_ageChkYn($(this)); return false;">
            </th>
		...
		<tr>
			<th class="center" rowspan="10">기부금<br><br><br>
		...
		<tr>
			<th class="center" rowspan="2">[소득세법]</br>제34조제2항제1호의</br>기부금(법정기부금)</th>
			<th class="center">공제대상금액</th>
			<td class="right" rowspan="2">
		...
		<tr>
			<th class="center" rowspan="2">[소득세법]</br>제34조제3항제1호의</br>기부금(지정기부금)</th>
			<th class="center">공제대상금액</th>
			<td class="right" rowspan="2">
