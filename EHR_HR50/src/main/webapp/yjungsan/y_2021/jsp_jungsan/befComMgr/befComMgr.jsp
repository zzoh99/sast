...
var curRow = "";
    ...
    function sheet1_OnChange(Row, Col, Value) {
        try{
            ...
            var subWorkSYmd = workSYmd.substring(0,4);
            var subWorkEYmd = workEYmd.substring(0,4);
            var subReSYmd = reSYmd.substring(0,4);
            var subReEYmd = reEYmd.substring(0,4);

            if(sheet1.ColSaveName(Col)  == "work_s_ymd") {
                if($("#srchYear").val() != subWorkSYmd && subWorkSYmd != ""){
            ...
            if(sheet1.ColSaveName(Col)  == "work_e_ymd") {
                if($("#srchYear").val() != subWorkEYmd && subWorkEYmd != ""){
                    alert("근무기간시작, 종료일은 귀속연도에 포함되어야 합니다.\n Ex) "+$("#srchYear").val()+".01.01 ~ "+$("#srchYear").val()+".12.31");
