...
<%!
//간이지급명세 출력
public List selectSimplePymtPrtMgrList(Map paramMap, Map queryMap) throws Exception {
...
//중복 사번 체크
public List getHpChk(Map paramMap, Map queryMap) throws Exception {
...
<%
	Map queryMap = XmlQueryParser.getQueryMap(xmlPath+"/simplePymtPrtMgr/simplePymtPrtMgrMonth.xml");
	...
	if("selectSimplePymtPrtMgrList".equals(cmd)) {
		...
		try {
			listData = selectSimplePymtPrtMgrList(mp, queryMap);
		} catch(Exception e) {
			code = "-1";
