...
//권한그룹코드 검색
public List selectGrpCdList(Map paramMap, Map queryMap) throws Exception {
...
//권한그룹프로그램 검색
public List selectAthGrpMenuMgrList(Map paramMap, Map queryMap) throws Exception {
...
//권한그룹프로그램 팝업 검색
public List selectAthGrpMenuMgrRegPopList(Map paramMap, Map queryMap) throws Exception {
...
//권한그룹프로그램 팝업 저장.
public int saveAthGrpMenuMgrRegPop(Map paramMap, Map queryMap) throws Exception {
...
//프로그램 팝업 검색
public List selectPrgMgrPopList(Map paramMap, Map queryMap) throws Exception {
...
<%
	//쿼리 맵 셋팅
	Map queryMap = setQueryMap(xmlPath+"/auth/athGrpMenuMgr.xml");
	...
	if("selectGrpCdList".equals(cmd)) {
		...
		try {
			listData = selectGrpCdList(mp, queryMap);
		} catch(Exception e) {
			code = "-1";
		...
		try {
			listData = selectAthGrpMenuMgrList(mp, queryMap);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
		...
		try {
			listData = selectAthGrpMenuMgrRegPopList(mp, queryMap);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
		...
		try {
			int cnt = saveAthGrpMenuMgrRegPop(mp, queryMap);
		...
		try {
			listData = selectPrgMgrPopList(mp, queryMap);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
