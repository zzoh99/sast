...
//사업소득관리 다건 조회
public List getSimplePymtBsnsIncpMgr(Map paramMap, Map queryMap) throws Exception {
...
//사업소득관리 저장
public int saveSimplePymtBsnsIncpMgr(Map paramMap, Map queryMap) throws Exception {
...
<%
	//쿼리 맵 셋팅
	Map queryMap = setQueryMap(xmlPath+"/simplePymtBsnsIncpMgr/simplePymtBsnsIncpMgrMonth.xml");
	...
	if("getSimplePymtBsnsIncpMgr".equals(cmd)) {
		...
		try {
			listData = getSimplePymtBsnsIncpMgr(mp, queryMap);
		} catch(Exception e) {
			code = "-1";
	...
	//사업소득관리 저장
        ...
        try {
            int cnt = saveSimplePymtBsnsIncpMgr(mp, queryMap);
