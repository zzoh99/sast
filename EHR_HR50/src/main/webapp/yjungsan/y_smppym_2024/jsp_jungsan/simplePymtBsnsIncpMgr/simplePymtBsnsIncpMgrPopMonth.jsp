...
<!DOCTYPE html> <html class="hidden"><head> <title>사업소득 생성</title>
...
// 		if((workYy == "2021" && halfType == "1") || workYy < "2021"){
// 			//2021년 상반기거나 2021년 이전(기존)
// 	        // 자료생성
<%-- 	        var data = ajaxCall("<%=jspPath%>/simplePymtBsnsIncpMgr/simplePymtBsnsIncpMgrMonthRst.jsp?cmd=P_CPN_SMPPYM_EMP",$("#sheet1Form").serialize(),false);			 --%>
// 		}else{
// 			//2021년 하반기부터 P_CPN_SMPPYM_EMP_2021 호출
<%-- 	        var data = ajaxCall("<%=jspPath%>/simplePymtBsnsIncpMgr/simplePymtBsnsIncpMgrMonthRst.jsp?cmd=P_CPN_SMPPYM_EMP_2021",$("#sheet1Form").serialize(),false);			 --%>
// 		}
		var data = ajaxCall("<%=jspPath%>/simplePymtBsnsIncpMgr/simplePymtBsnsIncpMgrMonthRst.jsp?cmd=P_CPN_SMPPYM_EMP_2024",$("#sheet1Form").serialize(),false);
		...
		<td class="">
			<div class="inner">
				<table class="table w100p" style="margin-top: 5px;">
					...
					<tr>
						<th style="font-size: 15px; text-align: center;" rowspan="3" >생성 기준</th>
                    ...
                    <tr>
                       <td style="font-size: 13px;" colspan="2" align="left"><span style="color: red">12월 귀속 다음해 1월 지급분은 <b>12월</b> 신고에 포함됩니다</span></td>
                    </tr>
				</table>
			</div>
		</td>
