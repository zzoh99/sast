...
//우편번호 갯수 조회
public String getZipCodePopupDoroListCnt(Map paramMap, Map queryMap) throws Exception {
...
//우편번호 조회
public List getZipCodePopupDoroList(Map paramMap, Map queryMap) throws Exception {
...
<%
	//쿼리 맵 셋팅
	Map queryMap = setQueryMap(xmlPath+"/common/zipCodeRefPopup.xml");
	...
	if("getZipCodePopupDoroList".equals(cmd)) {
		...
		try {
			totalCnt = getZipCodePopupDoroListCnt(mp, queryMap);
			listData = getZipCodePopupDoroList(mp, queryMap);
		} catch(Exception e) {
			code = "-1";
