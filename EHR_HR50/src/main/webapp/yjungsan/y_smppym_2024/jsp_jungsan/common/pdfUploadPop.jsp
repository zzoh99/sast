...
<body class="bodywrap">
    ...
    <div class="wrapper">
		...
		<div class="outer">
			<!-- PDF 등록 파일업로드 Start -->
			<table border="0" cellpadding="0" cellspacing="0" class="default outer" id="pdfUpload">
			    <colgroup>
			        <col width="70%" />
			        <col width="20%" />
			        <col width="10%" />
			    ...
			    <tr>
			        <td class="center">
			            <input type="file" id="upload" name="upload" class="text" style="width:100%;">
			        </td>
			        <td class="right">
			            <input type="text" id="paramPwd" name="paramPwd" class="text w100p right"/>
			        </td>
			        <td class="center">
			        	<a href="javascript:goAction();" class="basic" title="전자문서 제출">업로드</a>
			        	<!-- <a href="#" onclick="javascript:goAction(); return false" class="basic" title="전자문서 제출">업로드</a> -->
			        	
			        	<!-- <input type="button" class="basic" value="업로드" title="전자문서 제출" onclick="goAction()"> -->
			        	<!-- <input type="submit" value="업로드" class="basic" title="전자문서 제출"> -->
			        </td>
			    </tr>
		    </table>
		    <!-- PDF 등록 파일업로드 End -->
