...
<%--         	var data = ajaxCall("<%=jspPath%>/simplePymtNonResdntMgr/simplePymtNonResdntMgrRst.jsp?cmd=P_CPN_SMPPYM_EMP_2021",$("#sheet1Form").serialize(),false); --%>
//         }else if(workYy > "2021"){
//         	//2022년 부터  P_CPN_SMPPYM_EMP_2021 호출
<%--         	var data = ajaxCall("<%=jspPath%>/simplePymtNonResdntMgr/simplePymtNonResdntMgrRst.jsp?cmd=P_CPN_SMPPYM_EMP_2021",$("#sheet1Form").serialize(),false); --%>
//         }else{
//             // 자료생성
<%--         	var data = ajaxCall("<%=jspPath%>/simplePymtNonResdntMgr/simplePymtNonResdntMgrRst.jsp?cmd=P_CPN_SMPPYM_EMP",$("#sheet1Form").serialize(),false); --%>
//         }
        var data = ajaxCall("<%=jspPath%>/simplePymtNonResdntMgr/simplePymtNonResdntMgrMonthRst.jsp?cmd=P_CPN_SMPPYM_EMP_2024",$("#sheet1Form").serialize(),false);
