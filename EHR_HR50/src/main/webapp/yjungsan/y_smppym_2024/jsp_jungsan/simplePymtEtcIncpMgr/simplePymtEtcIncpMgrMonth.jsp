...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata0.Cols = [
                ...
                {Header:"월 구분|월 구분",         Type:"Combo",      Hidden:0,   Width:40,      Align:"Center",     ColMerge:0,     SaveName:"work_mm",         KeyField:1,     CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:2 },
                {Header:"월 구분|월 구분",         Type:"Combo",      Hidden:1,   Width:40,      Align:"Center",     ColMerge:0,     SaveName:"month_seq",         KeyField:0,     CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:2 },
                ...
                {Header:"비고|비고",            Type:"Text",   Wrap:"true",   Hidden:0,   Width:100,      Align:"Left",       ColMerge:0,     SaveName:"bigo",              KeyField:0,     CalcLogic:"",   Format:"",          PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:500, MultiLineText: 1, EnterMode: 1},
		...
		workMm = {ComboText:"1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월", ComboCode:"01|02|03|04|05|06|07|08|09|10|11|12"};
		sheet1.SetColProperty("work_mm", workMm);
    ...
    function doAction1(sAction) {
        switch (sAction) {
	        ...
	        case "Search":
	        	...
	        	sheet1.DoSearch( "<%=jspPath%>/simplePymtEtcIncpMgr/simplePymtEtcIncpMgrMonthRst.jsp?cmd=getsimplePymtEtcIncpMgr", $("#mySheetForm").serialize() ); 
	        	break;

	        case "Save":
	        	var msgSts = false;
	        	if($("#searchYear").val() == "") { alert("년도를 입력하여 주십시오."); return ; }
	        	if($("#searchWorkMm").val() == "") { alert("지급월을 입력하여 주십시오."); return ; }

				if (!dupChk2(sheet1, "work_yy|work_mm|send_type|income_type|half_type|sabun", true, true)) {break;} // 중복체크
	        	...
	        	sheet1.DoSave( "<%=jspPath%>/simplePymtEtcIncpMgr/simplePymtEtcIncpMgrMonthRst.jsp?cmd=saveSimplePymtEtcIncpMgr", $("#mySheetForm").serialize());
	        	break;
