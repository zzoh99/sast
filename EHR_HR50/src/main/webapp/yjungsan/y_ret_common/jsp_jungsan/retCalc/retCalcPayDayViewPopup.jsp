...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchMonthTo").val("<%=curSysYear%>"+"-12");
		...
		$("#searchPayCd").html(retPayCdList[2]);
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			sheet1.DoSearch("<%=jspPath%>/retCalc/retCalcPayDayPopupRst.jsp?cmd=selectRetCalcPayDayPopupList",$("#sheetForm").serialize());
			break;
		case "Down2Excel":
