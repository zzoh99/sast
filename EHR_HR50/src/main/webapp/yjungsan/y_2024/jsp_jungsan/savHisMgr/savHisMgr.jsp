...
<script type="text/javascript">
	...
	function doAction1(sAction) {
        ...
        case "Down2Excel":
			...
			break;
		case "Down2Template":
			var param  = {DownCols:"sabun|saving_deduct_type|finance_org_cd|reg_dt|mth_per|account_no|appl_mon|adj_input_type",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
