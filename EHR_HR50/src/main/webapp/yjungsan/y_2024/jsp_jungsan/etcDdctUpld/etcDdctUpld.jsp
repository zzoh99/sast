...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"대상년도",               Type:"Text",      Hidden:1,  Width:60,  Align:"Center",  ColMerge:1,   SaveName:"work_yy",          KeyField:1,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:4 },
