...
var fileUploadType = '0';
	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"파일명",		Type:"Text",		Hidden:1,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"attr1",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
		...
		var fileTypeList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&searchYear=<%=yeaYear%>", "YEA001"), "전체" );
            ...
            if(sheet1.ColSaveName(Col) == "down_btn" ) {
                ...
                if(arrDown.length > 0){
                    ...
                    if(bFlag){
                        ...
                        if(fileUploadType == '1'){
                        	$("#pfrm").attr("action", "<%=jspPath%>/withHoldRcptPdfUpload/withHoldRcptFileDownloadS3.jsp");
                        	$("#pfrm").submit();	
                        } else{
