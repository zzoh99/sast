  ...
  //담당자확인(2021.10.25)
	...
	function doAction1(sAction) {
        ...
        case "Down2Excel":
			...
			break;
		case "Down2Template":
			var param  = {DownCols:"sabun|saving_deduct_type|ret_pen_type|finance_org_cd|account_no|appl_mon|appl_mon_isa|adj_input_type",SheetDesign:1,Merge:1,DownRows:"0|1",ExcelFontSize:"9"
