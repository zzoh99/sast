...
<script type="text/javascript">
	...
	$(function() {
        ...
        initdata1.Cols = [
            ...
            {Header:"대상\n연도|대상\n연도",				Type:"Text",    Hidden:0,  Width:45,Align:"Center",    ColMerge:1,   SaveName:"work_yy",			KeyField:1,   CalcLogic:"",   Format:"",           PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
            {Header:"정산구분|정산구분",					Type:"Combo",    Hidden:0,  Width:110,Align:"Center",    ColMerge:1,   SaveName:"adjust_type",		KeyField:1,   CalcLogic:"",   Format:"",           PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
            ...
            {Header:"기부금종류|기부금종류",				Type:"Combo",   Hidden:0,  Width:180,Align:"Center",    ColMerge:1,   SaveName:"contribution_cd",	KeyField:1,   CalcLogic:"",   Format:"",           PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:500 },
            {Header:"기부\n연도|기부\n연도",						Type:"Text",	Hidden:0,  Width:45,Align:"Center",    ColMerge:1,   SaveName:"donation_yy",		KeyField:1,   CalcLogic:"",   Format:"",           PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:500 },
            ...
            {Header:"해당연도에 공제받지 못한금액|소멸금액",		Type:"Int",		Hidden:0,  Width:60,Align:"Right",     ColMerge:1,   SaveName:"extinction_mon",		KeyField:0,   CalcLogic:"",   Format:"Integer",    PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:35 },
            {Header:"해당연도에 공제받지 못한금액|이월금액",		Type:"Int",		Hidden:0,  Width:80,Align:"Right",     ColMerge:1,   SaveName:"carried_mon",		KeyField:1,   CalcLogic:"",   Format:"Integer",    PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:35 },
        ...
        contributionCdList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&useYn=Y&searchYear=<%=yeaYear%>", "C00307"), "" );
    ...
    function doAction1(sAction) {
		...
		case "Save":
            ...
            if(!dupChk(sheet1, "work_yy|adjust_type|sabun|contribution_cd|donation_yy", true, true)) {break;}
		...
		case "LoadExcel":
            /* ----------------------------------------------------------------------------------- 
            연말정산 매뉴얼에서 업로드 관련 양식이 확정된 상태로 
            인쇄소로 넘어갔기 때문에 아래 로직은 일단 주석처리함. 20241125 
			if($("#searchAdjustType").val() == "") {
                alert("정산구분을 먼저 입력하여 주십시오.");
                return;
            }*/
