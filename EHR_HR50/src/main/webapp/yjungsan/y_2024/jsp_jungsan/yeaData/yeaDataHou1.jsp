    ...
    function paytotMonView(obj1, obj2){
        if(paytotMonStr != ""){
            ...
            if( ( paytotMonStr.replace(/,/gi, "") *1 ) > obj2 ) {
                $("#span_paytotMonView"+obj1).html("<B>YES</B>&nbsp;<a href='javascript:paytotMonViewClose("+obj1+")' ><font class='red'>[닫기]</font></a>") ;
            } else {
                $("#span_paytotMonView"+obj1).html("<B>NO</B>&nbsp;<a href='javascript:paytotMonViewClose("+obj1+")' ><font class='red'>[닫기]</font></a>") ;
            }
        } else {
