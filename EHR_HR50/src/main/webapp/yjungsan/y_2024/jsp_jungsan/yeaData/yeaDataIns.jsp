	...
	function doAction2(sAction) {
		...
		case "Save":
			...
			var param = $("#sheetForm").serialize();
		        param += "&orgAuthPg="+orgAuthPg;
			sheet2.DoSave( "<%=jspPath%>/yeaData/yeaDataInsRst.jsp?cmd=saveYeaDataIns",param);
...
<div class="wrapper">
	...
	<tr>
		<td>
			...
			<table border="0" cellpadding="0" cellspacing="0" class="default line">
			<colgroup>
				<col width="10%" />
				<col width="15%" />
				<col width="15%" />
	...
	<div class="outer">
        ...
        <ul>
            <li class="txt">
                ...
                <a href="#layerPopup" class="basic btn-white ico-question" id="lifeInfoPlus"><b>보험료 안내+</b></a>
	            <a href="#layerPopup" class="basic btn-white ico-question" id="lifeInfoMinus" style="display:none"><b>보험료 안내-</b></a>
            </li>
        </ul>
        </div>
    </div>
		...
		<ul>
			...
			<li class="btn">
				<%if("A".equals(request.getParameter("orgAuthPg") ) ) {%>
	            	<font class='blue'>지역가입 보험료는 [연간소득_개별] 혹은 [연간소득 탭] 에서 건강보험, 국민연금등으로 추가 등록 하십시오.&nbsp;</font>
	            <%}else{%>
	            	<font class='blue'>지역가입 보험료는 연간소득에 등록해야 하며 담당자에게 문의해 주십시오.&nbsp;</font>
	            <%}%>
