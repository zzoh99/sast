...
<script type="text/javascript">
	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"정산구분",			Type:"Combo",		Hidden:0,	Width:150,	Align:"Center",	ColMerge:0,   SaveName:"adjust_type",		KeyField:0,   CalcLogic:"",   Format:"",		PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
            ...
            {Header:"총급여",				Type:"AutoSum",		Hidden:0,	Width:110,	Align:"Right", 	ColMerge:0,   SaveName:"total",				KeyField:0,   CalcLogic:"",   Format:"Integer",	PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:35, CalcLogic:"|pay_mon|+|bonus_mon|+|etc_bonus_mon|+|stock_buy_mon|+|stock_union_mon|+|imwon_ret_over_mon|" },
            ...
            {Header:"기타비과세\n(미신고)",		Type:"AutoSum",		Hidden:0,  	Width:80,	Align:"Right",	ColMerge:0,   SaveName:"notax_etc_mon",   	KeyField:0,   CalcLogic:"",   Format:"Integer",	PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"차량비과세\n(미신고)",	    Type:"AutoSum",     Hidden:0,  	Width:80,	Align:"Right",	ColMerge:0,   SaveName:"notax_car_mon",   	KeyField:0,   CalcLogic:"",   Format:"Integer",	PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"일직료비과세\n(미신고)",	Type:"AutoSum",		Hidden:0,  	Width:80,	Align:"Right",	ColMerge:0,   SaveName:"notax_nightduty_mon",KeyField:0,  CalcLogic:"",   Format:"Integer",	PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"외국인\n비과세",    	    Type:"AutoSum",		Hidden:1,  	Width:80,	Align:"Right",	ColMerge:0,   SaveName:"notax_forn_mon",   	KeyField:0,   CalcLogic:"",   Format:"Integer",	PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            {Header:"비과세계",				Type:"AutoSum",		Hidden:0,  	Width:110,	Align:"Right",	ColMerge:0,   SaveName:"notax_total",		KeyField:0,   CalcLogic:"",   Format:"Integer",	PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:35, CalcLogic:"|notax_work_mon|+|notax_abroad_mon|+|notax_food_mon|+|notax_car_mon|+|notax_forn_mon|+|notax_research_mon|+|notax_baby_mon|+|notax_train_mon|+|notax_nightduty_mon|+|notax_reporter_mon|+|notax_etc_mon|" },
			...
			{Header:"농특세",			    Type:"AutoSum",     Hidden:0,  	Width:100,	Align:"Right",  ColMerge:0,   SaveName:"rural_tax_mon",   	KeyField:0,   CalcLogic:"",   Format:"Integer",	PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
			...
			{Header:"기타소득_과세",				Type:"AutoSum",     Hidden:0, 	Width:110,	Align:"Right",	ColMerge:0,   SaveName:"tax_mon",   		KeyField:0,   CalcLogic:"",   Format:"Integer", PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
			{Header:"기타소득_비과세",				Type:"AutoSum",     Hidden:0, 	Width:110,	Align:"Right",	ColMerge:0,   SaveName:"notax_mon",   		KeyField:0,   CalcLogic:"",   Format:"Integer", PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
			{Header:"기타소득_비과세\n(미신고)",		Type:"AutoSum",     Hidden:0, 	Width:110,	Align:"Right",	ColMerge:0,   SaveName:"notax_mon2",   		KeyField:0,   CalcLogic:"",   Format:"Integer", PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 }
        ...
        initdata2.Cols = [
            {Header:"No",		Type:"<%=sNoTy%>",    Hidden:Number("<%=sNoHdn%>"),   Width:"<%=sNoWdt%>",  Align:"Center", ColMerge:0,   SaveName:"sNo" },
            {Header:"년도",		Type:"Text",      	Hidden:1,  Width:80,	Align:"Center",	ColMerge:0,   SaveName:"work_yy",   	KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"정산구분",	Type:"Combo",      	Hidden:0,  Width:50,	Align:"Center",	ColMerge:0,   SaveName:"adjust_type",   KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			...
			{Header:"소득구분명",	Type:"Combo",      	Hidden:0,  Width:90,	Align:"Center",	ColMerge:0,   SaveName:"adj_element_cd",KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"지급월",		Type:"Date",      	Hidden:0,  Width:70,	Align:"Center",	ColMerge:0,   SaveName:"ym",   			KeyField:0,   CalcLogic:"",   Format:"Ym",		PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:6 },
        ...
        case "Search":
			...
			sheet2.SetColProperty("adj_element_cd",    {ComboText:"|"+adjElementCdList[0], ComboCode:"|"+adjElementCdList[1]} );
			 ...
			 if(sheet1.GetSelectRow() < 1) {
				 $("#yearIncomeMgrEtcInfo").hide();
				var param = "cmd=selectYearIncomeEachMgrEtc&srchYear=&srchAdjustType=&srchSabun=";
    	...
    	try{
    		if(sheet1.GetSelectRow() > 0) {
    			if(OldRow != NewRow){
    				...
    				var param = "srchYear="+sheet1.GetCellValue(NewRow, "work_yy")
    				+"&srchAdjustType="+sheet1.GetCellValue(NewRow, "adjust_type")
    				+"&srchSabun="+sheet1.GetCellValue(NewRow, "sabun");

    				sheet2.DoSearch( "<%=jspPath%>/yearIncomeMgr/yearIncomeMgrRst.jsp?cmd=selectYearIncomeMgrEtc", param, 1 );
    			}
    		}
		...
		if(searchReCalcSeq == null || searchReCalcSeq == "" || searchReCalcSeq[0] == "") {
			$("#srchAdjustType").html("");
 			...
 			sheet1.SetColProperty("adjust_type", {ComboText:"|"+searchReCalcSeq[0]+"|원천징수부", ComboCode:"|"+searchReCalcSeq[1]+"|9"});
  			sheet2.SetColProperty("adjust_type", {ComboText:"|"+searchReCalcSeq[0]+"|원천징수부", ComboCode:"|"+searchReCalcSeq[1]+"|9"});
		}
	}
