...
<script type="text/javascript">
    ...
    $(function() {
        ...
        //작업구분
        var adjustTypeList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&searchYear=<%=yeaYear%>","YEA005"), "전체");
        $("#inputCdType").html(adjustTypeList[2]);
    ...
    $(function(){
    	...
    	initdata1.Cols = [
			...
			{Header:"제목",		Type:"Text",	Hidden:0,	Width:150,	Align:"Left",	ColMerge:0,	SaveName:"title",	    KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100, ToolTip:1 },
				...
				<table border="0" cellspacing="0" cellpadding="0"  class="sheet_main">
					...
					<tr>
						<td>
							...
							<table class="table none-line" style="width: 100%" id="htmlTable">
								<tr>
									<!-- <th>답변</th> -->
									<td class="none-line">
										<div class="inner" id="reply2" style="width: 100%; height: 100px; padding: 24px; overflow-y: auto; box-sizing: border-box; background: #f7f7f7;"></div>
