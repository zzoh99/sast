...
<!DOCTYPE html> <html class="hidden"><head> <title>PDF등록현황</title>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"정산구분",     Type:"Combo",        Hidden:0,   Width:120,   Align:"Center", ColMerge:1, SaveName:"adjust_type",     KeyField:0, Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
            ...
            {Header:"내용",         Type:"Text",        Hidden:0,   Width:400,  Align:"Left",   ColMerge:1, SaveName:"contents",        KeyField:0, Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:4000, MultiLineText: 1, EnterMode: 1 },
        ...
        formCdList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList","getPdfFormCdList") , "");
        sheet1.SetColProperty("status_cd",  {ComboText:"반영|미반영|오류|반영제외", ComboCode:"S|N|E|D"} );

        exceptGubun = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&searchYear=<%=yeaYear%>","C00346"), "");
        //반영제외자
    ...
    function doAction1(sAction, formCd) {
        ...
        case "Search":
            ...
            var param = "cmd=selectPdfRegMgr&"+$("#srchFrm").serialize();
