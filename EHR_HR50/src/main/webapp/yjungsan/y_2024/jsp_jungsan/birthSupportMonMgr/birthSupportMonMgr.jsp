...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"대상년도|대상년도",             Type:"Text",      Hidden:0,  Width:60,    Align:"Center",   ColMerge:0, SaveName:"work_yy",             KeyField:1,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
    ...
    function doAction1(sAction) {
        ...
        case "Down2Excel":
            ...
            break;
        case "Down2Template":
            var param  = {DownCols:"sabun|fam_nm|famres|sup_ymd|sup_mon|sup_cnt|regino|memo",SheetDesign:1,Merge:1,DownRows:'0|1',ExcelFontSize:"9"
