...
<script type="text/javascript">
	...
	function doAction1(sAction) {
		...
		case "Down2Template":
			...
			var param  = {DownCols:makeHiddenSkipCol(sheet1),SheetDesign:1,Merge:1,DownRows:0,FileName:'Template',SheetName:'sheet1',TitleText:titleText,UserMerge:"0,0,1,57", ExcelRowHeight:100 ,menuNm:$(document).find("title").text()};
