...
<script type="text/javascript">
    ...
    $(function() {
		...
		//영문출력 사용 여부
		var engPrintYn = ajaxCall("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&searchStdCd=CPN_YEA_ENG_PRINT_YN", "queryId=getSystemStdData",false).codeList;
