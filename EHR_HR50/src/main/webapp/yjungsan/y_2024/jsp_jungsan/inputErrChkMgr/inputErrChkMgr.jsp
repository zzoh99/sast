...
<!DOCTYPE html> <html class="hidden"><head> <title>공제자료오류검증</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"대상년도",		Type:"Text",		Hidden:0,	Width:40,	Align:"Center",	ColMerge:0,	SaveName:"work_yy",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4 },
			{Header:"정산구분",					Type:"Combo",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"adjust_type",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:10 },
			...
			{Header:"구분",		Type:"Text",		Hidden:0,	Width:80,	Align:"Left",	ColMerge:0,	SaveName:"chk_gubun",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
			...
			{Header:"결과유형\n(경고,확인필요 : 오류 X)\n(오류: 신고불가)",		Type:"Combo",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"chk_type",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
		...
		//결과유형
		<%-- var chkTypeList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&searchYear=<%=yeaYear%>", "R20070"), "전체" ); --%>
	...
	function sheet1_OnSearchEnd(Code, Msg, StCode, StMsg) {
		try {
			...
			for(var i = 1; i < sheet1.RowCount()+1; i++){
				var chkType = sheet1.GetCellValue(i, "chk_type");
				if(chkType == "E"){
					sheet1.SetRowBackColor(i, "#FFFFCC");
					sheet1.SetCellFontColor(i, "chk_gubun", "#EE0000");	//구분
					sheet1.SetCellFontColor(i, "chk_type", "#EE0000");	//결과유형
				}
			}
...
<div class="wrapper">
    ...
    <div class="outer">
        ...
        <ul>
            ...
            <li class="btn">
				<a href="javascript:openInputErrChkMgrPopup()" 	class="basic ico-popup authA">오류검증항목 보기</a>
				<a href="javascript:getErrorCheck()" 			class="basic btn-red authA">오류검증</a>
