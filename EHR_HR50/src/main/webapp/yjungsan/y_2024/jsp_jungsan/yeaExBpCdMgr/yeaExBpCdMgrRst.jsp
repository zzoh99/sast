  ...
  if(list != null && list.size() > 0 && conn != null) {
      ...
      try{
          ...
          for(int i = 0; i < list.size(); i++ ) {
              ...
              // 25.03.19 사업장예외관리 화면 수정, 삭제 작업시 각 ROW 데이터의 정산 구분 값(adjust_type)을 기준으로 처리하도록 수정
              ...
              if((String)mp.get("adjust_type") 	!= null){	adjust_type = (String)mp.get("adjust_type");} else adjust_type = "";
              ...
              if("D".equals(sStatus) && !"0".equals(sDelete)) {
    	          ...
    	          setQuery.append("\n 				                     , TRIM('"+adjust_type+"') AS ADJUST_TYPE");
    	          setQuery.append("\n 				                     , TRIM('"+sabun+"') AS SABUN");
    	          setQuery.append("\n 				                     , NVL(TRIM('"+std_bp_cd+"')");
    	          setQuery.append("\n 				                          , (SELECT MAX(BUSINESS_PLACE_CD)" +
						  														"  FROM TCPN811" +
