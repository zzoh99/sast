...
<!--   STYLE	 -->
<link rel="stylesheet" href="../../../common_jungsan/css/font.css" />
<link rel="stylesheet" href="../../../common_jungsan/theme1/css/style_new.css" />
<link rel="stylesheet" href="../../../common_jungsan/theme1/css/pdfUpload.css" />
<!--   JQUERY	 -->
...
<!-- PDF File Download-->
<script src="../../../common_jungsan/js/jquery/jquery.fileDownload.js" type="text/javascript" charset="<%=StringUtil.getPropertiesValue("SYS.ENC")%>"></script>
<!--  COMMON SCRIT -->
<script type="text/javascript">
<!--

<%
	String tmpSysVer = StringUtil.getPropertiesValue("SYS.VERSION") ;

	if (tmpSysVer == null || "".equals(tmpSysVer)) {
		tmpSysVer = "2";			
	} else {
		tmpSysVer = StringUtil.removeXSS(tmpSysVer);
