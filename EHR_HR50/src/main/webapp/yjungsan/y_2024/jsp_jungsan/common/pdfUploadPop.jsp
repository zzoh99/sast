    ...
    <div class="wrapper">
		...
		<div class="outer">
			<table>
				...
				<tr>
					<td style="padding:10px 5px 5px 5px;">&nbsp;&nbsp;<font class="red">* 국세청 연말정산간소화서비스 사이트에서 아래의 이미지에 해당하는 PDF를 다운로드 하셔서 등록하시기 바랍니다.</font></td>
				</tr>
				<tr>
				...
				<tr>
					<td style="padding:20px 5px 5px 5px;">
						<table style="width:100%;">
							<tr>
								<td>&nbsp;&nbsp;<font class="red">* PDF 자료를 국세청에서 다운받을 때 비밀번호를 설정하였을 경우, 해당 비밀번호를 입력하셔야 합니다.</font></td>
			...
			<ul>
				<li class="txt"><font class="red">PDF 자료를 국세청에서 다운받을 때 비밀번호를 설정하였을 경우, 해당 비밀번호를 입력하셔야 합니다.</font></li>
			</ul>
			<ul align="right">
				<li class="txt">비밀번호:<input type="text" id="paramPwd" name="paramPwd" value=""/></li>
			</ul>
			<ul>
				<li class="txt"><font class="red">찾아보기 버튼을 클릭하여 PDF파일을 선택하신 후, 업로드 버튼을 클릭하여 주시기 바랍니다.</font></li>
			</ul>
			<ul>
				<li class="txt">
