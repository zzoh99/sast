...
<!DOCTYPE html> <html class="hidden"><head> <title>개인별인적공제현황</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"정산구분",				Type:"Combo",      	Hidden:0,  Width:85,    Align:"Center", 	ColMerge:1,   SaveName:"adjust_type",		KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			...
			{Header:"작년기본공제유무",			Type:"Text",      	Hidden:0,  Width:100,    Align:"Center", 	ColMerge:1,   SaveName:"last_dpndnt_yn",			KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			...
			{Header:"장애여부",			Type:"Text",      	Hidden:0,  Width:80,    Align:"Center", 	ColMerge:1,   SaveName:"hndcp_yn",			KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			...
			{Header:"결혼세액공제",		Type:"Text",      	Hidden:0,  Width:80,    Align:"Center", 	ColMerge:1,   SaveName:"wed_ded_yn",		KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
	...
	$(function() {
		...
		$("#searchWorkYy,#searchSbNm").change(function(){
	        getCprBtnChk();
			doAction1("Search");
		});*/
...
<div class="wrapper">
    ...
    <div class="outer">
        ...
        <ul>
			<li id="txt" class="txt">개인별인적공제현황</li>
			<li class="btn">
