...
<%!
	//연말정산 사업자 단위과세자 조회
	public List selectBranchOptionList(Map paramMap, String locPath) throws Exception {
	...
	//연말정산 사업자 단위과세자 저장.
	public int saveBranchOption(Map paramMap, String locPath) throws Exception {
...
<%
	...
	if ("selectBranchOptionList".equals(cmd)) {
		...
		try {
			listData = selectBranchOptionList(mp, locPath);
		} catch (Exception e) {
			code = "-1";
		...
		try {
			int cnt = saveBranchOption(mp, locPath);
