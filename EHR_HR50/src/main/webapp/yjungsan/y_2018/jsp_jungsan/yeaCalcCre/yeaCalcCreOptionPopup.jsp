	...
	function shtToCtl(){		 
		if(sheet1.RowCount() > 0){
			for (i = 1; i < sheet1.RowCount()+1; i++){
				...
				} else if(sheet1.GetCellValue(i,"std_cd")=="CPN_YEA_HOU_INFO_YN"){   //1주택 신청 사용 여부
	...
	<div class="wrapper">
		...
		<div>
			<table border="0" cellpadding="0" cellspacing="0" class="default outer">
				...
				<tr>
					<td class="left">
						<b>[공시지가 및 전용면적 사용여부]</b><br>
						&nbsp;자료등록 기본_주소사항 탭에서 공시지가 및 전용면적 사용여부 옵션을 사용할수 있습니다.(자료등록(관리자)에는 영향을 미치지 않습니다.)<br>
						&nbsp;YES : 1주택 신청을 오픈하여 사용합니다.<br>
						&nbsp;NO : 1주택 신청을 숨깁니다.<br>
					</td>
					<td align="left">
