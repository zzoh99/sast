...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
            ...
            {Header:"저축구분",					Type:"Combo",       Hidden:0,   Width:60,   Align:"Left",   ColMerge:1, SaveName:"saving_deduct_type",  KeyField:1, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
            ...
            {Header:"가입일자",                  Type:"Date",       Hidden:0,   Width:60,   Align:"Center",   ColMerge:1, SaveName:"reg_dt",      KeyField:0, Format:"Ymd",  PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:8 },
            ...
            {Header:"납입횟수",                  Type:"Int",       Hidden:1,   Width:60,   Align:"Left",   ColMerge:1, SaveName:"paying_num_cd",       KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
