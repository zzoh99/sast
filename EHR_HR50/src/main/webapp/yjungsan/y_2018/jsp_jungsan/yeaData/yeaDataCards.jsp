	...
	function card_type_chk(shtObj, Row, gubun) {
		...
		// 신용카드구분이 2013 일 경우(명의인:본인, 반기구분:2013 전체)
			...
			if ( shtObj.GetCellValue(Row, "famres") != gOwnFamCd 
				...
				if ( gubun == "OnChange" ) {
					shtObj.SetCellValue(Row, "famres", gOwnFamCd) ;
					shtObj.SetCellValue(Row, "half_gubun", "30") ;
				}
				return false;
			}
			return true;
...
<script type="text/javascript">
	function load_sheet1() {
		...
		initdata1.Cols = [
			...
			{Header:"신용카드|신용카드",			    Type:"AutoSum",	Hidden:0,   Width:60,   Align:"Center",   ColMerge:1, SaveName:"card_amt",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"현금영수증|현금영수증",				Type:"AutoSum",	Hidden:0,   Width:60,   Align:"Center",   ColMerge:1, SaveName:"cash_amt",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"직불카드등|직불카드등",				Type:"AutoSum",	Hidden:0,   Width:80,  	Align:"Center",   ColMerge:1, SaveName:"check_amt",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"도서공연사용분|신용카드",			Type:"AutoSum",	Hidden:0,   Width:60,   Align:"Center",   ColMerge:1, SaveName:"bookcard_amt",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"도서공연사용분|직불카드",			Type:"AutoSum",	Hidden:0,   Width:60,   Align:"Center",   ColMerge:1, SaveName:"bookcheck_amt",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"도서공연사용분|현금영수증",			Type:"AutoSum",	Hidden:0,   Width:60,   Align:"Center",   ColMerge:1, SaveName:"bookchash_amt",		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"전통시장사용분|전통시장사용분",			Type:"AutoSum",	Hidden:0,   Width:80,   Align:"Center",   ColMerge:1, SaveName:"market_amt",	KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"대중교통이용분|대중교통이용분",			Type:"AutoSum",	Hidden:0,   Width:80,   Align:"Center",   ColMerge:1, SaveName:"bus_amt",	    KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"사업관련비용|사업관련비용",			Type:"AutoSum",	Hidden:0,   Width:60,	Align:"Center",   ColMerge:1, SaveName:"business_amt",  KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"합계|합계",				    Type:"AutoSum",	Hidden:0,   Width:60,	Align:"Center",   ColMerge:1, SaveName:"tot_amt",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"추가공제율사용분",				Type:"Int",		Hidden:1,   Width:60,	Align:"Center",   ColMerge:1, SaveName:"add_amt",       KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"추가공제율사용분\n담당자 입력",		Type:"Int",		Hidden:1,   Width:60,	Align:"Center",   ColMerge:1, SaveName:"admin_add_mon", KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 }
...
<script type="text/javascript">
	...
	function load_sheet2() {
		...
		initdata1.Cols = [
			...
			{Header:"금액자료|직원용",				Type:"AutoSum",	    Hidden:0,   Width:110,  Align:"Right",  ColMerge:0, SaveName:"use_mon",		    KeyField:0, Format:"#,###",  PointCount:0,   UpdateEdit:<%=inputEdit%>,   InsertEdit:<%=inputEdit%>,   EditLen:35, MinimumValue: 0 },
			{Header:"금액자료|담당자용",			Type:"AutoSum",	    Hidden:0,   Width:110,  Align:"Right",  ColMerge:0, SaveName:"appl_mon",		KeyField:1, Format:"#,###",  PointCount:0,   UpdateEdit:<%=applEdit%>,	InsertEdit:<%=applEdit%>,	EditLen:35, MinimumValue: 0 },
	...
	//		 var info =[{StdCol:"card_type", SumCols:sumColsInfo, ShowCumulate:0, CaptionCol:3}];
		...
		case "Down2Template":
			...
			var DownCols = "";
			if ( $("#searchYyType").val() == "0" || $("#searchYyType").val() == "-99") {
				DownCols = "7|8|9"+monTmp+"|16"+feedbackTmp;
			} else {
				DownCols = "8|9"+monTmp+"|16"+feedbackTmp;
			}
			
			var param  = {DownCols:DownCols, SheetDesign:1,Merge:1,DownRows:'0|1',ExcelFontSize:"9"
				,TitleText:templeteTitle2,UserMerge :"0,0,1,5"};
			sheet2.Down2Excel(param); 
			break;
...
<div class="wrapper">
	...
	<div class="outer">
		...
		<ul>
			<li class="txt"><span name="toYear" style="font-weight:bold;">2018</span> 신용카드<span class="txt"> ※ 총급여 25% 미만의 연간 총액은 공제금액이 발생하지 않습니다.(도서공연사용분은 총급여 7천 이하자만 별도공제됨)</span>
			...
			<a href="#layerPopup" class="cute_gray" id="InfoPlus"><b>신용카드 안내+</b></a>
	        <a href="#layerPopup" class="cute_gray" id="InfoMinus" style="display:none"><b>신용카드 안내-</b></a>
			</li>
		</ul>
		</div>
