		...
		<div class="openYeaDataPerBef_main" id="openYeaDataPerBef_main" style="display:none;">
			<div class="sheet_title" id="openYeaDataPerBef">
				<ul>
				    ...
				    <li class="btn">
				    	<a href="#" class="button authA" id="buttonPlus2"><b id="authText2">과거 인적공제 현황+</b></a>
			        	<a href="#" class="button authA" id="buttonMinus2" style="display:none"><b id="authText3">과거 인적공제 현황-</b></a>
				    </li>
				</ul>
			</div>
    ...
    <div class="outer">
        ...
        <ul>
            ...
            <li class="btn">
	            ...
	            <a href="#" class="button authA" id="buttonPlus"><b>과거 인적공제 현황+</b></a>
	            <a href="#" class="button authA" id="buttonMinus" style="display:none"><b>과거 인적공제 현황-</b></a>
