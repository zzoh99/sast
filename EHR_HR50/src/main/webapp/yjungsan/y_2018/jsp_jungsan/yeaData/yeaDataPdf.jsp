...
<div class="wrapper" id="topNav">
	...
	<div class="outer" id="infoLayer" style="display:none">
		<table>
			...
			<tr>
				<td style="padding:5px;"><img src="../../../common_jungsan/images/common/pdf_popup_2018.jpg" border="0" style="vertical-align:middle;width:100%;height:100%"></td>
			</tr>
			<tr>
		...
		<div class="sheet_title">
			...
			<ul>
				<li class="btn">
					...
					<a href="#" class="blue authA" id="buttonPlus"><b>PDF 등록+</b></a>
		            <a href="#" class="blue authA" id="buttonMinus" style="display:none"><b>PDF 등록-</b></a>
