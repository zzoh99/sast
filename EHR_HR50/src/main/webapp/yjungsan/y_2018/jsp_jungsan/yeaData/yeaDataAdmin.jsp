					...
					<table>
						<tr>
							<td>
								...
								<a href="#" class="cute" id="buttonPlusNt"><b>특이사항+</b></a>
	            				<a href="#" class="cute" id="buttonMinusNt" style="display:none"><b>특이사항-</b></a>
								<span id="span_feedback" style="margin-left:2px;"></span>
								<a href="#" class="button authA" id="buttonPlus"><b>담당자 피드백+</b></a>
	            				<a href="#" class="button authA" id="buttonMinus" style="display:none"><b>담당자 피드백-</b></a>
							</td>
							<td>
