...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"수련보조수당비과세",                    Type:"AutoSum",     Hidden:0,   Width:100,  Align:"Right",  ColMerge:0, SaveName:"notax_etc_mon",       KeyField:0, Format:"Integer",   PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 }
