...
//연말정산 기타소득 검색
public List selectPdfRegMgr(Map paramMap, String locPath) throws Exception {
...
//연말정산 기타소득 저장.
public int savePdfRegMgr(Map paramMap, String orgAuthPg, String locPath) throws Exception {
...
<%
	...
	if("search".equals(cmd)) {
		...
		try {
			listData = selectPdfRegMgr(mp, locPath);
		} catch(Exception e) {
			code = "-1";
...
//pdf 파일 상세 저장.
        ...
        try {
            int cnt = savePdfRegMgr(paramMap, orgAuthPg, locPath);
