...
<script type="text/javascript">
    ...
    $(function() {  
        ...
        initdata.Cols = [
                        ...
                        {Header:"수련보조수당비과세_현",                     Type:"AutoSum",         Hidden:0,  Width:100,    Align:"Right",     ColMerge:1,   SaveName:"notax_etc_mon",		         KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
