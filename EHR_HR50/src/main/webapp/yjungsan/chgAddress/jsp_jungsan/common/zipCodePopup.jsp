...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"영문주소",		Type:"Text", Hidden:1,  Width:200,Align:"Left",    SaveName:"juso_e",    EditLen:200 },
			...
			{Header:"도로명영문",		Type:"Text", Hidden:1,  Width:0,  Align:"Left",    SaveName:"roadName_e",EditLen:20 },
			...
			{Header:"우편번호일련번호6",	Type:"Text", Hidden:1,  Width:0,  Align:"Left",    SaveName:"old_zipcode_no",  EditLen:20 }
	...
	function doAction(sAction) {
		...
		case "Search": //조회
			//조회 조건 체크
			if( searchNameCheck($("#searchWord").val())){
						...
						<div class="outer">
							<table>
								<tr>
									...
									1. 도로명주소 검색시 "<B>도로명/건물명 통합검색</B>" 선택 후 도로명/건물명 입력 <B>예)</B> 사평대로 84, 남부순환로 2406, 예술의전당<br/>
									2. 지번주소 검색시 "<B>지번주소로 도로명주소 찾기</B>" 선택 후 지번주소 입력 <B>예)</B> 반포동 112-4, 서초동 700, 덕동리 산90-1<br/>
