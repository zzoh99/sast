...
<!DOCTYPE html> <html class="hidden"><head> <title>사업소득 업로드</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		// 업종코드(C00508)
		var businessCd = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList&searchYM=","C00508"), "");
		sheet1.SetColProperty("business_cd", {ComboText:"|"+businessCd[0], ComboCode:"|"+businessCd[1]});

		sheet1.SetColProperty("tax_rate", 	{ComboText:"|3|5", ComboCode:"|3|5"}	);
	...
	function doAction1(sAction) {
		...
		case "Save":
			...
			sheet1.DoSave( "<%=jspPath%>/bizIncomeMgr/bizIncomeMgrRst.jsp?cmd=saveBizIncomeMgrPopup", "",-1,0 );
			break;
        case "Down2Excel":
