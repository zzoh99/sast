...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata1.Cols = [                                                                                                                                                                                                                            
            ...
            {Header:"소득구분",    		Type:"Text",    Hidden:1,  Width:100,  Align:"Center",      ColMerge:0,   SaveName:"earn_cd", 	        	KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
            {Header:"소득상세코드",    		Type:"Text",    Hidden:1,  Width:100,  Align:"Center",      ColMerge:0,   SaveName:"earn_dtl", 	        	KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
            {Header:"소득상세",    		Type:"Text",    Hidden:1,  Width:100,  Align:"Center",      ColMerge:0,   SaveName:"earn_dtl_nm", 	      	KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
            {Header:"과세표준금액",	 	  	Type:"AutoSum",     Hidden:0,  Width:100,  Align:"Right",       ColMerge:0,   SaveName:"tax_std_mon",       KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
            {Header:"지방소득세",			Type:"AutoSum",     Hidden:0,  Width:100,  Align:"Right",       ColMerge:0,   SaveName:"rtax_mon",  	    KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 }                      
        ...
        if($("#searchEarnCd").val() == "1"){
        	sheet1.SetColHidden("earn_dtl_nm", 1);
        	$("#searchEarnDtl").hide();
        }else{
        	sheet1.SetColHidden("earn_dtl_nm", 0);
        	$("#searchEarnDtl").show();
        }
    ...
    function doAction1(sAction) {
        switch (sAction) {
        case "Search":      //조회
            sheet1.DoSearch("<%=jspPath%>/earnIncomeTaxMgr/earnIncomeTaxMgrRst.jsp?cmd=getEarnIncomeTaxMgrDtl2EmpPopupList", $("#sheetForm").serialize() );
            break;
        case "Down2Excel":
...
<form id="sheetForm" name="sheetForm" >
    ...
    <input type="hidden" id="searchEarnCd" name="searchEarnCd" value="" />
    <div class="wrapper">
                        ...
                        <div class="outer">
                            <div class="sheet_title">
                                <ul>
                                    ...
                                    <li class="btn">
                                    	<span>소득상세</span>
										<select id="searchEarnDtl" name="searchEarnDtl" onChange="javascript:doAction1('Search')">
											<option value="">전체</option>
											<option value="2">간이세액</option>
											<option value="3">중도퇴사</option>
											<option value="4">일용근로</option>
										</select>
                                        <span>사번/성명</span>
