...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if( arg != undefined ) {
            ...
            $("#searchTaxEleCd").val(arg["tax_ele_cd"]);
        ...
        initdata1.Cols = [                                                                                                                                                                                                                            
            ...
            {Header:"항목코드",       		Type:"Text",    Hidden:1,  Width:100,  Align:"Center",      ColMerge:0,   SaveName:"tax_ele_cd",         	KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
            {Header:"총지급액",       		Type:"AutoSum",     Hidden:0,  Width:100,  Align:"Right",       ColMerge:0,   SaveName:"payment_mon",           KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
            {Header:"징수세액\n소득세등",   	Type:"AutoSum",     Hidden:0,  Width:100,  Align:"Right",       ColMerge:0,   SaveName:"paye_itax_mon",         KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
            {Header:"징수세액\n농특세",		Type:"AutoSum",     Hidden:0,  Width:100,  Align:"Right",       ColMerge:0,   SaveName:"paye_atax_mon",         KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 }                      
    ...
    function doAction1(sAction) {
        switch (sAction) {
        case "Search":      //조회
            sheet1.DoSearch("<%=jspPath%>/earnIncomeTaxMgr/earnIncomeTaxMgrRst.jsp?cmd=getEarnIncomeTaxMgrDtl1Tab1EmpPopupList", $("#sheetForm").serialize() );
            break;
        case "Down2Excel":
...
<form id="sheetForm" name="sheetForm" >
    ...
    <input type="hidden" id="searchTaxEleCd" name="searchTaxEleCd" value="">
    <div class="wrapper">
