...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"Location",	Type:"Combo",			Hidden:0,	Width:20,				Align:"Center",	ColMerge:0,	SaveName:"location_cd", 	UpdateEdit:0 },
		...
		// Location(TSYS015)
		var locationCd = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList", "getLocationCdAllList") , "");
    ...
    <div class="wrapper">
        ...
        <div class="popup_main">
            <form id="srchFrm" name="srchFrm">
                ...
                <input type="hidden" id="searchStatusCd" name="searchStatusCd" value="X"/>
                ...
                <div class="sheet_search outer">
                    ...
                    <tr>
                        ...
                        <td id = "chkArea1"> <input name="searchStatusRadio" onchange="$('#searchStatusCd').val('X');" checked="checked" type="radio"  class="radio"/> 임직원 제외</td>
                        <td id = "chkArea2"> <input name="searchStatusRadio" onchange="$('#searchStatusCd').val('A');" type="radio" class="radio"/> 임직원 포함</td>
                        <td>
