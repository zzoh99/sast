...
<script type="text/javascript">
	$(function(){
	    ...
	    if(printButtonYn[0].code_nm == "") {
			...
			if( printButtonYn[0].code_nm == "1" ) {
				$("#cpnIncomePrintYn").show() ;
			} else if( printButtonYn[0].code_nm == "0" ) {
				$("#cpnIncomePrintYn").hide() ;
			}
		}
	...
	function sht2ToCtl(){
		if(sheet2.RowCount() > 0){
			...
			$("#sht2_PreNotaxWorkMon").val( sheet2.GetCellText(1, "curr_notax_work_mon"));//종전근무지야간근로수당비과세
	...
	function sht5ToCtl(){
		if(sheet5.RowCount() > 0){
			$("#sht5_A000_01").val( sheet5.GetCellText(1, "a000_01") );//근로소득공제
			$("#sht5_A010_01").val( sheet5.GetCellText(1, "a010_01"));//본인기본공제
			$("#sht5_A010_03").val( sheet5.GetCellText(1, "a010_03"));//배우자공제
			$("#sht5_A010_11_CNT").val( sheet5.GetCellText(1, "a010_11_cnt"));//부양가족인원수
			$("#sht5_A010_11").val( sheet5.GetCellText(1, "a010_11"));//부양가족공제
			$("#sht5_A020_04").val( sheet5.GetCellText(1, "a020_04"));//경로우대공제
			$("#sht5_A020_05").val( sheet5.GetCellText(1, "a020_05"));//장애자공제
			$("#sht5_A020_07").val( sheet5.GetCellText(1, "a020_07"));//부녀자공제
			$("#sht5_A020_09").val( sheet5.GetCellText(1, "a020_09"));//자녀양육공제
			$("#sht5_A020_11").val( sheet5.GetCellText(1, "a020_11"));//다자녀추가공제
			$("#sht5_A020_12").val( sheet5.GetCellText(1, "a020_12"));//다자녀추가공제
			$("#sht5_A030_01").val( sheet5.GetCellText(1, "a030_01"));//국민연금보험료공제
			$("#sht5_A030_02").val( sheet5.GetCellText(1, "a030_02"));//기타연금보험료공제
			$("#sht5_A040_03").val( sheet5.GetCellText(1, "a040_03"));//보험료공제-건강보험료
	        $("#sht5_A040_04").val( sheet5.GetCellText(1, "a040_04"));//보험료공제-고용보험료
	        $("#sht5_A040_05").val( sheet5.GetCellText(1, "a040_05"));//보험료공제-보장성보험
	        $("#sht5_A040_07").val( sheet5.GetCellText(1, "a040_07"));//보험료공제-장애인전용
			$("#sht5_A070_14").val( sheet5.GetCellText(1, "a070_14"));//임차차입금 원리금공제(대출기관)
			$("#sht5_A070_21").val( sheet5.GetCellText(1, "a070_21"));//임차차입금 원리금공제(거주자)
			$("#sht5_A070_17").val( sheet5.GetCellText(1, "a070_17"));//장기주택저당차입금이자상환액입금(2011년 이전(15년미만)                )
			$("#sht5_A070_15").val( sheet5.GetCellText(1, "a070_15"));//장기주택저당차입금이자상환액입금(2011년 이전(15년~29년)               )
			$("#sht5_A070_16").val( sheet5.GetCellText(1, "a070_16"));//장기주택저당차입금이자상환액입금(2011년 이전(30년이상)                )
			$("#sht5_A070_22").val( sheet5.GetCellText(1, "a070_22"));//장기주택저당차입금이자상환액입금(2012년 이후(고정금리/비거치상환 대출))
			$("#sht5_A070_23").val( sheet5.GetCellText(1, "a070_23"));//장기주택저당차입금이자상환액입금(2012년 이후(기타 대출)               )
			$("#sht5_A100_03").val( sheet5.GetCellText(1, "a100_03"));//개인연금저축공제  
			$("#sht5_A100_07").val( sheet5.GetCellText(1, "a100_07"));//투조출자공제 
			$("#sht5_A100_21").val( sheet5.GetCellText(1, "a100_21"));//우리사주공제
			$("#sht5_A100_23").val( sheet5.GetCellText(1, "a100_23"));//신용카드공제   
			$("#sht5_A100_30").val( sheet5.GetCellText(1, "a100_30"));//소기업소상공인   
			$("#sht5_A100_37").val( sheet5.GetCellText(1, "a100_37"));//임금삭감액공제   
			$("#sht5_B000_01").val( sheet5.GetCellText(1, "b000_01"));//근로세액공제
			$("#sht5_B010_01").val( sheet5.GetCellText(1, "b010_01"));//납세조합공제
			$("#sht5_B010_03").val( sheet5.GetCellText(1, "b010_03"));//주택자금세액공제
			$("#sht5_B010_05").val( sheet5.GetCellText(1, "b010_05"));//기부금세액공제 
			$("#sht5_B010_07").val( sheet5.GetCellText(1, "b010_07"));//외국납부공제			
	        $("#sht5_B010_14").val( sheet5.GetCellText(1, "b010_14"));//소득세법		               
	        $("#sht5_B010_15").val( sheet5.GetCellText(1, "b010_15"));//조세특례제한법(제30조 제외)
	        $("#sht5_B010_16").val( sheet5.GetCellText(1, "b010_16"));//조세특례제한법 제30조		   
	        $("#sht5_B010_17").val( sheet5.GetCellText(1, "b010_17"));//조세조약		               
	        $("#sht5_B010_14_INP").val( sheet5.GetCellText(1, "b010_14_inp"));  	//소득세법		               
	        $("#sht5_B010_15_INP").val( sheet5.GetCellText(1, "b010_15_inp"));  	//조세특례제한법(제30조 제외)
	        $("#sht5_B010_16_INP").val( sheet5.GetCellText(1, "b010_16_inp"));  	//조세특례제한법 제30조		   
	        $("#sht5_B010_17_INP").val( sheet5.GetCellText(1, "b010_17_inp"));  	//조세조약		               
	        $("#sht5_B010_13").val( sheet5.GetCellText(1, "b010_13"));			//세액감면 계		             
			$("#sht5_A020_03_CNT").val( sheet5.GetCellText(1,"a020_03_cnt"));		//경로우대인원수
			$("#sht5_A020_05_CNT").val( sheet5.GetCellText(1,"a020_05_cnt"));		//장애인원수
			$("#sht5_A020_09_CNT").val( sheet5.GetCellText(1,"a020_09_cnt"));		//자녀양육비인원수
			$("#sht5_A020_12_CNT").val( sheet5.GetCellText(1,"a020_12_cnt"));		//출산입양인원수
			$("#sht5_A020_11_CNT").val( sheet5.GetCellText(1,"a020_11_cnt"));		//다자녀인원수
			$("#sht5_A030_01_INP").val( sheet5.GetCellText(1,"a030_01_inp"));		//국민연금보험료
			$("#sht5_A030_02_INP").val( sheet5.GetCellText(1,"a030_02_inp"));		//기타연금보험료
			$("#sht5_A040_03_INP").val( sheet5.GetCellText(1,"a040_03_inp"));				//건강보험공제
			$("#sht5_A040_04_INP").val( sheet5.GetCellText(1,"a040_04_inp"));				//고용보험공제
			$("#sht5_A040_05_INP").val( sheet5.GetCellText(1,"a040_05_inp"));				//보장성보험공제
			$("#sht5_A040_07_INP").val( sheet5.GetCellText(1,"a040_07_inp"));				//장애인전용보험공제
			$("#sht5_A070_13").val( sheet5.GetCellText(1,"a070_13"));				//주택임차차입금원리금상환액(대출기관)
			$("#sht5_A070_19").val( sheet5.GetCellText(1,"a070_19"));				//주택임차차입금원리금상환액(거주자)
			$("#sht5_A070_10_INP").val( sheet5.GetCellText(1,"a070_10_inp"));		//월세액
			$("#sht5_A070_10").val( sheet5.GetCellText(1,"a070_10"));				//월세액공제
			$("#sht5_A070_17_INP").val( sheet5.GetCellText(1,"a070_17_inp"));		//이자상환액(차입금상환기간 2011년 이전(15년미만)                )
			$("#sht5_A070_15_INP").val( sheet5.GetCellText(1,"a070_15_inp"));		//이자상환액(차입금상환기간 2011년 이전(15년~29년)               )
			$("#sht5_A070_16_INP").val( sheet5.GetCellText(1,"a070_16_inp"));		//이자상환액(차입금상환기간 2011년 이전(30년이상)                )
			$("#sht5_A070_22_INP").val( sheet5.GetCellText(1,"a070_22_inp"));		//이자상환액(차입금상환기간 2012년 이후(고정금리/비거치상환 대출))
			$("#sht5_A070_23_INP").val( sheet5.GetCellText(1,"a070_23_inp"));		//이자상환액(차입금상환기간 2012년 이후(기타 대출)               )
			$("#sht5_A099_01").val( 	sheet5.GetCellText(1,"a099_01"));			//표준공제
			$("#sht5_A100_03_INP").val( sheet5.GetCellText(1,"a100_03_inp"));		//개인연금저축소득
			$("#sht5_A100_30_INP").val( sheet5.GetCellText(1,"a100_30_inp"));		//소기업·소상공인 공제부금
			$("#sht5_A100_34").val( sheet5.GetCellText(1,"a100_34"));				//주택청약저축
			$("#sht5_A100_31").val( sheet5.GetCellText(1,"a100_31"));				//주택청약종합저축
			$("#sht5_A100_33").val( sheet5.GetCellText(1,"a100_33"));				//근로자주택마련저축
			$("#sht5_A100_34_INP").val( sheet5.GetCellText(1,"a100_34_inp"));				//주택청약저축
			$("#sht5_A100_31_INP").val( sheet5.GetCellText(1,"a100_31_inp"));				//주택청약종합저축
			$("#sht5_A100_33_INP").val( sheet5.GetCellText(1,"a100_33_inp"));				//근로자주택마련저축
	        $("#sht5_A100_11").val( sheet5.GetCellText(1,"a100_11"));             //투자조합출자(2011년 이전 출자)
	        $("#sht5_A100_08").val( sheet5.GetCellText(1,"a100_08"));             //투자조합출자(2012년 이후 출자(벤처기업 투자분 제외)) 
	        $("#sht5_A100_10").val( sheet5.GetCellText(1,"a100_10"));             //투자조합출자(2012년 이후 출자(벤처기업 투자분))
			$("#sht5_A100_15").val( sheet5.GetCellText(1,"a100_15"));				//신용카드
			$("#sht5_A100_13").val( sheet5.GetCellText(1,"a100_13"));				//현금영수증
			$("#sht5_A100_22").val( sheet5.GetCellText(1,"a100_22"));				//전통시장사용분
			$("#sht5_A100_14").val( sheet5.GetCellText(1,"a100_14"));				//직불(선불)카드
			$("#sht5_A100_17").val( sheet5.GetCellText(1,"a100_17"));				//사업관련비용
			$("#sht5_A100_21_INP").val( sheet5.GetCellText(1,"a100_21_inp"));		//우리사주조합출연금
			$("#sht5_A100_37_INP").val( sheet5.GetCellText(1,"a100_37_inp"));		//고용유지중소기업근로자
			$("#sht5_A100_99").val( sheet5.GetCellText(1,"a100_99"));			//그밖의소득공제계
			$("#sht5_B010_01_INP").val( sheet5.GetCellText(1,"b010_01_inp"));		//납세조합공제
			$("#sht5_B010_03_INP").val( sheet5.GetCellText(1,"b010_03_inp"));		//주택자금이자
			$("#sht5_B010_05_INP").val( sheet5.GetCellText(1,"b010_05_inp"));		//정치자금기부금
			$("#sht5_B010_09").val( sheet5.GetCellText(1,"b010_09"));				//국외근로소득
			$("#sht5_B010_11").val( sheet5.GetCellText(1,"b010_11"));				//외국납부세액
			
			$("#sht5_A020_14").val( sheet5.GetCellText(1,"a020_14"));
			$("#sht5_A030_04").val( sheet5.GetCellText(1,"a030_04"));
			$("#sht5_A030_04_INP").val( sheet5.GetCellText(1,"a030_04_inp"));
			$("#sht5_A030_03").val( sheet5.GetCellText(1,"a030_03"));
			$("#sht5_A030_03_INP").val( sheet5.GetCellText(1,"a030_03_inp"));
			$("#sht5_A100_05").val( sheet5.GetCellText(1,"a100_05"));
			$("#sht5_A100_05_INP").val( sheet5.GetCellText(1,"a100_05_inp"));
			$("#sht5_A050_20").val( sheet5.GetCellText(1,"a050_20"));
			$("#sht5_A050_21").val( sheet5.GetCellText(1,"a050_21"));
			$("#sht5_A060_20").val( sheet5.GetCellText(1,"a060_20"));
			$("#sht5_A060_21").val( sheet5.GetCellText(1,"a060_21"));
			$("#sht5_A100_09").val( sheet5.GetCellText(1,"a100_09"));
			$("#sht5_A100_12").val( sheet5.GetCellText(1,"a100_12"));
			$("#sht5_A100_16").val( sheet5.GetCellText(1,"a100_16"));
			$("#sht5_A100_38").val( sheet5.GetCellText(1,"a100_38"));
			$("#sht5_A100_38_INP").val( sheet5.GetCellText(1,"a100_38_inp"));
			$("#sht5_A080_05").val( sheet5.GetCellText(1,"a080_05"));
			$("#sht5_A080_03").val( sheet5.GetCellText(1,"a080_03"));
			$("#sht5_A080_09").val( sheet5.GetCellText(1,"a080_09"));
			$("#sht5_A080_10_11").val( sheet5.GetCellText(1,"a080_10_11"));
			$("#sht5_A099_02").val( sheet5.GetCellText(1,"a099_02"));
			
			$("#sht5_A030_11").val( sheet5.GetCellText(1,"a030_11"));
			$("#sht5_A030_12").val( sheet5.GetCellText(1,"a030_12"));
			$("#sht5_A030_02").val( sheet5.GetCellText(1,"a030_02"));
			$("#sht5_A030_13").val( sheet5.GetCellText(1,"a030_13"));
			$("#sht5_A030_11_INP").val( sheet5.GetCellText(1,"a030_11_inp"));
			$("#sht5_A030_12_INP").val( sheet5.GetCellText(1,"a030_12_inp"));
			$("#sht5_A030_02_INP").val( sheet5.GetCellText(1,"a030_02_inp"));
			$("#sht5_A030_13_INP").val( sheet5.GetCellText(1,"a030_13_inp"));
			...
			$("#sht5_A030_01").val( "0");
			$("#sht5_A030_02").val( "0");
			$("#sht5_A040_03").val( "0");//보험료공제-건강보험료
	        $("#sht5_A040_04").val( "0");//보험료공제-고용보험료
	        $("#sht5_A040_05").val( "0");//보험료공제-보장성보험
	        $("#sht5_A040_07").val( "0");//보험료공제-장애인전용
			$("#sht5_A050_01").val( "0");
			$("#sht5_A060_01").val( "0");
			$("#sht5_A070_14").val( "0");
			$("#sht5_A070_21").val( "0");
			...
			$("#sht5_A040_03_inp").val( "0");//건강보험공제
			$("#sht5_A040_04_inp").val( "0");//고용보험공제
			$("#sht5_A040_05_inp").val( "0");//보장성보험공제
			$("#sht5_A040_07_inp").val( "0");//장애인전용보험공제
			...
			$("#sht5_A020_14").val( "0");
			$("#sht5_A030_04").val( "0");
			$("#sht5_A030_04_INP").val( "0");
			$("#sht5_A030_03").val( "0");
			$("#sht5_A030_03_INP").val( "0");
			$("#sht5_A100_05").val( "0");
			$("#sht5_A100_05_INP").val( "0");
			$("#sht5_A050_20").val( "0");
			$("#sht5_A050_21").val( "0");
			$("#sht5_A060_20").val( "0");
			$("#sht5_A060_21").val( "0");
	...
	function finalCloseYnValueSet(){
		...
		$("#sht5_A020_09").val("");//자녀양육공제
		$("#sht5_A020_11").val("");//소수추가공제 
		$("#sht5_A020_12").val("");//출산입양공제 
		$("#sht5_A030_01").val("");//국민연금보험료공제 
		$("#sht5_A030_02").val("");//기타연금보험료공제 
		$("#sht5_A030_03").val("");//퇴직연금보험료공제 
		$("#sht5_A040_01").val("");//보험료공제-건강보험료  
    	$("#sht5_A040_08").val("");//보험료공제 -고용보험료
    	$("#sht5_A040_09").val("");//보험료공제 -보장성보험
    	$("#sht5_A040_10").val("");//보험료공제-장애인전용
		...
		$("#sht5_A020_09_CNT").val("");//자녀양육비인원수
		$("#sht5_A020_12_CNT").val("");//출산입양인원수
		$("#sht5_A020_11_CNT").val("");//다자녀인원수
	 ...
	 */
	function print(){
		if(sheet3.GetCellValue(1, "final_close_yn") == "N"){
			alert("마감된 자료가 존재하지 않습니다.");
		  	return;
		}
		...
		args["rdParam"] = "[<%=session.getAttribute("ssnEnterCd")%>] ["+$("#searchWorkYy").val()+"] ["+$("#searchAdjustType").val()+"] ['"+$("#searchSabun").val()+"'] ['']" +
						  "["+bpCd+"] [A] ["+imgPath+"]" +
						  "[4] ["+$("#searchSabun").val()+"] [] [] [] ["+ imgFile +"] [1] []";//rd파라매터
...
<div class="wrapper">
	...
	<div class="outer" >
		...
		<tr>
			<th class="center" rowspan="4">기타연금보험료</th>
		...
		<tr>
			<th class="center" rowspan="3">연금계좌소득공제</th>
		...
		<tr>
			<th class="center">근로자퇴직급여 보장법에<br> 따른 퇴직연금</th>
			<th class="center"></th>
			<td class="right"> 
