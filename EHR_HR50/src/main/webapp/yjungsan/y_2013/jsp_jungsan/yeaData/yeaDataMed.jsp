...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata2.Cols = [
			...
			{Header:"관계|관계",					Type:"Combo",		Hidden:1,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"adj_fam_cd",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:200 },
...
*/
	...
	function initDefaultData() {
		...
		var result1 = ajaxCall("<%=jspPath%>/common/commonSelect.jsp?cmd=commonSelectMap",param1+"&adjProcessCd=A050",false);
