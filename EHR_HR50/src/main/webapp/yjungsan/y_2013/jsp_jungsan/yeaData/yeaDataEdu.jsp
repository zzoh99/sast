...
<script type="text/javascript">
	...
	$(function() {
		...
		var contributionCdList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList","C00342"), "");
		...
		sheet2.SetColProperty("restrict_cd",	{ComboText:"|"+contributionCdList[0], ComboCode:"|"+contributionCdList[1]} );
	...
	function doAction2(sAction) {
		...
		case "Save":
			...
			sheet2.DoSave( "<%=jspPath%>/yeaData/yeaDataEduRst.jsp?cmd=saveYeaDataEdu"); 
			break;
		case "Insert":	
			if(!parent.checkClose())return;
	...
	function initDefaultData() {
		...
		var result1 = ajaxCall("<%=jspPath%>/common/commonSelect.jsp?cmd=commonSelectMap",param1+"&adjProcessCd=A060",false);
...
<div class="wrapper">
	...
	<div class="outer">
		<div class="sheet_title">
		<ul>
			<li class="txt">※ 교복구입비는 교육대상 구분 "초중고 > 교복구입비" 로 선택하여 주십시오. (개인별 50만원 한도)</li>
			<li class="btn">
