...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"사업자등록번호등|사업자등록번호등",			Type:"Text",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"enter_no",		KeyField:0,	Format:"SaupNo",			PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:15 },
...
<div class="wrapper">
	...
	<tr>
		...
		<th class="center">전액공제기부금</th>
		<th class="center">50%한도 적용기부금</th>
		<th class="center">30%한도 적용기부금</th>
