...
<script type="text/javascript">
	...
	function loadSheet2() {
		...
		initdata2.Cols = [
			...
			{Header:"순번|순번",					Type:"Text",	Hidden:1,	Width:60,	Align:"Left",	ColMerge:1,	SaveName:"seq",				KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:35 },
			{Header:"임대인|성명",			Type:"Text",	Hidden:0,	Width:60,	Align:"Left",	ColMerge:1,	SaveName:"name_imdaein",		KeyField:1,	Format:"",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
			{Header:"임대인|주민번호",	Type:"Text",	Hidden:0,	Width:70,	Align:"Center",	ColMerge:1,	SaveName:"res_no_imdaein",	KeyField:1,	Format:"IdNo",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:200, FullInput:1 },
			{Header:"계약(가입)일|시작일",	Type:"Date",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"con_s_ymd",		KeyField:1,	Format:"Ymd",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:8 },
			{Header:"계약(가입)일|종료일",	Type:"Date",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"con_e_ymd",		KeyField:1,	Format:"Ymd",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:8 },
			{Header:"임대차계약서상 주소지|임대차계약서상 주소지",	Type:"Text",	Hidden:0,	Width:90,	Align:"Left",	ColMerge:1,	SaveName:"address",				KeyField:1,	Format:"",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:4000 },
			{Header:"월세액|월세액",			Type:"Int",		Hidden:0,	Width:60,	Align:"Right",	ColMerge:1,	SaveName:"rent_mon",		KeyField:1,	Format:"Integer",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:35 },
			{Header:"해당과세기간임차일수|해당과세기간임차일수",Type:"Int",		Hidden:1,	Width:80,	Align:"Right",	ColMerge:1,	SaveName:"tax_day",			KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:35 },
			{Header:"월세대상금액|직원용",				Type:"AutoSum",		Hidden:0,	Width:60,	Align:"Right",	ColMerge:1,	SaveName:"input_mon",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:inputEdit,	InsertEdit:inputEdit,	EditLen:35 },
			{Header:"월세대상금액|담당자용",				Type:"AutoSum",		Hidden:0,	Width:60,	Align:"Right",	ColMerge:1,	SaveName:"appl_mon",		KeyField:1,	Format:"",		PointCount:0,	UpdateEdit:applEdit,	InsertEdit:applEdit,	EditLen:35 },
			{Header:"자료입력유형|자료입력유형",			Type:"Combo",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"adj_input_type",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"담당자확인|담당자확인",			Type:"Combo",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"feedback_type",		KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 }
	...
	function loadSheet3() {
		...
		initdata3.Cols = [
			...
			{Header:"주택자금공제구분|주택자금공제구분",		Type:"Combo",	Hidden:1,	Width:60,	Align:"Left",	ColMerge:1,	SaveName:"house_dec_cd",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:13 },
			{Header:"순번|순번",					Type:"Text",	Hidden:1,	Width:60,	Align:"Left",	ColMerge:1,	SaveName:"seq",				KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:35 },
			{Header:"대주|성명",						Type:"Text",	Hidden:0,	Width:60,	Align:"Left",	ColMerge:1,	SaveName:"name_imdaein",		KeyField:1,	Format:"",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
			{Header:"대주|주민번호",	Type:"Text",	Hidden:0,	Width:70,	Align:"Center",	ColMerge:1,	SaveName:"res_no_imdaein",	KeyField:1,	Format:"IdNo",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:200, FullInput:1 },
			{Header:"계약(가입)일|시작일",	Type:"Date",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"con_s_ymd",		KeyField:1,	Format:"Ymd",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:8 },
			{Header:"계약(가입)일|종료일",	Type:"Date",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"con_e_ymd",		KeyField:1,	Format:"Ymd",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:8 },
	...
	function loadSheet4() {
		//거주자간 주택임차차입금 원리금 상환액(임대차 계약) 쉬트
		var initdata4 = {};
		initdata4.Cfg = {SearchMode:smLazyLoad,Page:22, MergeSheet:msHeaderOnly};
		...
		initdata4.Cols = [
			...
			{Header:"계약(가입)일|종료일",	Type:"Date",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"con_e_ymd",		KeyField:1,	Format:"Ymd",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:8 },
			{Header:"임대차계약서상 주소지|임대차계약서상 주소지",	Type:"Text",	Hidden:0,	Width:90,	Align:"Left",	ColMerge:1,	SaveName:"address",				KeyField:1,	Format:"",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:4000 },
			{Header:"전세보증금|직원용",					Type:"AutoSum",		Hidden:0,	Width:60,	Align:"Right",	ColMerge:1,	SaveName:"input_mon",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:inputEdit,	InsertEdit:inputEdit,	EditLen:35 },
			{Header:"전세보증금|담당자용",				Type:"AutoSum",		Hidden:0,	Width:60,	Align:"Right",	ColMerge:1,	SaveName:"appl_mon",		KeyField:1,	Format:"",		PointCount:0,	UpdateEdit:applEdit,	InsertEdit:applEdit,	EditLen:35 },
			{Header:"자료입력유형|자료입력유형",	Type:"Combo",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"adj_input_type",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"거주자 주택임차차입금간 구분|거주자 주택임차차입금간 구분",	Type:"Text",	Hidden:1,	Width:60,	Align:"Left",	ColMerge:1,	SaveName:"keojuza_gubun",				KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:1 },
			{Header:"담당자확인|담당자확인",			Type:"Combo",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"feedback_type",		KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 }
	...
	function sheet1_OnChange(Row, Col, Value) {
		...
		try{
			if( shtObj.ColSaveName(Col) == "house_dec_cd" ){
				if(shtObj.GetCellValue(Row, "house_dec_cd") == "10" || shtObj.GetCellValue(Row, "house_dec_cd") == "20" || shtObj.GetCellValue(Row, "house_dec_cd") == "60" ){
					/*  무주택 세대주일 경우  등록 가능 */
					if(houseOwnerYn != "Y" || houseCnt != "0") {
						alert("주택임차차입금원리금 및 월세액공제는 국민주택규모의 세입자로서 무주택, 세대주에 한해서 등록 가능합니다. 주소사항 탭의 입력내역을 확인 하십시오.");
						shtObj.SetCellValue(Row, "house_dec_cd", "") ;
						return;
					}
					if(shtObj.GetCellValue(Row, "house_dec_cd") == "20" || shtObj.GetCellValue(Row, "house_dec_cd") == "60" ){
						/*  총급여가 5000만원 이하일경우에 등록 가능 , 2012년 개정*/
						if( (paytotMonStr.replace(/,/gi, "")*1) > 50000000) {
							alert("월세액공제는 총급여액이 5천만원 이하인 근로소득자에 한해서 등록 가능합니다. \n 총급여액 : "+paytotMonStr);
							shtObj.SetCellValue(Row, "house_dec_cd", "") ;
							return;
						}
					}
	...
	/*-----------------------------------------------------------------------------------------
	//거주자간 주택임차차입금 원리금 상환액(임대차 계약) --- start
	------------------------------------------------------------------------------------------*/
	function doAction4(sAction) {
		switch (sAction) {
		case "Search":
			sheet4.DoSearch( "<%=jspPath%>/yeaData/yeaDataHouRst.jsp?cmd=selectYeaDataHouList&codeType=4", $("#sheetForm").serialize() );
			break;
		case "Save":
		...
		case "Insert":
			...
			sheet4.SetCellValue(newRow, "keojuza_gubun", "2");
		...
		try {
			...
			if (Code == 1) {
				for(var i = sheet4.HeaderRows(); i <= sheet4.LastRow(); i++){
					tab_setAuthEdtitable(orgAuthPg, sheet4, i);
				}
			}
	...
	/*-----------------------------------------------------------------------------------------
	//거주자간 주택임차차입금 원리금 상환액(임대차 계약) --- end
	------------------------------------------------------------------------------------------*/
	...
	function saveBefore(shtObj) {
		...
		for( var i = 2; i < shtObj.LastRow()+2; i++) {
			...
			if( shtObj.GetCellValue(i, "sStatus") == "U" ||
				...
				if( shtObj.GetCellValue(i, "house_dec_cd") == "20" || shtObj.GetCellValue(i, "house_dec_cd") == "60" ) {
					/* 무주택 세대주일 경우 등록 가능 */
					if( houseOwnerYn != "Y") {
...
<div class="wrapper">
		...
		<ul>
			<li class="txt">주택자금 ☞ <span id="houseInfo"></span>
				<span id="paytotMonViewYn">
					<a href="javascript:paytotMonView();" class="basic authA"><b><font color="red">[총급여 5000만원 초과여부]</font></b></a>
				</span>
				<span id="span_paytotMonView" ></span>
				<a href="javascript:yeaDataExpPopup('주택자금', helpText, 420);" class="cute_gray authR">주택자금 안내</a>
			</li>
		</ul>
		</div>
	</div>
	...
	<tr>
		<th class="center" rowspan="3">임차차입금(대출기관)</th>
		<th class="center" rowspan="3">임차차입금(거주자)</th>
		<th class="center" rowspan="3">월세액</th>
		<th class="center" colspan="5">저당차입금 이자상환액</th>
	</tr>
	<tr>
	...
	<tr>
		...
		<th class="center">고정금리/비거치상환 대출</th>
	...
	<div style="height:170px">
		<script type="text/javascript">createIBSheet("sheet1", "100%", "170px"); </script>
	</div>
	...
	<div class="outer">
		...
		<ul>
			<li class="txt">
				※ 월세액 : <span>월세액 및 계약기간은 당해년도분이 아니라 전체 계약기간과 총 합계액을 입력하십시오.</span>
			</li>
			<li class="btn">
	...
	<div class="outer">
		...
		<ul>
			<li class="txt">
				※ 거주자간 주택임차차입금 원리금 상환액(금전소비대차 계약) : <span>해당연도 원리금만 입력하십시오.</span>
			</li>
			<li class="btn">
	...
	<div class="outer">
		...
		<ul>
			<li class="txt">
				※ 거주자간 주택임차차입금 원리금 상환액(임대차 계약)  : <span>전세보증금은 과세기간 종료일(12.31) 현재의 전세보증금입니다.</span>
			</li>
			<li class="btn">
	...
	<div style="height:170px">
		<script type="text/javascript">createIBSheet("sheet4", "100%", "170px"); </script>
	</div>
