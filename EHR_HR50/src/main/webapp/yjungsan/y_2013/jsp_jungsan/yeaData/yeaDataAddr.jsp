...
<script type="text/javascript">
	...
	$(function(){
		...
		initdata.Cols = [
			...
			{Header:"우편번호",			Type:"Text",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"zip",				KeyField:1,	Format:"PostNo",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:7 },
		...
		var foreign_tax_type_list = ["3|4", "적용안함|17%단일세율"
			,"<option value='3'>적용안함</option>"
				+ "<option value='4'>17%단일세율</option>"
		];
		var national_cd_list = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList","H20290"), "");
	...
	$(function(){
		...
		if(orgAuthPg == "A") $("#div_foreign").show();
...
<div class="wrapper">
		...
		<ul>
			...
			<li class="btn">
				<span id="btnDisplayYn01">
				  <a href="javascript:saveZipCode();" class="basic authA">저장</a>
				  <a href="javascript:initZipCode();" class="basic authA">초기화</a>
				</span>
			</li>
		</ul>
		</div>
	...
	<tr>
		...
		<td class="left">
			...
			<a href="javascript:openZipCode('0');" class="basic authA">우편번호</a>
	...
	<tr id='houseinfo2' style="display:none;">
		...
		<td class="left">
			...
			<a href='http://aao.kab.co.kr/aaofx/' target='_blank'><font color='blue'><u>☞ 전용면적 및 공시지가 조회(국토해양부) 바로가기</u></font></a>
		</td>
	</tr>
	<tr id='houseinfo3' style="display:none;">
		<th>주택공시지가</th>
		<td class="left">
			<input name="official_price" id="official_price" type="text" class="<%=textCss%> right" onFocus="this.select()" value="" maxlength="20" <%=readonly%> /> 원
		</td>
	</tr>
	</table>

	<div id="div_foreign" style="display:none;">
	<table border="0" cellpadding="0" cellspacing="0" class="default outer">
	<colgroup>
		<col width="15%" />
		<col width="" />
