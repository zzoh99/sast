...
<script type="text/javascript">
	...
	$(function(){
		...
		initdata3.Cols = [
			...
			{Header:"a08003",				Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a080_03",			KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"a08009",				Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a080_09",			KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
			{Header:"a08001011",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"a080_10_11",			KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:500 },
	...
	function sht5ToCtl(){
		if(yeaResultSht5.RowCount() > 0){
			...
			$("#sht5_A020_14").val( yeaResultSht5.GetCellText(1, "a020_14"));//한부모공제
			...
			$("#sht5_A030_04").val( yeaResultSht5.GetCellText(1,"a030_04"));		//과학기술인공제
			$("#sht5_A030_04_INP").val( yeaResultSht5.GetCellText(1,"a030_04_inp"));		//과학기술인공제
			$("#sht5_A030_03").val( yeaResultSht5.GetCellText(1,"a030_03"));		//퇴직연금납입금액
			$("#sht5_A030_03_INP").val( yeaResultSht5.GetCellText(1,"a030_03_inp"));		//퇴직연금납입금액
			$("#sht5_A100_05").val( yeaResultSht5.GetCellText(1,"a100_05"));		//연금저축
			$("#sht5_A100_05_INP").val( yeaResultSht5.GetCellText(1,"a100_05_inp"));		//연금저축
			...
			// 의료비
			$("#sht5_A050_20").val( yeaResultSht5.GetCellText(1,"a050_20"));				//장애인 의료비
			$("#sht5_A050_21").val( yeaResultSht5.GetCellText(1,"a050_21"));//의료비 기타
			
			// 교육비
			$("#sht5_A060_20").val( yeaResultSht5.GetCellText(1,"a060_20"));				//장애인 교육비
			$("#sht5_A060_21").val( yeaResultSht5.GetCellText(1,"a060_21"));//교육비 기타
			...
			$("#sht5_A100_34_INP").val( yeaResultSht5.GetCellText(1,"a100_34_inp"));				//주택청약저축
			$("#sht5_A100_31_INP").val( yeaResultSht5.GetCellText(1,"a100_31_inp"));				//주택청약종합저축
			$("#sht5_A100_33_INP").val( yeaResultSht5.GetCellText(1,"a100_33_inp"));				//근로자주택마련저축
			$("#sht5_A100_11").val( yeaResultSht5.GetCellText(1,"a100_11"));		//투자조합출자(2011.12.31 이전 출자분)
			$("#sht5_A100_08").val( yeaResultSht5.GetCellText(1,"a100_08"));		//투자조합출자(2012.1.1 ~ 2012.12.31(간접출자)) 
			$("#sht5_A100_10").val( yeaResultSht5.GetCellText(1,"a100_10"));		//투자조합출자(2012.1.1 ~ 2012.12.31(직접출자)) 
			$("#sht5_A100_09").val( yeaResultSht5.GetCellText(1,"a100_09"));		//투자조합출자(2013.1.1 ~ 2013.12.31(간접출자)) 
			$("#sht5_A100_12").val( yeaResultSht5.GetCellText(1,"a100_12"));		//투자조합출자(2013.1.1 ~ 2013.12.31(직접출자)) 
			$("#sht5_A100_07").val( yeaResultSht5.GetCellText(1,"a100_07"));		//투자조합출자 계
			$("#sht5_A100_15").val( yeaResultSht5.GetCellText(1,"a100_15"));				//신용카드
			$("#sht5_A100_16").val( yeaResultSht5.GetCellText(1,"a100_16"));				//대중교통이용분
			...
			$("#sht5_A100_38").val( yeaResultSht5.GetCellText(1,"a100_38"));				//목돈 안드는 전세 이자상환액
			$("#sht5_A100_38_INP").val( yeaResultSht5.GetCellText(1,"a100_38_inp"));				//목돈 안드는 전세 이자상환액
			$("#sht5_A100_99").val( yeaResultSht5.GetCellText(1,"a100_99"));			//그밖의소득공제계
			...
			$("#sht5_A080_05").val( yeaResultSht5.GetCellText(1,"a080_05"));
			$("#sht5_A080_03").val( yeaResultSht5.GetCellText(1,"a080_03"));
			$("#sht5_A080_09").val( yeaResultSht5.GetCellText(1,"a080_09"));
			$("#sht5_A080_10_11").val( yeaResultSht5.GetCellText(1,"a080_10_11"));
			$("#sht5_A099_02").val( yeaResultSht5.GetCellText(1,"a099_02"));
			
			$("#sht5_A030_11").val( yeaResultSht5.GetCellText(1,"a030_11"));
			$("#sht5_A030_12").val( yeaResultSht5.GetCellText(1,"a030_12"));
			$("#sht5_A030_02").val( yeaResultSht5.GetCellText(1,"a030_02"));
			$("#sht5_A030_13").val( yeaResultSht5.GetCellText(1,"a030_13"));
			$("#sht5_A030_11_INP").val( yeaResultSht5.GetCellText(1,"a030_11_inp"));
			$("#sht5_A030_12_INP").val( yeaResultSht5.GetCellText(1,"a030_12_inp"));
			$("#sht5_A030_02_INP").val( yeaResultSht5.GetCellText(1,"a030_02_inp"));
			$("#sht5_A030_13_INP").val( yeaResultSht5.GetCellText(1,"a030_13_inp"));
		}else{
			...
			$("#sht5_A030_04").val( "0");		//과학기술인공제
			$("#sht5_A030_04_INP").val( "0");//과학기술인공제
			$("#sht5_A030_03").val( "0");		//퇴직연금납입금액
			$("#sht5_A030_03_INP").val( "0");//퇴직연금납입금액
			$("#sht5_A100_05").val( "0");		//연금저축
			$("#sht5_A100_05_INP").val( "0");//연금저축
			$("#sht5_A040_03").val( "0");//건강보험공제
			$("#sht5_A040_04").val( "0");//고용보험공제
			$("#sht5_A040_05").val( "0");//보장성보험공제
			
			//의료비
			$("#sht5_A050_20").val( "0");//장애인 의료비
			$("#sht5_A050_21").val( "0");//기타 의료비
			
			//교육비
			$("#sht5_A060_20").val( "0");//장애인 교육비
			$("#sht5_A060_21").val( "0");//기타 교육비
			...
			$("#sht5_A100_34_INP").val( "0");//주택청약저축
			$("#sht5_A100_31_INP").val( "0");//주택청약종합저축
			$("#sht5_A100_33_INP").val( "0");//근로자주택마련저축
			$("#sht5_A100_11").val( "0");//투자조합출자(2011.12.31 이전 출자분)
			$("#sht5_A100_08").val( "0");//투자조합출자(2012.1.1 ~ 2012.12.31(간접출자) )
			$("#sht5_A100_10").val( "0");//투자조합출자(2012.1.1 ~ 2012.12.31(직접출자))
			$("#sht5_A100_09").val( "0");//투자조합출자(2013.1.1 ~ 2013.12.31(간접출자) )
			$("#sht5_A100_12").val( "0");//투자조합출자(2013.1.1 ~ 2013.12.31(직접출자))
			$("#sht5_A100_07").val( "0");
			$("#sht5_A100_15").val( "0");//신용카드
			$("#sht5_A100_16").val( "0");//대중교통이용분
			...
			$("#sht5_A100_38").val( "0");				//목돈 안드는 전세 이자상환액
			$("#sht5_A100_38_INP").val( "0");//목돈 안드는 전세 이자상환액
			$("#sht5_A100_99").val( "0");//그밖의소득공제계
			...
			$("#sht5_A030_02").val( "0");
			$("#sht5_A030_13").val( "0");
			$("#sht5_A030_11_INP").val( "0");
			$("#sht5_A030_12_INP").val( "0");
			$("#sht5_A030_02_INP").val( "0");
			$("#sht5_A030_13_INP").val( "0");
		}
	}	
...
<div class="wrapper" style="overflow:scroll;">
	...
	<tr>
		<th class="center" rowspan="6">추가공제</th>
	...
	<tr>
		<th class="center" rowspan="8">연금보험료<br>공제</th>
	...
	<tr>
		<th class="center" rowspan="4">기타<br>연금<br>보험료<br>공제</th>
		<th class="center" colspan="1">공무원연금</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" colspan="1">군인연금</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" colspan="1">사립학교교직원연금</th>
		<th class="center"></th>
		<td class="right"> 
...
<tr>
		<th class="center" colspan="1">별정우체국연금</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" rowspan="3">연금<br>계좌<br>소득<br>공제</th>
		<th class="center" colspan="1">과학기술인공제</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" colspan="1">근로자퇴직급여 보장법에<br>따른 퇴직연금</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" colspan="1">연금저축</th>
		<th class="center"></th>
		<td class="right"> 
	...
	<tr>
		<th class="center" rowspan="22">특별공제</th>
	...
	<tr>
		...
		<td class="right"></td>
		<td class="right"> 
			<input id="sht5_A050_20" name="sht5_A050_20" type="text" class="text w100p right" readOnly />
		</td>	
	</tr>
	<tr>
		...
		<td class="right"></td>
		<td class="right"> 
			<input id="sht5_A050_21" name="sht5_A050_21" type="text" class="text w100p right" readOnly />
		</td>	
	</tr>
	<tr>
		...
		<td class="right"></td>
		<td class="right"> 
			<input id="sht5_A060_20" name="sht5_A060_20" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
		<th class="center">기타</th>
		...
		<td class="right"></td>
		<td class="right"> 
			<input id="sht5_A060_21" name="sht5_A060_21" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<th class="center" rowspan="4">기부금</th>
	...
	<tr>
		<th class="center" >지정기부금</th>
		<td class="center" ></td>
		<td class="center" ></td>
		<td class="right"> 
			<input id="sht5_A080_10_11" name="sht5_A080_10_11" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<th class="center" colspan="4">표준공제</th>
		<td class="right"> 
	...
	<tr>
		<th class="center" rowspan="19">그 밖의<br>소득공제</th>
	...
	<tr>
		<th class="center" rowspan="5">투자조합 출자공제</th>
		<th class="center" >2011.12.31 이전 출자분</th>
		<td class="center" ></td>
		<td class="right"> 
	...
	<tr>
		<th class="center" colspan="5">특별공제 종합한도 초과액</th>
		<td class="right"> 
			<input id="sht2_LIMIT_OVER_MON" name="sht5_LIMIT_OVER_MON" type="text" class="text w100p right" readOnly />
		</td>
	</tr>
	<tr>
