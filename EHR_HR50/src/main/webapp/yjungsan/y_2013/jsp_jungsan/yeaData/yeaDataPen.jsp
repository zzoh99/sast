...
<script type="text/javascript">
	...
	$(function() {
		...
		var savingDeductTypeList = stfConvCode( ajaxCall("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&queryId=getSavingDeductList","searchGubun=2",false).codeList, "");
...
<div class="wrapper">
	...
	<div class="outer">
		...
		<ul>
			<li class="txt">연금보험료
				<a href="javascript:yeaDataExpPopup('연금보험료', helpText3, 200);" class="cute_gray authR">연금보험료 안내</a>
			</li>
		</ul>
		</div>
	</div>
	...
	<tr>
		<th class="center" rowspan=2>국민연금보험료</th>
		<th class="center" rowspan=2>기타 연금보험</th>
		<th class="center" colspan=3>연금계좌소득공제</th>
	</tr>
	<tr>
