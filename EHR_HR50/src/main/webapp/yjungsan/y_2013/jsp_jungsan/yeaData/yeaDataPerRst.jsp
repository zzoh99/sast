		...
		try {
			...
			if(saveList != null && saveList.size() > 0) {
				for(int i = 0; i < saveList.size(); i++) {
					...
					String childYn = (String)mp.get("child_yn");
					String adoptBornYn = (String)mp.get("adopt_born_yn");
					...
					String[] param = new String[]{"","",sStatus,ssnEnterCd,workYy
							...
							,dpndntYn,spouseYn,seniorYn,hndcpYn,hndcpType,womanYn
							,childYn,adoptBornYn,oneParentYn,ssnSabun};
