...
<div class="wrapper">
	...
	<tr>
		<th class="center" colspan=2>2011.12.31 이전 출자분</th>
		<td class="right">
			<input id="A100_11" name="A100_11" type="text" class="text w90 right" /> 원
		</td>
		<td class="left" rowspan="5">
			&nbsp;거주자가 중소기업창업투자조합 등에 2012년 12월 31일까지 출자 또는 투자한 금액의 100분의 10<br>
			&nbsp;(2012.1.1. 이후)개인이 직접 또는 개인투자조합을 통해 벤처기업에 투자하는 경우 100분의 20)에 <br>
			&nbsp;상당하는 금액을 그 출자일 또는 투자일이 속하는 과세연도부터 2년이 되는 날이 속하는 과세연도까지 <br>
			&nbsp;거주자가 선택하는 1과세연도의 종합소득금액에서 공제  - 공제한도 : 근로소득금액의 40%<br>&nbsp;(2012.1.1 이전 30%)
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="left" rowspan="3">
			...
			&nbsp;연간 임금총액 고용유지중소기업에 근로를 제공하는 상시근로자에 대하여 2012년 12월 31일이<br>
