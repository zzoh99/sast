...
//오류항목 팝업 조회
public List selectInputErrChkMgrPopupList(Map paramMap, String locPath) throws Exception {
...
<%
	...
	if("selectInputErrChkMgrList".equals(cmd)) {
		...
		try {
			listData = selectInputErrChkMgrPopupList(mp, locPath);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
		...
		try {
			...
			String[] type =  new String[]{"OUT","OUT","STR","STR","STR"
					,"STR","STR"};
			String[] param = new String[]{"","",ssnEnterCd,workYy,adjustType
					,sabun,ssnSabun};
