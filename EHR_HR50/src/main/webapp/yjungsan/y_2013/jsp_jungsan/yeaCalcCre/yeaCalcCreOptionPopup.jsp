			...
			<table border="0" cellpadding="0" cellspacing="0" class="default outer">
				...
				<tr>
					<td class="left">
						...
						&nbsp;NO : 세액계산 및 결과보기 버튼이 비활성화되어 미리 세액계산을 할 수 없습니다.		
					</td>
					<td align="left">
						<input type="radio" class="radio" name="cpn_yea_sim_yn" value = "Y" >YES&nbsp;&nbsp;&nbsp;<br>    
						<input type="radio" class="radio" name="cpn_yea_sim_yn" value = "N" >NO	   
					</td>		
				</tr>
				<tr>
				...
				<tr>
					<td class="left">
						...
						&nbsp;NO  : 총급여 확인버튼이 비활성화 됩니다.
					</td>
					<td align="left">
						<input type="radio" class="radio" name="cpn_yea_mon_show_yn" value = "Y" >YES&nbsp;&nbsp;&nbsp;<br>   
						<input type="radio" class="radio" name="cpn_yea_mon_show_yn" value = "N" >NO
					</td>		
				</tr>
				<tr>
