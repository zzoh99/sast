...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata1.Cols = [                                                                                                                                                                                                                            
            ...
            {Header:"성명", 			Type:"Popup",     Hidden:0,  Width:100,  Align:"Center",     	ColMerge:0,   SaveName:"name",  				KeyField:1,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100, FontColor:"#0000ff" },
            ...
            {Header:"우편번호", 		Type:"Popup",     Hidden:0,  Width:100,  Align:"Center",     	ColMerge:0,   SaveName:"zip",  					KeyField:0,   CalcLogic:"",   Format:"PostNo",  PointCount:0,   UpdateEdit:1,   InsertEdit:0,   EditLen:6 },
            {Header:"주소1", 			Type:"Text",      Hidden:0,  Width:100,  Align:"Left",   		ColMerge:0,   SaveName:"addr1", 		 		KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:0,   EditLen:4000 },
            {Header:"주소2", 			Type:"Text",      Hidden:0,  Width:100,  Align:"Left",   		ColMerge:0,   SaveName:"addr2",  				KeyField:0,   CalcLogic:"",   Format:"",        PointCount:0,   UpdateEdit:1,   InsertEdit:0,   EditLen:4000 },
		...
		var nationalCdList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonCodeList","H20290"), "");
	...
	function doAction1(sAction) {
		...
		case "Search": 		//조회
			...
			break;
		case "Save": 		//저장
			sheet1.DoSave( "<%=jspPath%>/yeaCalcCre/yeaCalcCrePeoplePopupRst.jsp?cmd=saveYeaCalcCrePopup"); 
			break;
		 case "Insert":
		...
		<div>
			...
			<colgroup>
				...
				<tr>
					...
					<td class="center"> 
						<a href="javascript:callProcedure();"	class="basic authA">작업</a>
					</td>
				</tr>
			</table>
		</div>
