...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"정산구분|정산구분",		    		Type:"Text",	Hidden:1,  Width:80,Align:"Center",    ColMerge:1,   SaveName:"adjust_type",		KeyField:0,   CalcLogic:"",   Format:"",           PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:500 },
    ...
    function doAction2(sAction) {
		...
		case "Save": 
			...
			sheet2.DoSave( "<%=jspPath%>/donationAdj/donationAdjAdminRst.jsp?cmd=saveDonationAdjAdminDetail"); 
			break;
		case "Insert":
