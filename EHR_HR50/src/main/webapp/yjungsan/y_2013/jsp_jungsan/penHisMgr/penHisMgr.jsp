...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
	        ...
	        {Header:"연금저축구분",		Type:"Combo",     Hidden:0,  Width:110,   Align:"Left",    ColMerge:1,   SaveName:"saving_deduct_type",	KeyField:1,		CalcLogic:"",   Format:"",	PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
