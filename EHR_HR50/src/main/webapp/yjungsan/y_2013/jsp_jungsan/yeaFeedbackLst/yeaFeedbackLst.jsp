...
<script type="text/javascript">
	...
	$(function() {	
		...
		initdata1.Cols = [
            ...
            {Header:"정산구분", 		Type:"Text",     	Hidden:1,  	Width:50,  	Align:"Center",    	ColMerge:0, SaveName:"adjust_type",  	KeyField:0,   CalcLogic:"",   Format:"",    PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
            ...
            {Header:"구분", 			Type:"Combo",    	Hidden:0,  	Width:70,  	Align:"Center",    	ColMerge:0, SaveName:"gubun_cd",  		KeyField:0,   CalcLogic:"",   Format:"",    PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
            ...
            {Header:"담당자멘트",		Type:"Text",     	Hidden:0,  	Width:200,  Align:"Left",    	ColMerge:1, SaveName:"manager_note",  	KeyField:0,   CalcLogic:"",   Format:"",    PointCount:0,   UpdateEdit:0,	InsertEdit:0,   EditLen:1000, MultiLineText:1 },
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "<%=jspPath%>/yeaFeedbackLst/yearFeedbackLstRst.jsp?cmd=selectYeaFeedbackLstList", $("#sheetForm").serialize() );
			break;
		case "Down2Excel":
			...
			<div>
				<table>
					<tr>
						...
						<td>
							<span>작업구분</span>
							<select id="searchAdjustType" name ="searchAdjustType">
							</select> 
						</td>
						<td>
							<span>자료구분</span>
