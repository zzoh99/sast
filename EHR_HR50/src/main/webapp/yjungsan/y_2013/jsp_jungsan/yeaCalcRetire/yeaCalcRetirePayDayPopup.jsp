...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata1.Cols = [
   			...
   			{Header:"급여구분코드명|급여구분코드명",	Type:"Text",	Hidden:0,	Width:100,	Align:"Center",	ColMerge:1,	SaveName:"pay_nm",				KeyField:0,	CalcLogic:"",	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100},
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			break;
		case "Save":
			sheet1.DoSave("<%=jspPath%>/yeaCalcRetire/yeaCalcRetirePayDayPopupRst.jsp?cmd=saveYeaCalcRetirePayDayPopup");
			break;
		case "Insert":
