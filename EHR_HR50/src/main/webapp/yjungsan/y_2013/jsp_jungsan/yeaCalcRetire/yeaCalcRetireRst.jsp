...
public List selectYeaCalcRetireSheet1List(Map paramMap, String locPath) throws Exception {
...
<%
	...
	if("selectYeaPayActionInfo".equals(cmd)) {
		...
		try {
			listData = selectYeaCalcRetireSheet1List(mp, locPath);
		} catch(Exception e) {
			code = "-1";
			message = e.getMessage();
		}
		...
		try {
			...
			String[] rstStr = DBConn.executeProcedure("PKG_CPN_YEA_"+yeaYear+".P_CPN_YEAREND_CANCEL",type,param);
