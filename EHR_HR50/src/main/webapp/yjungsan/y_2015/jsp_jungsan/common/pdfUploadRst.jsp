...
//                                 }
                                ...
                                for(int halfIndex = 0; halfIndex < 6; halfIndex++ ) {
                                    ...
                                    dataMap.put("A9",""); //귀속년도_상반기_대상금액합계
                                    dataMap.put("A10",""); //조회기간 시작월
                                    dataMap.put("A11",""); //조회기간 종료월
                                ...
                                for(int dataIndex = 0; dataIndex < childList2.size(); dataIndex++ ) {
                                    ...
                                    for(int halfIndex = 0; halfIndex < 2; halfIndex++ ) {
                                        ...
                                        // 상/하반기 신용카드 사용액, 반기구분코드
                                        if ( halfIndex == 0 ) {
                                            dataMap.put("A7",((Element)childList2.get(dataIndex)).getAttributeValue("first_tot_amt"));      //귀속년도_상반기_대상금액합계(조회기간)
                                            dataMap.put("A8", "10"); //반기구분 당해상반기
                                            dataMap.put("A9",((Element)childList2.get(dataIndex)).getAttributeValue("first_year_tot_amt")); //귀속년도_상반기_대상금액합계
                                            dataMap.put("A10",((Element)childList2.get(dataIndex)).getAttributeValue("inqr_strt_mm")); //조회기간 시작월
                                            dataMap.put("A11",((Element)childList2.get(dataIndex)).getAttributeValue("inqr_end_mm")); //조회기간 종료월
                                        } else {
                                            dataMap.put("A7",((Element)childList2.get(dataIndex)).getAttributeValue("second_tot_amt")); //귀속년도_하반기_대상금액합계(조회기간)
                                            dataMap.put("A8", "20"); //반기구분 당해 하반기
                                            dataMap.put("A9",((Element)childList2.get(dataIndex)).getAttributeValue("second_year_tot_amt")); //귀속년도_하반기_대상금액합계
                                            dataMap.put("A10",((Element)childList2.get(dataIndex)).getAttributeValue("inqr_strt_mm")); //조회기간 시작월
                                            dataMap.put("A11",((Element)childList2.get(dataIndex)).getAttributeValue("inqr_end_mm")); //조회기간 종료월
                                        }
...
//                                 }
                                ...
                                for(int halfIndex = 0; halfIndex < 6; halfIndex++ ) {
                                    ...
                                    dataMap.put("A7",""); //귀속년도_상반기_대상금액합계
                                    dataMap.put("A8",""); //조회기간 시작월
                                    dataMap.put("A9",""); //조회기간 종료월
                                ...
                                for(int dataIndex = 0; dataIndex < childList2.size(); dataIndex++ ) {
                                    ...
                                    for(int halfIndex = 0; halfIndex < 2; halfIndex++ ) {
                                        ...
                                        if ( halfIndex == 0 ) {
                                            ...
                                            dataMap.put("A7",((Element)childList2.get(dataIndex)).getAttributeValue("first_year_tot_amt")); //귀속년도_상반기_대상금액합계
                                            dataMap.put("A8",((Element)childList2.get(dataIndex)).getAttributeValue("inqr_strt_mm")); //조회기간 시작월
                                            dataMap.put("A9",((Element)childList2.get(dataIndex)).getAttributeValue("inqr_end_mm")); //조회기간 종료월
                                        } else {
                                            dataMap.put("A5",((Element)childList2.get(dataIndex)).getAttributeValue("second_tot_amt")); //하반기 현금영수증
                                            //dataMap.put("A5",((Element)childList2.get(dataIndex)).getAttributeValue("shfy_tot_amt")); //하반기 현금영수증
                                            dataMap.put("A6", "20"); //반기구분 당해하반기
                                            dataMap.put("A7",((Element)childList2.get(dataIndex)).getAttributeValue("second_year_tot_amt")); //귀속년도_하반기_대상금액합계
                                            dataMap.put("A8",((Element)childList2.get(dataIndex)).getAttributeValue("inqr_strt_mm")); //조회기간 시작월
                                            dataMap.put("A9",((Element)childList2.get(dataIndex)).getAttributeValue("inqr_end_mm")); //조회기간 종료월
                                        }
