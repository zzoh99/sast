...
<script type="text/javascript">
	...
	$(function() {
		...
		//연금저축구분
        var savingDeductTypeList = stfConvCode( codeList("<%=jspPath%>/common/commonCode.jsp?cmd=getCommonNSCodeList&note1='2','3'&queryId=getCommonCodeNote1List", "C00317"), "" );
		//퇴직연금구분
	...
	function doAction1(sAction) {
        ...
        case "Down2Excel":
			...
			break;
		case "Down2Template":
			var param  = {DownCols:"3|4|7|8|9|10|12|14|15",SheetDesign:1,Merge:1,DownRows:'0',ExcelFontSize:"9"
