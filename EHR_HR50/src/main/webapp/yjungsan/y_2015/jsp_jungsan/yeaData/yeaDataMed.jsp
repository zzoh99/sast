...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata2.Cols = [
            ...
            {Header:"구분|구분",                                   Type:"Combo",       Hidden:0,   Width:60,   Align:"Center", ColMerge:1, SaveName:"special_yn",      KeyField:0, Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:0, EditLen:10 },
            {Header:"관계|관계",                                   Type:"Combo",       Hidden:0,   Width:60,   Align:"Center", ColMerge:1, SaveName:"adj_fam_cd",      KeyField:0, Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:200 },
            {Header:"의료비증빙코드|의료비증빙코드",               Type:"Combo",       Hidden:0,   Width:60,   Align:"Left",   ColMerge:1, SaveName:"medical_imp_cd",  KeyField:1, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 },
            ...
            {Header:"재가/시설급여|재가/시설급여",                 Type:"Combo",       Hidden:0,   Width:60,   Align:"Center", ColMerge:1, SaveName:"medical_type",    KeyField:0, Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
            {Header:"사업자번호|사업자번호",                       Type:"Text",        Hidden:0,   Width:60,   Align:"Center", ColMerge:1, SaveName:"enter_no",        KeyField:0, Format:"SaupNo",PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            ...
            {Header:"건수|건수",                                   Type:"Int",         Hidden:0,   Width:60,   Align:"Right",  ColMerge:1, SaveName:"cnt",             KeyField:1, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:35 },
            ...
            {Header:"자료입력유형|자료입력유형",                   Type:"Combo",       Hidden:0,   Width:60,   Align:"Right",  ColMerge:1, SaveName:"adj_input_type",  KeyField:0, Format:"",      PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
            {Header:"난임시술비\n해당여부|난임시술비\n해당여부",   Type:"CheckBox",    Hidden:0,   Width:60,   Align:"Center", ColMerge:1, SaveName:"nanim_yn",        KeyField:0, Format:"",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1, TrueValue:"Y", FalseValue:"N" },
        ...
        sheet2.SetColProperty("special_yn",     {ComboText:" |65세이상|장애인", ComboCode:" |B|A"} );
    ...
    function doAction2(sAction) {
        ...
        case "Save":
            ...
            sheet2.DoSave( "<%=jspPath%>/yeaData/yeaDataMedRst.jsp?cmd=saveYeaDataMed");
            break;
        case "Insert":
            if(!parent.checkClose())return;
...
*/
                ...
                if(sht1FamresIdx != -1) { // 관계
                    if ( sht1FamCd == "0" || sht1FamCd == "3" || sht1FamCd == "6" || sht1FamCd == "4" ) {
    ...
    <div class="outer">
        ...
        <ul>
            ...
            <span id="span_paytotMonView" ></span>
                <a href="javascript:yeaDataExpPopup('의료비', helpText, 300);" class="cute_gray authR">의료비 안내</a>
            </li>
        </ul>
        </div>
    </div>
