                ...
                //2015년도 추가 내역 start
                    ...
                    if( ( paytotMonStr.replace(/,/gi, "") *1 ) > 70000000 ) {
                    	if(chkFlag == '31' || chkFlag == '32'){
                    		...
                    		if(chkFlag == '31'){
                    			alert("총급여 7천만원 이하인 자에 한해 청약저축 선택이 가능합니다.");
	                        }
	                        
	                        if(chkFlag == '32'){
	                        	alert("총급여 7천만원 이하인 자에 한해 주택청약종합저축 선택이 가능합니다.");
	                        } 
                    	...
                    	if(chkFlag == '35' || chkFlag == '36'){
	                    	if(chkFlag == '35'){
	                            alert("총급여 7천만원 초과인 자에 한해 청약저축_2015년이전 선택이 가능합니다.");
	                        }
	                        
	                        if(chkFlag == '36'){
	                            alert("총급여 7천만원 초과인 자에 한해 주택청약종합저축_2015년이전 선택이 가능합니다.");
	                        }           
	                        sheet1.SetCellValue(sheet1.GetSelectRow(),"saving_deduct_type", "") ;
	                        return;
                    	}
...
<div class="wrapper">
    ...
    <tr>
        ...
        <th class="center" rowspan="2" >장기집합투자증권저축</th>
    </tr>
    <tr>
