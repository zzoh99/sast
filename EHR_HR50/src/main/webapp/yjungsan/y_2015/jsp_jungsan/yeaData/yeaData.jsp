...
<script type="text/javascript">
	...
	function createTabFrame() {
		...
		.append("<li><a href='#tabs-4' id='tabs4'>연금</a></li>")
		.append("<li><a href='#tabs-5' id='tabs5'>보험</a></li>")
		.append("<li><a href='#tabs-6' id='tabs6'>주택자금1</a></li>")
		.append("<li><a href='#tabs-7' id='tabs7'>주택자금2</a></li>")
		.append("<li><a href='#tabs-8' id='tabs8'>저축</a></li>")
		.append("<li><a href='#tabs-9' id='tabs9'>카드등</a></li>")
		.append("<li><a href='#tabs-10' id='tabs10'>기타공제</a></li>")
		.append("<li><a href='#tabs-11' id='tabs11'>의료</a></li>")
		.append("<li><a href='#tabs-12' id='tabs12'>교육</a></li>")
		.append("<li><a href='#tabs-13' id='tabs13'>기부</a></li>")
	...
	function showIframe() {
		...
		if(iframeIdx == 0) {
			...
			newIframe.attr("src","<%=jspPath%>/yeaData/yeaDataHou1.jsp?authPg="+authPg+"&orgAuthPg="+orgAuthPg);
		} else if(iframeIdx == 6) {
			newIframe.attr("src","<%=jspPath%>/yeaData/yeaDataHou2.jsp?authPg="+authPg+"&orgAuthPg="+orgAuthPg);
		} else if(iframeIdx == 7) {
	...
	function getYearDefaultInfoObj() {
		...
		if(result.Result.Code == 1) {
			...
			$("#tabs6").html("주택자금1("+result.Data.cnt6+")");
			$("#tabs7").html("주택자금2("+result.Data.cnt7+")");
			$("#tabs8").html("저축("+result.Data.cnt8+")");
			$("#tabs9").html("카드등("+result.Data.cnt9+")");
			$("#tabs10").html("기타공제("+result.Data.cnt10+")");
			$("#tabs11").html("의료("+result.Data.cnt11+")");
			$("#tabs12").html("교육("+result.Data.cnt12+")");
			$("#tabs13").html("기부("+result.Data.cnt13+")");
