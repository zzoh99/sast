...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata2.Cols = [
			...
			{Header:"반영제외자",		Type:"Combo",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"except_gubun",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 },
	...
	function doAction2(sAction) {
		...
		case "Save":
			...
			sheet2.DoSave( "<%=jspPath%>/yeaData/yeaDataPdfRst.jsp?cmd=saveYeaDataPdf&orgAuthPg="+orgAuthPg); 
			break;
		case "Down2Excel":
