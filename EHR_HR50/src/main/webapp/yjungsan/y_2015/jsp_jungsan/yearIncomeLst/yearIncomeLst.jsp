...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"출산보육수당비과세",		Type:"Int",			Hidden:0,	Width:110,	Align:"Right",	ColMerge:0,	SaveName:"notax_baby_mon",		KeyField:0,	Format:"Integer",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
