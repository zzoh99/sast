...
<script type="text/javascript">
	...
	function showRd(){
		...
		let parameters = Utils.encase('<%=session.getAttribute("ssnEnterCd")%>') + ' ';
		parameters += Utils.encase('\'' + $("#searchPayActionCd").val() + '\'') + ' ';
		parameters += Utils.encase('\'' + $("#searchSabun").val() + '\'') + ' ';
		parameters += Utils.encase('00000') + ' ';
		parameters += Utils.encase('A') + ' ';
		parameters += Utils.encase(imgPath);
		parameters += Utils.encase('%') + ' ';
		parameters += Utils.encase('R01') + ' ';
		parameters += Utils.encase('<%=curSysYyyyMMddHyphen%>') + ' ';
		parameters += Utils.encase('\'' + $("#searchSabun").val() + '\'') + ' ';
		parameters += Utils.encase('\'1\'') + ' ';
		parameters += Utils.encase(imgFile);
		if(year*1 >= 2019)  parameters += Utils.encase('\'1\'');

		//todo : 추후에 rdMrd 변경해야됨
		const data = {
			rdMrd : '/' + '<%=cpnYearEndPath%>' + '/' + rdFileNm
...
<%--				<a href="javascript:print();" class="basic authA">출력</a>--%>
				<a href="javascript:showRd();" class="basic authA">출력</a>
            </td>
        </tr>
        </table>
        </div>
    ...
    <table id="comment_table" name="comment_table" border="0" cellpadding="0" cellspacing="0" class="table inner">
	<colgroup>
		<col width="100%" />
	</colgroup>
	<tr>
		<th>2016 ~ 2019년간 퇴직소득세액 계산방법<br>(※ 개정규정 및 종전 규정에 따른 산출세액에 퇴직연도별 비율을 적용하여 계산합니다.)</th>
	</tr>
	</table>
	<!-- table4 start -->
	<div class="outer">
	...
	<tr>
		<th class="center" rowspan="9">개정<br>규정에<br>따른<br>계산<br>방법</th>
	...
	<tr>
		<th class="center" rowspan="3">세액<br>계산</th>
		<th class="center">계 산 내 용</th>
		<th class="center">금 액</th>
	</tr>
	<tr>
	...
	<tr>
		<th>산출세액</th>
		<td class="center"><input id="cal_tax_mon_2016" name="tax_base_mon_2016" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	</table>
	<!-- table4 end -->
	<!-- table5 start -->
    ...
    <table id="bef_table" name="bef_table" border="0" cellpadding="0" cellspacing="0" class="table inner">
	<colgroup>
		<col width="15%" />
		<col width="15%" />
		<col width="25%" />
	...
	<tr>
		<th class="center" rowspan="14">종전<br>규정에<br>따른<br>계산<br>방법</th>
		<th class="center" rowspan="5">과세<br>표준<br>계산</th>
		<th class="center">계 산 내 용</th>
		<th class="center" colspan="3">금 액</th>
	</tr>
	<tr>
		<th>퇴직소득</th>
		<td class="center" colspan="3"><input id="tot_ret_mon" name="tot_ret_mon" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	<tr>
		<th>퇴직소득정률공제</th>
		<td class="center" colspan="3"><input id="income_ded_rate_mon" name="income_ded_rate_mon" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	<tr>
		<th>근속연수공제</th>
		<td class="center" colspan="3"><input id="income_ded_year_mon" name="income_ded_year_mon" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	<tr>
		<th>퇴직소득과세표준</th>
		<td class="center" colspan="3"><input id="tax_base_mon" name="tax_base_mon" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	<tr>
		<th class="center" rowspan="7">세액<br>계산</th>
		<th class="center">계 산 내 용</th>
		<th class="center">2012.12.31.이전</th>
		<th class="center">2013.1.1.이후</th>
	...
	<tr>
		<th>과세표준안분</th>
		<td class="center"><input id="tax_base_mon_2012" name="tax_base_mon_2012" type="text" class="text w100p right transparent" readonly/></td>
		<td class="center"><input id="tax_base_mon_2013" name="tax_base_mon_2013" type="text" class="text w100p right transparent" readonly/></td>
		<td class="center"><input id="tax_base_mon" name="tax_base_mon" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	<tr>
		<th>연평균과세표준</th>
		<td class="center"><input id="ytax_base_mon_2012" name="ytax_base_mon_2012" type="text" class="text w100p right transparent" readonly/></td>
		<td class="center"><input id="ytax_base_mon_2013" name="ytax_base_mon_2013" type="text" class="text w100p right transparent" readonly/></td>
		<td class="center"><input id="ytax_base_mon" name="ytax_base_mon" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	<tr>
		<th>환산과세표준</th>
		<td class="center" style="background:#ebeef0;"></td>
		<td class="center"><input id="conv_base_mon_2013" name="conv_base_mon_2013" type="text" class="text w100p right transparent" readonly/></td>
		<td class="center"><input id="conv_base_mon" name="conv_base_mon" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	<tr>
		<th>환산산출세액</th>
		<td class="center" style="background:#ebeef0;"></td>
		<td class="center"><input id="conv_tax_mon_2013" name="conv_tax_mon_2013" type="text" class="text w100p right transparent" readonly/></td>
		<td class="center"><input id="conv_tax_mon" name="conv_tax_mon" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	<tr>
		<th>연평균산출세액</th>
		<td class="center"><input id="ycal_tax_mon_2012" name="ycal_tax_mon_2012" type="text" class="text w100p right transparent" readonly/></td>
		<td class="center"><input id="ycal_tax_mon_2013" name="ycal_tax_mon_2013" type="text" class="text w100p right transparent" readonly/></td>
		<td class="center"><input id="ycal_tax_mon" name="ycal_tax_mon" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	<tr>
		<th>산출세액</th>
		<td class="center"><input id="cal_tax_mon_2012" name="cal_tax_mon_2012" type="text" class="text w100p right transparent" readonly/></td>
		<td class="center"><input id="cal_tax_mon_2013" name="cal_tax_mon_2013" type="text" class="text w100p right transparent" readonly/></td>
		<td class="center"><input id="cal_tax_mon" name="cal_tax_mon" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	</table>
	<!-- table5 end -->
	<!-- table6 start -->
    ...
    <table id="tax_table" name="tax_table" border="0" cellpadding="0" cellspacing="0" class="table inner">
	<colgroup>
		<col width="15%" />
		<col width="40%" />
		<col width="45%" />
	...
	<tr>
		<th class="center" rowspan="4">퇴직소득<br>세액계산</th>
		<th>퇴직일이 속하는 과세연도</th>
		<td class="center"><input id="tax_year" name="tax_year" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	<tr>
		<th>퇴직소득세 산출세액</th>
		<td class="center"><input id="spc_cal_tax_mon_2016" name="spc_conv_tax_mon" type="text" class="text w100p right transparent" readonly/></td>
	</tr>
	<tr>
