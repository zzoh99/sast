...
<!DOCTYPE html> <html class="hidden"><head><title>연간교육계획승인</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchApplStatusCd, #searchYear").on("change", function(e) {
			doAction1("Search");
		});
		
		var codeList = convCodeCols(ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList", "queryId=getYearEduAprYearCode", false).codeList
        , "sdate,edate"
        , "전체");
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
				...
				//신청내용
				{Header:"신청내용|기준년도",	Type:"Text",  Hidden:0,	Width:60, Align:"Center", ColMerge:1, SaveName:"year",			KeyField:0,	Format:"",		Edit:0 },
				{Header:"신청내용|부서명",		Type:"Text",  Hidden:0,	Width:100,Align:"Left", ColMerge:1, SaveName:"appOrgNm",			KeyField:0,	Format:"",		Edit:0 },
				{Header:"신청내용|인원수", 		Type:"Text",  Hidden:0, Width:80, Align:"Center", ColMerge:1, SaveName:"memCnt", 		KeyField:0,	Format:"",		Edit:0 },
				{Header:"신청내용|교육과목수",	Type:"Text",  Hidden:0, Width:80, Align:"Center", ColMerge:1, SaveName:"eduCnt", 		KeyField:0,	Format:"",		Edit:0 },
				{Header:"신청내용|합계", 		Type:"Int",   Hidden:0, Width:100,Align:"Right", ColMerge:1, SaveName:"sumTotMon", 	KeyField:0,	Format:"",		Edit:0 },
	...
	function doAction1(sAction) {
		...
		case "Search":
			if(!chkInVal()){break;}
			var sXml = sheet1.GetSearchData("${ctx}/YearEduOrgApr.do?cmd=getYearEduOrgAprList", $("#sheet1Form").serialize() );
...
<div class="wrapper">	<form id="sheet1Form" name="sheet1Form" >
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li id="txt" class="txt">연간교육계획승인</li> 
				<li class="btn"> 
