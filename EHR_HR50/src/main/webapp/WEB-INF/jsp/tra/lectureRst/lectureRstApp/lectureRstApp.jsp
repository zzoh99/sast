...
var pGubun = "";
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/LectureRstApp.do?cmd=getLectureRstAppList", $("#sheet1Form").serialize() );
			sheet1.LoadSearchData(sXml );
			break;
        case "Save":   
			if( !confirm('<msg:txt mid="alertDelete" mdef="삭제하시겠습니까?" />')) { initDelStatus(sheet1); return;}
       		IBS_SaveName(document.sheet1Form,sheet1);
        	sheet1.DoSave( "${ctx}/LectureRstApp.do?cmd=deleteLectureRstApp", $("#sheet1Form").serialize(), -1, 0); 
        	break;
        case "Down2Excel":
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li id="txt" class="txt"><tit:txt mid='lectureRstApp' mdef='사내교육결과보고신청'/></li>
				<li class="btn">
					<span><tit:txt mid='112270' mdef='기준년도'/> : </span>
					<input type="text" id="searchYear" name="searchYear" class="text w70 center" value="${curSysYear}" maxlength="4"/>
