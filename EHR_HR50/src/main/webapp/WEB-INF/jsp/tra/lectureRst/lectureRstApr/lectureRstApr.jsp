...
<!DOCTYPE html> <html class="hidden"><head><title>사내교육결과보고신청승인</title>
...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			{Header:"신청내용|수강인원(명)", 	Type:"Int",     Hidden:0, 	Width:80, 	Align:"Center", ColMerge:1, SaveName:"empCnt", 			KeyField:0,	Format:"", 		Edit:0},
	...
	function doAction1(sAction) {
		...
		case "Search":
			if(!chkInVal()){break;}
			var sXml = sheet1.GetSearchData("${ctx}/LectureRstApr.do?cmd=getLectureRstAprList", $("#sheet1Form").serialize() );
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li id="txt" class="txt">사내교육결과보고승인</li> 
				<li class="btn">
