...
var pGubun = "";
	...
	function init_sheet(){
		...
		initdata1.Cols = [
			...
			{Header:"<sht:txt mid='applYmdV6' mdef='신청일자' />",		Type:"Text",	Hidden:0, Width:80,	 Align:"Center", SaveName:"applYmd",		KeyField:0,	Format:"Ymd",	Edit:0 },
			...
			{Header:"<sht:txt mid='payYmV3' mdef='대상년월'/>",	Type:"Date",	Hidden:0, 	Width:80,	Align:"Center", SaveName:"ym",			Format:"Ym",Edit:0 },
			{Header:"<sht:txt mid='eduElCd' mdef='신청항목'/>",	Type:"Combo",	Hidden:0, 	Width:100,	Align:"Center", SaveName:"eduCd",		Format:"",	Edit:0 },
			{Header:"<sht:txt mid='eduDtlCd' mdef='신청세부항목'/>",	Type:"Combo",	Hidden:0, 	Width:150,	Align:"Center", SaveName:"eduDtlCd",	Format:"",	Edit:0 },
			{Header:"<sht:txt mid='eduNmV1' mdef='강좌명'/>",		Type:"Text",	Hidden:0,	Width:300,	Align:"Left",	SaveName:"eduNm",		Format:"", 	Edit:0 },
			{Header:"<sht:txt mid='eduSYm' mdef='강좌시작'/>",	Type:"Date",	Hidden:0, 	Width:80,	Align:"Center", SaveName:"sYm",			Format:"Ym",Edit:0 },
			{Header:"<sht:txt mid='eduEYm' mdef='강좌종료'/>",	Type:"Date",	Hidden:0, 	Width:80,	Align:"Center", SaveName:"eYm",			Format:"Ym",Edit:0 },
		...
		//==============================================================================================================================
		//공통코드 한번에 조회
		var grpCds = "L50110,L50120,R10010";
	...
	function doAction1(sAction) {
		switch (sAction) {
			case "Search":
				sheet1.DoSearch( "${ctx}/EduElApp.do?cmd=getEduElAppList", $("#sheet1Form").serialize() );
	        	break;	
	        case "Save": //임시저장의 경우 삭제처리.      
				if( !confirm('<msg:txt mid="alertDelete" mdef="삭제하시겠습니까?" />')) { initDelStatus(sheet1); return;}
	       		IBS_SaveName(document.sheet1Form,sheet1);
	        	sheet1.DoSave( "${ctx}/EduElApp.do?cmd=deleteEduElApp", $("#sheet1Form").serialize(), -1, 0); 
	        	break;
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li class="txt"><tit:txt mid='eduElApp' mdef='이러닝신청'/></li>
				<li class="btn">
