...
<!DOCTYPE html> <html class="hidden"><head><title>어학시험응시료승인</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchFrom, #searchTo, #searchSabunName, #searchOrgNm, #searchYm").on("keyup", function(event) {
			if( event.keyCode == 13) {
				doAction1("Search");
			}
		});
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			{Header:"신청자|직군",			Type:"Text",   	Hidden:1, Width:80, 	Align:"Center", ColMerge:0,  SaveName:"worktypeNm", 		Edit:0},
			{Header:"신청자|휴대폰번호",		Type:"Text",	Hidden:0,	Width:150,	Align:"Center",	SaveName:"phoneNo",		Format:"", 	Edit:0 },
			{Header:"신청자|이메일주소",		Type:"Text",	Hidden:0,	Width:150,	Align:"Center",	SaveName:"mailId",		Format:"", 	Edit:0 },
			
			//신청내용
			{Header:"신청내용|대상년월",		Type:"Date",	Hidden:0, 	Width:80,	Align:"Center", SaveName:"ym",			Format:"Ym",Edit:0 },
			{Header:"신청내용|신청항목",		Type:"Combo",	Hidden:0, 	Width:100,	Align:"Center", SaveName:"eduCd",		Format:"",	Edit:0 },
			{Header:"신청내용|신청세부항목",	Type:"Combo",	Hidden:0, 	Width:150,	Align:"Center", SaveName:"eduDtlCd",	Format:"",	Edit:0 },
			{Header:"신청내용|강좌명",		Type:"Text",	Hidden:0,	Width:300,	Align:"Left",	SaveName:"eduNm",		Format:"", 	Edit:0 },
			{Header:"신청내용|강좌시작",		Type:"Date",	Hidden:1, 	Width:80,	Align:"Center", SaveName:"sYm",			Format:"Ym",Edit:0 },
			{Header:"신청내용|강좌종료",		Type:"Date",	Hidden:1, 	Width:80,	Align:"Center", SaveName:"eYm",			Format:"Ym",Edit:0 },
	...
	function getCommonCodeList() {
		...
		sheet1.SetColProperty("eduCd", 			{ComboText:"|"+codeLists["L50110"][0], ComboCode:"|"+codeLists["L50110"][1]} );//  신청항목
		sheet1.SetColProperty("eduDtlCd", 		{ComboText:"|"+codeLists["L50120"][0], ComboCode:"|"+codeLists["L50120"][1]} );//  신청상세항목
		//==============================================================================================================================
	}
	...
	function doAction1(sAction) {
		...
		case "Search":
			if(!chkInVal()){break;}
			var sXml = sheet1.GetSearchData("${ctx}/EduElApr.do?cmd=getEduElAprList", $("#sheet1Form").serialize() );
...
<div class="wrapper">
	...
	<div class="sheet_search outer">
		...
		<tr>
			...
			<th>대상년월</th>
			<td>
				<input type="text" id="searchYm" name="searchYm" class="date2 w70" value="">
			</td>
			<td>
