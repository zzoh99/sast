...
<!DOCTYPE html> <html class="hidden"><head><title>교육결과승인</title>
...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			{Header:"신청내용|교육구분",		Type:"Combo",		Hidden:1,	Width:150,	Align:"Left",	ColMerge:0,	SaveName:"eduBranchCd",		KeyField:0,	Format:"",		Edit:0},
			{Header:"신청내용|교육분류",		Type:"Combo",		Hidden:1,	Width:150,	Align:"Left",	ColMerge:0,	SaveName:"eduMBranchCd",	KeyField:0,	Format:"",		Edit:0},
	...
	function doAction1(sAction) {
		...
		case "Search":
			if(!chkInVal()){break;}
			var sXml = sheet1.GetSearchData("${ctx}/EduResultApr.do?cmd=getEduResultAprList", $("#sheet1Form").serialize() );
