...
<!DOCTYPE html> <html class="hidden"><head><title>교육취소승인</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchFrom, #searchTo, #searchSabunName, #searchOrgNm, #searchEduCourseNm, #searchEduSYmd, #searchEduEYmd").on("keyup", function(event) {
			if( event.keyCode == 13) {
				doAction1("Search");
			}
		});
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			//신청내용
			{Header:"교육과정|과정코드",		Type:"Text",	Hidden:1,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"eduSeq",			KeyField:0,	Format:"",		Edit:0},
			{Header:"교육과정|과정명",		Type:"Text",	Hidden:0,	Width:250,	Align:"Left",	ColMerge:0,	SaveName:"eduCourseNm",		KeyField:0,	Format:"",		Edit:0},
			{Header:"교육과정|사내/외",  	Type:"Combo",   Hidden:0,   Width:80,   Align:"Center", ColMerge:0, SaveName:"inOutType",  		KeyField:0, Format:"",      Edit:0},
			{Header:"교육과정|시행방법",  	Type:"Combo",   Hidden:1,   Width:80,   Align:"Center", ColMerge:0, SaveName:"eduMethodCd",  	KeyField:0, Format:"",      Edit:0},
			{Header:"교육과정|교육구분",		Type:"Combo",	Hidden:0,	Width:150,	Align:"Left",	ColMerge:0,	SaveName:"eduBranchCd",		KeyField:0,	Format:"",		Edit:0},
			{Header:"교육과정|교육분류",		Type:"Combo",	Hidden:0,	Width:150,	Align:"Left",	ColMerge:0,	SaveName:"eduMBranchCd",	KeyField:0,	Format:"",		Edit:0},
			{Header:"교육과정|교육시작일",	Type:"Date",	Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"eduSYmd",			KeyField:0,	Format:"Ymd",	Edit:0},	
			{Header:"교육과정|교육종료일",	Type:"Date",	Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"eduEYmd",			KeyField:0,	Format:"Ymd",	Edit:0},	
			{Header:"신청내용|취소사유",		Type:"Combo",	Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"gubunCd",			KeyField:0,	Format:"",		Edit:0},
			{Header:"신청내용|취소상세내용",	Type:"Text",	Hidden:0,	Width:250,	Align:"Left",	ColMerge:0,	SaveName:"appMemo",			KeyField:0,	Format:"",		Edit:0},
	...
	function getCommonCodeList() {
		//==============================================================================================================================
		//공통코드 한번에 조회
		let grpCds = "L20020,L10050,L10010,L10015,L90100";
	...
	function doAction1(sAction) {
		...
		case "Search":
			if(!chkInVal()){break;}
			var sXml = sheet1.GetSearchData("${ctx}/EduCancelApr.do?cmd=getEduCancelAprList", $("#sheet1Form").serialize() );
