...
//            {Header:"재직상태",     Type:"Combo",     Hidden:0,  Width:60,   Align:"Center",  ColMerge:0,   SaveName:"statusCd",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
            ...
            //{Header:"아침시작\n시간",	Type:"Text",	Hidden:0,	Width:50,	Align:"Center",	ColMerge:0,	SaveName:"morningSHm",					Format:"##:##",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:10 },
            ...
            {Header:"골프장\n여부",		Type:"Combo",	Hidden:0,	Width:50,	Align:"Center",	ColMerge:0,	SaveName:"golfYn",			KeyField:1, 														UpdateEdit:1,	InsertEdit:1  },
            {Header:"주간근로\n시간",	Type:"Text",	Hidden:0,	Width:50,	Align:"Center",	ColMerge:0,	SaveName:"tgDayTime",							Format:"",	Edit:0 },
            {Header:"야간근로\n시간",	Type:"Text",	Hidden:0,	Width:50,	Align:"Center",	ColMerge:0,	SaveName:"tgNightTime",						Format:"",	Edit:0 },
            {Header:"연장근로\n시간",	Type:"Text",	Hidden:0,	Width:50,	Align:"Center",	ColMerge:0,	SaveName:"tgOverTime",							Format:"",	Edit:0 },            
		...
		// 골프장여부
		sheet1.SetColProperty("golfYn", 			{ComboText:"선택|N|Y", ComboCode:"|N|Y"} );
        ...
        //var firstdayYmd = "${curSysYear}" + "${curSysMon}" + "01";
        //var lastdayYmd = "${curSysYear}" + "${curSysMon}" +  getMonthEndDate("${curSysYear}","${curSysMon}");
    ...
    function doAction1(sAction) {
        ...
        case "Search":
            ...
            sheet1.DoSearch( "${ctx}/GetDataList.do?cmd=getExWorkDriverCalcSList", $("#srchFrm").serialize() ); break;
        case "Save":
        	if(!dupChk(sheet1,"sabun|enterCd|workGubun|sdate", false, true)){break;}
            // 미처리 상태의 건에 대한 update
            IBS_SaveName(document.srchFrm,sheet1);
            sheet1.DoSave( "${ctx}/SaveData.do?cmd=saveExWorkDriverCalcS", $("#srchFrm").serialize()); break;
		case "Insert":
		...
		case "DownTemplate":
			// 양식다운로드
			sheet1.Down2Excel({ SheetDesign:1, Merge:1, DownRows:"0", DownCols:"4|7|8|9|10|15|16|17"});		
		break;
        }
    }
	...
	function doCallPrc(step) {
	    ...
	    var data = ajaxCall("${ctx}/ExecPrc.do?cmd=prcExWorkDriverCalcS", param, false);
            ...
            <td>
                <div class="inner">
                    <div class="sheet_title">
                        <ul>
                            <li id="txt" class="txt">특근수당(기원)계산</li>
                            <li class="btn">
