...
<!DOCTYPE html> <html class="hidden"><head> <title>특근수당(기원)종합신청</title>
...
<script type="text/javascript">
	...
	$(function() {		
		...
		initdata2.Cols = [
			...
			{Header:"직위",				Type:"Text",			Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,		SaveName:"jikweeNm",	KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },   
   			{Header:"근무년월", 		Type:"Date",			Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,		SaveName:"workYm",		KeyField:0,	Format:"Ym",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 },   			
			{Header:"특근수당",		Type:"AutoSum",	Hidden:0,	Width:120,	Align:"Right",	ColMerge:0,	SaveName:"payMon",		KeyField:0,	Format:"Integer",			PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:35 },
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "${ctx}/GetDataList.do?cmd=getExWorkDriverSAppList",param );
			break;
        case "Save":        	
        	IBS_SaveName(document.sheet1Form,sheet1);
        	// 삭제 처리만 저장
        	sheet1.DoSave( "${ctx}/ExWorkDriverSApp.do?cmd=deleteExWorkDriverSApp", $("#sheet1Form").serialize()); break;			
		case "Down2Excel":
	...
	function doAction2(sAction) {
		...
		case "Search":
			...
			sheet2.DoSearch( "${ctx}/GetDataList.do?cmd=getExWorkDriverSAppDetailList",param );
			break;
		case "Down2Excel":
