...
<!DOCTYPE html> <html class="hidden"><head> <title><tit:txt mid="202005150000133" mdef="수당지급신청내역" /></title>
...
<script type="text/javascript">
	...
	$(function() {		
		...
		initdata1.Cols = [
			...
			{Header:"<sht:txt mid='sDelete' mdef='삭제' />",	Hidden:0,	Width:"${sDelWdt}",	Align:"Center",	ColMerge:0,	SaveName:"sDelete",	Sort:0 },
		...
		initdata2.Cols = [
			...
			{Header:"<sht:txt mid='sabun' mdef='사번' />",			Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"sabun",				KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:13 },
			{Header:"<sht:txt mid='orgNm' mdef='소속' />",			Hidden:0,	Width:120,	Align:"Center",	ColMerge:0,	SaveName:"orgNm",				KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
			{Header:"<sht:txt mid='jikgubNm' mdef='직급' />",			Hidden:1,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"jikgubNm",		KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
			{Header:"<sht:txt mid='seq' mdef='순번' />",			Hidden:1,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"seq",				KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:13 },
			{Header:"<sht:txt mid='benefitBizNm' mdef='수당명' />",			Hidden:1,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"benefitBizNm",	KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
		...
		var deptPartPayAppBnCd = convCode(ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList", "queryId=getDeptPartPayAppBnCdList", false).codeList, allText);
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "${ctx}/DeptPartPayApp.do?cmd=getDeptPartPayAppList",param );
			break;
        case "Save":        	
        	IBS_SaveName(document.sheet1Form,sheet1);
        	// 삭제 처리만 저장
        	sheet1.DoSave( "${ctx}/DeptPartPayApp.do?cmd=deleteDeptPartPayApp", $("#sheet1Form").serialize()); break;			
		case "Down2Excel":
	...
	function doAction2(sAction) {
		...
		case "Search":
			...
			sheet2.DoSearch( "${ctx}/DeptPartPayApp.do?cmd=getDeptPartPayAppDetailList",param );
			break;
		case "Down2Excel":
			...
			<div>
				<table>
					<tr>
						...
						<td>  <select id="deptPartPayAppBnCd" name="deptPartPayAppBnCd"> </select></td>
	...
	<tr>
		<td class="sheet_left">
			<div class="inner">
				...
				<ul>
					<li class="txt"><tit:txt mid="202005150000133" mdef="수당지급신청내역" /></li>
					<li class="btn">
