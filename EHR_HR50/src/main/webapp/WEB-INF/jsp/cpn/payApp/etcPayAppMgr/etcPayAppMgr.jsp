...
//========================================================================================================================
		...
		// 수당명 
		var etcPayAppBnCd = convCode(ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList", "queryId=getEtcPayAppBnCdList", false).codeList, "전체");
...
//========================================================================================================================
	...
	function doAction1(sAction) {
		...
		case "Search":
						...
						sheet1.DoSearch( "${ctx}/GetDataList.do?cmd=getEtcPayAppMgrList",param );
						
						break;
		case "Save":
						IBS_SaveName(document.sendForm,sheet1);
						sheet1.DoSave( "${ctx}/EtcPayAppMgr.do?cmd=saveEtcPayAppMgr", $("#sendForm").serialize());						
	...
	function doAction2(sAction) {
		...
		case "Search":
						...
						sheet2.DoSearch( "${ctx}/GetDataList.do?cmd=getEtcPayAppMgrDetailList",param );
						break;
		case "Down2Excel":
	...
	<div class="sheet_search outer">
		...
		<table>
			<tr>
				...
				<th>수당명</th>
				<td>
					<select id="etcPayAppBnCd" name="etcPayAppBnCd" onchange="javascript:doAction1('Search');"></select>
				</td>
				<th>확인여부</th>
				<td colspan="2">
