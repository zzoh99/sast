...
//========================================================================================================================
		...
		// 시간외수당(기원)급여비교 수당명 
		var etcPayAppBnCd = convCode(ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList", "queryId=getDriverPayRealChaMonBnCdList", false).codeList, "전체");
		$("#searchBenefitBizCd").html(etcPayAppBnCd[2]);
...
//========================================================================================================================
        ...
        initdata.Cols = [
            ...
            {Header:"급여일자",			Type:"Text",		Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"payActionNm",		KeyField:0,                   Format:"",   PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
    ...
    function doAction1(sAction) {
        ...
        case "Search":			
			...
			sheet1.DoSearch( "${ctx}/GetDataList.do?cmd=getDriverPayRealChaMonList", $("#srchFrm").serialize() ); break;
		case "Down2Excel":
            ...
            <td>
                <div class="inner">
                    <div class="sheet_title">
                        <ul>
                            <li id="txt" class="txt">시간외수당(기원)급여비교</li>
                            <li class="btn">
