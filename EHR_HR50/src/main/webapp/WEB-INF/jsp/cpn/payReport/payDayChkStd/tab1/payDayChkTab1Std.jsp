...
<script type="text/javascript">
    $(function() {
        ...
        initdata.Cols = [
				...
				*/
				{Header:"<sht:txt mid='temp2' mdef='세부\n내역'/>",    	 Type:"Image",     	Hidden:0,  	Width:40,	Align:"Center", ColMerge:0, SaveName:"detail" ,  KeyField:0,   CalcLogic:"",           PointCount:0,   UpdateEdit:0,   InsertEdit:0,    Cursor:"Pointer"},
				...
				{Header:"<sht:txt mid='dayChkTypeNm' mdef='일할구분'/>",        Type:"Text",     	Hidden:0,  	Width:100,  Align:"Center", ColMerge:1, SaveName:"dayChkTypeNm",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
				{Header:"<sht:txt mid='ordDetailCdV3' mdef='발령종류'/>",        Type:"Combo",    	Hidden:0,  	Width:100,  Align:"Center", ColMerge:1, SaveName:"ordDetailCd",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
				{Header:"<sht:txt mid='ordDetailReasonV1' mdef='발령사유'/>",         Type:"Combo",    	Hidden:0,  	Width:100,  Align:"Center", ColMerge:1, SaveName:"ordDetailReason",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
				...
				{Header:"<sht:txt mid='elementSetCdV3' mdef='적용항목그룹'/>", 		 Type:"Combo", 	Hidden:0,  	Width:120,  Align:"Center", ColMerge:1, SaveName:"elementSetCd",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
				{Header:"<sht:txt mid='rateV4' mdef='휴직감율(%)'/>",      Type:"Float",    	Hidden:0, 	Width:75,   Align:"Center", ColMerge:1, SaveName:"rate",             KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:1,   EditLen:6 },
				{Header:"<sht:txt mid='payActionCd' mdef='급여일자'/>",      Type:"Text",     	Hidden:1, 	Width:75,   Align:"Center", ColMerge:1, SaveName:"payActionCd",             KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:1,   EditLen:6 }
    ...
    function doAction(sAction) {
        switch (sAction) {
        case "Search":      sheet1.DoSearch( "${ctx}/PayDayChkStd.do?cmd=getPayDayChkTab1StdList", $("#mySheetForm", parent.document).serialize()); break;
        case "Save":
			IBS_SaveName(document.sheet1Form,sheet1);
        	sheet1.DoSave( "${ctx}/PayDayChkStd.do?cmd=savePayDayChkTab1Std", $("#mySheetForm", parent.document).serialize()); break;
            ...
            <td>
                <div class="inner">
                    <div class="sheet_title">
                        <ul>
                            <li id="txt" class="txt"><tit:txt mid='ordDetail' mdef='발령'/></li>
                            <li class="btn">
