...
$(function() {
	...
	initdata1.Cols = [
		...
		{Header:"항목명",	Type:"Text",		Hidden:0,	Width:80,			Align:"Left",	ColMerge:0,	SaveName:"elementNm",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
		{Header:"금액",		Type:"Text",		Hidden:0,	Width:80,			Align:"Right",	ColMerge:0,	SaveName:"resultMon",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
		{Header:"항목명",	Type:"Text",		Hidden:0,	Width:80,			Align:"Left",	ColMerge:0,	SaveName:"elementNm2",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
		{Header:"금액",		Type:"Text",		Hidden:0,	Width:80,			Align:"Right",	ColMerge:0,	SaveName:"resultMon2",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 }
...
function doAction1(sAction) {
	switch (sAction) {
		case "Search":
			...
			// 퇴직금계산내역 조회
			sheet1.DoSearch("${ctx}/SepEmpRsMgr.do?cmd=getSepEmpRsMgrSeverancePayCalcList", $("#sheet1Form").serialize());

/*			var severancePayCalcInfo = ajaxCall("${ctx}/SepEmpRsMgr.do?cmd=getSepEmpRsMgrSeverancePayCalcList", $("#sheet1Form").serialize(), false);
...
<div class="inner">
	<script type="text/javascript">createIBSheet("sheet1", "50%", "52%", "kr"); </script>
</div>
