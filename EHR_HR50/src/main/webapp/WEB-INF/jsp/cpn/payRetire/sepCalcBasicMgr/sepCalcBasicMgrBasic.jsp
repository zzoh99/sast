	...
	switch (sAction) {
		...
		case "Save":
			...
			if (confirm("IRP정보를 저장하시겠습니까?")) {
				...
				var result = ajaxCall("${ctx}/SepCalcBasicMgr.do?cmd=saveSepCalcBasicMgrIrpInfo", $("#sheet1Form").serialize(), false);
...
<form id="sheet1Form" name="sheet1Form">
	...
	<table border="0" cellpadding="0" cellspacing="0" class="default outer">
		...
		<tr>
			...
			<td id="tdRetYmd" class="center" colspan="2"> </td>
		</tr>
		<tr>
			<th>최종중간정산일</th>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="default outer hide">
		...
		<tr>
			...
			<th>작업일자</th>
			<td colspan="3"> <input type="text" id="paymentYmd" name="paymentYmd" class="date2 readonly" readonly /> </td>
		</tr>
		<tr>
			<th>법정제외기간</th>
			<td colspan="3"> <input type="text" id="" name="" class="date2 readonly" readonly /> ~ <input type="text" id="" name="" class="date2 readonly" readonly /> </td>
			<th>법정제외일수</th>
			<td> <input type="text" id="" name="" class="text readonly" style="width:60px;" readonly /> </td>
			<th>법정제외월수</th>
		...
		<tr>
			<th>정산기간</th>
			<td colspan="3"> <input type="text" id="sepSymd" name="sepSymd" class="date2 readonly" readonly /> ~ <input type="text" id="sepEymd" name="sepEymd" class="date2 readonly" readonly /> </td>
			<th>법정가산월수</th>
		...
		<tr>
			<th>수령구분</th>
			<td colspan="7"> <input type="radio" id="retCorp" name="retCorp" class="radio" value="" disabled /> 본인수령
