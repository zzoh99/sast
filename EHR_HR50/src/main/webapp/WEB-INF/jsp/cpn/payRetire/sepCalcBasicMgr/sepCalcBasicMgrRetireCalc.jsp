...
function doAction1(sAction) {
	switch (sAction) {
		case "Search":
			...
			// 지급내역 조회
			sheet1.DoSearch("${ctx}/SepCalcBasicMgr.do?cmd=getSepCalcBasicMgrRetireCalcPayList", $("#sheet1Form").serialize());
			break;
...
function doAction2(sAction) {
	switch (sAction) {
		case "Search":
			...
			// 공제내역 조회
			sheet2.DoSearch("${ctx}/SepCalcBasicMgr.do?cmd=getSepCalcBasicMgrRetireCalcDeductionList", $("#sheet1Form").serialize());
			break;
	...
	<colgroup>
		...
		<tr>
			<td class="top">
				...
				<script type="text/javascript">createIBSheet("sheet1", "50%", "99%", "${ssnLocaleCd}"); </script>
			</td>
			<td></td>
			<td class="top">
				<div>
				...
				<script type="text/javascript">createIBSheet("sheet2", "50%", "99%", "${ssnLocaleCd}"); </script>
			</td>
		</tr>
	</table>
</div>
