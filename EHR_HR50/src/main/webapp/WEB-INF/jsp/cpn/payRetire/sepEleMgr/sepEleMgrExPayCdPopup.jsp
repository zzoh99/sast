...
$(function() {
	...
	initdata1.Cols = [
		...
		{Header:"<sht:txt mid='payActionCdV4' mdef='급여코드'/>",	Type:"Combo",		Hidden:0,					Width:100,			Align:"Left",	ColMerge:0,	SaveName:"payCd",		KeyField:1,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:10 }
...
<div class="wrapper">
	...
	<ul>
		<li><tit:txt mid='sepEleMgrExPayCdPopup' mdef='제외급여코드'/></li>
		<li class="close"></li>
	</ul>
	</div>
	<div class="popup_main">
		...
		<div class="popup_button outer">
			<ul>
				<li>
					<a href="javascript:pClose();" class="gray large"><tit:txt mid='104157' mdef='닫기'/></a>
				</li>
			</ul>
		</div>
	</div>
