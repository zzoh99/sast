...
<!DOCTYPE html> <html class="hidden"> <head> <title>퇴직금결과내역 전근무지사항</title>
...
function doAction1(sAction) {
	switch (sAction) {
		case "Search":
			...
			var beforeWorkInfo = ajaxCall("${ctx}/SepCalcResultSta.do?cmd=getSepCalcResultStaBeforeWorkMap", $("#sheet1Form").serialize(), false);
