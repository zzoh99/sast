...
<script type="text/javascript">
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"<sht:txt mid='sStatus' mdef='상태|상태'/>",                Type:"${sSttTy}",   Hidden:Number("${sSttHdn}"),Width:"${sSttWdt}", Align:"Center", ColMerge:0, SaveName:"sStatus", Sort:0 },
             ...
             {Header:"<sht:txt mid='confirm1Mon' mdef='1차|확정금액'/>",        Type:"Float",     Hidden:0,  Width:100,  Align:"Right",     ColMerge:0,   SaveName:"confirm1Mon",       KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
             {Header:"<sht:txt mid='confirm1Yn' mdef='1차|확정여부(Y/N)'/> ",   Type:"CheckBox",  Hidden:0,  Width:60,   Align:"Center",    ColMerge:0,   SaveName:"confirm1Yn",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
             {Header:"<sht:txt mid='confirm2Mon' mdef='2차|확정금액'/>",        Type:"Float",     Hidden:0,  Width:100,  Align:"Right",     ColMerge:0,   SaveName:"confirm2Mon",       KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
             {Header:"<sht:txt mid='confirm2Yn' mdef='2차|확정여부(Y/N)'/> ",   Type:"CheckBox",  Hidden:0,  Width:60,   Align:"Center",    ColMerge:0,   SaveName:"confirm2Yn",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 }
    ...
    function doAction1(sAction) {
        ...
        case "Search":
        	//소계
        	var info = [{StdCol:"yyyy", SumCols:"rate|confirm1Mon|confirm2Mon", CaptionCol:"yyyy"}];
            sheet1.ShowSubSum(info) ;
            
        	sheet1.DoSearch( "${ctx}/BonusConfirm2.do?cmd=getBonusConfirm2List", $("#srchFrm").serialize() ); 
        	break;
        case "Confirm":     sheet1.CheckAll("confirm2Yn", 1, false ); break;
        case "Save":
                            IBS_SaveName(document.srchFrm,sheet1);
                            sheet1.DoSave( "${ctx}/BonusConfirm2.do?cmd=saveBonusConfirm2", $("#srchFrm").serialize() ); break;
        case "Down2Excel":
            
            var downcol = "yyyy|orgNm|sabun|name";
            sheet1.Down2Excel({ SheetDesign:1, Merge:1, ExcelFontSize:"9",ExcelRowHeight:"20", DownRows:"0", DownCols:downcol});
            ...
            <td>
                <div class="inner">
                    <div class="sheet_title">
                        <ul>
                            <li id="txt" class="txt"><tit:txt mid='BonusGrpMgr' mdef='성과급평가2차'/></li>
                            <li class="btn">
