...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#searchYear").val(year);
        $("#searchBonusType").val("DIV");
        // 1번 그리드
        var initdata1 = {};
        initdata1.Cfg = {FrozenCol:4, SearchMode:smLazyLoad,Page:10};
        ...
        initdata1.Cols = [
                ...
                {Header:"<sht:txt mid='gapMon' mdef='차액 '/>",                      Type:"Float",     Hidden:0,  Width:150,   Align:"Right",    ColMerge:0,   SaveName:"gapMon",               KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 }
        ];
        ...
        initdata2.Cols = [
            ...
            {Header:"<sht:txt mid='yyyy' mdef='성과급연도'/>",      Type:"Text",      Hidden:1,  Width:100,   Align:"Center",    ColMerge:1,   SaveName:"yyyy",          KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            {Header:"<sht:txt mid='bonusGrp' mdef='성과급그룹'/>",  Type:"Combo",     Hidden:0,  Width:100,   Align:"Center",    ColMerge:1,   SaveName:"bonusGrp",          KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            {Header:"<sht:txt mid='orgNm' mdef='소속'/>",           Type:"Text",      Hidden:0,  Width:80,    Align:"Center",    ColMerge:1,   SaveName:"orgNm",             KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            {Header:"<sht:txt mid='sabun' mdef='사번'/>",           Type:"Text",      Hidden:0,  Width:100,   Align:"Center",    ColMerge:1,   SaveName:"sabun",             KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            {Header:"<sht:txt mid='name' mdef='성명'/>",            Type:"Text",      Hidden:0,  Width:100,   Align:"Center",    ColMerge:1,   SaveName:"name",              KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            {Header:"<sht:txt mid='jikweeNm' mdef='직위'/>",        Type:"Text",      Hidden:0,  Width:60,    Align:"Center",    ColMerge:1,   SaveName:"jikweeNm",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            {Header:"<sht:txt mid='jikchakNm' mdef='직책'/>",       Type:"Text",      Hidden:0,  Width:60,    Align:"Center",    ColMerge:1,   SaveName:"jikchakNm",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            {Header:"<sht:txt mid='rate' mdef='할당계수'/>",        Type:"Float",     Hidden:0,  Width:100,   Align:"Right",     ColMerge:1,   SaveName:"rate",              KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:2,   UpdateEdit:1,   InsertEdit:0,   EditLen:100 },
            {Header:"<sht:txt mid='planMon' mdef='할당금액'/>",     Type:"Float",     Hidden:0,  Width:100,   Align:"Right",     ColMerge:1,   SaveName:"planMon",           KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:0,   UpdateEdit:1,   InsertEdit:0,   EditLen:100 },
            {Header:"<sht:txt mid='resultMon' mdef='확정금액'/>",   Type:"Float",     Hidden:0,  Width:100,   Align:"Right",     ColMerge:1,   SaveName:"resultMon",         KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:0,   UpdateEdit:1,   InsertEdit:0,   EditLen:100 }
    ...
    function doAction1(sAction) {
        switch (sAction) {
            case "Search":
                sheet1.DoSearch( "${ctx}/BonusDiv.do?cmd=getBonusDivList", $("#srchFrm").serialize() );
                break;
        }
    }
    ...
    function doAction2(sAction) {
        ...
        if ( (sheet1.GetCellValue(sheet1.GetSelectRow(),"sStatus")=="I") && !(sAction=="Search") ) {
           ...
           switch (sAction) {
             case "Search":      
                 //소계
              var info = [{StdCol:"bonusGrp", SumCols:"rate|planMon|resultMon", CaptionCol:"bonusGrp"}];
              sheet2.ShowSubSum(info) ;
              
                 sheet2.DoSearch( "${ctx}/BonusDiv.do?cmd=getBonusDivDetailList", $("#srchFrm").serialize() ); 
                 break;
           case "Create":
               callProcCreate();
               break;
           ...
           case "Save":       
               ...
               sheet2.DoSave( "${ctx}/BonusDiv.do?cmd=saveBonusDiv", $("#srchFrm").serialize() ); 
               break;
           case "Down2Excel":
        ...
        <tr>
            <td> 
                <div class="outer">
                    <div class="sheet_title">
                    <ul>
                        <li class="txt"><tit:txt mid='textFileMgr2' mdef='성과급배분'/></li>
                        <li class="btn">
                          <btn:a href="javascript:doAction2('Create')" css="basic authA" mid='110700' mdef="대상자 생성"/>
                          <btn:a href="javascript:doAction2('DivExe')"   css="basic authA" mid='110696' mdef="배분실행"/>
