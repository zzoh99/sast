...
$(function() {
	...
	initdata1.Cols = [
	        		...
	        		{Header:"직책",		Type:"Combo",		Hidden:0,					Width:60,			Align:"Center",	ColMerge:0,	SaveName:"jikchakCd",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 },
	        		{Header:"직위",		Type:"Combo",		Hidden:0,					Width:60,			Align:"Center",	ColMerge:0,	SaveName:"jikweeCd",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 },
...
function chkInVal(sAction) {
	if ($("#payActionCd1").val() == "" || $("#payActionCd2").val() == "") {
		alert("급여일자1 및 급여일자2를 선택하시기 바랍니다.");
		$("#payActionNm1").focus();
		return false;
	}else{
...
function doAction1(sAction) {
	switch (sAction) {
		case "Search":
			...
			sheet1.DoSearch("${ctx}/PayChgMonPerEleSta2.do?cmd=getPayChgMonPerEleMltSta2List", $("#sheet1Form").serialize());
			break;
...
function searchTitleList() {
	...
	if (titleList != null && titleList.DATA != null) {
		...
		initdata1.Cols[3] = {Header:"소속",		Type:"Text",		Hidden:0,					Width:120,			Align:"Left",	ColMerge:0,	SaveName:"orgNm",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 };
		initdata1.Cols[4] = {Header:"사번",		Type:"Text",		Hidden:0,					Width:70,			Align:"Center",	ColMerge:0,	SaveName:"sabun",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:13 };
		initdata1.Cols[5] = {Header:"성명",		Type:"Text",		Hidden:0,					Width:60,			Align:"Center",	ColMerge:0,	SaveName:"name",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 };
		initdata1.Cols[6] = {Header:"직책",		Type:"Combo",		Hidden:0,					Width:60,			Align:"Center",	ColMerge:0,	SaveName:"jikchakCd",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 };
		initdata1.Cols[7] = {Header:"직위",		Type:"Combo",		Hidden:0,					Width:60,			Align:"Center",	ColMerge:0,	SaveName:"jikweeCd",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 };
...
function payActionSearchPopup(id) {
	if(!isPopup()) {return;}
	gPRow = "";
	pGubun = "payDayMultiLayer"+id;

	let payDayMultiLayer = new window.top.document.LayerModal({
		id : 'payDayMultiLayer'
		, url : '/PayDayPopup.do?cmd=viewPayDayMultiLayer&authPg=R'
		, parameters : {
	...
	payDayMultiLayer.show();
}

function getReturnValue(rv) {
	if(pGubun == "payDayMultiLayer1"){
		$("#payActionCd1").val(rv["payActionCd"]);
		$("#payActionNm1").val(rv["payActionNm"]);
    }else if(pGubun == "payDayMultiLayer2"){
				...
				<table>
					<tr>
						...
						<td> 
							...
							<input type="text" id="payActionNm1" name="payActionNm1" class="text required readonly" value="" readonly style="width:380px" />
							<a href="javascript:payActionSearchPopup('1');" class="button6"><img src="/common/${theme}/images/btn_search2.gif"/></a>
						</td>
						<th>급여일자2</th>
						<td> 
							<input type="hidden" id="payActionCd2" name="payActionCd2" value="" />
							<input type="text" id="payActionNm2" name="payActionNm2" class="text required readonly" value="" readonly style="width:380px" />
							<a href="javascript:payActionSearchPopup('2');" class="button6"><img src="/common/${theme}/images/btn_search2.gif"/></a>
						</td>
					</tr>
					<tr>
						<th>수당/공제</th>
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt">급여변동내역(당전차)</li>
							<li class="btn">
