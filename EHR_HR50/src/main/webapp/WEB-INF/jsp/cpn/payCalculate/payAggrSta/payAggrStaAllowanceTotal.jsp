...
<!DOCTYPE html> <html class="hidden"> <head> <title><tit:txt mid='payAggrStaAllowanceTotal' mdef='수당집계'/></title>
	...
	switch (sAction) {
		case "Search":
			if (parent.$("#payActionCd").val() != null && parent.$("#payActionCd").val() != "") {
				...
				sheet1.DoSearch("${ctx}/PayAggrSta.do?cmd=getPayAggrStaAllowanceTotalList", $("#sheet1Form").serialize());
			}
			break;
			...
			<td>
				<div class="outer">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt"><tit:txt mid='payAggrStaAllowanceTotal' mdef='수당집계'/></li>
							<li class="btn">
