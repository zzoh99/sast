...
<!DOCTYPE html> <html class="hidden"> <head> <title><tit:txt mid='payAggrStaDeductionTotal' mdef='공제집계'/></title>
...
$(function() {
	...
	initdata1.Cols = [
		...
		{Header:"<sht:txt mid='sawonCnt' mdef='대상자수'/>",	Type:"Int",			Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"sawonCnt",	KeyField:0,	Format:"Integer",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='nowMon' mdef='당월금액'/>",	Type:"AutoSum",		Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"resultMon",	KeyField:0,	Format:"Integer",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 }
	...
	switch (sAction) {
		case "Search":
			if (parent.$("#payActionCd").val() != null && parent.$("#payActionCd").val() != "") {
				...
				sheet1.DoSearch("${ctx}/PayAggrSta.do?cmd=getPayAggrStaDeductionTotalList", $("#sheet1Form").serialize());
			}
			break;
			...
			<td>
				<div class="outer">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt"><tit:txt mid='payAggrStaDeductionTotal' mdef='공제집계'/></li>
							<li class="btn">
