...
var searchSabun = "";
	...
	$(function() {
		...
		const modal = window.top.document.LayerModalUtility.getModal('payDayMgrLayer2');
...
<script type="text/javascript">
	...
	function doAction2(sAction) {
		switch (sAction) {
			case "Search":
				sheet2.DoSearch( "${ctx}/PayDayMgr.do?cmd=getPayDayChPopupList", $("#mySheetForm").serialize() );
				break;
			case "Insert" :
...
<%--						<script type="text/javascript"> createIBSheet("sheet1", "50%", "100%", "${ssnLocaleCd}"); </script>--%>
		...
		<div class="modal_footer">
			<a href="javascript:closeCommonLayer('payDayMgrLayer2');" class="btn outline_gray">닫기</a>
		</div>
	</div>
</body>
</html>