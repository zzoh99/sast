...
<!DOCTYPE html> <html class="hidden"> <head> <title><tit:txt mid='payRateTab1Std' mdef='휴직'/></title>
...
<script type="text/javascript">
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"<sht:txt mid='ordDetailCdV2' mdef='발령종류|발령종류'/>",   Type:"Combo",     Hidden:0,  Width:100,  Align:"Center",  ColMerge:1,   SaveName:"ordDetailCd",      KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
            {Header:"SEQ|SEQ",                   Type:"Text",      Hidden:0,  Width:0,    Align:"Center",  ColMerge:1,   SaveName:"seq",              KeyField:1,   CalcLogic:"",   Format:"NullFloat",   PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:22 },				
            {Header:"발령사유|발령사유",         Type:"Combo",     Hidden:1,  Width:100,  Align:"Center",  ColMerge:1,   SaveName:"ordDetailReason",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
            {Header:"<sht:txt mid='fWorkMonth' mdef='근속개월|From(이상)'/>",       Type:"Int",       Hidden:0,  Width:70,   Align:"Center",  ColMerge:0,   SaveName:"fWorkMonth",       KeyField:0,   CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:22 },
            {Header:"<sht:txt mid='tWorkMonth' mdef='근속개월|To(미만)'/>",         Type:"Int",       Hidden:0,  Width:70,   Align:"Center",  ColMerge:0,   SaveName:"tWorkMonth",       KeyField:0,   CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:22 },
            {Header:"<sht:txt mid='fRestPeriod' mdef='휴직기간(일수)|From(초과)'/>", Type:"Int",       Hidden:0,  Width:70,   Align:"Center",  ColMerge:0,   SaveName:"fRestPeriod",      KeyField:0,   CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:22 },
            {Header:"<sht:txt mid='tRestPeriod' mdef='휴직기간(일수)|To(이하)'/>",   Type:"Int",       Hidden:0,  Width:70,   Align:"Center",  ColMerge:0,   SaveName:"tRestPeriod",      KeyField:0,   CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:22 },
            ...
            {Header:"<sht:txt mid='minusRate' mdef='감율(%)|감율(%)'/>",           Type:"Float",     Hidden:0,  Width:75,   Align:"Center",  ColMerge:1,   SaveName:"rate",             KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:1,   InsertEdit:1,   EditLen:6 },
        ...
        // 발령종류
        var ordDetailCdList = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList","queryId=getOrdDetailCdList",false).codeList, "");
        
        sheet1.SetColProperty("ordDetailCd", {ComboText:"|"+ordDetailCdList[0], ComboCode:"|"+ordDetailCdList[1]} );
        
        // 발령사유
        var ordDetailReasonList = convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","H40110"), "");
        sheet1.SetColProperty("ordDetailReason", {ComboText:"|"+ordDetailReasonList[0], ComboCode:"|"+ordDetailReasonList[1]} );
    ...
    function doAction(sAction) {
        ...
        switch (sAction) {
        case "Search":      sheet1.DoSearch( "${ctx}/PayRateTab1Std.do?cmd=getPayRateTab1StdList", $("#sheet1Form").serialize() ); break;
        case "Save":        
        	//if(!dupChk(sheet1,"payCd|ordDetailCd|ordDetailReason", false, true)){break;}
         	if(!dupChk(sheet1,"payCd|ordDetailCd|seq", false, true)){break;}
			IBS_SaveName(document.sheet1Form,sheet1);
        	sheet1.DoSave( "${ctx}/PayRateTab1Std.do?cmd=savePayRateTab1Std", $("#sheet1Form").serialize()); break;
            ...
            <td>
                <div class="inner">
                    <div class="sheet_title">
                        <ul>
                            <li id="txt" class="txt"><tit:txt mid='payRateTab1Std' mdef='휴직'/></li>
                            <li class="btn">
