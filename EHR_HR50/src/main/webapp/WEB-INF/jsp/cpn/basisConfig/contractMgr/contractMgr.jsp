...
<!DOCTYPE html> <html class="hidden"> <head> <title><tit:txt mid='contractMgr' mdef='급여계약서관리'/></title>
...
<script type="text/javascript">
	$(function() {
		...
		initdata.Cols = [
             ...
             {Header:"<sht:txt mid='dbItemDesc' mdef='세부\n내역'/>",	Type:"Image",	Hidden:1,	Width:40,	Align:"Center",	ColMerge:1,	SaveName:"detail",			KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100 },
             {Header:"<sht:txt mid='2017082800789' mdef='계약서 유형'/>",		Type:"Combo",		Hidden:0,  Width:80,   Align:"Center",  ColMerge:1,   SaveName:"contType",		KeyField:1,   CalcLogic:"",   Format:"",         PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
             {Header:"급여유형",												Type:"Combo",		Hidden:0,  Width:80,   Align:"Center",  ColMerge:1,   SaveName:"payType",		KeyField:1,   CalcLogic:"",   Format:"",         PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
             {Header:"<sht:txt mid='sYmd' mdef='시작일자'/>",		Type:"Date",      	Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"sdate",        	KeyField:1,   CalcLogic:"",   Format:"Ymd",      PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
 			 {Header:"<sht:txt mid='eYmd' mdef='종료일자'/>",		Type:"Date",      	Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"edate",        	KeyField:1,   CalcLogic:"",   Format:"Ymd",      PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 },
             ...
             {Header:"<sht:txt mid='fileNm' mdef='파일명'/>",  		Type:"Text",		Hidden:0,  Width:130,  Align:"Left",	ColMerge:1,   SaveName:"fileNm",	   	KeyField:0,   CalcLogic:"",   Format:"",         PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
             {Header:"<sht:txt mid='mailcont' mdef='내용'/>",  		Type:"Text",		Hidden:1,  Width:130,  Align:"Left",	ColMerge:1,   SaveName:"contents",	   	KeyField:0,   CalcLogic:"",   Format:"",         PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:0 }
	...
	function doAction(sAction) {
		switch (sAction) {
		case "Search": 	 	sheet1.DoSearch( "${ctx}/ContractMgr.do?cmd=getContractMgrList", $("#sheetForm").serialize() ); break;
		case "Save":
			if(!dupChk(sheet1,"contType|sdate", false, true)){break;}
			IBS_SaveName(document.sheetForm,sheet1);
			sheet1.DoSave( "${ctx}/ContractMgr.do?cmd=saveContractMgr", $("#sheetForm").serialize()); break;
		case "Insert":
	...
	function sheet1_OnClick(Row, Col, Value, CellX, CellY, CellW, CellH) {
		try{
			if(sheet1.ColSaveName(Col) == "detail" && Row >= sheet1.HeaderRows()){
				gPRow = Row;
				var url ="/ContractMgr.do?cmd=viewContractMgrPop";
				var args    = new Array();
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt"><tit:txt mid='contractMgr' mdef='급여계약서관리'/></li>
							<li class="btn">
