...
//   		{Header:"<sht:txt mid='sStatus' mdef='상태'/>",			Type:"${sSttTy}",	Hidden:Number("${sSttHdn}"),Width:"${sSttWdt}",	Align:"Center",	ColMerge:0,	SaveName:"sStatus",	Sort:0 },
  			{Header:"<sht:txt mid='dbItemDesc' mdef='세부\n내역'/>",    	Type:"Image",     	Hidden:0,  Width:40,   Align:"Center",  ColMerge:0,   SaveName:"detail" ,  Sort:0},
  			{Header:"<sht:txt mid='paymentYmdV4' mdef='PAYMENT_YMD'/>",  Type:"Text",      	Hidden:1,  Width:0,    Align:"Center",  ColMerge:0,   SaveName:"paymentYmd",       UpdateEdit:0},
  			{Header:"<sht:txt mid='payActionCdV2' mdef='pay_action_cd'/>",Type:"Text",      	Hidden:1,  Width:0,    Align:"Center",  ColMerge:0,   SaveName:"payActionCd",      UpdateEdit:0 },
  			{Header:"<sht:txt mid='payActionCd' mdef='급여일자'/>",      	Type:"Text",      	Hidden:0,  Width:150,  Align:"Center",  ColMerge:0,   SaveName:"payActionNm",      UpdateEdit:0},
  			{Header:"<sht:txt mid='agreeSabun' mdef='사번'/>",          	Type:"Text",      	Hidden:1,  Width:0,    Align:"Center",  ColMerge:0,   SaveName:"sabun",            UpdateEdit:0 },
  			{Header:"<sht:txt mid='totEarningMonV2' mdef='급여총액'/>",      	Type:"AutoSum",       	Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"totEarningMon",    UpdateEdit:0 },
  			{Header:"<sht:txt mid='element15' mdef='공제총액'/>",      	Type:"AutoSum",       	Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"totDedMon",        UpdateEdit:0 },
  			{Header:"<sht:txt mid='element16' mdef='실지급액'/>",      	Type:"AutoSum",       	Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"paymentMon",       UpdateEdit:0 },
  			{Header:"<sht:txt mid='element1070' mdef='소득세'/>",       	Type:"AutoSum",       	Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"itaxMon",          UpdateEdit:0 },
  			{Header:"<sht:txt mid='finInbitTaxMon' mdef='주민세'/>",        	Type:"AutoSum",       	Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"rtaxMon",          UpdateEdit:0 },
  			{Header:"<sht:txt mid='gubun3' mdef='국민연금'/>",      	Type:"AutoSum",       	Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"npEeMon",          UpdateEdit:0 },
  			{Header:"<sht:txt mid='gubun4' mdef='건강보험'/>",      	Type:"AutoSum",       	Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"hiEeMon",          UpdateEdit:0 },
  			{Header:"<sht:txt mid='eiEeMonV1' mdef='고용보험'/>",      	Type:"AutoSum",       	Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"eiEeMon",          UpdateEdit:0 },
  			{Header:"<sht:txt mid='mon1V5' mdef='제세공과금외공제'/>",   	Type:"AutoSum",       	Hidden:1,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"mon1",          	UpdateEdit:0 },
 		...
 		IBS_InitSheet(sheet1, initdata);sheet1.SetEditable("${editable}");sheet1.SetVisible(true);sheet1.SetCountPosition(0); sheet1.SetEditableColorDiff (0);
		...
		//var searchPayCdList = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList","queryId=getCpnPayCdList&searchRunType=00001,00002,00003,RETRO",false).codeList, "<tit:txt mid='103895' mdef='전체'/>");
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "${ctx}/PerPayPartiTermUSta.do?cmd=getPerPayPartiTermUStaList", $("#sheet1Form").serialize() ); break;
		case "Insert":
	...
	function sheet1_OnClick(Row, Col, Value, CellX, CellY, CellW, CellH) {
		if(Row > 0 && sheet1.ColSaveName(Col) == "detail"){
			try{var colName = sheet1.ColSaveName(Col);
		        if(colName == "detail") { // 팝업 호출
	...
	function openRegPopup(sabun, payActionCd){
		...
		<%--url = "${ctx}/PerPayPartiTermUSta.do?cmd=viewPerPayPartiTermAStaPopup";--%>

		<%--var rv = openPopup(url+"&authPg=R", args, "950","550");--%>
			...
			<div>
				<table>
					<tr>
						...
						<!-- td> <span><tit:txt mid='114519' mdef='급여구분 '/></span> <select id="searchPayCd" name="searchPayCd"> </select></td -->
						<td>
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt"><tit:txt mid='perPayPartiTermUSta' mdef='기간별급여세부내역'/></li>
							<li class="btn">
