...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchDate").datepicker2({onReturn: getCommonCodeList});
		
		// 연봉항목
		var elementCdList 	= convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList","queryId=getPerPayYearLstEleList",false).codeList, "");;
		...
		initdata.Cols = [
			...
			{Header:"사번|사번|사번",				Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"sabun",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:15},
			{Header:"성명|성명|성명",				Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"name",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:30},
			{Header:"부서|부서|부서",				Type:"Text",		Hidden:0,	Width:100,	Align:"Left",	ColMerge:0,	SaveName:"orgNm",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100},
			{Header:"계약유형|계약유형|계약유형",	Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"manageNm",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100},
			{Header:"직책|직책|직책",				Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"jikchakNm",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100},
			{Header:"직위|직위|직위",				Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"jikweeNm",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100},
			{Header:"직급|직급|직급",				Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"jikgubNm",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100},
			{Header:"재직상태|재직상태|재직상태",	Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"statusNm",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100}

		]; IBS_InitSheet(sheet1, initdata);sheet1.SetEditable("${editable}");sheet1.SetVisible(true);sheet1.SetCountPosition(4);
		
		$(window).smartresize(sheetResize); sheetInit();

		$("#searchNm, #searchOrgNm, #searchDate").bind("keyup",function(event){
	...
	function getCommonCodeList() {
		let baseSYmd = $("#searchDate").val();
		// 계약유형
		var manageCdList 	= convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","H10030", baseSYmd), "");
		...
		*/
		...
		// 재직상태
		var statusCdList 	= convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","H10010", baseSYmd), "");
	...
	function searchTitleList() {
		...
		if (dataList != null && dataList.DATA != null) {
			...
			var initdata1 = {};
			initdata1.Cfg = {FrozenCol:5, MergeSheet:msHeaderOnly,SearchMode:smLazyLoad, Page:22/* , FrozenCol:11 */ };
			initdata1.HeaderMode = {Sort:1, ColMove:1, ColResize:1, HeaderCheck:1};
	
			initdata1.Cols = [];
	
			initdata1.Cols[v++] = {Header:"No|No|No",				Type:"${sNoTy}",	Hidden:Number("${sNoHdn}"),	Width:"${sNoWdt}",	Align:"Center",	ColMerge:0,	SaveName:"sNo" };
			initdata1.Cols[v++] = {Header:"사번|사번|사번",			Type:"Text",		Hidden:0,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"sabun",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:20};
			initdata1.Cols[v++] = {Header:"성명|성명|성명",			Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"name",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:20};
			initdata1.Cols[v++] = {Header:"부서|부서|부서",			Type:"Text",		Hidden:0,	Width:100,	Align:"Left",	ColMerge:0,	SaveName:"orgNm",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:150};
			initdata1.Cols[v++] = {Header:"계약유형|계약유형|계약유형",	Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"manageNm",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100};
			initdata1.Cols[v++] = {Header:"직책|직책|직책",			Type:"Text",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"jikchakNm",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100};
			initdata1.Cols[v++] = {Header:"직위|직위|직위",			Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"jikweeNm",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100};
			initdata1.Cols[v++] = {Header:"직급|직급|직급",			Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"jikgubNm",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100};
			initdata1.Cols[v++] = {Header:"직구분|직구분|직구분",		Type:"Text",		Hidden:1,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"workType",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100};
			initdata1.Cols[v++] = {Header:"직구분|직구분|직구분",		Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"workTypeNm",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100};
			initdata1.Cols[v++] = {Header:"재직상태|재직상태|재직상태",	Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"statusNm",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100};
			...
			for(var i = 0; i < dataList.DATA.length; i++) {
				...
				colId = item.elementCd.substring(0, 1).toUpperCase() + item.elementCd.substring(1, item.elementCd.length).toLowerCase();
				
				// add column (2년전)
				initdata1.Cols[v++]  = {
					  Header:item.elementNm + "|" + item.elementNm + "|2년전"
					, Type:"Int"
					, Hidden:0
					, Width:100
					, Align:"Right"
				...
				// add column (1년전)
				initdata1.Cols[v++]  = {
					  Header:item.elementNm + "|" + item.elementNm + "|1년전"
					, Type:"Int"
					, Hidden:0
					, Width:100
					, Align:"Right"
				...
				// add column (기준일)
				initdata1.Cols[v++]  = {
					  Header:item.elementNm + "|" + item.elementNm + "|기준일"
					, Type:"Int"
					, Hidden:0
					, Width:100
					, Align:"Right"
			...
			initdata1.Cols[v++] = {Header:"기간|2년전|시작일",			Type:"Date",		Hidden:1,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"sdate2",		KeyField:0,	Format:"Ymd",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10};
			initdata1.Cols[v++] = {Header:"기간|2년전|종료일",			Type:"Date",		Hidden:1,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"edate2",		KeyField:0,	Format:"Ymd",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10};
			initdata1.Cols[v++] = {Header:"기간|1년전|시작일",			Type:"Date",		Hidden:1,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"sdate1",		KeyField:0,	Format:"Ymd",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10};
			initdata1.Cols[v++] = {Header:"기간|1년전|종료일",			Type:"Date",		Hidden:1,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"edate1",		KeyField:0,	Format:"Ymd",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10};
			initdata1.Cols[v++] = {Header:"기간|기준연도|시작일",		Type:"Date",		Hidden:1,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"sdate0",		KeyField:0,	Format:"Ymd",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10};
			initdata1.Cols[v++] = {Header:"기간|기준연도|종료일",		Type:"Date",		Hidden:1,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"edate0",		KeyField:0,	Format:"Ymd",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10};
			...
			// 데이타 조회
			sheet1.DoSearch( "${ctx}/PerPayYearCompareTreeYears.do?cmd=getPerPayYearCompareTreeYearsList", $("#srchFrm").serialize() );
		}
	}
			...
			<div>
				<table>
					...
					<tr>
						<th>소속</th>
						<td colspan="3">
							<input type="text" id="searchOrgNm" name="searchOrgNm" class="text required readonly alignL" value="" readonly style="width:340px" />
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt">연봉비교(3개년)</li>
							<li class="btn">
