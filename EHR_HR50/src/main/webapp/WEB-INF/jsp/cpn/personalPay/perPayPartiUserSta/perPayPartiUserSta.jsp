...
$(function() {
	...
	setTimeout(function(){
		$("#iframeSubMain").attr("src","${ctx}/PerPayPartiUserSta.do?cmd=viewPerPayPartiUserStaSubMain&authPg=${authPg}");
	},100);
});
...
function payActionSearchPopup() {
	...
	// args["searchType"]	= "B";	// 월별급여지급현황용 쿼리호출
	//
	// if(!isPopup()) {return;}
	// gPRow = "";
	// pGubun = "payDayPopup";
...
function previewPopup() {
	...
	// var w		= 680;
	// var h		= 700;
	// var url		= "/PerPayPartiUserSta.do?cmd=viewPerPayPartiPopSta";
	// var args	= new Array();
	//
