...
$(function() {
	...
	initdata.Cols = [
	         		...
	         		{Header:"<sht:txt mid='eleValue' mdef='항목값'/>",	Type:"Text",			Hidden:0,	Width:100,			Align:"Center",	ColMerge:0,	SaveName:"eleValue2",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
	         		{Header:"<sht:txt mid='danwi' mdef='단위'/>",	Type:"Text",			Hidden:0,	Width:100,			Align:"Center",	ColMerge:0,	SaveName:"unit2",		KeyField:0,	Format:"",	PointCount:2,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 }
	...
	switch (sAction) {
		case "Search":
			...
			if (parent.$("#sabun").val() != null && parent.$("#sabun").val() != "null" &&
				...
				sheet1.DoSearch("${ctx}/PerPayPartiUserSta.do?cmd=getPerPayPartiUserStaEtcList", $("#sheet1Form").serialize());
			}
			break;
	}
}
