...
$(function() {
	...
	initdata.Cols = [
		...
		{Header:"<sht:txt mid='baseMon' mdef='기준금액'/>",		Type:"AutoSum",		Hidden:0,	Width:100,			Align:"Right",	ColMerge:0,	SaveName:"basicMon",	KeyField:0,	Format:"Integer",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
		{Header:"<sht:txt mid='resultMon' mdef='계산금액'/>",		Type:"AutoSum",		Hidden:0,	Width:100,			Align:"Right",	ColMerge:0,	SaveName:"resultMon",	KeyField:0,	Format:"Integer",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
	...
	switch (sAction) {
		case "Search":
			...
			if (parent.$("#sabun").val() != null && parent.$("#sabun").val() != "null" &&
				...
				// 항목세부내역조회
				sheet1.DoSearch("${ctx}/PerPayPartiTermUSta.do?cmd=getPerPayPartiAdminStaDtlList", $("#sheet1Form").serialize());
			}
			break;
	}
}
