...
$(function() {
	...
	const modal = window.top.document.LayerModalUtility.getModal('payPartiLayer');
	let searchSabun = modal.parameters.sabun || '';
	if (searchSabun == null || searchSabun === "")
		searchSabun = "${ssnSabun}";
	let searchPayActionCd = modal.parameters.payActionCd || '';
...
<form id="sheet1Form" name="sheet1Form" >
	...
	<div class="modal_footer">
		<a href="javascript:closeCommonLayer('payPartiLayer');" class="btn outline_gray"><tit:txt mid='104157' mdef='닫기'/></a>
	</div>
</div>
</body>
</html>
