...
$(function() {
	...
	newIframe.attr("src","${ctx}/PerPayPartiUserSta.do?cmd=viewPerPayPartiUserStaCalc&authPg=${authPg}"); 
});
...
function showIframe() {
	...
	if(iframeIdx == 0) {
		...
		// 근태/근무내역
		newIframe.attr("src","${ctx}/PerPayPartiUserSta.do?cmd=viewPerPayPartiUserStaEtc&authPg=${authPg}");
	} else if(iframeIdx == 2) {
		// 항목세부내역
		newIframe.attr("src","${ctx}/PerPayPartiUserSta.do?cmd=viewPerPayPartiUserStaDtl&authPg=${authPg}");
	}
}
