...
<script type="text/javascript">
	...
	function inist_sheet1(){
		...
		var comboList1 = convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","P20005"), ""); // 평가sheet구분(P20005)
		...
		var initdata = {};
		initdata.Cfg = {FrozenCol:4,SearchMode:smLazyLoad,Page:22,FrozenColRight:9};
		...
		{Header:"<sht:txt mid='appSeqCdV2' mdef='평가차수'/>"			,Type:"Combo",     Hidden:0,  Width:70,   Align:"Left",    ColMerge:0,   SaveName:"appSeqCd",		KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 },
		{Header:"<sht:txt mid='appGroupCd' mdef='평가그룹코드'/>"			,Type:"Text",      Hidden:1,  Width:80,  Align:"Left",    ColMerge:0,   SaveName:"appGroupCd",		KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
        {Header:"<sht:txt mid='appGroupNm' mdef='평가그룹명'/>"			,Type:"Text",      Hidden:0,  Width:150,  Align:"Left",    ColMerge:0,   SaveName:"appGroupNm",		KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
        {Header:"<sht:txt mid='appSabunV3' mdef='평가자사번'/>"			,Type:"Text",       Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"appSabun",      KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
        {Header:"평가자성명"			,Type:"Text",  	Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"appName",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100 },
        //{Header:"범위구분",			Type:"Combo",		Hidden:0,	Width:70,	Align:"Center",	ColMerge:0,	SaveName:"scopeGubun",		KeyField:0,	CalcLogic:"",	Format:"",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:1 },
        {Header:"비고(피평가자)"				,Type:"Text",      Hidden:1,  Width:150,  Align:"Left",    ColMerge:0,   SaveName:"note",			KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100 },
        {Header:"범위설정"			,Type:"Image",     Hidden:0,  Width:30,   Align:"Center",  ColMerge:0,   SaveName:"btnSet",       	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:1 },
        
        {Header:"<sht:txt mid='detailYnV1' mdef='설정유무'/>"			,Type:"Text",      Hidden:1,  Width:50,   Align:"Center",  ColMerge:0,   SaveName:"detailYn",		KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:1 },

        {Header:"<sht:txt mid='check' mdef='선택'/>"				,Type:"DummyCheck",Hidden:1,  Width:50,	  Align:"Center",  ColMerge:0,	 SaveName:"select",			KeyField:0,	  Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100},
        {Header:"<sht:txt mid='grpId' mdef='조직'/>"			    ,Type:"Combo",     Hidden:1,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"grpId",			KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },

        {Header:"<sht:txt mid='agreeSeq' mdef='순서'/>"				,Type:"Text",      Hidden:1,  Width:50,   Align:"Center",  ColMerge:0,   SaveName:"seq",         	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 },
        {Header:"<sht:txt mid='app1stYn' mdef='1차평가\n종료여부'/>"		,Type:"CheckBox",  Hidden:1,  Width:50,   Align:"Center",  ColMerge:0,   SaveName:"app1stYn",		KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1 , TrueValue:"Y", FalseValue:"N"},
        {Header:"<sht:txt mid='appSheetType' mdef='평가Sheet구분'/>"		,Type:"Combo",     Hidden:1,  Width:100,  Align:"Center",  ColMerge:0,   SaveName:"appSheetType",	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 },
        {Header:"<sht:txt mid='appraisalCd' mdef='평가ID'/>"				,Type:"Text",      Hidden:1,  Width:10,   Align:"Left",    ColMerge:0,   SaveName:"appraisalCd",	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
        {Header:"<sht:txt mid='appMethodCdV1' mdef='평가방법코드'/>"			,Type:"Text",      Hidden:1,  Width:10,   Align:"Left",    ColMerge:0,   SaveName:"appMethodCd",	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
		];IBS_InitSheet(sheet1, initdata); sheet1.SetEditable("${editable}"); sheet1.SetCountPosition(4); sheet1.SetUnicodeByte(3);

		//Autocomplete
		$(sheet1).sheetAutocompleteNew({
		...
		sheet1.SetDataLinkMouse("btnSet", 1);

		var appraisalCdList = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList&","queryId=getAppraisalCdList",false).codeList, ""); //평가명
		var comGubunCdList 	= convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","P00007"),""); // 역량구분.

		sheet1.SetColProperty("appSeqCd",	{ComboText:appSeqCdList[0], ComboCode:appSeqCdList[1]} );
		sheet1.SetColProperty("appSheetType", {ComboText:"|"+comboList1[0], ComboCode:"|"+comboList1[1]} );
		...
		//sheet1.SetColProperty("comGubunCd", 	{ComboText:comGubunCdList[0], ComboCode:comGubunCdList[1]} );
		//sheet1.SetColProperty("scopeGubun", {ComboText:"전체|범위적용", ComboCode:"A|O"} ); // 범위구분
	}
...
function doAction(sAction){
	...
	switch(sAction){
		case "Search":		//조회
			sheet1.DoSearch("${ctx}/AppGroupCreateMgr.do?cmd=getAppGroupCreateMgrList", $("#srchFrm").serialize());
			break;
		case "Save":		//저장
			IBS_SaveName(document.srchFrm,sheet1);
			sheet1.DoSave( "${ctx}/AppGroupCreateMgr.do?cmd=saveAppGroupCreateMgr", $("#srchFrm").serialize()); break;
			break;
		case "Insert":		//입력
			...
			if( $("#searchComGubunCd").val() != '' ) {
				sheet1.SetCellValue(Row, "comGubunCd",$("#searchComGubunCd").val());
		...
		case "Copy":		//행복사
			...
			sheet1.SetCellValue(Row, "appGroupCd", "");
			sheet1.SetCellValue(Row, "scope", "0");
		...
		case "LoadExcel":	//엑셀업로드
			...
			break;
		case "DownTemplate":
			sheet1.Down2Excel({ SheetDesign:1, Merge:1, DownRows:"0", DownCols:"appSeqCd|appGroupNm|appSabun",ExcelFontSize:"9",ExcelRowHeight:"20"});
			break;
...
function doAction2(sAction){
	switch (sAction) {
	case "Search":
		//sheet2.DoSearch( "${ctx}/AppGroupCreateMgr.do?cmd=getAppGroupCreateMgrScopeCd", $("#srchFrm").serialize() );
...
function doAction3(sAction) {
	switch (sAction) {
	case "Search":
		sheet3.DoSearch( "${ctx}/AppGroupMgr.do?cmd=getAppGroupMgrScopeList2", $("#sheetForm").serialize());
		break;
...
/* 			if(sheet1.GetCellValue(Row,"scopeGubun") != "O") {
		    ...
		    $("#searchUseGubun").val("G");
		    $("#searchItemValue1").val(sheet1.GetCellValue(Row,"appraisalCd"));
		    $("#searchItemValue2").val(sheet1.GetCellValue(Row,"appGroupCd"));
...
/*
		if( sheet1.ColSaveName(Col) == "scope" 	&& Row >= sheet1.HeaderRows()) {
			...
			args["searchItemValue2"] = sheet1.GetCellValue(Row,"appGroupCd");
...
function setSheet2Txt(){
	...
	$("#appGroupCd").val(sheet1.GetCellValue(Row, "appGroupCd"));
	$("#seq").val("0");
	var seqInfo = ajaxCall("${ctx}/AppGroupCreateMgr.do?cmd=getAppGroupCreateMgrTblNm", "queryId=getAppGroupCreateMgrTblNm&"+ $("#srchFrm").serialize(), false);
...
function sheet1_OnLoadExcel() {
	...
	sheet1.SetRangeValue(searchAppraisalCd, sheet1.HeaderRows(), 16, sheet1.LastRow(), 16);
}

function makeDic(){
	
	var data = ajaxCall("${ctx}/AppGroupMgr.do?cmd=getAppGroupMgrCreateChk",$("#srchFrm").serialize(),false).map;
	
	if(data != null && data.closeYn == "Y" ) {
		
		alert("해당 평가는 마감되어\r\n기초 평가그룹을 생성 할 수 없습니다.");
		return;
	} else {
		if ( !confirm("기본적인 평가그룹 생성 작업입니다.\n기초 평가그룹을 생성하시겠습니까?\n기존자료는 삭제 후 작업이 이루어집니다.") ) return;
		
		var data = ajaxCall("${ctx}/AppGroupMgr.do?cmd=prcAppGroupMgr",$("#srchFrm").serialize(),false);
		...
		<div class="sheet_search outer">
			<div>
				<table>
					<tr>
						<td>
							<span><tit:txt mid='114019' mdef='평가명'/></span>
							<select name="searchAppraisalCd" id="searchAppraisalCd" class="box"></select>
						</td>
						<td>
							<span><tit:txt mid='112518' mdef='평가그룹명'/></span>
							<input id="searchAppGroupNm" name ="searchAppGroupNm" type="text" class="text" />
						</td>
						<td>
							<span><tit:txt mid='113314' mdef='평가차수'/></span>
				...
				<div class="inner">
					<div class="sheet_title">
						<ul>
							...
							<li class="btn">
								<a href="javascript:makeDic();" 			class="button authA">기초그룹생성</a>
								<a href="javascript:doAction('DownTemplate');" 	class="basic authA">양식다운로드</a>
								<a href="javascript:doAction('LoadExcel');" 		class="basic authA">업로드</a>
					...
					<div class="sheet_title">
						<ul>
							...
							<li id="" class="btn setBtn">
							    <a href="javascript:doAction3('PrcClear');" class="button authA" id="btnMake">범위설정초기화</a>
				...
				<div class="inner">
					<div class="sheet_title">
						<ul>
							...
							<li id="" class="btn setBtn">
								<a href="javascript:doAction4('DownTemplate')" class="basic authR btnEmp">양식</a>
								<a href="javascript:doAction4('LoadExcel')" class="basic authR btnEmp">업로드</a>
								<a href="javascript:doAction4('Insert')" class="basic authA btnEmp" style="display:none;">입력</a>
