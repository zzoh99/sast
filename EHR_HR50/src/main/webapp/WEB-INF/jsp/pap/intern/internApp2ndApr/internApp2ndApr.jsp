...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"성명",				Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"name",		KeyField:1,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
			...
			{Header:"1차평가\n진행상태",	Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"statusNm1",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
			{Header:"2차평가\n진행상태",	Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"statusNm2",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
			...
			{Header:"1차평가진행상태코드",	Type:"Text",	Hidden:1,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"statusCd1",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
			{Header:"2차평가진행상태코드",	Type:"Text",	Hidden:1,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"statusCd2",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
		...
		initdata2.Cols = [
			...
			{Header:"삭제",		Type:"${sDelTy}",	Hidden:1,Width:"${sDelWdt}",	Align:"Center",	ColMerge:0,	SaveName:"sDelete",	Sort:0 },
			{Header:"상태",		Type:"${sSttTy}",	Hidden:1,Width:"${sSttWdt}",	Align:"Center",	ColMerge:0,	SaveName:"sStatus",	Sort:0 },
			{Header:"역량종류",		Type:"Combo",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:1,	SaveName:"internItemType",	KeyField:1,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
			{Header:"역량코드",		Type:"Text",	Hidden:1,	Width:100,	Align:"Left",	ColMerge:0,	SaveName:"seq",				KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
			{Header:"역량항목",		Type:"Text",	Hidden:0,	Width:80,	Align:"Left",	ColMerge:0,	SaveName:"internItemNm",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
			{Header:"역량정의",		Type:"Text",	Hidden:0,	Width:250,	Align:"Left",	ColMerge:0,	SaveName:"internItemMemo",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100, ToolTip:1 },
			...
			{Header:"1차평가",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"appClassCd1",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:5 },
			...
			{Header:"1차 평가의견",	Type:"Text",	Hidden:0,	Width:200,	Align:"Left",	ColMerge:0,	SaveName:"appAppMemo",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100  , MultiLineText:1, ToolTip:1  },
			{Header:"2차 평가의견",	Type:"Text",	Hidden:0,	Width:200,	Align:"Left",	ColMerge:0,	SaveName:"appAppMemo2",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100  , MultiLineText:1, ToolTip:1 }
		...
		//평가명
		var comboCodeList1  = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList","queryId=getAppraisalCdListAppType&searchAppTypeCd=D,",false).codeList, "");
		$("#searchAppraisalCd").html(comboCodeList1[2]);

		//역량종류
		var comboCodeList2 	= convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","P10010"), "");
		sheet2.SetColProperty("internItemType", 			{ComboText:comboCodeList2[0], ComboCode:comboCodeList2[1]} );
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			sheet1.DoSearch( "${ctx}/InternApp2ndApr.do?cmd=getInternApp2ndAprList", $("#srchFrm").serialize() ); break;
		case "Save1":
							if(chkConfirm()){
								IBS_SaveName(document.srchFrm,sheet1);
								sheet1.DoSave( "${ctx}/CompApp2ndApr.do?cmd=saveCompApp2ndApr", $("#srchFrm").serialize());
							}
							break;
		case "Save2":
							if(chkEval()){
								IBS_SaveName(document.srchFrm,sheet1);
								sheet1.DoSave( "${ctx}/InternApp2ndApr.do?cmd=saveInternApp2ndApr2Return1", $("#srchFrm").serialize());
							}
							break;
	...
	function doAction2(sAction) {
		switch (sAction) {
		case "Search": 	 	sheet2.DoSearch( "${ctx}/InternApp1stApr.do?cmd=getInternApp1stAprList2", $("#srchFrm").serialize() ); break;
		case "Save":
			  	if(chkBeforeSave()){
			  		IBS_SaveName(document.srchFrm,sheet2);
					sheet2.DoSave( "${ctx}/InternApp2ndApr.do?cmd=saveInternApp2ndApr", $("#srchFrm").serialize());
			  	}
			  	 break;
	...
	function sheet2_OnSearchEnd(Code, Msg, StCode, StMsg) {
		try{
			...
			var coboCodeList3 = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList","queryId=getTargetIndexKpiCdList&searchAppSabun="+$("#searchSabun").val()+"&searchAppraisalCd="+$("#searchAppraisalCd").val(),false).codeList, "");
		     ...
		     if(sheet1.GetCellValue(row,"statusCd1") == 5 && sheet1.GetCellValue(row,"statusCd2") != 5 ){
		    	 sheet2.SetColEditable("appAppMemo2",1);
		     }else{
		    	 sheet2.SetColEditable("appAppMemo2",0);
		     }
  ...
  //사원 팝입
	...
	function chkConfirm(){
		...
		for(var i = sheet1.HeaderRows(); i<sheet1.RowCount()+sheet1.HeaderRows(); i++){
			var v_statusCd = sheet1.GetCellValue(i,"statusCd1");
			if(v_statusCd == 1){
				 alert("1차평가가 완료된 상태에서 확정처리 할 수 있습니다.");
                 return false;
			}

			var v_statusCd2 = sheet1.GetCellValue(i,"statusCd2");
			if(v_statusCd2 == 5){
				 alert("이미 확정 처리 하셨습니다.");
                return false;
			}
		}
	...
	function chkEval(){
		...
		for(var i = sheet1.HeaderRows(); i<sheet1.RowCount()+sheet1.HeaderRows(); i++){
			...
			var v_statusCd = sheet1.GetCellValue(i,"statusCd1");
			if(v_statusCd == 1){
				 alert("1차평가가 완료된 상태에서 반려처리 할 수 있습니다.");
                 return false;
			}

			var v_statusCd2 = sheet1.GetCellValue(i,"statusCd2");
			if(v_statusCd2 == 5){
				 alert("평가완료 상태에서는 반려 처리 하실 수 없습니다. ");
               	 return false;
			}
	...
	function sheet2_OnChange(Row, Col, Value){
	 ...
	 function calTotalPoint1(){
		...
		sheet2.SetCellValue(lr,"internItemMemo","점수/등급");
		sheet2.SetCellAlign(lr,"internItemMemo","Right");
    }
	...
	function chkBeforeSave(){
		...
		for(var i = sheet1.HeaderRows(); i<sheet1.RowCount()+sheet1.HeaderRows(); i++){
			...
			var v_statusCd = sheet1.GetCellValue(i,"statusCd2");
			if(v_statusCd == 5){
		...
		<td class="">
			<div class="inner">
				...
				<ul>
					...
					<li class="btn">
						<a href="javascript:doAction1('Save2')" 	class="basic authA group2">반려</a>
