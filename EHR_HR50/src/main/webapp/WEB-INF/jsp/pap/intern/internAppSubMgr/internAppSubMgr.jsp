...
<!DOCTYPE html> <html class="hidden"><head> <title>계약직평가관리</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"-3평가",				Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"App3Point",   KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:50},
			{Header:"-2평가",				Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"App2Point",   KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:50},
			{Header:"-1평가",				Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"App1Point",   KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:50},
			{Header:"본인평가",				Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"selfAppPoint",KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:50},
			{Header:"본인평가등급",			Type:"Text",		Hidden:1,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"appClassCd",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:50},
			{Header:"본인평가여부",			Type:"Text",		Hidden:1,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"appraisalYn",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:50},
			...
			{Header:"의견",					Type:"Text",		Hidden:0,	Width:200,	Align:"Center",	ColMerge:0,	SaveName:"memo",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100,ToolTip:1},
		...
		var comboCodeList2 	= convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","P20030"), "");		//계약연장확인
		var comboCdList7 	= convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","P00001"), "전체");
		sheet1.SetColProperty("App3Point", 	{ComboText:"|"+comboCdList7[0], ComboCode:"|"+comboCdList7[1]} );
		sheet1.SetColProperty("App2Point", 	{ComboText:"|"+comboCdList7[0], ComboCode:"|"+comboCdList7[1]} );
		sheet1.SetColProperty("App1Point", 	{ComboText:"|"+comboCdList7[0], ComboCode:"|"+comboCdList7[1]} );
		...
		sheet1.SetColProperty("confirmContractYn", {ComboText:comboCodeList2[0], ComboCode:comboCodeList2[1]} );
...
/* 		var userCd1 = stfConvCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","H20010"), "전체");
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "${ctx}/InternAppSubMgr.do?cmd=getInternAppSubMgrList", $("#mySheetForm").serialize() );
			break;
		case "Save":

			if(!dupChk(sheet1,"appraisalCd|sabun", true, true)){break;}
			IBS_SaveName(document.mySheetForm,sheet1);
			sheet1.DoSave( "${ctx}/InternAppSubMgr.do?cmd=saveInternAppSubMgr", $("#mySheetForm").serialize() );
			break;
		case "Insert":
