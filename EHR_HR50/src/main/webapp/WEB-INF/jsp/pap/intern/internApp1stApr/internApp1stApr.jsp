...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata2.Cols = [
			...
			{Header:"1차평가",		Type:"Int",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"appClassCd1",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:6 },
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			sheet1.DoSearch( "${ctx}/InternApp1stApr.do?cmd=getInternApp1stAprList", $("#srchFrm").serialize() ); break;
		case "Save":
							if(chkConfirm()){
								IBS_SaveName(document.srchFrm,sheet1);
								sheet1.DoSave( "${ctx}/InternApp1stApr.do?cmd=saveInternApp1stApr3", $("#srchFrm").serialize());
							}
							break;
	...
	function doAction2(sAction) {
		...
		case "Save":
			  	if(chkBeforeSave()){
					...
					sheet2.DoSave( "${ctx}/InternApp1stApr.do?cmd=saveInternApp1stApr", $("#srchFrm").serialize());
			  	}
			  	 break;
		...
		<td class="">
			<div class="inner">
				...
				<ul>
					...
					<li class="btn">
						<a href="javascript:doAction1('Save')" 	class="basic authA group2">확정</a>
					</li>
				</ul>
				</div>
			</div>
