...
<script type="text/javascript">
	...
	$(function() {
		const modal = window.top.document.LayerModalUtility.getModal('apFeedBackLstCommentViewLayer');
    ...
    function setValue() {
		...
		*/
		...
		if(data.Result.Code == -1) {
			...
			var rtnModal = window.top.document.LayerModalUtility.getModal('apFeedBackLstCommentViewLayer');
			rtnModal.fire("apFeedBackLstCommentViewTrigger", rv).hide();
    	}
	}
...
<div class="wrapper modal_layer">
	...
	<div class="modal_footer">
		...
		<a href="javascript:closeCommonLayer('apFeedBackLstCommentViewLayer')" class="btn outline_gray">닫기</a>
	</div>
</div>
</body>
</html>