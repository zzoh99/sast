...
<script type="text/javascript">
	$(function() {
		var initdata = {};
		initdata.Cfg = {FrozenCol:0,SearchMode:2,Page:22};
		...
		initdata.Cols = [
            ...
            {Header:"현직위",			Type:"Combo",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"jikweeCd",		KeyField:1,	CalcLogic:"",	Format:"",				PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:10 },
            {Header:"승진직위",		Type:"Combo",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"tgtJikweeCd",		KeyField:1,	CalcLogic:"",	Format:"",				PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:10 },
            {Header:"최소체류기간",		Type:"Int",			Hidden:0,	Width:80,	Align:"Right",	ColMerge:0,	SaveName:"stayCnt",			KeyField:0,	CalcLogic:"",	Format:"",				PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:5 },
            {Header:"충족포인트",		Type:"Float",		Hidden:0,	Width:80,	Align:"Right",	ColMerge:0,	SaveName:"maxPoint",		KeyField:0,	CalcLogic:"",	Format:"NullFloat",		PointCount:2,	UpdateEdit:1,	InsertEdit:1,	EditLen:5 },
		...
		sheet1.SetColProperty("tgtJikweeCd"	, {ComboText:"|"+jikweeCd[0], ComboCode:"|"+jikweeCd[1]});
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search": 	 	sheet1.DoSearch( "${ctx}/GetDataList.do?cmd=getAppPromPointMgrList", $("#srchFrm").serialize() ); break;
		case "Save":
							if(sheet1.FindStatusRow("I") != ""){
								if(!dupChk(sheet1,"appraisalCd|jikweeCd", true, true)){break;}
							}
							IBS_SaveName(document.srchFrm,sheet1);
							sheet1.DoSave( "${ctx}/SaveData.do?cmd=saveAppPromPointMgr", $("#srchFrm").serialize()); break;
		case "Insert":
