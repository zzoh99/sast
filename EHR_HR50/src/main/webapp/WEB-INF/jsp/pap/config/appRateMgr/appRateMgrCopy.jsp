...
<script type="text/javascript">
	...
	$(function() {
		...
		// 평가명
		var appraisalCdList = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList&","queryId=getAppraisalCdListAppType",false).codeList, "");
		...
		$("#prcCall").click(function() {
			...
			var data = ajaxCall("/AppRateMgr.do?cmd=saveAppRateMgrCopyPop",$("#mySheetForm").serialize(),false);
