...
<script type="text/javascript">
    ...
    function doAction1(sAction) {
		switch (sAction) { case "Search":  sheet1.DoSearch( "${ctx}/GetDataList.do?cmd=getAppGroupMgrRngPopList1", $("#sheetForm").serialize()); break; }
    }
	function doAction2(sAction) {
		switch (sAction) {
		case "Search":
			sheet2.DoSearch( "${ctx}/AppGroupMgrRngPop.do?cmd=getAppGroupMgrRngPopList2", $("#sheetForm").serialize());
			break;
		case "Save":
			...
			sheet2.DoSave( "${ctx}/AppGroupMgrRngPop.do?cmd=saveAppGroupMgrRngPop", $("#sheetForm").serialize());
			break;
		}
	}
