...
<script type="text/javascript">
	...
	$(function() {
		...
		var appraisalCdList = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList&","queryId=getAppraisalCdList",false).codeList, ""); //평가명, 다면평가 제외
	...
	function inist_sheet1(){
		var initdata = {};
		initdata.Cfg = {SearchMode:smLazyLoad,FrozenCol:4,FrozenColRight:1,Page:22};
		...
		initdata.Cols = [
			...
			{Header:"평가명",				Type:"Combo",		Hidden:0,	Width:120,	Align:"Center",	ColMerge:0,	SaveName:"appraisalCd",		KeyField:1,	CalcLogic:"",	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 },
			{Header:"역량구분"	,			Type:"Combo",		Hidden:0,	Width:120,	Align:"Center",	ColMerge:0,	SaveName:"comGubunCd",		KeyField:1,	CalcLogic:"",	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 },
			{Header:"역량코드",			Type:"Text",		Hidden:1,	Width:50,	Align:"Left",	ColMerge:0,	SaveName:"competencyCd",	KeyField:1,	CalcLogic:"",	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:10 },
			{Header:"역량",				Type:"Popup",		Hidden:0,	Width:120,	Align:"Left",	ColMerge:0,	SaveName:"competencyNm",	KeyField:0,	CalcLogic:"",	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
			{Header:"반영\n비율",			Type:"Float",		Hidden:0,	Width:50,	Align:"Center",	ColMerge:0,	SaveName:"appRate",			KeyField:0,	CalcLogic:"",	Format:"",		PointCount:2,	UpdateEdit:1,	InsertEdit:1,	EditLen:10 },
			...
			{Header:"범위\n적용",			Type:"Image",		Hidden:1,	Width:30,	Align:"Center",	ColMerge:0,	SaveName:"scope",			KeyField:0,	CalcLogic:"",	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 },
			...
			{Header:"비고",				Type:"Text",		Hidden:0,	Width:200,	Align:"Left",	ColMerge:0,	SaveName:"memo",			KeyField:0,	CalcLogic:"",	Format:"",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:1000 },

			{Header:"순번"				,Type:"Int",		Hidden:1,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"seq",				KeyField:0,	CalcLogic:"",	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:10 },
	        {Header:"범위설정",			Type:"Image",   	Hidden:0,   Width:50,   Align:"Center", ColMerge:0,	SaveName:"btnSet",			Cursor:"Pointer" }
...
function doAction(sAction){
	...
	switch(sAction){
		case "Search":		//조회
			sheet1.DoSearch("${ctx}/AppCompItemMgr.do?cmd=getAppCompItemMgrList", $("#srchFrm").serialize());
			break;
		case "Save":		//저장
			IBS_SaveName(document.srchFrm,sheet1);
			sheet1.DoSave( "${ctx}/AppCompItemMgr.do?cmd=saveAppCompItemMgr", $("#srchFrm").serialize()); break;
			break;
		case "Insert":		//입력
	...
	try{
		...
		if(colName == "competencyNm") {
			...
			let modalLayer = new window.top.document.LayerModal({
				id: 'papCptcLayer',
				url: 'PapCptcPopup.do?cmd=viewPapCptcLayer',
				parameters: {},
				width: 880,
				height: 700,
				title: '역량 조회',
...
function sheet1_OnClick(Row, Col, Value) {
	try{
		...
		if( sheet1.ColSaveName(Col) == "btnSet" ){
		    ...
		    $("#searchUseGubun").val("C");
		    $("#searchItemValue1").val(sheet1.GetCellValue(Row,"appraisalCd"));
		    $("#searchItemValue2").val(sheet1.GetCellValue(Row,"competencyCd"));
		    $("#searchItemValue3").val(sheet1.GetCellValue(Row,"seq"));
			...
			<div>
				<table>
					<tr>
						...
						<td>
							<span>역량구분</span>
							<select name="searchComGubunCd" id="searchComGubunCd">
							</select>
						</td>
						<td>
			...
			<td class="sheet_left">
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt">역량평가항목정의</li>
							<li class="btn">
