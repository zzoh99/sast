...
<script type="text/javascript">
	...
	$(function() {
		...
		{Header:"평가단계"				,Type:"Combo",	  	Hidden:0,  Width:50,Align:"Center",  ColMerge:0,   SaveName:"appStepCd",	KeyField:1,   CalcLogic:"",   Format:"",		PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
		...
		{Header:"대상자생성\n기준일"		,Type:"Date",	  	Hidden:0,  Width:80,Align:"Center",  ColMerge:0,   SaveName:"dBaseYmd",		KeyField:0,   CalcLogic:"",   Format:"Ymd",		PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 }
	...
	function doAction2(sAction) {
		...
		switch (sAction) {
		case "Search": 	 	sheet2.DoSearch( "${ctx}/AppraisalIdMgr.do?cmd=getAppraisalIdMgrTab1", "appraisalCd="+appraisalCd ); break;
		case "Save":
			...
			sheet2.DoSave( "${ctx}/AppraisalIdMgr.do?cmd=saveAppraisalIdMgrTab1", $("#srchFrm").serialize()); break;
		case "Insert":
			if ( appraisalCd == "" ) {
				alert("평가ID를 선택해 주세요");
				return;
			...
			sheet2.SelectCell(row, "appStepCd");
			break;
		case "Copy":
            ...
            sheet2.SetCellValue(row, "dBaseYmd");            
