...
<script type="text/javascript">
	...
	$(function() {
		...
		// 평가명
		var appraisalCdList = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList&","queryId=getAppraisalCdListAppType&searchAppTypeCd=E,",false).codeList, "");
		...
		$("#prcCall").click(function() {
			...
			var data = ajaxCall("/AppSelfReportItemMgr.do?cmd=saveAppSelfReportItemMgrCopyPop",$("#mySheetForm").serialize(),false);
