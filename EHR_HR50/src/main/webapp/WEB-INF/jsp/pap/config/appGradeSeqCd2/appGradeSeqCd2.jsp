...
//=========================================================================================================================================
		...
		initdata1.Cols = [
			...
			{Header:"2차 총원",					Type:"Int",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"totCntExec",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 }
	...
	function initSheet1() {
		...
		if(data != null && data != undefined && data.DATA != null && data.DATA != undefined && data.DATA.length > 0) {
			...
			// 2차 총원 컬럼 추가
			initdata1.Cols.push({Header:"2차|총원|총원",					Type:"Int",			Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"totCntExec",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100,	BackColor:bcc });

			// [2차] 등급배분 컬럼 셋팅
			for(var i = 0; i < data.DATA.length; i++) {
				item = data.DATA[i];
				var colHeaderNm = "2차|" + item.appClassNm + "|" + item.appClassNm;
			...
			initdata1.Cols.push({Header:"2차인원수meta|인원",		Type:"Text", 	Hidden:1,	 Width:60,	Align:"Center", ColMerge:0, SaveName:"cntArrExec",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0 });
		}
