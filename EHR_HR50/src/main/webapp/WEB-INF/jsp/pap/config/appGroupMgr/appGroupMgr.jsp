...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchAppraisalCd, #searchComGubunCd, #searchAppSeqCd").bind("change",function(event){
			doAction("Search");
		});
	...
	function inist_sheet1(){
        ...
        {Header:"<sht:txt mid='appSabunV3' mdef='평가자사번'/>"			,Type:"Text",       Hidden:1,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"appSabun",      KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
        {Header:"평가자성명"			,Type:"Text",  	Hidden:1,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"appName",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100 },
        ...
        {Header:"범위설정"			,Type:"Image",     Hidden:0,  Width:30,   Align:"Center",  ColMerge:0,   SaveName:"btnSet", Cursor:"Pointer"},
...
function doAction(sAction){
	...
	switch(sAction){
		case "Search":		//조회
			...
			sheet1.DoSearch("${ctx}/AppGroupMgr.do?cmd=getAppGroupMgrList", $("#srchFrm").serialize());
			break;
		case "Save":		//저장
			IBS_SaveName(document.srchFrm,sheet1);
			sheet1.DoSave( "${ctx}/AppGroupMgr.do?cmd=saveAppGroupMgr", $("#srchFrm").serialize()); break;
			break;
		case "Insert":		//입력
			if ($("#searchAppraisalCd").val() == "") {
				alert("평가명을 선택하세요.");
			...
			sheet1.SelectCell(Row, "appSeqCd");
		...
		case "Copy":		//행복사
			...
			sheet1.SetCellValue(Row, "btnSet", "");
			//sheet1.SetCellValue(Row, "scope", "0");

			//sheet1.SelectCell(Row, 3);
			sheet1.SelectCell(Row, "appGroupNm");
			break;
...
//			break;
		case "DownTemplate":
			sheet1.Down2Excel({ SheetDesign:1, Merge:1, DownRows:"0", DownCols:"appSeqCd|appGroupNm",ExcelFontSize:"9",ExcelRowHeight:"20"});
			break;
			...
			<div>
				<table>
					<tr>
						...
						<td>
							<a href="javascript:doAction('Search');" id="btnSearch" class="btn dark"><tit:txt mid='104081' mdef='조회'/></a>
						</td>
					</tr>
				</table>
			</div>
					...
					<div class="sheet_title">
						<ul>
							...
							<li class="btn">
								...
								<a href="javascript:makeDic();" 			class="btn filled authA">기초그룹생성</a>
							</li>
						</ul>
					</div>
				</div>
