...
<script type="text/javascript">
	...
	$(function() {
		...
		//평가차수
		var comboList4 = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList","queryId=getAppraisalIdMgrTab2CdList&useYn=Y&searchAppraisalCd=" + $("#searchAppraisalCd").val(),false).codeList, "");
	...
	function doAction2(sAction) {
		...
		switch (sAction) {
		case "Search": 	 	sheet2.DoSearch( "${ctx}/AppraisalIdMgr.do?cmd=getAppraisalIdMgrTab2", "appraisalCd="+appraisalCd ); break;
		case "Save":
			...
			sheet2.DoSave( "${ctx}/AppraisalIdMgr.do?cmd=saveAppraisalIdMgrTab2", $("#srchFrm").serialize()); break;
		case "Insert":
			if ( appraisalCd == "" ) {
				alert("평가ID를 선택해 주세요");
				return;
