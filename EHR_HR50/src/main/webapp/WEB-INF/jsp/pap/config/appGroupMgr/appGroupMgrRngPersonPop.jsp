...
<script type="text/javascript">
	...
	function doAction1(sAction) {
		...
		switch (sAction) {
		case "Search":
			sheet1.DoSearch( "${ctx}/AppGroupMgrRngPop.do?cmd=getAppGroupMgrRngPopList4", $("#srchFrm").serialize() ); break;
	...
	function doAction2(sAction) {
		...
		case "Search":
			if( $("#searchType").is(":checked") == false ){
				sheet2.DoSearch( "${ctx}/AppGroupMgrRngPop.do?cmd=getAppGroupMgrRngPopList5", $("#srchFrm").serialize() ); break;
			} else {
				sheet2.DoSearch( "${ctx}/AppGroupMgrRngPop.do?cmd=getAppGroupMgrRngPopList6", $("#srchFrm").serialize() ); break;
			}
		...
		case "Save":
			...
			sheet2.DoSave( "${ctx}/AppGroupMgrRngPop.do?cmd=saveAppGroupMgrRngPop", $("#srchFrm").serialize()); break;
