...
<script type="text/javascript">
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "${ctx}/AppGroupMgrRngPop.do?cmd=getAppGroupMgrRngPopList3", $("#srchFrm").serialize() ); break;
		case "Save": 		for(i=1; i<=sheet1.LastRow(); i++){
							...
							sheet1.DoSave( "${ctx}/AppGroupMgrRngPop.do?cmd=saveAppGroupMgrRngPop", $("#srchFrm").serialize()); break;
