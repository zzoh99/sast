...
<script type="text/javascript">
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			sheet1.DoSearch( "${ctx}/CompApp2ndApr.do?cmd=getCompApp2ndAprList", $("#srchFrm").serialize() ); break;
		case "Save1":
							if(chkConfirm()){
		...
		case "Save2":
							if(chkEval()){
								IBS_SaveName(document.srchFrm,sheet1);
								sheet1.DoSave( "${ctx}/CompApp2ndApr.do?cmd=saveCompApp2ndAprReturn", $("#srchFrm").serialize());
							}
							break;
