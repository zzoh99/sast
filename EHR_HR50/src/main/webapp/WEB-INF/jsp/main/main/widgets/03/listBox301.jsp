...
<script src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/ibleaders.js?=3" type="text/javascript" charset="utf-8"></script>
 -->
    ...
    <script src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/module/ibconfig.js?=6" type="text/javascript" charset="utf-8"></script>
    ...
    <script src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/module/nodeEditObjBoard.js?=3" type="text/javascript" charset="utf-8"></script>
    <script src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/module/orgObjBoard.js?=6" type="text/javascript" charset="utf-8"></script>
...
<div class="wrapper widget" id="widget301Element">
    ...
    <div id="body">
        <div class="contents" style="padding:0;">
            <!-- 패널&탭 영역 -->
            <div id="ibContent" style="position:absolute; left:10px; top:20px; width:280px; border:1px solid silver; background-color:#fff; z-index:1000; border-radius: 5px">
                <label for="treeShow" class="floatR" style="margin:2px 7px 0 0;"><img src="${ ctx }/common/images/common/btn_delete.gif" style="vertical-align: middle;" /></label>
                <ul class="tabs">
                    <!--<li class="" rel="tab1"><tit:txt mid="L190827000007" mdef="트리" /></li>-->
                    <li class="active" style="display:none;" rel="tab2"><tit:txt mid="112170" mdef="정보"/></li>
                </ul>
                <div class="tab_container" style="width:270px; height:calc(100% - 52px);">
                    ...
                    <div id="tab2" class="tab_content">
                        <div id="editPanelArea" style="position:absolute; top:36px;left:2px; width:270px; height:calc(100% - 52px);; overflow-y:auto;"></div>
                    </div>
                </div>
            </div>
            ...
            <div id="Toolbar" style="position:absolute;top:93px;right:36px; z-Index:9999; padding:4px 4px 4px 4px; border-radius:4px; border: 2px solid #FFFFFF; background-color:#D3D3D3; box-shadow:4px 4px 8px #CCC;">
                <img src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/img/CAPTURE.png" id="btnImageSave" class="item" style="cursor:pointer;" />
                <%-- 				<img src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/img/FILEOPEN.png" id="btnFileOpen" style="cursor:pointer; margin-left:4px;" /> --%>
                <img src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/img/FILESAVE.png" id="btnFileSave" class="item" style="cursor:pointer;" />

                <!-- 확대 -->
                <img src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/img/ZOOM_IN.png" id="btnZoomIn" class="item" style="cursor:pointer;" />
                <!-- 축소 -->
                <img src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/img/ZOOM_OUT.png" id="btnZoomOut" class="item" style="cursor:pointer;" />
                <!-- 100% -->
                <img src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/img/ZOOM_RESET.png" id="btnZoomReset" class="item" style="cursor:pointer;" />
                <!-- Fit -->
                <img src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/img/ZOOM_FIT.png" id="btnZoomFit" class="item" style="cursor:pointer;" />
            </div>
        </div>
    </div>
</div>