...
<script type="text/javascript">
	 ...
	 */
	function init_listBox901(size) {
		widget901.size = size;
		
		// if (size == "normal"){
		// 	createWidgetMini901();
		// 	setDataWidgetMini901();
		// } else if (size == ("wide")){
		// 	createWidgetWide901();
		// 	setDataWidgetWide901();
		// }
	}

	// 위젯 html 코드 생성
	function createWidgetMini901(){
		var code =
		...
		document.querySelector('#widget901Element').innerHTML = code;
	}
    ...
    function openModal() {
        var menuListLayer = new window.top.document.LayerModal({
            id: 'list901Layer',
            url: "${ctx}/list09.do?cmd=viewList901Layer",
            parameters: {},
            width: 800,
            height: 635,
            title: '규정'
