...
<script type="text/javascript">
     ...
     */
    function init_listBox905(size) {
        widget905.size = size;

        // if (size == "normal"){
        // 	createWidgetMini905();
        // 	setDataWidgetMini905();
        // } else if (size == ("wide")){
        // 	createWidgetWide905();
        // 	setDataWidgetWide905();
        // }
    }

    // 위젯 html 코드 생성
    function createWidgetMini905(){
        var code =
        ...
        document.querySelector('#widget905Element').innerHTML = code;
    }


    // Function to open the modal
    function open905Modal() {
        var menuListLayer = new window.top.document.LayerModal({
            id: 'list905Layer',
            url: "${ctx}/list09.do?cmd=viewList905Layer",
            parameters: {},
            width: 800,
            height: 635,
            title: '규정'
...
<div class="widget_body widget_approval widget-benefit">
    <div class="inner-wrap">
        ...
        <div class="btn-wrap">
            <button class="btn-common" onclick="open905Modal()">가이드</button>
        </div>
        <div class="img-wrap">
