...
<script type="text/javascript">
	 ...
	 */
	function init_listBox902(size) {
		widget902.size = size;
		
		// if (size == "normal"){
		// 	createWidgetMini902();
		// 	setDataWidgetMini902();
		// } else if (size == ("wide")){
		// 	createWidgetWide902();
		// 	setDataWidgetWide902();
		// }
	}

	// 위젯 html 코드 생성
	function createWidgetMini902(){
		var code =
		...
		document.querySelector('#widget902Element').innerHTML = code;
	}
    ...
    function open902Modal() {
        var menuListLayer = new window.top.document.LayerModal({
            id: 'list902Layer',
            url: "${ctx}/list09.do?cmd=viewList902Layer",
            parameters: {},
            width: 800,
            height: 635,
            title: '규정'
...
<div class="widget_body widget_approval widget-benefit">
    <div class="inner-wrap">
        ...
        <div class="btn-wrap">
            <button class="btn-common"   onclick="open902Modal()">규정</button>
        </div>
        <div class="img-wrap">
