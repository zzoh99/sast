...
<script>
    ...
    function closeChangePwLayer() {
    	const modal = window.top.document.LayerModalUtility.getModal('changePwLayer');
    	modal.hide();
    }
...
<div class="wrapper modal_layer">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <c:choose>
                                ...
                                <c:when test="${sessionScope.ssnLoginPwLevel == 'M'}">
                                    <div style="float:right;width:200px;word-break:break-all;padding-right:3px; margin-top:4px;">
    ...
    <div class="modal_footer">
        <ul>
            <li class="center">
                <a href="javascript:closeChangePwLayer();" class="btn outline_gray"><tit:txt mid='113097' mdef='다음에 변경하기'/></a>
