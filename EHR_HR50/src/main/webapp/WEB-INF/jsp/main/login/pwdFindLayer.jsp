...
<link rel="stylesheet" href="/assets/css/hrux_fit.css" />
<style>
	/* 먼저 로드되어서 일단 감춤 */
	.pass_info{display: none;}
</style>
<script type="text/javascript" src="/common/js/jquery/jquery.defaultvalue.js"></script>

<script type="text/javascript">
	var pwdFindLayer = { id: 'pwdFindLayer' };
	$(function() {
		const modal = window.top.document.LayerModalUtility.getModal(pwdFindLayer.id);
		var { enterCd } = modal.parameters;
...
<div class="wrapper modal_layer">
	<div class="modal_body">
		...
		<tr>
			<td><input id="type" name="type" type="radio" value="0" class="form-radio" checked /> E-mail</td>
		...
		<table id="email" border="0" cellpadding="0" cellspacing="0" class="table">
		<colgroup>
			<col width="20%" />
			<col width="80%" />
		</colgroup>
	...
	<div class="modal_footer">
		<btn:a href="javascript:findDw();" css="btn filled" mid='findDw' mdef="임시비밀번호 생성" id="pwdFindFormPopTempPwd" />
		<btn:a href="javascript:closeCommonLayer('pwdFindLayer');" css="btn outline_gray" mid='110778' mdef="취소" id="pwdFindFormPopCancel" />
	</div>
</div>
