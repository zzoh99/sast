...
<script type="text/javascript">
	...
	function init_sheetHtml(){
		...
		initdata.Cols = [
			...
			//신청내용
			{Header:"신청내용|신청서",		Type:"Combo",	Hidden:1,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"applCd",		KeyField:0,	Format:"",		Edit:0 },
...
<div class="wrapper">
	...
	<input type="hidden" id="searchApplTypeCd" name="searchApplTypeCd"  value="${applTypeCd}"/>
