...
$(function(){
    ...
    const modal = window.top.document.LayerModalUtility.getModal('appCodeMgrDetailLayer');
...
// 	window.returnValue = rv;
	...
	const modal = window.top.document.LayerModalUtility.getModal('appCodeMgrDetailLayer');
    modal.fire('appCodeMgrDetailTrigger', {
 ...
 -->
	...
	<div class="modal_footer">
		<ul>
			<li>
				<a href="javascript:save();" class="pink large"><tit:txt mid='104435' mdef='확인'/></a>
				<a href="javascript:closeCommonLayer('appCodeMgrDetailLayer');" class="gray large"><tit:txt mid='104157' mdef='닫기'/></a>
			</li>
		</ul>
	</div>
</div>
