...
<div class="wrapper">
	...
	<tr>
		<td class="sheet_left">
			...
			<script type="text/javascript"> createIBSheet("mySheet0", "33%", "100%", "${ssnLocaleCd}"); </script>
		</td>
		<td class="sheet_right">
			...
			<script type="text/javascript"> createIBSheet("mySheet2", "33%", "100%", "${ssnLocaleCd}"); </script>
		</td>
		<td class="sheet_arrow">
			<a class="basic">&gt;</a><br/><br/>
			<a class="basic">&lt;</a>
		</td>
		<td>
			<div class="inner">
			...
			<script type="text/javascript"> createIBSheet("mySheet1", "33%", "100%", "${ssnLocaleCd}"); </script>
		</td>
	</tr>
	</table>
