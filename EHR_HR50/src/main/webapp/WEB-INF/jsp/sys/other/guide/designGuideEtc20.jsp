...
<div class="wrapper">
	...
	<tr>
		...
		<td class="sheet_left sheet_right">
			<script type="text/javascript"> createIBSheet("mySheet2", "50%", "100%", "${ssnLocaleCd}"); </script>
		</td>
		<td class="sheet_left sheet_right">
			<script type="text/javascript"> createIBSheet("mySheet3", "50%", "100%", "${ssnLocaleCd}"); </script>
		</td>
