...
<div class="wrapper">
	...
	<script type="text/javascript"> createIBSheet("mySheet0", "100%", "33%", "${ssnLocaleCd}"); </script>
	...
	<script type="text/javascript"> createIBSheet("mySheet1", "100%", "33%", "${ssnLocaleCd}"); </script>
	...
	<script type="text/javascript"> createIBSheet("mySheet2", "100%", "33%", "${ssnLocaleCd}"); </script>
