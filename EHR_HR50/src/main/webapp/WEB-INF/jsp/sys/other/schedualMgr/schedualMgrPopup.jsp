...
$(function(){
    ...
    if( arg != undefined ) {
    	seq  		= arg["seq"];       
    	schGubunCd  = arg["schGubunCd"];
    	sdate  		= arg["sdate"];     
    	edate  		= arg["edate"];     
    	title  		= arg["title"];     
    	memo		= arg["memo"];      
    }else{
    	if(p.popDialogArgument("seq")!=null)			seq  		= p.popDialogArgument("seq");
    	if(p.popDialogArgument("schGubunCd")!=null)		schGubunCd  = p.popDialogArgument("schGubunCd");
    	...
    	if(p.popDialogArgument("memo")!=null)			memo		= p.popDialogArgument("memo");
    }
