	...
	<tr>
		...
		<td class="sheet_right">
			<div>
				...
				<script type="text/javascript"> createIBSheet("mySheet2", "50%", "50%", "${ssnLocaleCd}"); </script>
			</div>
			<div>
				<div class="inner">
					<div class="sheet_title">
				...
				<script type="text/javascript"> createIBSheet("mySheet1", "50%", "50%", "${ssnLocaleCd}"); </script>
			</div>
		</td>
	</tr>
	</table>
