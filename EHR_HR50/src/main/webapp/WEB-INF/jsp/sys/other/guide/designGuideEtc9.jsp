...
<div class="wrapper">
	...
	<ul>
		<li><tit:txt mid='114312' mdef='임직원 조회'/></li>
		<li class="close"></li>
	</ul>
	</div>
		...
		<tr>
			<td class="sheet_left">
				<div class="inner">
					...
					<ul>
						<li class="txt"></li>
						<li class="btn">
							<btn:a css="basic" mid='111263' mdef="조회항목으로 이동"/>
							<btn:a css="basic" mid='111874' mdef="조건항목으로 이동"/>
							<a class="basic"><tit:txt mid='104054' mdef='사용자입력 조건항목 이동'/></a>
						</li>
					</ul>
					</div>
				</div>
			...
			<td class="sheet_right">
				<div>
					...
					<script type="text/javascript"> createIBSheet("mySheet1", "50%", "33%", "${ssnLocaleCd}"); </script>
				</div>
				...
				<div>
					...
					<script type="text/javascript"> createIBSheet("mySheet2", "50%", "33%", "${ssnLocaleCd}"); </script>
				</div>
				...
				<div>
					...
					<script type="text/javascript"> createIBSheet("mySheet3", "50%", "33%", "${ssnLocaleCd}"); </script>
				</div>
			</td>
		</tr>
		</table>
