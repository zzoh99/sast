...
$(function() {
	...
	initdata.Cols = [
		...
		{Header:"<sht:txt mid='koKrV5' mdef='메뉴/프로그램명'/>",		Type:"Text",	Hidden:0,	Wid0h:280,	Align:"Left",	ColMerge:0,	SaveName:"menuNm",		UpdateEdit:0, TreeCol:1  },
		...
		{Header:"<sht:txt mid='dataPrgType' mdef='적용권한'/>",			Type:"Combo",	Hidden:1,	Wid0h:80,	Align:"Center",	ColMerge:0,	SaveName:"dataPrgType",	UpdateEdit:0 },
	...
	initdata.Cols = [
		...
		{Header:"<sht:txt mid='prgCdV2' mdef='프로그램'/>",			Type:"Text",		Hidden:1,	Width:150,	Align:"Left",	ColMerge:0,	SaveName:"prgCd",		UpdateEdit:0 },
		{Header:"<sht:txt mid='prgNmV1' mdef='프로그램명'/>",			Type:"Text",		Hidden:0,	Wid0h:180,	Align:"Left",	ColMerge:0,	SaveName:"menuNm",		UpdateEdit:0 },
		{Header:"<sht:txt mid='sDelete V5' mdef='삭제'/>",				Type:"Image",		Hidden:0,	Width:45,	Align:"Center",	ColMerge:0,	SaveName:"delImg",		UpdateEdit:0, Cursor:"Pointer" },
		{Header:"<sht:txt mid='eduSeqV8' mdef='순번'/>",				Type:"Text",		Hidden:1,	Wid0h:180,	Align:"Left",	ColMerge:0,	SaveName:"mySeq",		UpdateEdit:0 },
		{Header:"<sht:txt mid='agreeSabun' mdef='사번'/>",				Type:"Text",		Hidden:1,	Wid0h:180,	Align:"Left",	ColMerge:0,	SaveName:"sabun",		UpdateEdit:0}
...
function doAction2(sAction) {
	...
	case "Save":
						...
						sheet2.DoSave( "${ctx}/QuickMenu.do?cmd=saveQuickMenu", $("#sheet1Form").serialize() ); break;
	...
	<tr>
		<td class="sheet_left">
			<div class="inner">
				...
				<ul>
					<li class="txt"><tit:txt mid='104233' mdef='메뉴명'/></li>
					<li class="btn">
		...
		<td class="sheet_arrow">
			...
			<div class="arrow_button">
					<%-- <btn:a href="javascript:goSave();"	css="pink" mid='110746' mdef="참조&gt;"/> --%>
				<a href="javascript:goSave();" class="pink">이동</a>
			</div>
		</td>
		...
		<td class="sheet_right">
			<div class="inner">
				<div class="sheet_title">
				<ul>
					<li class="txt">Quick Menu</li>
					<li class="btn">
						<btn:a href="javascript:doAction2('Save')"  css="basic" mid='110708' mdef="저장"/>
						<a href="javascript:goUpDown('up');"  class="basic">▲</a>
						<a href="javascript:goUpDown('down');"  class="basic">▼</a>
					</li>
				</ul>
				</div>
			</div>
