...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"Locale",	Type:"Combo",		Width:120,	Align:"Center",	SaveName:"localeCd",		KeyField:1,	UpdateEdit:1,	InsertEdit:1,EditLen:100},
			{Header:"<sht:txt mid='keyText' mdef='정의'/>",		Type:"Text",		Width:120,	Align:"Left",	SaveName:"keyText",		KeyField:1,	UpdateEdit:1,	InsertEdit:1,EditLen:3000, MultiLineText:true},
			{Header:"<sht:txt mid='keyReadV1' mdef='Memory'/>",	Type:"CheckBox",	Width:50,	Align:"Center",	SaveName:"keyRead",		TrueValue:"0",	FalseValue:"1", DefaultValue:"1"}
		];
		...
		var keyLevelCode = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList","queryId=getKeyLevelList",false).codeList, "<tit:txt mid='111914' mdef='선택'/>"); //
			...
			<tr>
				...
				<td class="sheet_left">
					<div class="inner">
						...
						<ul>
							<li	id="txt"	class="txt">어휘관리</li>
							<li class="btn">
								<btn:a href="javascript:doAction('Insert1');" mid="110700" mdef="입력" css="basic"/>
								<btn:a href="javascript:doAction('Save1');" mid="110708" mdef="저장" css="basic"/>
							</li>
						</ul>
						</div>
					</div>
				...
				<td class="sheet_right">
					<div class="inner">
						<div class="sheet_title">
						<ul>
							<li	id="txt" class="txt">용어관리</li>
							<li class="btn">
								<btn:a href="javascript:doAction('Insert2');" mid="110700" mdef="입력" css="basic"/>
								<btn:a href="javascript:doAction('Save2');" mid="110708" mdef="저장" css="basic"/>
							</li>
						</ul>
						</div>
					</div>
					...
					<div class="inner">
						<div class="sheet_title">
						<ul>
							<li	id="txt" class="txt">회사별 용어 관리</li>
							<li class="btn">
								<btn:a href="javascript:doAction('Insert3');" mid="110700" mdef="입력" css="basic"/>
								<btn:a href="javascript:doAction('Save3');" mid="110708" mdef="저장" css="basic"/>
							</li>
						</ul>
						</div>
					</div>
			...
			<div class="popup_button outer">
				<ul>
					<li>
						...
						<a href="javascript:doAction('Clear')" class="blue large">어휘코드명 초기화</a>
