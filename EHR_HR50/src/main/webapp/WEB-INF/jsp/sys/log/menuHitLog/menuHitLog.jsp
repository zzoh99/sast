...
<script type="text/javascript">
	$(function() {
		...
		initdata.Cols = [
            ...
            {Header:"<sht:txt mid='prgNmV2' mdef='메뉴명'/>",			Type:"Text",     Hidden:0,  Width:100, 	Align:"Left",  	 ColMerge:0,   SaveName:"prgNm",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            {Header:"<sht:txt mid='prgCdV2' mdef='프로그램'/>",		Type:"Text",     Hidden:0,  Width:100, 	Align:"Left",  	 ColMerge:0,   SaveName:"prgCd",   	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            ...
            {Header:"<sht:txt mid='ymdV2' mdef='메뉴HIT일자'/>",	Type:"Text",     Hidden:0,  Width:100,  Align:"Center",  ColMerge:0,   SaveName:"ymd",     	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
            {Header:"<sht:txt mid='hmsV2' mdef='메뉴HIT시간'/>",	Type:"Text",     Hidden:0,  Width:100, 	Align:"Center",  ColMerge:0,   SaveName:"hms",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
...
*/
		$("#searchName,#searchPrgNm,#searchFromYmd,#searchToYmd").bind("keyup",function(event){
	...
	function doAction1(sAction) {
		...
		case "Search":
			if(!chkInVal()){break;}
			sheet1.DoSearch( "${ctx}/MenuHitLog.do?cmd=getMenuHitLogList", $("#srchFrm").serialize() ); break;
...
<!--
 ...
 -->
 						<th><tit:txt mid='113670' mdef='메뉴HIT일자'/></th>
						<td>
						...
						<td>  <input id="searchPrgNm" name ="searchPrgNm" type="text" class="text" /> </td>
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt"><tit:txt mid='menuHitLog' mdef='메뉴HIT로그'/></li>
							<li class="btn">
