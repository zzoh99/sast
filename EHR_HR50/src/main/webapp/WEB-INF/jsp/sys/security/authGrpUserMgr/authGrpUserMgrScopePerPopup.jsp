...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"<sht:txt mid='orgChartNmV1' mdef='조직도명'/>",		Type:"Text",	Hidden:1,  Width:0,		Align:"Left",	ColMerge:0,   SaveName:"orgChartNm",	KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:30 },
			{Header:"<sht:txt mid='eduSYmd' mdef='시작일'/>",			Type:"Text",	Hidden:1,  Width:0,		Align:"Center",	ColMerge:0,   SaveName:"sdate",			KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10 },
			...
			{Header:"<sht:txt mid='orgNmV6' mdef='조직도'/>",			Type:"Text", 	Hidden:0,  Width:100,	Align:"Left",	ColMerge:0,   SaveName:"orgNm",			KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:50,    TreeCol:1 },
			...
			{Header:"<sht:txt mid='agreeSeq' mdef='순서'/>",			Type:"Int", 	Hidden:1,  Width:0,		Align:"Right",	ColMerge:0,   SaveName:"seq",       	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:20 },
			{Header:"<sht:txt mid='empCnt_V1' mdef='인원'/>",			Type:"Int", 	Hidden:1,  Width:50,	Align:"Right",	ColMerge:0,   SaveName:"empCnt1",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
			{Header:"<sht:txt mid='chiefSabun' mdef='조직장사번'/>",		Type:"Text", 	Hidden:1,  Width:0,		Align:"Center",	ColMerge:0,   SaveName:"orgChiefSabun",	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100},
			{Header:"<sht:txt mid='orgChiefName' mdef='조직장'/>",			Type:"Text", 	Hidden:1,  Width:50,	Align:"Center",	ColMerge:0,   SaveName:"orgChiefName",	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100},
			{Header:"<sht:txt mid='empCnt2' mdef='화상조직도'/>",		Type:"Int",		Hidden:1,  Width:0,		Align:"Right",	ColMerge:0,   SaveName:"empCnt2",		KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:1 }
		...
		initdata.Cols = [
			...
			{Header:"<sht:txt mid='detailV1' mdef='프로필'/>",		Type:"Text",		Hidden:1,  Width:40,	Align:"Center",	ColMerge:0,   SaveName:"profile",		KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:1 },
			{Header:"<sht:txt mid='agreeSabun' mdef='사번'/>",		Type:"Text",		Hidden:0,  Width:70,	Align:"Center",	ColMerge:0,   SaveName:"scopeValue",	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"<sht:txt mid='appNameV1' mdef='성명'/>",		Type:"Text", 		Hidden:0,  Width:70,	Align:"Center",	ColMerge:0,   SaveName:"scopeValueNm",	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"<sht:txt mid='appOrgNmV5' mdef='소속'/>",		Type:"Text", 		Hidden:0,  Width:130,	Align:"Left",	ColMerge:0,   SaveName:"orgNm",			KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			...
			{Header:"<sht:txt mid='jikgubCd' mdef='직급'/>",		Type:"Text", 		Hidden:0,  Width:90,	Align:"Center",	ColMerge:0,   SaveName:"jikgubNm",		KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"<sht:txt mid='jikgubCd' mdef='직급'/>",		Type:"Int", 		Hidden:1,  Width:70,	Align:"Center",	ColMerge:0,   SaveName:"jikgubNm",		KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"<sht:txt mid='partNm' mdef='파트'/>",		Type:"Int", 		Hidden:1,  Width:80,	Align:"Center",	ColMerge:0,   SaveName:"partNm",		KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"<sht:txt mid='manageCd' mdef='사원구분'/>",	Type:"Text", 		Hidden:0,  Width:70,	Align:"Center",	ColMerge:0,   SaveName:"manageNm",		KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100},
			{Header:"<sht:txt mid='chkV1' mdef='등록'/>",		Type:"CheckBox",	Hidden:0,  Width:45,	Align:"Center",	ColMerge:0,   SaveName:"chk",			KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1 }
	...
	function doAction1(sAction) {
		...
		switch (sAction) {
		case "Search":
			sheet1.DoSearch( "${ctx}/AuthGrpUserMgr.do?cmd=getAuthGrpUserMgrPopList4", $("#srchFrm").serialize() ); break;
	...
	function doAction2(sAction) {
		...
		case "Search":
			if( $("#searchType").is(":checked") == false ){
				sheet2.DoSearch( "${ctx}/AuthGrpUserMgr.do?cmd=getAuthGrpUserMgrPopList5", $("#srchFrm").serialize() ); break;
			} else {
				sheet2.DoSearch( "${ctx}/AuthGrpUserMgr.do?cmd=getAuthGrpUserMgrPopList6", $("#srchFrm").serialize() ); break;
			}
		...
		case "Save":
			...
			sheet2.DoSave( "${ctx}/AuthGrpUserMgr.do?cmd=saveAuthGrpUserMgrScopePopup", $("#srchFrm").serialize()); break;
...
<div class="wrapper">
	...
	<ul>
		<li><tit:txt mid='113593' mdef='사용자 권한범위 설정(성명)'/></li>
		<li class="close"></li>
	</ul>
	</div>
