...
<script type="text/javascript">
    ...
    $(function() {
        ...
        initdata.Cols = [
            ...
            {Header:"<sht:txt mid='detail1_V3285' mdef='설문작성'/>",      Type:"Image",       Hidden:1,   Width:30,       Align:"Center", ColMerge:0, SaveName:"detail1",         Sort:0, Cursor:"Pointer" },
            ...
            {Header:"<sht:txt mid='repYn' mdef='답변여부'/>",      Type:"Text",        Hidden:1,   Width:30,       Align:"Center", ColMerge:0, SaveName:"answerYn",        KeyField:0, CalcLogic:"",   Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
    ...
    function doAction1(sAction) {
        switch (sAction) {
        case "Search":  sheet1.DoSearch( "${ctx}/ResearchAppMgr.do?cmd=getResearchAppMgrList", $("#sheetForm").serialize() ); break;
        }
    }
    ...
    function sheet1_OnClick(Row, Col, Value){
    	if(sheet1.ColSaveName(Col) == "detail2"){
...
/*     function sheet1_OnClick(Row, Col, Value){
     ...
     function researchAppDetail1Popup(Row){
        ...
        var w       = 1040;
        var h       = 500;
        var url     = "${ctx}/ResearchApp.do?cmd=researchAppWritePopup&authPg=${authPg}";
        ...
        args["researchSeq"]     = sheet1.GetCellValue(Row,"researchSeq");
        args["researchNm"]  = sheet1.GetCellValue(Row,"researchNm");
