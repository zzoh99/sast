...
<title><tit:txt mid='112235' mdef='예외사용자관리 팝업'/></title>
...
$(function(){
	...
	var agbnYn		= arg["agbnYn"]		;
	var bgbnYn		= arg["bgbnYn"]		;
	var cgbnYn		= arg["cgbnYn"]		;
	var dgbnYn		= arg["dgbnYn"]		;
	...
	$("#retYmd").val(retYmd)    ;
	agbnYn == "Y" ? $(':checkbox[name=agbnYn]').attr('checked', true) : $(':checkbox[name=agbnYn]').attr('checked', false);
	bgbnYn == "Y" ? $(':checkbox[name=bgbnYn]').attr('checked', true) : $(':checkbox[name=bgbnYn]').attr('checked', false);
	cgbnYn == "Y" ? $(':checkbox[name=cgbnYn]').attr('checked', true) : $(':checkbox[name=cgbnYn]').attr('checked', false);
	dgbnYn == "Y" ? $(':checkbox[name=dgbnYn]').attr('checked', true) : $(':checkbox[name=dgbnYn]').attr('checked', false);
...
function setValue() {
	...
	rv["manageCd"]	  = $("#manageCd").val();
	rv["empYmd"]	  = $("#empYmd").val();
	rv["fpromYmd"]	  = $("#fpromYmd").val();
	rv["retYmd"]	  = $("#retYmd").val();
	var temp = "N";
	$("#agbnYn").is(":checked") == true ? temp = "Y" : temp = "N" ;
	rv["agbnYn"]	  = temp ; temp = "N" ;
	$("#bgbnYn").is(":checked") == true ? temp = "Y" : temp = "N" ;
	rv["bgbnYn"]	  = temp ; temp = "N" ;
	$("#cgbnYn").is(":checked") == true ? temp = "Y" : temp = "N" ;
	rv["cgbnYn"]	  = temp ; temp = "N" ;
	$("#dgbnYn").is(":checked") == true ? temp = "Y" : temp = "N" ;
	rv["dgbnYn"]	  = temp ; temp = "N" ;
...
<div class="wrapper">
	...
	<div class="popup_title">
		<ul>
			<li><tit:txt mid='114341' mdef='예외사용자관리 세부내역'/></li>
			<li class="close"></li>
		</ul>
	</div>
	...
	<div class="popup_main">
		<table class="table">
			...
			<tr>
				...
				<td>
					<select id="manageCd" name="manageCd">
					</select>
				</td>
				<th>E-Mail</th>
				<td>
			...
			<tr>
				<th><tit:txt mid='112562' mdef='예외구분'/></th>
				<td colspan="3">
					<input type="checkBox" class="checkBox" name="agbnYn" id="agbnYn" value="" >&nbsp;인사연동 예외처리자&nbsp;
		            <input type="checkBox" class="checkBox" name="bgbnYn" id="bgbnYn" value="" >&nbsp;비정규직 중 연동대상자&nbsp;
		            <input type="checkBox" class="checkBox" name="cgbnYn" id="cgbnYn" value="" >&nbsp;사외메일 연동예외자&nbsp;
		            <input type="checkBox" class="checkBox" name="dgbnYn" id="dgbnYn" value="" >&nbsp;사외메일 영문이름 사용자
		        </td>
			</tr>
		</table>
		&nbsp;
