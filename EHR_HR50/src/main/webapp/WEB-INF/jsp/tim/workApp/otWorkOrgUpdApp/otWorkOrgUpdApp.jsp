...
<!DOCTYPE html> <html class="hidden"><head> <title>연장근무변경신청</title>
...
var pGubun = "";
	...
	function doAction1(sAction) {
		...
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/OtWorkOrgUpdApp.do?cmd=getOtWorkOrgUpdAppList", $("#sheet1Form").serialize() );
        ...
        case "Save": //임시저장의 경우 삭제처리만함.      
        	...
        	sheet1.DoSave( "${ctx}/OtWorkOrgUpdApp.do?cmd=deleteOtWorkOrgUpdApp", $("#sheet1Form").serialize(), -1, 0); 
        	break;
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li class="txt"><tit:txt mid="requestOtWork" mdef="연장근무변경신청" /></li>
				<li class="btn">
