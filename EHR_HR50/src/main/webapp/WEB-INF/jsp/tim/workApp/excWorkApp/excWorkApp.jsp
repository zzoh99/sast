...
<!DOCTYPE html> <html class="hidden"><head> <title>당직신청</title>
...
var pGubun = "";
	...
	$(function() {
	    ...
	    $("#searchSYear, #searchEYear").bind("keyup",function(event){
	    	makeNumber(this,"A");
			if( event.keyCode == 13){
				doAction1("Search");
			}
	    ...
	    $("searchSYear").val("${ curSysYear-1 }");
	    $("searchEYear").val("${ curSysYear }");
	...
	function init_sheet(){
		...
		initdata1.Cols = [
			...
			{Header:"근무일",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"ymd",			Format:"Ymd", 		Edit:0 },
			{Header:"시작시간",	Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"reqSHm",			Format:"Hm", 		Edit:0 },
			{Header:"종료시간",	Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"reqEHm",			Format:"Hm", 		Edit:0 },
			{Header:"신청시간",	Type:"Float",	Hidden:0, Width:80,	 Align:"Center", SaveName:"requestHour",	Format:"#,##0.#\\시간",	Edit:0 },
			{Header:"비고",		Type:"Text",	Hidden:0, Width:120, Align:"Left",	 SaveName:"note",			Edit:0 }, 
	...
	function doAction1(sAction) {
		...
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/ExcWorkApp.do?cmd=getExcWorkAppList", $("#sheet1Form").serialize() );
        ...
        case "Save": //임시저장의 경우 삭제처리만함.      
        	...
        	sheet1.DoSave( "${ctx}/ExcWorkApp.do?cmd=deleteExcWorkApp", $("#sheet1Form").serialize(), -1, 0); 
        	break;
    ...
    function setEmpPage() {
		...
		//신청자정보 조회
		var user = ajaxCall( "${ctx}/ExcWorkApp.do?cmd=getExcWorkAppUserInfo", $("#sheet1Form").serialize(),false);
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li class="txt">당직신청</li>
				<li class="btn">
					<a href="javascript:showApplPopup(-1);" 		class="button" >신청</a>
