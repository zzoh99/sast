...
<!DOCTYPE html> <html class="hidden"><head> <title>출퇴근시간변경신청</title>
...
var pGubun = "";
	...
	$(function() {
		...
		// from - to 일자 근태대상기준일(TTIM004)에서 가져오도록 처리 -- 왜??
		/*
		...
		if(data != null && data.codeList[0] != null ) {
			$("#searchSdate").val(data.codeList[0].symd);
			$("#searchEdate").val(data.codeList[0].eymd);
		}*/

        $("#searchSdate").val("<%= DateUtil.addDays(DateUtil.getCurrentTime("yyyy-MM-dd"),-90)%>");
        $("#searchEdate").val("${curSysYyyyMMddHyphen}");
	...
	function init_sheet(){
		...
		initdata1.Cols = [
			...
			{Header:"<sht:txt mid='applYmdV10' mdef='신청일|신청일'/>",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"applYmd",		Format:"Ymd",		Edit:0 },
			{Header:"<sht:txt mid='applStatusNmV1' mdef='신청상태|신청상태'/>",		Type:"Combo",	Hidden:0, Width:80,	 Align:"Center", SaveName:"applStatusCd",	Format:"",			Edit:0 },

			{Header:"<sht:txt mid='ymdV7' mdef='근무일|근무일'/>",									Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"ymd",			Format:"Ymd",		Edit:0 },
   			{Header:"<sht:txt mid='befChg' mdef='변경전'/>|<sht:txt mid='goToWork' mdef='출근'/>",	Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"bfShm",			Format:"Hm",		Edit:0 },
   			{Header:"<sht:txt mid='befChg' mdef='변경전'/>|<sht:txt mid='getOffWork' mdef='퇴근'/>",	Type:"Text",	Hidden:0, Width:80,	 Align:"Center", SaveName:"bfEhm",			Format:"Hm",		Edit:0 },
   			{Header:"<sht:txt mid='aftChg' mdef='변경후'/>|<sht:txt mid='goToWork' mdef='출근'/>",	Type:"Text",	Hidden:0, Width:80,	 Align:"Center", SaveName:"afShm",			Format:"Hm",		Edit:0 },
   			{Header:"<sht:txt mid='aftChg' mdef='변경후'/>|<sht:txt mid='getOffWork' mdef='퇴근'/>",	Type:"Text",	Hidden:0, Width:80,	 Align:"Center", SaveName:"afEhm",			Format:"Hm",		Edit:0 },
   			{Header:"<sht:txt mid='reasonCdV2' mdef='사유|사유'/>",									Type:"Text",	Hidden:0, Width:200, Align:"Left",   SaveName:"reason",			Format:"",		Edit:0 },
	...
	function doAction1(sAction) {
		...
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/WorkAttendAdjApp.do?cmd=getWorkAttendAdjAppList", $("#sheet1Form").serialize() );
        ...
        case "Save": //임시저장의 경우 삭제처리만함.      
        	...
        	sheet1.DoSave( "${ctx}/WorkAttendAdjApp.do?cmd=saveWorkAttendAdjApp", $("#sheet1Form").serialize(), -1, 0); 
        	break;
...
<div class="wrapper">
	...
	<div class="sheet_search sheet_search_s outer">
   		...
   		<tr>
			<th><tit:txt mid="111928" mdef="근무기간" /></th>
   			<td>
   				<input id="searchSdate" name="searchSdate" type="text"  maxlength="10" class="text center date"/> ~
   				<input id="searchEdate" name="searchEdate" type="text"  maxlength="10" class="text center date"/>
   			</td>
   			<td>
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li class="txt"><tit:txt mid="appCommuteTimeChg" mdef="출퇴근시간변경신청" /></li>
				<li class="btn">
					<a href="javascript:showApplPopup(-1);" 		class="btn filled authA" ><tit:txt mid="appTitleV1" mdef="신청" /></a>
