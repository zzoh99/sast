...
<!DOCTYPE html> <html class="hidden"><head><title>당직승인</title>
...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			{Header:"신청내용|비고",		Type:"Text",	Hidden:0,   Width:120,  Align:"Left",	SaveName:"note",		Edit:0 }, 
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/ExcWorkApr.do?cmd=getExcWorkAprList", $("#sheet1Form").serialize() );
