...
<!DOCTYPE html> <html class="hidden"><head> <title>연장근무사전신청</title>
...
var pGubun = "";
	...
	$(function() {
		...
		$("#searchAppSYmd").datepicker2().val("${curSysYyyyMMHyphen}-01");
		$("#searchAppEYmd").datepicker2().val('<%= DateUtil.getLastDateOfMonthString(DateUtil.getCurrentTime("yyyy-MM-dd"))%>'); //말일
	...
	function init_sheet(){
		...
		initdata1.Cols = [
			...
			{Header:"<sht:txt mid='sYmdV5' mdef='근무일'/>",			Type:"Text",	Hidden:0, Width:100, Align:"Center", SaveName:"ymd",			Format:"", 		Edit:0 },
			{Header:"<sht:txt mid='orgNmV9' mdef='부서명' />",		Type:"Text",	Hidden:0, Width:150, Align:"Center", SaveName:"orgNm",			Format:"", 		Edit:0 },
			{Header:"<sht:txt mid='sawonCnt' mdef='대상자수'/>",		Type:"Text",	Hidden:1, Width:60,  Align:"Center", SaveName:"empCnt",			Edit:0 },
			{Header:"<sht:txt mid='workHmV1' mdef='신청시간'/>",		Type:"Text",	Hidden:0, Width:60,  Align:"Center", SaveName:"requestHour",	Edit:0 },
			{Header:"<sht:txt mid='empname' mdef='대상자명'/>(<sht:txt mid='workHmV1' mdef='신청시간'/>)",	Type:"Text",	Hidden:0, Width:300, Align:"Left",	 SaveName:"empList",		Edit:0 },
	...
	function doAction1(sAction) {
		...
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/OtWorkOrgApp.do?cmd=getOtWorkOrgAppList", $("#sheet1Form").serialize() );
        ...
        case "Save": //임시저장의 경우 삭제처리만함.      
        	...
        	sheet1.DoSave( "${ctx}/OtWorkOrgApp.do?cmd=deleteOtWorkOrgApp", $("#sheet1Form").serialize(), -1, 0); 
        	break;
