...
<!DOCTYPE html> <html class="hidden"><head><title>휴일근무승인</title>
...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			//신청내용
			{Header:"신청내용|근무일",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"ymd",			Format:"Ymd",	Edit:0 },
			{Header:"신청내용|출근시간",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"reqSHm",			Format:"Hm", 	Edit:0 },
			{Header:"신청내용|퇴근시간",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"reqEHm",			Format:"Hm", 	Edit:0 },
			{Header:"신청내용|총시간",		Type:"Text",	Hidden:0, Width:60,	 Align:"Center", SaveName:"requestHour",	Format:"", 		Edit:0 },
			{Header:"신청내용|보상구분",		Type:"Combo",	Hidden:0, Width:100, Align:"Center", SaveName:"reqTimeCd",		Format:"", 		Edit:0 },
			{Header:"신청내용|대체휴무일",	Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"alterYmd",		Format:"Ymd", 	Edit:0 },
			{Header:"신청내용|신청사유",		Type:"Text",	Hidden:0, Width:120, Align:"Left",	 SaveName:"reason",			Edit:0 },

			{Header:"인정 근무시간|출근시간",	Type:"Date",	Hidden:1, Width:60,	 Align:"Center", SaveName:"sHm",			Format:"Hm", 	Edit:0 },
			{Header:"인정 근무시간|퇴근시간",	Type:"Date",	Hidden:1, Width:60,	 Align:"Center", SaveName:"eHm",			Format:"Hm", 	Edit:0 },
			{Header:"인정 근무시간|인정시간",	Type:"Date",	Hidden:1, Width:60,	 Align:"Center", SaveName:"workTime",		Format:"Hm",	Edit:0 },
			
			{Header:"비고|비고",			Type:"Text",	Hidden:1,   Width:200,  Align:"Left",	SaveName:"note",		Edit:0 }, 
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/HolWorkApr.do?cmd=getHolWorkAprList", $("#sheet1Form").serialize() );
			sXml = replaceAll(sXml,"shtcolEdit", "Edit");
			sheet1.LoadSearchData(sXml );
			break;
        case "Save":   
       		IBS_SaveName(document.sheet1Form,sheet1);
        	sheet1.DoSave( "${ctx}/HolWorkApr.do?cmd=saveHolWorkApr", $("#sheet1Form").serialize()); 
        	break;
        case "Down2Excel":
