...
<!DOCTYPE html> <html class="hidden"><head><title>출퇴근변경승인</title>
...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			{Header:"신청자|직위",			Type:"Text",   	Hidden:"${jwHdn}", Width:80, Align:"Center", SaveName:"jikweeNm", 	Edit:0},
			{Header:"신청자|직급",			Type:"Text",   	Hidden:"${jgHdn}", Width:80, Align:"Center", SaveName:"jikgubNm", 	Edit:0},
			
			//신청내용
			{Header:"근무일|근무일",		Type:"Date",	Hidden:0,	Width:80,	Align:"Center",	SaveName:"ymd",			Format:"Ymd",		Edit:0 },
			{Header:"변경전|출근시간",		Type:"Date",	Hidden:0,   Width:80,	Align:"Center", SaveName:"bfShm",		Format:"Hm", 		Edit:0 },
			{Header:"변경전|퇴근시간",		Type:"Date",	Hidden:0,   Width:80,	Align:"Center", SaveName:"bfEhm",		Format:"Hm", 		Edit:0 },
			{Header:"변경후|출근시간",		Type:"Date",	Hidden:0,   Width:80,	Align:"Center", SaveName:"afShm",		Format:"Hm",		Edit:0 },
			{Header:"변경후|퇴근시간",		Type:"Date",	Hidden:0,   Width:80,	Align:"Center", SaveName:"afEhm",		Format:"Hm",		Edit:0 },
			{Header:"신청사유|신청사유",		Type:"Text",	Hidden:0,   Width:120,  Align:"Left",	SaveName:"reason",		Edit:0 }, 
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/WorkAttendAdjApr.do?cmd=getWorkAttendAdjAprList", $("#sheet1Form").serialize() );
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li id="txt" class="txt">출퇴근변경승인</li> 
				<li class="btn">
