...
<!DOCTYPE html> <html class="hidden"><head><title>연장근무승인</title>
...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			{Header:"신청내용|시작시간",		Type:"Date",	Hidden:0,   Width:80,	Align:"Center", SaveName:"reqSHm",		Format:"Hm", 		Edit:0 },
			{Header:"신청내용|종료시간",		Type:"Date",	Hidden:0,   Width:80,	Align:"Center", SaveName:"reqEHm",		Format:"Hm", 		Edit:0 },
			{Header:"신청내용|신청시간",		Type:"Text",	Hidden:0,   Width:80,	Align:"Center", SaveName:"requestHour",	Format:"",	Edit:0 },
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/ExtenWorkApr.do?cmd=getExtenWorkAprList", $("#sheet1Form").serialize() );
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li id="txt" class="txt">연장근무추가승인</li> 
				<li class="btn">
