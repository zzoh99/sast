...
<!DOCTYPE html> <html class="hidden"><head><title>대체휴가승인</title>
...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			//휴일근무
			{Header:"휴일근무|근무일",		Type:"Date",	Hidden:0,	Width:80,	Align:"Center",	SaveName:"holYmd",			Format:"Ymd",		Edit:0 },
			{Header:"휴일근무|신청구분",		Type:"Combo",	Hidden:0,   Width:100,	Align:"Center", SaveName:"holReqTimeCd",	Format:"", 			Edit:0 },
			{Header:"휴일근무|출근시간",		Type:"Date",	Hidden:1,   Width:60,	Align:"Center", SaveName:"holShm",			Format:"Hm", 		Edit:0 },
			{Header:"휴일근무|퇴근시간",		Type:"Text",	Hidden:1,   Width:60,   Align:"Center",	SaveName:"holEhm",			Format:"Hm", 		Edit:0 },
			{Header:"휴일근무|인정시간",		Type:"Text",	Hidden:0,   Width:60,	Align:"Center", SaveName:"workTime",		Format:"Hm",		Edit:0 },

			
			//신청내용
			{Header:"신청내용|휴가일자",		Type:"Date",	Hidden:0,	Width:80,	Align:"Center",	SaveName:"sYmd",			Format:"Ymd",		Edit:0 },
			{Header:"신청내용|근태종류",		Type:"Text",	Hidden:0,   Width:80,	Align:"Center", SaveName:"gntNm",			Format:"", 			Edit:0 },
		...
		sheet1.SetColProperty("holReqTimeCd",  	{ComboText:"|"+codeLists["T11010"][0], ComboCode:"|"+codeLists["T11010"][1]} );//  신청구분
		//==============================================================================================================================
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/HolAlterApr.do?cmd=getHolAlterAprList", $("#sheet1Form").serialize() );
	...
	function showApplPopup(Row) {
		...
		var p = {
			  ...
			  , adminYn: 'Y'
			  , authPg: 'R'
			  , searchSabun: sheet1.GetCellValue(Row,"applInSabun") // 신청 내용을 입력 하는 사람
			  , searchApplSabun: sheet1.GetCellValue(Row, "sabun")// 대상자 사번
