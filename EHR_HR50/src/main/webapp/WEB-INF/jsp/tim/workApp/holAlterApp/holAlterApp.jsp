...
<!DOCTYPE html> <html class="hidden"><head> <title>대체휴가신청</title>
...
var appYn = "Y"; 
	...
	function init_sheet(){
		...
		initdata1.Cols = [
			...
			{Header:"<sht:txt mid='holHour' mdef='휴일근무'/>|<sht:txt mid='sYmdV5' mdef='근무일'/>",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"ymd",			Format:"Ymd", 	Edit:0 },
			{Header:"<sht:txt mid='holHour' mdef='휴일근무'/>|<sht:txt mid='inTime_V1' mdef='출근시간'/>",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"reqSHm",			Format:"Hm", 	Edit:0 },
			{Header:"<sht:txt mid='holHour' mdef='휴일근무'/>|<sht:txt mid='outTime_V1' mdef='퇴근시간'/>",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"reqEHm",			Format:"Hm", 	Edit:0 },
			{Header:"<sht:txt mid='holHour' mdef='휴일근무'/>|<sht:txt mid='eduHourV4' mdef='총시간'/>",		Type:"Text",	Hidden:0, Width:60,	 Align:"Center", SaveName:"requestHour",	Format:"", 		Edit:0 },
			...
			{Header:"<sht:txt mid='rcgnWorkHour' mdef='인정 근무시간'/>|<sht:txt mid='applyHm' mdef='인정시간'/>",		Type:"Date",	Hidden:1, Width:60,	 Align:"Center", SaveName:"workTime",		Format:"Hm",	Edit:0 },
   			...
   			//대체휴가신청
			{Header:"<sht:txt mid='applyCompTimeOff' mdef='대체휴가신청'/>|<sht:txt mid='sDelete' mdef='삭제'/>",			Type:"Html",		Hidden:0,	 Width:45,              Align:"Center",	ColMerge:0,	SaveName:"btnDel",  Sort:0,	Cursor:"Pointer" },
			{Header:"<sht:txt mid='applyCompTimeOff' mdef='대체휴가신청'/>|<sht:txt mid='detailV6' mdef='신청'/>",			Type:"Html",		Hidden:0,	 Width:45,              Align:"Center",	ColMerge:0,	SaveName:"btnApp",  Sort:0,	Cursor:"Pointer" },

			{Header:"<sht:txt mid='applyCompTimeOff' mdef='대체휴가신청'/>|<sht:txt mid='dbItemDesc' mdef='세부\n내역'/>",	Type:"Image",	Hidden:0, Width:45,	 Align:"Center", SaveName:"detail",			Format:"",			Edit:0, Cursor:"Pointer" },
			{Header:"<sht:txt mid='applyCompTimeOff' mdef='대체휴가신청'/>|<sht:txt mid='applYmdV5' mdef='신청일'/>",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"applYmd",		Format:"Ymd",		Edit:0 },
			{Header:"<sht:txt mid='applyCompTimeOff' mdef='대체휴가신청'/>|<sht:txt mid='applStatusCdV2' mdef='신청상태'/>",		Type:"Combo",	Hidden:0, Width:80,	 Align:"Center", SaveName:"applStatusCd",	Format:"",			Edit:0 },
  			{Header:"<sht:txt mid='applyCompTimeOff' mdef='대체휴가신청'/>|<sht:txt mid='gntCdV3' mdef='근태종류'/>", 		Type:"Text",	Hidden:0, Width:100, Align:"Center", SaveName:"gntNm",			Format:"",		Edit:0 },
  			{Header:"<sht:txt mid='applyCompTimeOff' mdef='대체휴가신청'/>|<sht:txt mid='leaveDate' mdef='휴가일자'/>",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"ymd2",			Format:"Ymd", 	Edit:0 },
  			...
  			{Header:"Hidden",	Type:"Text",   Hidden:1, SaveName:"bfApplSeq"},
	...
	function doAction1(sAction) {
		...
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/HolAlterApp.do?cmd=getHolAlterAppList", $("#sheet1Form").serialize() );
        ...
        case "Save": //임시저장의 경우 삭제처리만함.      
        	...
        	sheet1.DoSave( "${ctx}/HolAlterApp.do?cmd=deleteHolAlterApp", $("#sheet1Form").serialize(), -1, 0); 
        	break;
	...
	function showApplPopup( Row ) {
		...
		var p = {
			  ...
			  , etc01: sheet1.GetCellValue(Row,"bfApplSeq")
			};
    ...
    function setEmpPage() {
    	...
    	/*
		try{
    		var user = ajaxCall("${ctx}/HolWorkApp.do?cmd=getHolWorkAppUserMap","searchSabun="+$("#searchUserId").val() ,false);
			appYn = user.DATA.appYn;
			
			sheet1.RenderSheet(0);
			sheet1.SetColHidden("reqEHm",      (appYn == "N")?0:1);
			sheet1.SetColHidden("requestHour", (appYn == "N")?0:1);
			sheet1.SetColHidden("reqTimeCd",   (appYn == "N")?1:0);
			for( var i= sheet1.SaveNameCol("btnDel2"); i<= sheet1.SaveNameCol("ymd2"); i++ ){
				if( appYn == "N"){
