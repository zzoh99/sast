...
<!DOCTYPE html> <html class="hidden"><head><title>부서근무스케쥴승인</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchFrom, #searchTo, #searchSYmd, #searchEYmd, #searchSabunName, #searchOrgNm").on("keyup", function(event) {
			if( event.keyCode == 13) {
				doAction1("Search");
			}
		});
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			{Header:"신청자|직책",			Type:"Text",   	Hidden:1, Width:80, 	Align:"Center", SaveName:"jikchakNm", 		Edit:0},
			{Header:"신청자|직위",			Type:"Text",   	Hidden:0, Width:80, 	Align:"Center", ColMerge:0,  SaveName:"jikweeNm", 		Edit:0},
			{Header:"신청자|직급",			Type:"Text",   	Hidden:1, Width:80, 	Align:"Center", ColMerge:0,  SaveName:"jikgubNm", 		Edit:0},

			{Header:"신청내용|신청구분",		Type:"Text",	Hidden:0, Width:80,  Align:"Center", SaveName:"orgAuth",		Format:"",			Edit:0 },
			{Header:"신청내용|부서",		Type:"Text",	Hidden:0, Width:150, Align:"Center", SaveName:"appOrgNm",		Format:"",			Edit:0 },
			{Header:"신청내용|근무조",		Type:"Text",	Hidden:0, Width:100, Align:"Center", SaveName:"workOrgNm",		Format:"",			Edit:0 },
			{Header:"신청내용|기준일자",		Type:"Date",	Hidden:1, Width:100, Align:"Center", SaveName:"ymd",			Format:"Ymd",		Edit:0 },
			{Header:"신청내용|시작일자",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"sdate",			Format:"Ymd",		Edit:0 },
			{Header:"신청내용|종료일자",		Type:"Date",	Hidden:0, Width:80,  Align:"Center", SaveName:"edate",			Format:"Ymd",		Edit:0 },
			{Header:"신청내용|단위기간",		Type:"Combo",	Hidden:1, Width:100, Align:"Center", SaveName:"intervalCd",		Format:"",			Edit:0 },
			{Header:"신청내용|신청단위",		Type:"Text",	Hidden:1, Width:100, Align:"Center", SaveName:"dayGubunNm",		Format:"",			Edit:0 },
			{Header:"신청내용|신청인원수",	Type:"Int",		Hidden:0, Width:80,  Align:"Center", SaveName:"empCnt",			Format:"##\\명",		Edit:0 },
	...
	function getCommonCodeList() {
		...
		//단위기간
		var intervalCdList = convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","T90200", baseSYmd, baseEYmd), "전체");
		sheet1.SetColProperty("intervalCd",  	{ComboText:"|"+intervalCdList[0], ComboCode:"|"+intervalCdList[1]} );//  단위기간
	}
	...
	function doAction1(sAction) {
		...
		case "Search":
			getCommonCodeList();
			var sXml = sheet1.GetSearchData("${ctx}/WorkScheduleOrgApr.do?cmd=getWorkScheduleOrgAprList", $("#sheet1Form").serialize() );
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li id="txt" class="txt">근무스케쥴승인</li> 
				<li class="btn">
