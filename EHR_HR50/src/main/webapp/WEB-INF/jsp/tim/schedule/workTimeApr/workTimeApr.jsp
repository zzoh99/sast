...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchSYm").datepicker2({ymonly:true,startdate:"searchEYm"});
		$("#searchEYm").datepicker2({ymonly:true,enddate:"searchSYm"});
		
		
		$("#searchFrom, #searchTo, #searchSYm, #searchEYm, #searchSabunName, #searchOrgNm").on("keyup", function(event) {
			if( event.keyCode == 13) {
				doAction1("Search");
			}
		});
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			{Header:"신청내용|근무월",		Type:"Date",	Hidden:0,	Width:80,	Align:"Center",	SaveName:"ym",			Format:"Ym",		Edit:0 },
			{Header:"신청내용|대상부서",		Type:"Text",	Hidden:0,   Width:120,	Align:"Center", SaveName:"tgOrgNm",		Format:"", 			Edit:0 },
			{Header:"신청내용|대상자수",		Type:"Int",		Hidden:0,   Width:80,	Align:"Center", SaveName:"empCnt",		Format:"#,###\\명", 	Edit:0 },
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/WorkTimeApr.do?cmd=getWorkTimeAprList", $("#sheet1Form").serialize() );
...
<div class="wrapper">
	...
	<div class="sheet_search outer">
		...
		<tr>
			<th>근무월</th>
			<td>
				<input id="searchSYm" name="searchSYm" type="text" size="7" class="date2" value=""/> ~
				<input id="searchEYm" name="searchEYm" type="text" size="7" class="date2" value=""/>
			</td>	
			<th>소속</th>
			<td>
