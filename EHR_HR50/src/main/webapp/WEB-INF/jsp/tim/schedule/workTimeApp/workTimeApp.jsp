...
<!DOCTYPE html> <html class="hidden"><head> <title>월근무시간신청</title>
...
var pGubun = "";
	...
	function init_sheet(){
		...
		initdata1.Cols = [
			...
			{Header:"근무월",		Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"ym",				Format:"Ym", 		Edit:0 },
			{Header:"대상부서",	Type:"Text",	Hidden:0, Width:120, Align:"Left",	 SaveName:"tgOrgNm",			Edit:0 }, 
			{Header:"대상자수",	Type:"Int",		Hidden:0, Width:80,  Align:"Center", SaveName:"empCnt",			Format:"#,###\\명", 	Edit:0 }, 
	...
	function doAction1(sAction) {
		...
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/WorkTimeApp.do?cmd=getWorkTimeAppList", $("#sheet1Form").serialize() );
        ...
        case "Save": //임시저장의 경우 삭제처리만함.      
        	...
        	sheet1.DoSave( "${ctx}/WorkTimeApp.do?cmd=deleteWorkTimeApp", $("#sheet1Form").serialize(), -1, 0); 
        	break;
