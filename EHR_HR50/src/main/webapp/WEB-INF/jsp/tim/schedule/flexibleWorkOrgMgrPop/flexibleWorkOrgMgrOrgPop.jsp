...
<script type="text/javascript">
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "${ctx}/FlexibleWorkOrgMgrPop.do?cmd=getFlexibleWorkOrgMgrPopList3", $("#srchFrm").serialize() ); break;
		case "Save":
			...
			sheet1.DoSave( "${ctx}/FlexibleWorkOrgMgrPop.do?cmd=saveFlexibleWorkOrgMgrPop", $("#srchFrm").serialize());
			break;
