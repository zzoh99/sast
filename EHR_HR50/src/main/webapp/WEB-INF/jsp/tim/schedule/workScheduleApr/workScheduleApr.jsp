...
<!DOCTYPE html> <html class="hidden"><head><title>월근무시간승인</title>
...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			{Header:"신청내용|단위기간",		Type:"Combo",	Hidden:0, Width:100, Align:"Center", SaveName:"intervalCd",		Format:"",			Edit:0 },
			{Header:"신청내용|기준일자",		Type:"Date",	Hidden:0, Width:100, Align:"Center", SaveName:"ymd",			Format:"Ymd",		Edit:0 },
			{Header:"신청내용|신청단위",		Type:"Text",	Hidden:0, Width:100, Align:"Center", SaveName:"dayGubunNm",		Format:"",			Edit:0 },
	...
	function doAction1(sAction) {
		...
		case "Search":
			getCommonCodeList();
			var sXml = sheet1.GetSearchData("${ctx}/WorkScheduleApr.do?cmd=getWorkScheduleAprList", $("#sheet1Form").serialize() );
