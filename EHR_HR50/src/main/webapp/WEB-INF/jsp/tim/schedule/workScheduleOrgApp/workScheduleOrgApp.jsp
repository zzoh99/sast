...
<!DOCTYPE html> <html class="hidden"><head> <title>부서근무스케쥴신청</title>
...
var pGubun = "";
	...
	function init_sheet1(){
		...
		initdata1.Cols = [
			...
			{Header:"신청구분",	Type:"Text",	Hidden:0, Width:80,  Align:"Center", SaveName:"orgAuth",		Format:"",			Edit:0 },
			{Header:"부서",		Type:"Text",	Hidden:0, Width:150, Align:"Center", SaveName:"orgNm",			Format:"",			Edit:0 },
			{Header:"근무조",		Type:"Text",	Hidden:0, Width:100, Align:"Center", SaveName:"workOrgNm",		Format:"",			Edit:0 },
			{Header:"기준일자",	Type:"Date",	Hidden:1, Width:100, Align:"Center", SaveName:"ymd",			Format:"Ymd",		Edit:0 },
			...
			{Header:"단위기간",	Type:"Combo",	Hidden:1, Width:100, Align:"Center", SaveName:"intervalCd",		Format:"",			Edit:0 },
			{Header:"신청단위",	Type:"Text",	Hidden:1, Width:100, Align:"Center", SaveName:"dayGubunNm",		Format:"",			Edit:0 },
			{Header:"신청인원수",	Type:"Int",		Hidden:0, Width:80,  Align:"Center", SaveName:"empCnt",			Format:"##\\명",			Edit:0 },
  			//Hidden
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/WorkScheduleOrgApp.do?cmd=getWorkScheduleOrgAppList", $("#sheet1Form").serialize() );
        ...
        case "Save": //임시저장의 경우 삭제처리만함.      
        	...
        	sheet1.DoSave( "${ctx}/WorkScheduleOrgApp.do?cmd=deleteWorkScheduleOrgApp", $("#sheet1Form").serialize(), -1, 0); 
        	break;
