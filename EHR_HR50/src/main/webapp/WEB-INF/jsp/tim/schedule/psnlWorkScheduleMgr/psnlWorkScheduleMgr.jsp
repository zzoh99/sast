...
var timeCdList;
	...
	$(function() {	
		...
		var payTypeList = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList","queryId=getPsnlWorkScheduleMgrPayType",false).codeList, ""); //사업장
		...
		$("#searchWorkGrpCd").bind("change", function(){
    		...
    		param = "queryId=getWorkTimeCdList&searchUseYn=Y&searchShortNameFlag=Y&searchWorkGrpCd="+$("#searchWorkGrpCd").val();
    		timeCdList    = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList",param,false).codeList, "");
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
 		...
 		initdata.Cols = [
              ...
              {Header:"근무조",  		Type:"Text",		Hidden:0,  Width:80,   Align:"Center", SaveName:"workOrgCd"},
	...
	function searchTitleList1() {
		...
		var endData = ajaxCall("${ctx}/PsnlWorkScheduleMgr.do?cmd=getPsnlWorkScheduleMgrEndYn", $("#sheetForm").serialize(), false);
		...
		var titleList = ajaxCall("${ctx}/PsnlWorkScheduleMgr.do?cmd=getPsnlWorkScheduleMgrHeaderList", $("#sheetForm").serialize(), false);
		if (titleList != null && titleList.DATA != null) {
			...
			initdata1.Cols[v++]  = {Header:"근무조|근무조|근무조",		Type:"Text",		Hidden:1,  Width:100, Align:"Left",   ColMerge:1,   SaveName:"workOrgCd",	KeyField:0,  Format:"", UpdateEdit:0,   InsertEdit:0 };
			initdata1.Cols[v++]  = {Header:"근무조|근무조|근무조",		Type:"Text",		Hidden:0,  Width:100, Align:"Left",   ColMerge:1,   SaveName:"workOrgNm",	KeyField:0,  Format:"", UpdateEdit:0,   InsertEdit:0 };
			...
			initdata1.Cols[v++]  = {Header:"급여유형|급여유형|급여유형",	Type:"Text",		Hidden:0,  Width:80,  Align:"Center", ColMerge:1,   SaveName:"payTypeNm",	KeyField:0,  Format:"", UpdateEdit:0,   InsertEdit:0 };
	...
	function doAction1(sAction) {
		...
		case "Search":
			searchTitleList1();
			setTimeCdCombo();
			sheet1.DoSearch( "${ctx}/PsnlWorkScheduleMgr.do?cmd=getPsnlWorkScheduleMgrList", $("#sheetForm").serialize() );
			break;
		case "Save":
			setTTIM120Table();
			//if(!dupChk(sheet1,"jikweeCd|leaderYn|careerYn|sdate", false, true)){break;}
			//sheet1.DoSave( "${ctx}/PsnlWorkScheduleMgr.do?cmd=savePsnlWorkScheduleMgr");
			break;
        case "Down2Excel":
	...
	function doAction2(sAction) {
		...
		case "Save":
			...
			sheet2.DoSave( "${ctx}/PsnlWorkScheduleMgr.do?cmd=savePsnlWorkScheduleMgr", $("#sheetForm").serialize()); break;
			break;
		}
	}
	...
	function doAction3(sAction) {
		...
		case "Search":
			...
			try{
				...
				sheet3.DoSearch( "${ctx}/PsnlWorkScheduleMgr.do?cmd=getPsnlWorkScheduleMgrDayWorkList", param );
			}catch(e){}
			break;
		case "Clear":
			sheet3.RemoveAll();
	...
	function searchTitleList3(param) {
		var titleList = ajaxCall("${ctx}/PsnlWorkScheduleMgr.do?cmd=getPsnlWorkScheduleMgrDayWorkHeaderList", param, false);
		if (titleList != null && titleList.DATA != null) {
