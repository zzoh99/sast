    ...
    <script type="text/javascript">
        ...
        function init_sheet2(){
            ...
            initdata.Cols = [
                ...
                {Header:"삭제\n<sht:txt mid='sDelete'     mdef=''/>",				Type:"${sDelTy}",	Hidden:Number("${sDelHdn}"),Width:"${sDelWdt}",	Align:"Center",	ColMerge:0,	SaveName:"sDelete",	Sort:0 },
                ...
                {Header:"<sht:txt mid='seqV2'         mdef='순서'/>",				Type:"Int",			Hidden:0,	Width:40,	Align:"Center",	ColMerge:0,	SaveName:"seq",		KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1 },
                {Header:"<sht:txt mid='workCd'        mdef='근무코드'/>",			Type:"Combo",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"workCd",	KeyField:0,	Format:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:1 },
                {Header:"<sht:txt mid='reqSHm'        mdef='시작시간'/>",			Type:"Date",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"shm",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='reqEHm'        mdef='종료시간'/>",			Type:"Date",		Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"ehm",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='00'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"00",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='00'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"00",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='01'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"01",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='01'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"01",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='02'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"02",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='02'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"02",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='03'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"03",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='03'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"03",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='04'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"04",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='04'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"04",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='05'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"05",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='05'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"05",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='06'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"06",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='06'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"06",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='07'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"seven",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='07'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"seven",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='08'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"eight",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='08'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"eight2",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='09'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"nine",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='09'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"nine",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='10'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"ten",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='10'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"ten",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='11'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"eleven",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='11'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"eleven",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='12'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"12",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='12'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"12",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='13'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"13",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='13'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"13",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='14'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"14",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='14'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"14",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='15'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"15",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='15'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"15",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='16'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"16",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='16'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"16",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='17'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"17",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='17'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"17",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='18'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"18",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='18'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"18",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='19'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"19",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='19'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"19",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='20'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"20",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='20'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"20",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='21'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"21",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='21'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"21",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='22'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"22",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='22'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"22",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='23'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"23",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='23'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"23",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='00'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"24",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                {Header:"<sht:txt mid='sTime'        mdef='00'/>",			Type:"text",		Hidden:0,	Width:15,	Align:"Center",	ColMerge:0,	SaveName:"24",		KeyField:0,	Format:"Hm",PointCount:0,	UpdateEdit:1,	InsertEdit:1, EditLen:5 },
                ...
                {Header:"Hidden", Type:"Text", Hidden:1, SaveName:"workNm"}
            ...
            // sheet2.SetColProperty("workNm", 	{ComboText:workCdList[0], ComboCode:workCdList[1]} );
        ...
        function doAction1(sAction) {
            switch (sAction) {
                ...
                case "Save":
                    ...
                    sheet1.DoSave( "${ctx}/WorkTimeMgr.do?cmd=saveWorkTimeMgr", $("#sheet1Form").serialize());
                    break;
                case "Copy":
                    sheet1.DataCopy();
                    break;
                ...
                case "Delete":
                    if(sheet1.GetCellValue(sheet1.GetSelectRow(),"sStatus") !== "D") {
                        ...
                        sheet1.SetCellValue(sheet2.GetSelectRow(),"sStatus","D");
                        IBS_SaveName(document.sheet1Form,sheet1);
                        sheet1.DoSave( "${ctx}//WorkTimeMgr.do?cmd=saveWorkTimeMgr", $("#sheet1Form").serialize());
                    }
                    break;
        ...
        function doAction2(sAction) {
            switch (sAction) {
                ...
                case "Down2Excel":
                    ...
                    break;
                case "Delete":
                    if(sheet2.GetCellValue(sheet2.GetSelectRow(),"sStatus") !== "D") {
                        alert("<msg:txt mid='errorDeleteZero' mdef='삭제할 내역이 없습니다.'/>");
                        return;
                    }else {
                        sheet2.SetCellValue(sheet2.GetSelectRow(),"sStatus","D");
                        IBS_SaveName(document.sheet2Form,sheet2);
                        sheet2.DoSave( "${ctx}//WorkTimeMgr.do?cmd=saveWorkDaySchedule", $("#sheet2Form").serialize());
                    }
            }
        }
        ...
        function sheet2_OnRowSearchEnd(row){
            //4 = 근무코드, 5 = 시작시간, 6 = 종료시간 컬럼
            let start = Number(sheet2.GetCellValue(row, "shm").substring(0, 2)) * 2 + 7; //7 00 컬럼 들어가기 전 컬럼 수
            let end = Number(sheet2.GetCellValue(row, "ehm").substring(0, 2)) * 2 + 7;
            let barValue = sheet2.GetCellText(row, 4) + "(" + sheet2.GetCellText(row, 5) + " - " + sheet2.GetCellText(row, 6) + ")";
            let barColor;
            let half;

            if(sheet2.GetCellValue(row, "workCd") === "0010"){ //기본근무
                barColor = "#0070c0";
            } else if(sheet2.GetCellValue(row, "workCd") === "0120" || sheet2.GetCellValue(row, "workCd") === "0140") { //중식, 석식
                barValue = sheet2.GetCellText(row, 4);
                barColor = "#ffc000";
            } else if(sheet2.GetCellValue(row, "workCd") === "0040"){
                barColor = "#ee5e05";
            } else if(sheet2.GetCellValue(row, "workCd") === "0045"){
                barColor = "#9b01ce";
            }

            if(sheet2.GetCellValue(row, "shm").substring(3,2) !== '0'){ //30분일시
                start = start + 1;
            }

            if(sheet2.GetCellValue(row, "ehm").substring(3,2) !== '0'){ //30분일시
                end = end + 1;
            }

            let workLength = end - start;
            let hourCell = 57;  //24시 셀 컬럼
            let workLength2;

            if(workLength < 0){ //근무시간이 자정을 넘었을 시

                workLength = hourCell - start;
                workLength2 = end - 7;
                if(workLength > 0){
                    sheet2.SetMergeCell(row, 7, 1, workLength2, 0);
                    sheet2.SetCellBackColor(row, 7, barColor);
                }
            }

            sheet2.SetMergeCell(row, start, 1, workLength, 0);
            sheet2.SetCellBackColor(row, start, barColor);
            sheet2.SetCellFontColor(row ,start ,"#ffffff");
            sheet2.SetCellValue(row, start, barValue, 0);
        	sheet2.SetCellValue(row, 'sStatus', "R", 0);
        }
...
<div class="wrapper">
    ...
    <div id="detailArea">
        <div id="tabs" class="tab">
            <ul class="tab_bottom">
                <li><a href="#tabs-0" onclick="javascript:moveTab(0)" >일일근무스케줄</a></li>
            ...
            <div id="tabs-1">
                <form id="sheet3Form" name="sheet3Form">
                    <div class="inner">
                        <div class="sheet_title">
                            <ul>
                                <li id="txt" class="txt">예외인정근무시간</li>
                                <li class="btn">
