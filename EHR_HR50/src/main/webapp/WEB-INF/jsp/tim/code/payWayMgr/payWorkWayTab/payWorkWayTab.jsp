...
<!DOCTYPE html> <html class="hidden"><head> <title>근무사항</title>
...
<script type="text/javascript">
	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"근무명",				Type:"Combo",		Hidden:0,	Width:200,	Align:"Center",	ColMerge:0,	SaveName:"workCd",		KeyField:1,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:10 },
			{Header:"수당",				Type:"Popup",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"elementNm",	KeyField:1,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:1000 },
			...
			{Header:"적용비율",			Type:"Float",		Hidden:0,	Width:100,	Align:"Right",	ColMerge:0,	SaveName:"applyRate",	KeyField:0,	Format:"NullFloat",	PointCount:2,	UpdateEdit:1,	InsertEdit:1,	EditLen:5, DefaultValue:"1.00" }
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			sheet1.DoSearch( "${ctx}/PayWorkWayTab.do?cmd=getPayWorkWayTabList",param );
			break;
		case "Save":
			//if(!dupChk(sheet1,"workCd|elementCd", true, true)){break;}
			IBS_SaveName(document.sheet1Form,sheet1);
			sheet1.DoSave( "${ctx}/PayWorkWayTab.do?cmd=savePayWorkWayTab", $("#sheet1Form").serialize());
			break;
		case "Insert":
