...
<script type="text/javascript">
	$(function() {
		...
		var orgCd = convCode( codeList("${ctx}/PersonalTimeStats.do?cmd=getPersonalTimeStatsOrgList",""), "");
		$("#orgCd").html(orgCd[2]);
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "${ctx}/PersonalTimeStats.do?cmd=getPersonalTimeStatsList", $("#mySheetForm").serialize() );
			break;
		case "Down2Excel":
	...
	function searchTitleList() {
		...
		var titleList = ajaxCall("${ctx}/PersonalTimeStats.do?cmd=getPersonalTimeStatsHeaderList", param, false);
