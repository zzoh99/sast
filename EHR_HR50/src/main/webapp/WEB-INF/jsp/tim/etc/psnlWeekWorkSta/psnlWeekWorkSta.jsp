...
var pGubun = "";
	...
	function setOrgCombo(){
		...
		var orgCdlist = convCode( ajaxCall("${ctx}/PsnlWeekWorkSta.do?cmd=getPsnlWeekWorkStaOrgList", param, false).DATA, "");
	...
	function doAction1(sAction) {
		switch (sAction) {
			case "Search":
                ...
                var sXml = sheet1.GetSearchData("${ctx}/PsnlWeekWorkSta.do?cmd=getPsnlWeekWorkStaList", $("#sheet1Form").serialize() );
