...
var pGubun = "";
	...
	function setOrgCombo(){
		var orgCd = convCode( ajaxCall("${ctx}/PsnlTimeCalendar.do?cmd=getPsnlTimeCalendarOrgList","searchYmd="+$("#searchYm").val(),false).DATA, "");
	...
	function init_calendar() {
		...
		calendar = new FullCalendar.Calendar($('#calendar')[0], {
			...
			events: function(info, successCallback, failureCallback) {
				...
				progressBar(true);
		        $.ajax({
		            url: '${ctx}/PsnlTimeCalendar.do?cmd=getPsnlTimeCalendarList',
		            type : "post",
		            dataType: 'json',
		            data: {
