...
var pGubun = "";
	...
	function init_sheet(){
		...
		initdata1.Cols = [
			...
			{Header:"<sht:txt mid='sdate' mdef='출장시작일'/>",	Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"bizSdate",		Format:"Ymd", 		Edit:0 },
			{Header:"<sht:txt mid='edate' mdef='출장종료일'/>",	Type:"Date",	Hidden:0, Width:80,	 Align:"Center", SaveName:"bizEdate",		Format:"Ymd", 		Edit:0 },
			{Header:"<sht:txt mid='bizTerm' mdef='출장일수'/>",	Type:"Int",		Hidden:0, Width:60,	 Align:"Center", SaveName:"bizDays",		Format:"###\\일",	Edit:0 },
			{Header:"<sht:txt mid='bizTripTitle' mdef='출장제목'/>",	Type:"Text",	Hidden:0, Width:150, Align:"Left",   SaveName:"bizPurpose",		Edit:0 },
			{Header:"<sht:txt mid='companion' mdef='동행인'/>",		Type:"Text",	Hidden:0, Width:200, Align:"Left",   SaveName:"bizSabuns",		Edit:0 },
	...
	function doAction1(sAction) {
		...
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/BizTripExpenApp.do?cmd=getBizTripExpenAppList", $("#sheet1Form").serialize() );
        ...
        case "Save": //임시저장의 경우 삭제처리만함.      
        	...
        	sheet1.DoSave( "${ctx}/BizTripExpenApp.do?cmd=deleteBizTripExpenApp", $("#sheet1Form").serialize(), -1, 0); 
        	break;
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li class="txt"><tit:txt mid="bizTripExpenAppTitle" mdef="국내출장보고서"/><span class="tit_noti">* <msg:txt mid="bizTripAppNoti" mdef="국내출장신청은 [ 근태신청 ] 에서 신청 해주세요."/></span></li>
				<li class="btn">
					<a href="javascript:showApplPopup(-1);" 		class="btn filled authA"><tit:txt mid='appComLayout' mdef='신청'/></a>
