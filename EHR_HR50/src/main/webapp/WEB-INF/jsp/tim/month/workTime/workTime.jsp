...
var ColHidden = 0;
	...
	function searchTitleList() {
		...
		var titleList = ajaxCall("${ctx}/WorkTime.do?cmd=getWorkTimeHeaderList", $("#sheetForm").serialize(), false);
		if (titleList != null && titleList.DATA != null) {
			...
			initdata1.Cols = [];
			initdata1.Cols[v++] = {Header:"<sht:txt mid='sNoV1' mdef='No|No'/>",				Type:"${sNoTy}",    Hidden:Number("${sNoHdn}"),   Width:Number("${sNoWdt}"),  Align:"Center", ColMerge:0,   SaveName:"sNo" };
			initdata1.Cols[v++] = {Header:"<sht:txt mid='sStatus V4' mdef='상태|상태'/>",				Type:"${sSttTy}",   Hidden:1,  Width:Number("${sSttWdt}"), Align:"Center", ColMerge:0,   SaveName:"sStatus" , Sort:0};
			initdata1.Cols[v++] = {Header:"<sht:txt mid='ymdV7' mdef='근무일|근무일'/>",			Type:"Text",		Hidden:0,  Width:80,	Align:"Center",	ColMerge:0,   SaveName:"vYmd",			KeyField:0,   Format:"", 	Edit:0 };
			initdata1.Cols[v++] = {Header:"<sht:txt mid='gubunV7' mdef='구분|구분'/>",				Type:"Text",		Hidden:0,  Width:50,	Align:"Center",	ColMerge:0,   SaveName:"dayDiv",		KeyField:0,   Format:"", 	Edit:0 };
			
			initdata1.Cols[v++] = {Header:"<sht:txt mid='gntCd' mdef='근태|근태'/>",				Type:"Text",		Hidden:0,  Width:70,	Align:"Center",	ColMerge:0,   SaveName:"gntCd",			KeyField:0,   Format:"",    Edit:0 };
			initdata1.Cols[v++] = {Header:"<sht:txt mid='workCdV5' mdef='근무시간|근무시간'/>",		Type:"Combo",		Hidden:0,  Width:50,	Align:"Center",	ColMerge:0,   SaveName:"timeCd",		KeyField:0,   Format:"",    Edit:0 };
			initdata1.Cols[v++] = {Header:"<sht:txt mid='stdWorkSTime' mdef='기준시간|출근시간'/>",		Type:"Text",		Hidden:0,  Width:50,	Align:"Center",	ColMerge:0,   SaveName:"workShm",		KeyField:0,   Format:"Hm",  Edit:0 };
			initdata1.Cols[v++] = {Header:"<sht:txt mid='stdWorkETime' mdef='기준시간|퇴근시간'/>",		Type:"Text",		Hidden:0,  Width:50,	Align:"Center",	ColMerge:0,   SaveName:"workEhm",		KeyField:0,   Format:"Hm",  Edit:0 };
			initdata1.Cols[v++] = {Header:"<sht:txt mid='rcgnWorkSTime' mdef='인정시간|출근시간'/>",		Type:"Text",		Hidden:0,  Width:50,	Align:"Center",	ColMerge:0,   SaveName:"inHm",			KeyField:0,   Format:"Hm",  Edit:0 };
			initdata1.Cols[v++] = {Header:"<sht:txt mid='rcgnWorkETime' mdef='인정시간|퇴근시간'/>",		Type:"Text",		Hidden:0,  Width:50,	Align:"Center",	ColMerge:0,   SaveName:"outHm",			KeyField:0,   Format:"Hm",  Edit:0 };
			initdata1.Cols[v++] = {Header:"<sht:txt mid='rcgnWorkTotal' mdef='인정시간|계'/>",			Type:"Text",		Hidden:1,  Width:50,	Align:"Center",	ColMerge:0,   SaveName:"workTime",		KeyField:0,   Format:"Hm",  Edit:0 };
			initdata1.Cols[v++] = {Header:"<sht:txt mid='isNormal_lb_dbl' mdef='정상\n여부|정상\n여부'/>",	Type:"Text",		Hidden:0,  Width:40,	Align:"Center",	ColMerge:0,   SaveName:"workFlag",		KeyField:0,   Format:"",    Edit:0 };
			initdata1.Cols[v++] = {Header:"<sht:txt mid='workTime_lb_dbl' mdef='근무\n시간|근무\n시간'/>",	Type:"Text",		Hidden:0,  Width:40,	Align:"Center",	ColMerge:0,   SaveName:"realWorkTime",	KeyField:0,   Format:"Hm",  Edit:0 };
			initdata1.Cols[v++] = {Header:"<sht:txt mid='ymdV7' mdef='근무일|근무일'/>",			Type:"Text",		Hidden:1,  Width:80,	Align:"Center",	ColMerge:0,   SaveName:"ymd",			KeyField:0,   Format:"", 	Edit:0 };
	...
	function doAction1(sAction) {
		switch (sAction) {
			case "Search":
				...
				searchTitleList();
				var sXml = sheet1.GetSearchData("${ctx}/WorkTime.do?cmd=getWorkTimeList", $("#sheetForm").serialize() );
	...
	function doAction2(sAction) {
		switch (sAction) {
			...
			case "Search":
				sheet2.DoSearch( "${ctx}/WorkTime.do?cmd=getWorkTimeList2", $("#sheetForm").serialize() );
				break;
