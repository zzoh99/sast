...
var ssnSearchType = "${ssnSearchType}";
	...
	$(function() {
		...
		*/	
		...
		var initdata = {};
		initdata.Cfg = {FrozenCol:6,SearchMode:smLazyLoad,Page:22,MergeSheet:5};
		...
		initdata.Cols = [
			...
			{Header:"<sht:txt mid='sabunV2' mdef='사번|사번'/>",	    	Type:"Text",      Hidden:0,  Width:90,	Align:"Center",  ColMerge:0,   SaveName:"sabun",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
			{Header:"<sht:txt mid='nameV3' mdef='성명|성명'/>",	    	Type:"Text",      Hidden:0,  Width:90,	Align:"Center",  ColMerge:0,   SaveName:"name",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"호칭|호칭",	    	Type:"Text",     Hidden:Number("${aliasHdn}"),  Width:90,	Align:"Center",  ColMerge:0,   SaveName:"alias",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
			{Header:"<sht:txt mid='empYmdV1' mdef='입사일|입사일'/>",	    	Type:"Date",     Hidden:0,  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"empYmd",     KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"<sht:txt mid='stfTypeNm' mdef='채용구분|채용구분'/>",	    Type:"Text",      Hidden:1,  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"stfTypeNm",     KeyField:0,   CalcLogic:"",   Format:"",         PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"<sht:txt mid='empTypeNm' mdef='입사구분|입사구분'/>",	    Type:"Text",      Hidden:0,  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"empTypeNm",     KeyField:0,   CalcLogic:"",   Format:"",         PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"<sht:txt mid='orgNm_V4590' mdef='입사시|소속'/>",	    	Type:"Text",      Hidden:0,  Width:120,	Align:"Left",  ColMerge:0,   SaveName:"orgNm",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"<sht:txt mid='jikchakNm_V4592' mdef='입사시|직책'/>",	    	Type:"Text",      Hidden:0,  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"jikchakNm",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"입사시|직위",	    	Type:"Text",      Hidden:Number("${jwHdn}"),  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"jikweeNm",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"<sht:txt mid='jikgubNm_V4591' mdef='입사시|직급'/>",	    	Type:"Text",      Hidden:Number("${jgHdn}"),  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"jikgubNm",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"<sht:txt mid='workTypeNm' mdef='입사시|직군'/>",	    	Type:"Text",      Hidden:0,  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"workTypeNm",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"<sht:txt mid='manageNm' mdef='입사시|사원구분'/>",	    	Type:"Text",      Hidden:0,  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"manageNm",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"<sht:txt mid='jikchakNmCurr' mdef='조회시|직책'/>",	    	Type:"Text",      Hidden:0,  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"jikchakNmCurr",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"조회시|직위",	    	Type:"Text",      Hidden:Number("${jwHdn}"),  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"jikweeNmCurr",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"<sht:txt mid='jikgubNmCurr' mdef='조회시|직급'/>",	    	Type:"Text",      Hidden:Number("${jgHdn}"),  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"jikgubNmCurr",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"<sht:txt mid='workTypeNmCurr' mdef='조회시|직군'/>",	    	Type:"Text",      Hidden:0,  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"workTypeNmCurr",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
			{Header:"<sht:txt mid='manageNmCurr' mdef='조회시|사원구분'/>",	    	Type:"Text",      Hidden:0,  Width:80,	Align:"Center",  ColMerge:0,   SaveName:"manageNmCurr",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },

			{Header:"<sht:txt mid='ordDetailNm' mdef='발령상세|발령상세'/>",	    	Type:"Text",      Hidden:1,  Width:90,	Align:"Center",  ColMerge:0,   SaveName:"ordDetailNm",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
			{Header:"<sht:txt mid='ordReasonNm' mdef='발령세부사유|발령세부사유'/>",	    	Type:"Text",      Hidden:1,  Width:90,	Align:"Center",  ColMerge:0,   SaveName:"ordReasonNm",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:10 },
			{Header:"조회권한",		Type:"Text",		Hidden:1,	Width:45,			Align:"Center",	ColMerge:0,	SaveName:"authYn", UpdateEdit:0 },
			{Header:"<sht:txt mid='memo' mdef='비고|비고'/>",	    	Type:"Text",      Hidden:0,  Width:150,	Align:"Center",  ColMerge:0,   SaveName:"memo",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
		...
		*/
		...
		var basicInfo = ajaxCall("${ctx}/EmpEmpSta.do?cmd=getEmpEmpStaMap", $("#srchFrm").serialize(), false);
		if (basicInfo.DATA != null) {
			$("#nowCnt").html(basicInfo.DATA.nowCnt);
			$("#termCnt").html(basicInfo.DATA.termCnt);
			$("#enterCnt").html(basicInfo.DATA.enterCnt);
			$("#enterPer").html(basicInfo.DATA.enterPer);
		}
	...
	function getCommonCodeList() {
		...
		var resultData1 	= convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","H20010", baseSYmd, baseEYmd), "");		//직급
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			*/
			sheet1.DoSearch( "${ctx}/EmpEmpSta.do?cmd=getEmpEmpStaList", $("#srchFrm").serialize() );
		...
		case "Save":
							...
							sheet1.DoSave( "${ctx}/EmpEmpSta.do?cmd=saveEmpEmpSta", $("#srchFrm").serialize()); break;
		...
		<div class="sheet_search outer">
			<div>
				<table>
					...
					<tr>
						<th>사원구분</th>
						<td> <div class="select-inner-wrap"><select id="searchManageCd" name="searchManageCd" multiple> </select></div> </td>
						<th>직군</th>
						<td> <div class="select-inner-wrap"><select id="searchWorkType" name="searchWorkType" multiple> </select></div></td>
				...
				<div style="margin-top: 8px">
					<form id="infoFrom" name="infoFrom">
						...
						<tr>
							...
							<th class="right"><tit:txt mid='114652' mdef='입사인원'/></th>
							<td class="right" style="padding-right: 20px" >
								<span id="enterCnt"></span> 명
							</td>
							<th class="right"><tit:txt mid='112158' mdef='입사율'/></th>
							<td class="right" style="padding-right: 20px" >
								<span id="enterPer"></span>%
							</td>
						</tr>
						</table>
					</form>
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt"><tit:txt mid='112487' mdef='기간별입사자현황'/></li>
							<li class="btn">
				...
				<script type="text/javascript">createIBSheet("sheet1", "100%", "97%","${ssnLocaleCd}"); </script>
			</td>
		</tr>
	</table>
</div>
