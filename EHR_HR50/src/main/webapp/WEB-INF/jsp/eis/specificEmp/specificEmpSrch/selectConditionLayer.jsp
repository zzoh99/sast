...
<script type="text/javascript">
	...
	function doAction(sAction) {
		switch (sAction) {
			case "Search": //조회
			    selectConditionLayerSheet.DoSearch( "${ctx}/SpecificEmpSrch.do?cmd=getSpecificEmpListPop", $("#mySheetForm").serialize() );
	            break;
		}
    }
    ...
    <div class="wrapper modal_layer">
		...
		<div class="modal_footer">
			<a href="javascript:closeCommonLayer('selectConditionLayer');" class="btn outline_gray">닫기</a>
