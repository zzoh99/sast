...
<script type="text/javascript">
	...
	function initSheet1() {
		...
		initdata.Cols = [
			...
			{Header:"<sht:txt mid='applJikweeNm' mdef='직위'/>",			Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"jikweeNm",		KeyField:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4000 },
			...
			{Header:"<sht:txt mid='jikgubCd' mdef='직급'/>",			Type:"Text",		Hidden:1,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"jikgubNm",		KeyField:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4000 },
			{Header:"<sht:txt mid='applJobJikgunNmV1' mdef='직군'/>",			Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"workTypeNm",		KeyField:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4000 },
			{Header:"<sht:txt mid='gempYmd' mdef='그룹입사일'/>",	Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"gempYmd",		KeyField:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4000,	Format:"Ymd" },
			{Header:"<sht:txt mid='empYmd' mdef='입사일'/>",		Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"empYmd",		KeyField:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4000,	Format:"Ymd" },
			{Header:"<sht:txt mid='accResNoV1' mdef='주민번호'/>",		Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"resNo",		KeyField:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4000,	Format:"IdNo" },
			{Header:"<sht:txt mid='retYmd' mdef='퇴직일'/>",		Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"retYmd",		KeyField:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4000,	Format:"Ymd" },
			{Header:"<sht:txt mid='birYmd' mdef='생년월일'/>",		Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"birYmd",		KeyField:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4000,	Format:"Ymd" },
			{Header:"<sht:txt mid='handPhone_V6736' mdef='핸드폰번호'/>",	Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"handPhone",		KeyField:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4000 },
			{Header:"<sht:txt mid='mailId' mdef='메일주소'/>",		Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"mailId",		KeyField:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:4000 }
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			sheet1.DoSearch( "${ctx}/SpecificEmpSrch.do?cmd=getSpecificEmpExcel", $("#searchFrm").serialize() ); break;
...
<!-- 					            <option value="">전체</option>
	...
	<div class="sheet_title">
		<ul>
			...
			<li class="btn">
				<a href="javascript:doAction1('Search');" class="btn outline-gray"><tit:txt mid='112821' mdef='엑셀다운'/></a>
				<a href="javascript:setDefaultValue();" class="btn outline-gray"><tit:txt mid='112391' mdef='초기화'/></a>
				<a href="javascript:resultPopup();" class="btn dark"><tit:txt mid='114401' mdef='검색'/></a>
			</li>
		</ul>
	</div>
	<div class="hide">
