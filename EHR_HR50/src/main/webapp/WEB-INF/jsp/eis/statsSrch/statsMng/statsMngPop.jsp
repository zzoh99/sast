...
<script type="text/javascript">
	...
	function setSampleSqlSyntax(pluginObjNm) {
		...
		//console.log('pluginObjNm', pluginObjNm, 'sampleSql', sampleSql);
...
<div class="wrapper">
	...
	<div class="popup_main">
		<form id="sendForm" name="sendForm" method="POST">
			...
			<div class="mab20">
				<!-- 사용 차트 -->
				<span><strong>사용 차트</strong></span>
				<select id="chartCd" name="chartCd" class="custom_select mal10"></select>
				<!-- 차트 크기 설정 -->
				...
				<!-- 차트 미리보기 -->
				<a href="javascript:previewChart();" class="btn filled">차트 미리보기</a>
			</div>
					...
					<div id="tabs" class="tab" style="height: calc(100vh - 185px);">
						...
						<div id="tabs-2">
							<div class='layout_tabs'>
								...
								<pre id="edit_sqlSyntax" class="edit" style="height: calc(100% - 115px);"></pre>
						...
						<div id="tabs-3" >
							<div class='layout_tabs'>
								...
								<pre id="edit_sqlSyntaxSample" class="edit" style="height: calc(100% - 177px);"></pre>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="popup_button">
			<ul>
				<li>
					...
					<a href="javascript:p.self.close();" class="btn outline_gray"><tit:txt mid='104157' mdef='닫기'/></a>
				</li>
			</ul>
		</div>
	</div>
