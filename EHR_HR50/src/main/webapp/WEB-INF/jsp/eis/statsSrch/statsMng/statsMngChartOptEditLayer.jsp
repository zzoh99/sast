...
<script type="text/javascript">
	var statsMngChartOptEditLayer = {id:'statsMngChartOptEditLayer'};
	...
	$(function() {
		...
		const modal = window.top.document.LayerModalUtility.getModal(statsMngChartOptEditLayer.id);
		...
		<div class="popup_button">
			<ul>
				<li>
					...
					<a href="javascript:closeCommonLayer('statsMngChartOptEditLayer');" class="gray large"><tit:txt mid='104157' mdef='닫기'/></a>
				</li>
			</ul>
		</div>
	</div>
