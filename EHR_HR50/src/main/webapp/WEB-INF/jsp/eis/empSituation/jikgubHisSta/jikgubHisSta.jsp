...
<script type="text/javascript">
	...
	function CallChart1(Type)
	{
		...
		result1 = ajaxCall("${ctx}/JikgubHisSta.do?cmd=getJikgubHisStaList2",$("#srchFrm").serialize(),false);
		result2 = ajaxCall("${ctx}/JikgubHisSta.do?cmd=getJikgubHisStaList2",param1.replace($("#searchYmd").val(),minusYmd ),false);
		result3 = ajaxCall("${ctx}/JikgubHisSta.do?cmd=getJikgubHisStaList2",param1.replace($("#searchYmd").val(),minusYmd2 ),false);
	...
	function downChart(){
 		myChart1.Down2Image({FileName:"JikgubHistImage", Type:IBExportType.JPEG, Width:800, Url:"/common/plugin/IBLeaders/Sheet/jsp/Down2Image.jsp"});
	}
			...
			<div>
				<table>
					...
					<table>
						<tr>
							<td colspan="4">
								<span style="padding-left:16.5pt"><tit:txt mid='104104' mdef='직위'/></span>
