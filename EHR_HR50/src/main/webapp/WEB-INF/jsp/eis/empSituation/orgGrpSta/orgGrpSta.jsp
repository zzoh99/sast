...
<script type="text/javascript">
	...
	function drawChartForAnime1(result1) {
		if (result1["DATA"].length == 0 )return ;
		var pieChartTitle = '부문별 인원현황' ;
		var data = "{";
		data += 		"IBCHART: {";
...
// 		파이와 라벨의 거리, 두께, 색, padding, 부드러운 처리
	...
	function downChart(){
 		myChart1.Down2Image({FileName:"OrgGubunChartImage", Type:IBExportType.JPEG, Width:800, Url:"/common/plugin/IBLeaders/Sheet/jsp/Down2Image.jsp"});
	}
				...
				<table>
					<table>
						<tr>
							...
							<td><input type="radio" name="chartType" id="chartType" value="column" checked/><span><tit:txt mid='104393' mdef=' 인원'/></span></td>
							<!--<td>
