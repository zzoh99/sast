...
<script type="text/javascript">
	$(function() {
		...
		initdata.Cols = [
            ...
            {Header:"<sht:txt mid='jangCd' mdef='장애구분'/>",	    Type:"Text",      Hidden:0,  Width:70,	Align:"Center",  ColMerge:0,   SaveName:"jangNm",     KeyField:0,   CalcLogic:"",   Format:"",         PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
            {Header:"<sht:txt mid='jangGradeCd' mdef='장애등급'/>",	    Type:"Text",      Hidden:0,  Width:70,	Align:"Center",  ColMerge:0,   SaveName:"jangGradeNm",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
            ...
            {Header:"<sht:txt mid='jangYmd' mdef='장애인정일'/>",Type:"Text",      Hidden:0,  Width:90,	Align:"Center",  ColMerge:0,   SaveName:"jangYmd",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 },
            {Header:"<sht:txt mid='armyMemo' mdef='비고'/>",	    	Type:"Text",      Hidden:0,  Width:150,	Align:"Left",  ColMerge:0,   SaveName:"jangMemo",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:22 }
		...
		var basicInfo = ajaxCall("${ctx}/WelfareJangaeEmpSta.do?cmd=getWelfareJangaeEmpStaMap", $("#sheet1Form").serialize(), false);
		...
		if (basicInfo.DATA != null) {
			...
			var diffCnt = basicInfo.DATA.nowRctCnt - basicInfo.DATA.lawCnt;
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search": 	sheet1.DoSearch( "${ctx}/WelfareJangaeEmpSta.do?cmd=getWelfareJangaeEmpStaList", $("#srchFrm").serialize() ); break;
		case "Save": 		
							IBS_SaveName(document.srchFrm,sheet1);
							sheet1.DoSave( "${ctx}/WelfareJangaeEmpSta.do?cmd=saveWelfareJangaeEmpSta", $("#srchFrm").serialize()); break;
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt"><tit:txt mid='114223' mdef='장애인 고용현황'/></li>
							<li class="btn">
