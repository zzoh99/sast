...
<!DOCTYPE html> <html class="hidden"><head><title>대출상환승인</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchRepYm").datepicker2({ymonly:true});
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			{Header:"신청내용|대출일",		Type:"Date",	Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"loanYmd",		KeyField:0,	Format:"Ymd",	Edit:0 },
			{Header:"신청내용|대출금",		Type:"Int",		Hidden:0,	Width:80,	Align:"Right",	ColMerge:0,	SaveName:"loanMon",		KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|상환일자",		Type:"Date",	Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"repYmd",		KeyField:0,	Format:"Ymd",	Edit:0},
 			{Header:"신청내용|상환금",		Type:"Int",		Hidden:0,	Width:80,	Align:"Right",	ColMerge:0,	SaveName:"repMon",		KeyField:0,	Format:"",		Edit:0},
 			{Header:"신청내용|이자",		Type:"Int",		Hidden:0,	Width:80,	Align:"Right",	ColMerge:0,	SaveName:"intMon",		KeyField:0,	Format:"",		Edit:0},
 			{Header:"신청내용|계",			Type:"Int",		Hidden:0,	Width:80,	Align:"Right",	ColMerge:0,	SaveName:"totoMn",		CalcLogic:"|repMon|+|intMon|", KeyField:0,	Format:"", Edit:0},
	...
	function doAction1(sAction) {
		...
		case "Search":
			if(!chkInVal()){break;}
			getCommonCodeList();
			var sXml = sheet1.GetSearchData("${ctx}/LoanRepApr.do?cmd=getLoanRepAprList", $("#sheet1Form").serialize() );
...
<div class="wrapper">
	...
	<div class="sheet_search outer">
		...
		<tr>
			...
			<th>상환년월</th>
			<td>
				<input type="text" id="searchRepYm" name="searchRepYm" class="date2" value="">
			</td>
			<td>
