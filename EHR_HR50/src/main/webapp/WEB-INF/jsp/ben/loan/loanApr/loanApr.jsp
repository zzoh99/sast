...
<!DOCTYPE html> <html class="hidden"><head><title>대출승인</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchLoanYm").datepicker2({ymonly:true});
	...
	function init_sheet(){ 
		...
		var initdata = {};
		initdata.Cfg = {SearchMode:smLazyLoad,Page:22,MergeSheet:msHeaderOnly,FrozenCol:9, FrozenColRight:7};
		...
		initdata.Cols = [
			...
			//신청내용
			{Header:"신청내용|대출구분",		Type:"Combo",	Hidden:0,	Width:120,	Align:"Center",	ColMerge:0,	SaveName:"loanCd",			KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|대출희망일",		Type:"Date",	Hidden:0,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"loanReqYmd",		KeyField:0,	Format:"Ymd",	Edit:0 },
			{Header:"신청내용|대출신청금액",	Type:"Int",		Hidden:0,	Width:100,	Align:"Right",	ColMerge:0,	SaveName:"loanReqMon",		KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|상환기간\n(개월)",Type:"Int",		Hidden:0,	Width:60,	Align:"Right",	ColMerge:0,	SaveName:"loanReqPeriod",	KeyField:0,	Format:"##\\개월",			Edit:0 },
			{Header:"신청내용|이율",			Type:"Float",	Hidden:0,	Width:60,	Align:"Right",	ColMerge:0,	SaveName:"reqIntRate",		KeyField:0,	Format:"#0.#\\%",			Edit:0 },
			{Header:"신청내용|입금은행",		Type:"Combo",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"bankCd",			KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|예금주",			Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"accHolder",		KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|계좌번호",		Type:"Text",	Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"accNo",			KeyField:0,	Format:"",		Edit:0 },

			{Header:"확정내용|대출지급일",		Type:"Date",	Hidden:0,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"loanYmd",			KeyField:0,	Format:"Ymd",		UpdateEdit:1,	InsertEdit:0},
			{Header:"확정내용|대출확정금액",	Type:"Int",		Hidden:0,	Width:100,	Align:"Right",	ColMerge:0,	SaveName:"loanMon",			KeyField:0,	Format:"",			UpdateEdit:1,	InsertEdit:0},
			{Header:"확정내용|상환기간\n(개월)",Type:"Int",		Hidden:0,	Width:60,	Align:"Right",	ColMerge:0,	SaveName:"loanPeriod",		KeyField:0,	Format:"##\\개월",	UpdateEdit:1,	InsertEdit:0},
			{Header:"확정내용|이율",			Type:"Float",	Hidden:0,	Width:60,	Align:"Right",	ColMerge:0,	SaveName:"intRate",			KeyField:0,	Format:"#0.#\\%",	UpdateEdit:1,	InsertEdit:0},
			{Header:"확정내용|월상환액",		Type:"Int",		Hidden:0,	Width:100,	Align:"Right",	ColMerge:0,	SaveName:"repMon",			KeyField:0,	Format:"",			UpdateEdit:1,	InsertEdit:0},
		...
		//지급정보 헤더 배경색
		var bcc = "#fdf0f5";
		sheet1.SetCellBackColor(0, "loanYmd", bcc);  sheet1.SetCellBackColor(1, "loanYmd", bcc);  
		sheet1.SetCellBackColor(0, "loanMon", bcc);  sheet1.SetCellBackColor(1, "loanMon", bcc);  
		sheet1.SetCellBackColor(0, "repMon", bcc);   sheet1.SetCellBackColor(1, "repMon", bcc);  
		sheet1.SetCellBackColor(0, "loanPeriod", bcc);   sheet1.SetCellBackColor(1, "loanPeriod", bcc);  
		sheet1.SetCellBackColor(0, "intRate", bcc);   sheet1.SetCellBackColor(1, "intRate", bcc);  
	...
	function getCommonCodeList() {
		...
		var grpCds = "B50010,H30001";
		let params = "grpCd=" + grpCds + "&baseSYmd=" + baseSYmd + "&baseEYmd=" + baseEYmd;

		var codeLists = convCodes(ajaxCall("${ctx}/CommonCode.do?cmd=getCommonCodeLists", params,false).codeList, "전체");
	...
	function doAction1(sAction) {
		...
		case "Search":
			if(!chkInVal()){break;}
			getCommonCodeList();
			var sXml = sheet1.GetSearchData("${ctx}/LoanApr.do?cmd=getLoanAprList", $("#sheet1Form").serialize() );
        ...
        case "Save":   
        	...
        	sheet1.DoSave( "${ctx}/LoanApr.do?cmd=saveLoanApr", $("#sheet1Form").serialize()); 
        	break;
        case "Down2Excel":
	...
	function sheet1_OnChange(Row, Col, Value) {
		try {
			if (sheet1.ColSaveName(Col) == "loanMon") {
				...
				var info = ajaxCall( "${ctx}/LoanApp.do?cmd=getLoanAppDetMon", param,false);
...
<div class="wrapper">
	...
	<div class="sheet_search outer">
		...
		<tr>
			...
			<th>대출희망신청월</th>
			<td>
				<input type="text" id="searchLoanYm" name="searchLoanYm" class="date2" value="">
			</td>
			<td>
