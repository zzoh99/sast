...
<!DOCTYPE html> <html class="hidden"><head><title>의료비승인</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchFrom, #searchTo, #searchSabunName, #searchPayYm, #searchOrgNm").on("keyup", function(event) {
			if( event.keyCode == 13) {
				doAction1("Search");
			}
		});
	...
	function init_sheet(){ 
		...
		var initdata = {};
		initdata.Cfg = {SearchMode:smLazyLoad,Page:22,MergeSheet:msHeaderOnly,FrozenCol:4, FrozenColRight:7};
		...
		initdata.Cols = [
			...
			{Header:"신청자|직군",			Type:"Text",   	Hidden:0, Width:60, 	Align:"Center", ColMerge:0,  SaveName:"worktypeNm", 	Edit:0},
			
			//신청내용
			{Header:"신청내용|대상자",			Type:"Combo",	Hidden:0,	Width:70,	Align:"Center",	ColMerge:0,	SaveName:"famCd",		KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|대상자명",		Type:"Text",	Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"famNm",		KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|생년월일",		Type:"Date",	Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"famYmd",		KeyField:0,	Format:"Ymd",	Edit:0 },
			{Header:"신청내용|성별",			Type:"Text",	Hidden:0,	Width:40,	Align:"Center",	ColMerge:0,	SaveName:"sexTypeNm",	KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|질병분류코드",	Type:"Text",	Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"medCode",		KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|병명",			Type:"Text",	Hidden:0,	Width:300,	Align:"Left",	ColMerge:0,	SaveName:"medName",		KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|지원시작년월",	Type:"Date",	Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"medSYm",		KeyField:0,	Format:"Ym",	Edit:0 },
			{Header:"신청내용|년간지급금액",	Type:"Int",		Hidden:0,	Width:90,	Align:"Right",	ColMerge:0,	SaveName:"totalPayMon",	KeyField:0,	Format:"",	Edit:0 },
			{Header:"신청내용|첨부파일",		Type:"Html",	Hidden:0,	Width:70,	Align:"Center",	ColMerge:0,	SaveName:"btnFile",		KeyField:0,	Format:"",			PointCount:0,	Edit:0 },
			{Header:"신청내용|첨부번호",		Type:"Text",	Hidden:1,	Width:0,	Align:"Center",	ColMerge:0,	SaveName:"fileSeq",		KeyField:0,	Format:"",			PointCount:0,	Edit:0 },
			
			//지급정보
			{Header:"지급정보|신청금액",		Type:"Int",		Hidden:0,	Width:90,	Align:"Right",	ColMerge:0,	SaveName:"applMon",		KeyField:0,	Format:"",	UpdateEdit:1},
			...
			{Header:"지급정보|마감\n여부",		Type:"CheckBox",Hidden:0,	Width:40,	Align:"Center",	ColMerge:0,	SaveName:"closeYn",		KeyField:0,	Format:"",			UpdateEdit:1,   InsertEdit:1,   TrueValue:"Y",	FalseValue:"N" },
			{Header:"지급정보|비고",			Type:"Text",	Hidden:0,	Width:200,	Align:"Left",	ColMerge:0,	SaveName:"payNote",		KeyField:0,	Format:"",			UpdateEdit:1},
		...
		//지급정보 헤더 배경색
		var bcc = "#fdf0f5";
		sheet1.SetCellBackColor(0, "applMon", bcc);  sheet1.SetCellBackColor(1, "applMon", bcc);  
	...
	function doAction1(sAction) {
		...
		case "Search":
			getCommonCodeList();
			if(!chkInVal()){break;}
			var sXml = sheet1.GetSearchData("${ctx}/MedApr.do?cmd=getMedAprList", $("#sheet1Form").serialize() );
			//sXml = replaceAll(sXml,"shtcolEdit", "Edit");
			sheet1.LoadSearchData(sXml );
			break;
        case "Save":   
       		IBS_SaveName(document.sheet1Form,sheet1);
        	sheet1.DoSave( "${ctx}/MedApr.do?cmd=saveMedApr", $("#sheet1Form").serialize()); 
        	break;
        case "Down2Excel":
		...
		try {
		    ...
		    if(sheet1.ColSaveName(Col) == "btnFile" && Row >= sheet1.HeaderRows()){
				...
				if(sheet1.GetCellValue(Row,"btnFile") != ""){
					...
					var authPgTemp="A";
					openPopup("/fileuploadJFileUpload.do?cmd=fileMgrPopup&authPg="+authPgTemp+"&uploadType=appl", param, "740","620");
				}
