...
<!DOCTYPE html> <html class="hidden"><head> <title>경조신청</title>
...
var pGubun = "";
	...
	function init_sheet(){
		...
		initdata1.Cols = [
			...
			{Header:"<sht:txt mid='occCd_V763' mdef='경조구분'/>",	Type:"Combo",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"occCd",			Edit:0 },
			{Header:"<sht:txt mid='famCdV5' mdef='경조대상'/>",	Type:"Combo",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"famCd",			Edit:0 },
			{Header:"<sht:txt mid='famNmV7' mdef='가족성명'/>",	Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"famNm",			Edit:0 },
			{Header:"<sht:txt mid='occDate_V770' mdef='경조일자'/>",		Type:"Text",		Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"occYmd",			Format:"Ymd", 		Edit:0 },
			{Header:"<sht:txt mid='occMonV1' mdef='경조금'/>",		Type:"Int",			Hidden:0,	Width:80,	Align:"Right",	ColMerge:0,	SaveName:"occMon",			Format:"#,###\\원",	Edit:0 },
			{Header:"<sht:txt mid='occHolidayV1' mdef='휴가일수'/>",	Type:"Int",			Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"occHoliday",		Format:"###\\일",	Edit:0 },
			{Header:"<sht:txt mid='flowerBasketYn' mdef='꽃바구니'/>",	Type:"CheckBox",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"flowerBasketYn",	TrueValue:"Y",	FalseValue:"N" , Edit:0 },
			{Header:"<sht:txt mid='wreathYnV1' mdef='경조화환'/>",	Type:"CheckBox",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"wreathYn",		TrueValue:"Y",	FalseValue:"N" , Edit:0 },
			{Header:"<sht:txt mid='outfitYn' mdef='상조용품'/>",	Type:"CheckBox",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"outfitYn",		TrueValue:"Y",	FalseValue:"N" , Edit:0 },
			{Header:"<sht:txt mid='giftYn' mdef='상조깃발'/>",	Type:"CheckBox",	Hidden:1,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"giftYn",			TrueValue:"Y",	FalseValue:"N" , Edit:0 },
			{Header:"<sht:txt mid='day' mdef='지급일'/>",		Type:"Text",		Hidden:1,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"payYmd",			Edit:0 },
			{Header:"<sht:txt mid='payYnV1' mdef='지급여부'/>",	Type:"Text",		Hidden:1,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"payYn",			Edit:0 },
			{Header:"<sht:txt mid='closeYnV1' mdef='마감여부'/>",	Type:"Text",		Hidden:1,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"magamYn",			Edit:0 },
		...
		sheet1.SetEditableColorDiff(0); //편집불가 배경색 적용안함
 		...
 		//==============================================================================================================================
		//공통코드 한번에 조회
		var grpCds = "B60020,B60030,H30001,R10010";
	...
	function doAction1(sAction) {
		switch (sAction) {
			case "Search":
				var sXml = sheet1.GetSearchData("${ctx}/OccApp.do?cmd=getOccAppList", $("#sheet1Form").serialize() );
	        ...
	        case "Save": //임시저장의 경우 삭제처리.      
	        	...
	        	sheet1.DoSave( "${ctx}/OccApp.do?cmd=deleteOccApp", $("#sheet1Form").serialize(), -1, 0); 
	        	break;
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li class="txt"><tit:txt mid='occApp' mdef='경조신청'/></li>
				<li class="btn">
