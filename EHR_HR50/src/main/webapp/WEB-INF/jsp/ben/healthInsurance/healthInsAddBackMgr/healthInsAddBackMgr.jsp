...
<!DOCTYPE html> <html class="hidden"> <head> <title><tit:txt mid='113390' mdef='건강보험추가/환급액관리'/></title>
...
$(function() {
	...
	initdata1.Cols = [
		...
		{Header:"<sht:txt mid='qOrgNmV4' mdef='소속|소속'/>",					Type:"Text",		Hidden:0,					Width:100,			Align:"Center",	ColMerge:0,	SaveName:"orgNm",		KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
		...
		{Header:"<sht:txt mid='empYmdV1' mdef='입사일|입사일'/>",					Type:"Date",		Hidden:0,					Width:90,			Align:"Center",	ColMerge:0,	SaveName:"empYmd",		KeyField:0,	Format:"Ymd",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 },
		{Header:"<sht:txt mid='gempYmdV1' mdef='그룹입사일|그룹입사일'/>",				Type:"Date",		Hidden:0,					Width:90,			Align:"Center",	ColMerge:0,	SaveName:"gempYmd",		KeyField:0,	Format:"Ymd",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 },
		{Header:"<sht:txt mid='benefitBizCd_V2698' mdef='복리후생업무구분코드|복리후생업무구분코드'/>",	Type:"Text",		Hidden:1,					Width:100,			Align:"Center",	ColMerge:0,	SaveName:"benefitBizCd",KeyField:1,	Format:"",			PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:13 },
		{Header:"<sht:txt mid='payActionCdV3' mdef='급여계산코드|급여계산코드'/>",			Type:"Text",		Hidden:1,					Width:100,			Align:"Center",	ColMerge:0,	SaveName:"payActionCd",	KeyField:1,	Format:"",			PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:10 },
		{Header:"<sht:txt mid='selfMonV2' mdef='건강보험료|월보험료'/>",				Type:"Int",			Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"mon5",		KeyField:0,	Format:"NullInteger",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='addSelfMonV1' mdef='건강보험료|환급/추징'/>",				Type:"Int",			Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"addSelfMon",	KeyField:0,	Format:"NullInteger",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='mon1V2' mdef='건강보험료|정산금'/>",				Type:"Int",			Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"mon1",		KeyField:0,	Format:"NullInteger",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='mon3V1' mdef='건강보험료|환급이자'/>",				Type:"Int",			Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"mon3",		KeyField:0,	Format:"NullInteger",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='selfMon2' mdef='요양보험료|월보험료'/>",				Type:"Int",			Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"mon6",		KeyField:0,	Format:"NullInteger",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='addSelfMon2' mdef='요양보험료|환급/추징'/>",				Type:"Int",			Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"addSelfMon2",	KeyField:0,	Format:"NullInteger",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='mon2V2' mdef='요양보험료|정산금'/>",				Type:"Int",			Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"mon2",		KeyField:0,	Format:"NullInteger",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='mon4V1' mdef='요양보험료|환급이자'/>",				Type:"Int",			Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"mon4",		KeyField:0,	Format:"NullInteger",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='addReasonCd' mdef='발생사유|발생사유'/>",				Type:"Combo",		Hidden:0,					Width:120,			Align:"Center",	ColMerge:0,	SaveName:"addReasonCd",	KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:10 }
...
function doAction1(sAction) {
	switch (sAction) {
		case "Search":
			...
			sheet1.DoSearch("${ctx}/HealthInsAddBackMgr.do?cmd=getHealthInsAddBackMgrList", $("#sheet1Form").serialize());
			break;
		...
		case "Save":
			...
			sheet1.DoSave("${ctx}/HealthInsAddBackMgr.do?cmd=saveHealthInsAddBackMgr", $("#sheet1Form").serialize());
			break;
		...
		case "Insert":
			...
			sheet1.SetCellValue(Row, "benefitBizCd", "15"); // 복리후생업무구분코드(B10230-15.건강보험)
		...
		case "Down2Excel":
			...
			var d = new Date();
			var fName = "건강보험추가_환급액관리_" + d.getTime();
		...
		case "DownTemplate":
			// 양식다운로드
			sheet1.Down2Excel({ SheetDesign:1, Merge:1, DownRows:"0|1", DownCols:"3|18|19|20|21|22|23|24|25|26"});
			break;
	}
}
...
function getCpnLatestPaymentInfo() {
	...
	var paymentInfo = ajaxCall("${ctx}/HealthInsAddBackMgr.do?cmd=getCpnQueryList", "queryId=getCpnLatestPaymentInfoMap&procNm="+procNm+"&runType=00001,", false);
...
<div class="wrapper">
	<form id="sheet1Form" name="sheet1Form">
		...
		<input type="hidden" id="searchPayActionCd" name="searchPayActionCd" value="" /> <!-- 저장시 payActionCd가 null인경우 사용 -->
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt"><tit:txt mid='113390' mdef='건강보험추가/환급액관리'/></li>
							<li class="btn">
