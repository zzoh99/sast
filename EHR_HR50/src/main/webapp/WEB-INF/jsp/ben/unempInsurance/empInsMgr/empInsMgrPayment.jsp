...
$(function() {
	...
	initdata.Cols = [
		...
		{Header:"<sht:txt mid='payActionCd' mdef='급여일자'/>",		Type:"Text",		Hidden:0,					Width:100,			Align:"Center",	ColMerge:0,	SaveName:"paymentYmd",	KeyField:1,	Format:"Ymd",			PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:10 },
		{Header:"<sht:txt mid='payNmV1' mdef='급여명'/>",	Type:"Text",		Hidden:0,					Width:100,			Align:"Center",	ColMerge:0,	SaveName:"payNm",	KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:10 },
		{Header:"<sht:txt mid='socDeductCdV1' mdef='공제상태'/>",		Type:"Combo",		Hidden:0,					Width:100,			Align:"Center",	ColMerge:0,	SaveName:"socDeductCd",	KeyField:0,	Format:"",			PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:10 },
		{Header:"<sht:txt mid='baseMon' mdef='기준금액'/>",		Type:"Text",		Hidden:1,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"stdMon",		KeyField:0,	Format:"Integer",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='mon2_V4246' mdef='월보험료'/>",	Type:"AutoSum",		Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"selfMon",		KeyField:0,	Format:"Integer",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='compMon' mdef='회사부담액'/>",	Type:"AutoSum",		Hidden:1,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"compMon",		KeyField:0,	Format:"Integer",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='selfRate' mdef='본인부담율'/>",	Type:"Text",		Hidden:1,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"selfRate",	KeyField:0,	Format:"Float",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='compRate' mdef='회사부담율'/>",	Type:"Text",		Hidden:1,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"compRate",	KeyField:0,	Format:"Float",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 }
...
function doAction1(sAction) {
	switch (sAction) {
		case "Search":
			...
			sheet1.DoSearch("${ctx}/EmpInsMgr.do?cmd=getEmpInsMgrPaymentList", $("#sheet1Form").serialize());
			break;
		...
		case "Save":
			...
			sheet1.DoSave("${ctx}/EmpInsMgr.do?cmd=saveEmpInsMgrPayment", $("#sheet1Form").serialize());
			break;
