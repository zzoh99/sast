...
<!DOCTYPE html> <html class="hidden"> <head> <title><tit:txt mid='103976' mdef='고용보험기본사항'/></title>
...
function showIframe() {
	...
	if(iframeIdx == 0) {
		// 기본사항/변동내역
		newIframe.attr("src","${ctx}/EmpInsMgr.do?cmd=viewEmpInsMgrBasicChange&authPg=${authPg}");
	} else if(iframeIdx == 1) {
		// 불입내역
		newIframe.attr("src","${ctx}/EmpInsMgr.do?cmd=viewEmpInsMgrPayment&authPg=${authPg}");
	}
}
