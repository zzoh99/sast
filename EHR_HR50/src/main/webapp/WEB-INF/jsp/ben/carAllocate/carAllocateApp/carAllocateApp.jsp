...
//   			{Header:"상태|상태",		Type:"${sSttTy}",	Hidden:Number("${sSttHdn}"),Width:"${sSttWdt}",	Align:"Center",	ColMerge:1,	SaveName:"sStatus",	Sort:0 },
   	        ...
   	        {Header:"차량정보|차량번호",		Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:1,	SaveName:"carNo",		KeyField:0,	CalcLogic:"",	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:20 },
   	     	{Header:"차량정보|차량명",			Type:"Text",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:1,	SaveName:"carNm",		KeyField:0,	CalcLogic:"",	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			sheet1.DoSearch( "${ctx}/CarAllocateApp.do?cmd=getCarAllocateAppList", $("#sheet1Form").serialize() ); break;
        case "Save":        // 중복체크
       		// 해당 화면에는 저장기능 없이 삭제 기능만 존재 한다.
       		// 신규 신청은 팝업을 통하여 이루어진다.
       		IBS_SaveName(document.sheet1Form,sheet1);
        	sheet1.DoSave( "${ctx}/CarAllocateApp.do?cmd=deleteCarAllocateApp", $("#sheet1Form").serialize()); break;
        case "Down2Excel":
