...
<!DOCTYPE html> <html class="hidden"><head><title>개인연금승인</title>
...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			{Header:"신청내용|가입상품",			Type:"Combo",	Hidden:0,	Width:80,	Align:"Center",	SaveName:"pensCd",		Edit:0 },
			{Header:"신청내용|회사지원금",		Type:"Int",		Hidden:0,	Width:80,	Align:"Right",	SaveName:"compMon",		Format:"",	Edit:0 },
			{Header:"신청내용|개인부담금",		Type:"Int",		Hidden:0,	Width:80,	Align:"Right",	SaveName:"psnlMon",		Format:"",	UpdateEdit:1,	InsertEdit:1 },
			{Header:"신청내용|계",				Type:"Int",		Hidden:0,	Width:80,	Align:"Right",	SaveName:"totMon",		Format:"",	CalcLogic:"|compMon|+|psnlMon|", Edit:0 },
			{Header:"신청내용|적용시작년월",		Type:"Date",	Hidden:0,   Width:80,	Align:"Center", SaveName:"payYm",		Format:"Ym",		UpdateEdit:1,	InsertEdit:1 },
	...
	function doAction1(sAction) {
		...
		case "Search":
			if(!chkInVal()){break;}
			getCommonCodeList();
			var sXml = sheet1.GetSearchData("${ctx}/PsnalPenApr.do?cmd=getPsnalPenAprList", $("#sheet1Form").serialize() );
        ...
        case "Save":   
        	...
        	sheet1.DoSave( "${ctx}/PsnalPenApr.do?cmd=savePsnalPenApr", $("#sheet1Form").serialize()); 
        	break;
        case "Down2Excel":
