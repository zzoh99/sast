...
<!DOCTYPE html> <html class="hidden"><head><title>동호회(재)등록승인</title>
...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
				...
				//신청내용
				{Header:"신청내용|신청구분",		Type:"Combo",	Hidden:0,	Width:70,	Align:"Center",	ColMerge:0,	SaveName:"gubunCd",		KeyField:0,	Format:"",		Edit:0 },
				{Header:"신청내용|동호회명",		Type:"Text",	Hidden:0,	Width:140,	Align:"Center",	ColMerge:0,	SaveName:"clubNm",		KeyField:0,	Format:"",		Edit:0 },
				{Header:"신청내용|회장",			Type:"Text",	Hidden:0,	Width:70,	Align:"Center",	ColMerge:0,	SaveName:"sabunAView",	KeyField:0,	Format:"",		Edit:0 },
				{Header:"신청내용|총무",			Type:"Text",	Hidden:0,	Width:70,	Align:"Center",	ColMerge:0,	SaveName:"sabunBView",	KeyField:0,	Format:"",		Edit:0 },
				{Header:"신청내용|고문",			Type:"Text",	Hidden:1,	Width:70,	Align:"Center",	ColMerge:0,	SaveName:"sabunCView",	KeyField:0,	Format:"",		Edit:0 },
				{Header:"신청내용|회원수",			Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"memerCnt",	KeyField:0,	Format:"",		Edit:0 },
				{Header:"신청내용|전년도\n가입자수",Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"yearInCnt",	KeyField:0,	Format:"",		Edit:0 },
				{Header:"신청내용|전년도\n탈퇴자수",Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"yearOutCnt",	KeyField:0,	Format:"",		Edit:0 },
		...
		//==============================================================================================================================
		//공통코드 한번에 조회
        var clubCodeList = convCode( ajaxCall("${ctx}/CommonCode.do?cmd=getCommonNSCodeList","queryId=getClubrefAprClubCode",false).codeList, "전체");
	...
	function getCommonCodeList() {
		...
		sheet1.SetColProperty("gubunCd",  		{ComboText:"|"+codeLists["B50510"][0], ComboCode:"|"+codeLists["B50510"][1]} ); //신청구분
	}
	...
	function doAction1(sAction) {
		...
		case "Search":
			if(!chkInVal()){break;}
			getCommonCodeList();
			var sXml = sheet1.GetSearchData("${ctx}/ClubrefApr.do?cmd=getClubrefAprList", $("#sheet1Form").serialize() );
...
<div class="wrapper">	<form id="sheet1Form" name="sheet1Form" >
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li id="txt" class="txt">동호회(재)등록승인</li> 
				<li class="btn"> 
