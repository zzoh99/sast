...
<!DOCTYPE html> <html class="hidden"> <head> <title><tit:txt mid='healthRatioMgr' mdef='건강보험요율'/></title>
...
$(function() {
	...
	initdata1.Cols = [
		...
		{Header:"<sht:txt mid='selfRate' mdef='본인부담율'/>",		Type:"Float",		Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"selfRate",		KeyField:0,	Format:"Float",		PointCount:5,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='compRate' mdef='회사부담율'/>",		Type:"Float",		Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"compRate",		KeyField:0,	Format:"Float",		PointCount:5,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='lowMon' mdef='보수월액\n미만한도'/>",	Type:"Int",			Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"lowMon",			KeyField:0,	Format:"Integer",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='highMon' mdef='보수월액\n초과한도'/>",	Type:"Int",			Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"highMon",			KeyField:0,	Format:"Integer",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
		{Header:"<sht:txt mid='longtermcareRate' mdef='노인장기요양\n보험율'/>",	Type:"Float",		Hidden:0,					Width:100,			Align:"Right",	ColMerge:0,	SaveName:"longtermcareRate",KeyField:0,	Format:"Float",		PointCount:5,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 }
...
function doAction1(sAction) {
	switch (sAction) {
		case "Search":
			sheet1.DoSearch("${ctx}/SocInsRatesMgr.do?cmd=getHealthRatioMgrList");
			break;
		...
		case "Save":
			...
			sheet1.DoSave("${ctx}/SocInsRatesMgr.do?cmd=saveHealthRatioMgr", $("#sheet1Form").serialize());
			break;
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt"><tit:txt mid='healthRatioMgr' mdef='건강보험요율'/></li>
							<li class="btn">
