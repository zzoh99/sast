...
<!DOCTYPE html> <html class="hidden"> <head> <title><tit:txt mid='natiPenRatioMgr' mdef='국민연금요율'/></title>
...
function doAction1(sAction) {
	switch (sAction) {
		case "Search":
			sheet1.DoSearch("${ctx}/SocInsRatesMgr.do?cmd=getNatiPenRatioMgrList");
			break;
		...
		case "Save":
			...
			sheet1.DoSave("${ctx}/SocInsRatesMgr.do?cmd=saveNatiPenRatioMgr", $("#sheet1Form").serialize());
			break;
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt"><tit:txt mid='natiPenRatioMgr' mdef='국민연금요율'/></li>
							<li class="btn">
