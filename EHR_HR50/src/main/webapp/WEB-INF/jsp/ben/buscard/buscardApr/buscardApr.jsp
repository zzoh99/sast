...
<!DOCTYPE html> <html class="hidden"><head><title>명함승인</title>
...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		var initdata = {};
		initdata.Cfg = {SearchMode:smLazyLoad,Page:22,MergeSheet:msHeaderOnly,FrozenCol:6, FrozenColRight:0};
		...
		initdata.Cols = [
			...
			{Header:"결재상태|결재상태",		Type:"Combo",  	Hidden:0, Width:100, 	Align:"Center", ColMerge:0,  SaveName:"applStatusCd",	Format:"",	  Edit:1},
			//신청자정보
			...
			{Header:"신청자|부서",			Type:"Text",   	Hidden:0, Width:120, 	Align:"Center",   ColMerge:0,  SaveName:"orgNm", 			Edit:0},
			...
			//신청내용
		    {Header:"신청내용|명함타입",		Type:"Text",	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"cardTypeCd",	KeyField:0,	Format:"#타입",	Edit:0 },
			{Header:"신청내용|부서",		Type:"Text",	Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"orgNm1",		KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|영문부서명",	Type:"Text",	Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"orgNmEn",		KeyField:0,	Format:"",		Edit:0 },
		 	{Header:"신청내용|한글성명",		Type:"Text",	Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"name1",		KeyField:0,	Format:"",		Edit:0 },
		 	{Header:"신청내용|직급",		Type:"Text",	Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"jikweeNm1",	KeyField:0,	Format:"",		Edit:0 }, 
			{Header:"신청내용|영문직급",		Type:"Text",	Hidden:0,	Width:120,	Align:"Center",	ColMerge:0,	SaveName:"jikweeNmEn",	KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|영문성명",		Type:"Text",	Hidden:0,	Width:120,	Align:"Center",	ColMerge:0,	SaveName:"nameEn",		KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|핸드폰",		Type:"Text",	Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"phoneNo",		KeyField:0,	Format:"PhoneNo",	Edit:0 },
			{Header:"신청내용|핸드폰영문",	Type:"Text",	Hidden:0,	Width:120,	Align:"Center",	ColMerge:0,	SaveName:"phoneNoEn",	KeyField:0,	Format:"",	Edit:0 },
			{Header:"신청내용|e-mail",		Type:"Text",	Hidden:0,	Width:150,	Align:"Left",	ColMerge:0,	SaveName:"mailId",		KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|Fax",		Type:"Text",	Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"faxNo",		KeyField:0,	Format:"PhoneNo",	Edit:0 },
			{Header:"신청내용|Fax영문",		Type:"Text",	Hidden:0,	Width:120,	Align:"Center",	ColMerge:0,	SaveName:"faxNoEn",		KeyField:0,	Format:"",	Edit:0 },
			{Header:"신청내용|TEL",		Type:"Text",	Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"telNo",		KeyField:0,	Format:"PhoneNo",	Edit:0 },
			{Header:"신청내용|TEL영문",		Type:"Text",	Hidden:0,	Width:120,	Align:"Center",	ColMerge:0,	SaveName:"telNoEn",		KeyField:0,	Format:"",	Edit:0 },
			{Header:"신청내용|주소",		Type:"Text",	Hidden:0,	Width:250,	Align:"Left",	ColMerge:0,	SaveName:"compAddr",	KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|주소영문",		Type:"Text",	Hidden:0,	Width:300,	Align:"Left",	ColMerge:0,	SaveName:"compAddrEn",	KeyField:0,	Format:"",		Edit:0 },
			{Header:"신청내용|비고",		Type:"Text",	Hidden:0,	Width:200,	Align:"Left",	ColMerge:0,	SaveName:"note",		KeyField:0,	Format:"",		Edit:0 },
	...
	function doAction1(sAction) {
		...
		case "Search":
			getCommonCodeList();
			var sXml = sheet1.GetSearchData("${ctx}/BuscardApr.do?cmd=getBuscardAprList", $("#sheet1Form").serialize() );
        ...
        case "Save":   
        	...
        	sheet1.DoSave( "${ctx}/BuscardApr.do?cmd=saveBuscardApr", $("#sheet1Form").serialize()); 
        	break;
        case "Down2Excel":
        ...
        case "AllFinish":
        	...
        	for(var i = sheet1.HeaderRows(); i < sheet1.RowCount()+sheet1.HeaderRows() ; i++) {
        		if( sheet1.GetCellValue(i, "applStatusCd") != "99" ){
        			sheet1.SetCellValue(i, "applStatusCd", "99");
        			cnt++;
        		}
        	}
        	if( cnt > 0 ) {
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li id="txt" class="txt">명함승인</li> 
				<li class="btn">			

					<a href="javascript:doAction1('Down2Excel');" 	class="btn outline-gray authR">다운로드</a>
					<a href="javascript:doAction1('Save');" 		class="btn soft authA">저장</a>
					<a href="javascript:doAction1('AllFinish');" 	class="btn filled authA">전체 처리완료</a>
				</li>
			</ul>
		</div>
	</div>
