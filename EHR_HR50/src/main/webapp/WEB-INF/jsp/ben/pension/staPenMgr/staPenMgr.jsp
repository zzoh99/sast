...
<!DOCTYPE html> <html class="hidden"> <head> <title><tit:txt mid='104368' mdef='국민연금기본사항'/></title>
...
function showIframe() {
	...
	if(iframeIdx == 0) {
		// 기본사항/변동내역
		newIframe.attr("src","${ctx}/StaPenMgr.do?cmd=viewStaPenMgrBasicChange&authPg=${authPg}");
	} else if(iframeIdx == 1) {
		// 불입내역
		newIframe.attr("src","${ctx}/StaPenMgr.do?cmd=viewStaPenMgrPayment&authPg=${authPg}");
	}
}
