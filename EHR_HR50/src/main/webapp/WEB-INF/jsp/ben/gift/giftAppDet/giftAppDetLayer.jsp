...
<script type="text/javascript">
	...
	$(function() {
		...
		const modal = window.top.document.LayerModalUtility.getModal('giftAppDetLayer');
		var arg = modal.parameters;
		var giftSeq = arg.giftSeq || '';
		var applSabun = arg.applSabun || '';
		...
		switch (sAction) {
			...
			case "Save":
				...
				if(rtn.Result.Code < 1) {
					...
					const modal = window.top.document.LayerModalUtility.getModal('giftAppDetLayer');
	                modal.fire('giftAppDetTrigger', {}).hide();
				}
		}
	}
                ...
                , trigger :[
                    {
                        ...
                        , callback : function(result){
                            $("#recZip").val(result.zip);
                            $("#recAddr").val(result.doroFullAddr);
                        }
                    }
                ]
            });
...
<div class="wrapper modal_layer">
    ...
    <div class="modal_footer">
	    <btn:a href="javascript:doAction1('Save');" css="btn filled" mid='110881' mdef="신청"/>
	    <btn:a href="javascript:closeCommonLayer('giftAppDetLayer');"    css="btn outline_gray" mid='110881' mdef="닫기"/>
    </div>
</div>
</body>
</html>
