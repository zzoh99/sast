...
<script type="text/javascript">
	...
	function init_sheet(){ 
		...
		initdata.Cols = [
			...
			//신청내용
			{Header:"신청내용|어학시험",		Type:"Text",	Hidden:0,	Width:120,	Align:"Center",	ColMerge:0,	SaveName:"testCdNm", Format:"",		Edit:0 },
			{Header:"신청내용|시험일자",		Type:"Date",	Hidden:0,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"testYmd",	 Format:"Ymd",	Edit:0 },
			{Header:"신청내용|응시료",		Type:"Int",		Hidden:0,	Width:80,	Align:"Right",	ColMerge:0,	SaveName:"testMon",	 Format:"",		Edit:0 },
			{Header:"신청내용|비고",		Type:"Text",	Hidden:0,	Width:200,	Align:"Left",	ColMerge:0,	SaveName:"note",	 Format:"",			Edit:0 },
	...
	function getCommonCodeList() {
		...
		sheet1.SetColProperty("testCd", 	{ComboText:"|"+codeLists["H20307"][0], ComboCode:"|"+codeLists["H20307"][1]} );
	}
	...
	function doAction1(sAction) {
		...
		case "Search":
			if(!chkInVal()){break;}
			getCommonCodeList();
			var sXml = sheet1.GetSearchData("${ctx}/FtestmonApr.do?cmd=getFtestmonAprList", $("#sheet1Form").serialize() );
        ...
        case "Save":   
        	...
        	sheet1.DoSave( "${ctx}/FtestmonApr.do?cmd=saveFtestmonApr", $("#sheet1Form").serialize()); 
        	break;
        case "Down2Excel":
...
<div class="wrapper">
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li id="txt" class="txt">어학응시료승인</li> 
				<li class="btn">
