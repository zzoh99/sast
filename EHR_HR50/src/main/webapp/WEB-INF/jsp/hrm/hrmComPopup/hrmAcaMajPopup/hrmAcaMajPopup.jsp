...
<!DOCTYPE html> <html class="hidden"> <head> <title><tit:txt mid='111943' mdef='전공검색'/></title>
...
<script type="text/javascript">
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search": //조회
		    sheet1.DoSearch( "${ctx}/HrmAcaMajPopup.do?cmd=getHrmAcaMajPopupList", $("#sheet1Form").serialize());
            break;
        case "Clear":        //Clear
            sheet1.RemoveAll();
            break;
...
<body class="bodywrap">
    <div class="wrapper">
        <div class="popup_title">
            <ul>
                <li><tit:txt mid='111943' mdef='전공검색'/></li>
                <li class="close"></li>
            </ul>
        </div>
        ...
        <div class="popup_main">
            <form id="sheet1Form" name="sheet1Form" onsubmit="return false;">
                ...
                <div class="sheet_search outer">
                    ...
                    <table>
                    <tr>
						<th><tit:txt mid='113365' mdef='전공명'/></th>
                        <td>
	        ...
	        <table border="0" cellspacing="0" cellpadding="0" class="sheet_main">
	            <tr>
	                ...
	                <div class="inner">
	                    ...
	                    <ul>
	                        <li id="txt" class="txt"><tit:txt mid='114433' mdef='전공조회'/></li>
	                    </ul>
	                    </div>
	                </div>
