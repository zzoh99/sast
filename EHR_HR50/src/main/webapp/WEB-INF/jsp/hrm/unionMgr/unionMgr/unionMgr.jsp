...
<script type="text/javascript">
	$(function() {
		...
		var userCd1 = convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList&note1=사무노조","H90011"), "<tit:txt mid='103895' mdef='전체'/>");
...
//		$("#searchEdate").val("${curSysYyyyMMHyphen}-31") ;
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			var sXml = sheet1.GetSearchData("${ctx}/UnionMgr.do?cmd=getUnionMgrList", $("#sheet1Form").serialize() );
		...
		case "Save":
			...
			sheet1.DoSave( "${ctx}/UnionMgr.do?cmd=saveUnionMgr" ,$("#sheet1Form").serialize());
			break;
		case "Down2Excel":
...
<div class="wrapper">
	...
	<div class="inner">
		...
		<ul>
			<li class="txt"><tit:txt mid='112882' mdef='사무노조관리'/></li>
			<li class="btn">
