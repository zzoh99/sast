...
<script src="${ctx}/common/plugin/IBLeaders/Org/IBOrgSharp5/module/succOrgObj.js?=6" type="text/javascript" charset="utf-8"></script>
...
<script type="text/javascript">
	...
	function doAction(sAction) {
		var url = "${ctx}/SuccOrgList.do?cmd=getSuccOrgList";
...
<!-- 			                </td> -->
		...
		<div id="body">
			<div class="contents" style="padding:0;">
				<!-- 패널&탭 영역 -->
				<div id="ibContent" style="position:absolute; left:1px; top:96px; width:260px; border:1px solid silver; background-color:#fff; z-index:1000;">
					<label for="treeShow" class="floatR" style="margin:2px 7px 0 0;"><img src="${ ctx }/common/images/common/btn_delete.gif" /></label>
				    <ul class="tabs">
				       	<li class="active" rel="tab1"><tit:txt mid="L190827000007" mdef="트리" /></li>l
