...
<script type="text/javascript">
	...
	$(function() {
		createIBSheet3(document.getElementById('sheet1-wrap'), "sheet1", "0%", "0%", "${ssnLocaleCd}");
		createIBSheet3(document.getElementById('sheet2-wrap'), "sheet2", "100%", "50%", "${ssnLocaleCd}");
		createIBSheet3(document.getElementById('sheet3-wrap'), "sheet3", "100%", "50%", "${ssnLocaleCd}");

		const modal = window.top.document.LayerModalUtility.getModal('psnalCareerLayer');
		...
		var initdata2 = {};
		initdata2.Cfg = {SearchMode:smLazyLoad,MergeSheet:0,Page:22,FrozenCol:9,DataRowMerge:0, AutoFitColWidth:'init|search|resize|rowtransaction'};
		...
		initdata2.Cols = [
			...
			{Header:"<sht:txt mid='agreeRate' mdef='인정\n비율(%)'/>",Type:"Text",      	Hidden:0,  Width:50,    Align:"Center",  ColMerge:0,   SaveName:"agreeRate",		KeyField:0,   CalcLogic:"",   Format:"",		PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
		...
		var initdata3 = {};
		initdata3.Cfg = {SearchMode:smLazyLoad,MergeSheet:0,Page:22,FrozenCol:9,DataRowMerge:0, AutoFitColWidth:'init|search|resize|rowtransaction'};
		...
		sheet2.SetSheetHeight(sheetHeight/2);
		sheet3.SetSheetHeight(sheetHeight/2);
    ...
    function fileMgrPopup(Row, Col) {
        ...
        let layerModal = new window.top.document.LayerModal({
              id : 'fileMgrLayer'
            , url : '/fileuploadJFileUpload.do?cmd=viewFileMgrLayer&authPg=${authPg}&uploadType=career'
            , parameters : {
			...
			<div class="sheet_title">
				<ul>
					...
					<li class="btn _thrm116">
						...
						<c:if test="${authPg == 'A'}">
							<btn:a href="javascript:doAction3('Insert');" css="basic authA enterAuthBtn" mid='110700' mdef="입력"/>
							<btn:a href="javascript:doAction3('Copy');" css="basic authA enterAuthBtn" mid='110696' mdef="복사"/>
