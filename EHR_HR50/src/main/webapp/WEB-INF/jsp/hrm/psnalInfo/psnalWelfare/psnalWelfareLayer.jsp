...
<script type="text/javascript">
	...
	$(function() {
		createIBSheet3(document.getElementById('psnalWelfareLayerSheet1-wrap'), "psnalWelfareLayerSheet1", "100%", "50%", "${ssnLocaleCd}");
		createIBSheet3(document.getElementById('psnalWelfareLayerSheet2-wrap'), "psnalWelfareLayerSheet2", "100%", "50%", "${ssnLocaleCd}");
		createIBSheet3(document.getElementById('psnalWelfareLayerSheet3-wrap'), "psnalWelfareLayerSheet3", "100%", "50%", "${ssnLocaleCd}");
		createIBSheet3(document.getElementById('psnalWelfareLayerSheet4-wrap'), "psnalWelfareLayerSheet4", "100%", "50%", "${ssnLocaleCd}");

		const modal = window.top.document.LayerModalUtility.getModal('psnalWelfareLayer');
		...
		EMP_INFO_CHANGE_TABLE_SHEET["thrm121"] = psnalWelfareLayerSheet1;
		EMP_INFO_CHANGE_TABLE_SHEET["thrm122"] = psnalWelfareLayerSheet2;
		EMP_INFO_CHANGE_TABLE_SHEET["thrm120"] = psnalWelfareLayerSheet3;
		EMP_INFO_CHANGE_TABLE_SHEET["thrm132"] = psnalWelfareLayerSheet4;
		...
		]; IBS_InitSheet(psnalWelfareLayerSheet1, initdata1);psnalWelfareLayerSheet1.SetEditable("${editable}");psnalWelfareLayerSheet1.SetVisible(true);psnalWelfareLayerSheet1.SetCountPosition(4);
		...
		]; IBS_InitSheet(psnalWelfareLayerSheet2, initdata2);psnalWelfareLayerSheet2.SetEditable("${editable}");psnalWelfareLayerSheet2.SetVisible(true);psnalWelfareLayerSheet2.SetCountPosition(4);

		var initdata3 = {};
		initdata3.Cfg = {SearchMode:smLazyLoad,MergeSheet:0,Page:22,FrozenCol:0,DataRowMerge:0, AutoFitColWidth:'init|search|resize|rowtransaction'};
		...
		]; IBS_InitSheet(psnalWelfareLayerSheet3, initdata3);psnalWelfareLayerSheet3.SetEditable("${editable}");psnalWelfareLayerSheet3.SetVisible(true);psnalWelfareLayerSheet3.SetCountPosition(4);

		var initdata4 = {};
		initdata4.Cfg = {SearchMode:smLazyLoad,MergeSheet:0,Page:22,FrozenCol:0,DataRowMerge:0, AutoFitColWidth:'init|search|resize|rowtransaction'};
		...
		]; IBS_InitSheet(psnalWelfareLayerSheet4, initdata4);psnalWelfareLayerSheet4.SetEditable("${editable}");psnalWelfareLayerSheet4.SetVisible(true);psnalWelfareLayerSheet4.SetCountPosition(4);
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			psnalWelfareLayerSheet1.DoSearch( "${ctx}/PsnalWelfare.do?cmd=getPsnalWelfareArmyList", param );
			break;
		case "Save":
			/*
			if( $("#transferCd").val() == "" ) {
			...
			*/
			if(psnalWelfareLayerSheet1.RowCount() == 0) {
				var row = psnalWelfareLayerSheet1.DataInsert(0);
				psnalWelfareLayerSheet1.SetCellValue(row,"sabun",$("#hdnSabun").val());
			}
			if(setSheetValue(psnalWelfareLayerSheet1,1)) {
				IBS_SaveName(document.psnalWelfareLayerSheet1Form,psnalWelfareLayerSheet1);
				psnalWelfareLayerSheet1.DoSave( "${ctx}/PsnalWelfare.do?cmd=savePsnalWelfareArmy", $("#psnalWelfareLayerSheet1Form").serialize());
			}
			break;
		case "Delete":
			if(psnalWelfareLayerSheet1.RowCount() == 0) {
				...
				psnalWelfareLayerSheet1.SetCellValue(1,"sStatus","D");
				IBS_SaveName(document.psnalWelfareLayerSheet1Form,psnalWelfareLayerSheet1);
				psnalWelfareLayerSheet1.DoSave( "${ctx}/PsnalWelfare.do?cmd=savePsnalWelfareArmy", $("#psnalWelfareLayerSheet1Form").serialize());
			}
			break;
		case "Down2Excel":
			var downcol = makeHiddenSkipCol(psnalWelfareLayerSheet1);
			var param  = {DownCols:downcol,SheetDesign:1,Merge:1,ExcelFontSize:"9",ExcelRowHeight:"20"};
			psnalWelfareLayerSheet1.Down2Excel(param);
			break;
		}
	}
	...
	function doAction2(sAction) {
		...
		case "Search":
			var param = "sabun="+$("#hdnSabun").val()+"&searchUserEnterCd="+$("#hdnEnterCd").val();
			psnalWelfareLayerSheet2.DoSearch( "${ctx}/PsnalWelfare.do?cmd=getPsnalWelfareBohunList", param );
			break;
		case "Save":
			/*
			if( $("#bohunNo").val() == "" ) {
			...
			*/
			if(psnalWelfareLayerSheet2.RowCount() == 0) {
				var row = psnalWelfareLayerSheet2.DataInsert(0);
				psnalWelfareLayerSheet2.SetCellValue(row,"sabun",$("#hdnSabun").val());
			}

			if(setSheetValue(psnalWelfareLayerSheet2,2)) {
				IBS_SaveName(document.psnalWelfareLayerSheet1Form,psnalWelfareLayerSheet2);
				psnalWelfareLayerSheet2.DoSave( "${ctx}/PsnalWelfare.do?cmd=savePsnalWelfareBohun", $("#psnalWelfareLayerSheet1Form").serialize());
			}
			break;
		case "Delete":
			if(psnalWelfareLayerSheet2.RowCount() == 0) {
				...
				psnalWelfareLayerSheet2.SetCellValue(1,"sStatus","D");
				IBS_SaveName(document.psnalWelfareLayerSheet1Form,psnalWelfareLayerSheet2);
				psnalWelfareLayerSheet2.DoSave( "${ctx}/PsnalWelfare.do?cmd=savePsnalWelfareBohun", $("#psnalWelfareLayerSheet1Form").serialize());
			}
			break;
		case "Down2Excel":
			var downcol = makeHiddenSkipCol(psnalWelfareLayerSheet2);
			var param  = {DownCols:downcol,SheetDesign:1,Merge:1,ExcelFontSize:"9",ExcelRowHeight:"20"};
			psnalWelfareLayerSheet2.Down2Excel(param);
			break;
		}
	}
	...
	function doAction3(sAction) {
		...
		case "Search":
			var param = "sabun="+$("#hdnSabun").val()+"&searchUserEnterCd="+$("#hdnEnterCd").val();
			psnalWelfareLayerSheet3.DoSearch( "${ctx}/PsnalWelfare.do?cmd=getPsnalWelfareJangList", param );
			break;
		case "Save":
			/*
			if( $("#jangNo").val() == "" ) {
			...
			*/
			if(psnalWelfareLayerSheet3.RowCount() == 0) {
				var row = psnalWelfareLayerSheet3.DataInsert(0);
				psnalWelfareLayerSheet3.SetCellValue(row,"sabun",$("#hdnSabun").val());
			}
			if(setSheetValue(psnalWelfareLayerSheet3,3)) {
				IBS_SaveName(document.psnalWelfareLayerSheet1Form,psnalWelfareLayerSheet3);
				psnalWelfareLayerSheet3.DoSave( "${ctx}/PsnalWelfare.do?cmd=savePsnalWelfareJang", $("#psnalWelfareLayerSheet1Form").serialize());
			}
			break;
		case "Delete":
			if(psnalWelfareLayerSheet3.RowCount() == 0) {
				...
				psnalWelfareLayerSheet3.SetCellValue(1,"sStatus","D");
				IBS_SaveName(document.psnalWelfareLayerSheet1Form,psnalWelfareLayerSheet3);
				psnalWelfareLayerSheet3.DoSave( "${ctx}/PsnalWelfare.do?cmd=savePsnalWelfareJang", $("#psnalWelfareLayerSheet1Form").serialize());
			}
			break;
		case "Down2Excel":
			var downcol = makeHiddenSkipCol(psnalWelfareLayerSheet3);
			var param  = {DownCols:downcol,SheetDesign:1,Merge:1,ExcelFontSize:"9",ExcelRowHeight:"20"};
			psnalWelfareLayerSheet3.Down2Excel(param);
			break;
		}
	}
	...
	function doAction4(sAction) {
		...
		case "Search":
			var param = "sabun="+$("#hdnSabun").val()+"&searchUserEnterCd="+$("#hdnEnterCd").val();
			psnalWelfareLayerSheet4.DoSearch( "${ctx}/PsnalWelfare.do?cmd=getPsnalWelfareArmyEduList", param );
			break;
		case "Save":
			if(psnalWelfareLayerSheet4.RowCount() == 0) {
				var row = psnalWelfareLayerSheet4.DataInsert(0);
				psnalWelfareLayerSheet4.SetCellValue(row,"sabun",$("#hdnSabun").val());
			}
			if(setSheetValue(psnalWelfareLayerSheet4,4)){
				IBS_SaveName(document.psnalWelfareLayerSheet1Form,psnalWelfareLayerSheet4);
				psnalWelfareLayerSheet4.DoSave( "${ctx}/PsnalWelfare.do?cmd=savePsnalWelfareArmyEdu", $("#psnalWelfareLayerSheet1Form").serialize());
			}
			break;
		case "Delete":
			if(psnalWelfareLayerSheet4.RowCount() == 0) {
				...
				psnalWelfareLayerSheet4.SetCellValue(1,"sStatus","D");
				IBS_SaveName(document.psnalWelfareLayerSheet1Form,psnalWelfareLayerSheet4);
				psnalWelfareLayerSheet4.DoSave( "${ctx}/PsnalWelfare.do?cmd=savePsnalWelfareArmyEdu", $("#psnalWelfareLayerSheet1Form").serialize());
			}
			break;
		case "Down2Excel":
			var downcol = makeHiddenSkipCol(psnalWelfareLayerSheet4);
			var param  = {DownCols:downcol,SheetDesign:1,Merge:1,ExcelFontSize:"9",ExcelRowHeight:"20"};
			psnalWelfareLayerSheet4.Down2Excel(param);
			break;
		}
	}

	// 조회 후 에러 메시지
	function psnalWelfareLayerSheet1_OnSearchEnd(Code, Msg, StCode, StMsg) {
		try {
			if (Msg != "") {
				alert(Msg);
			}
			getSheetValue(psnalWelfareLayerSheet1,1);
		} catch (ex) {
	...
	// 저장 후 메시지
	function psnalWelfareLayerSheet1_OnSaveEnd(Code, Msg, StCode, StMsg) {
		try {
			if (Msg != "") {
				alert(Msg);
			}
	...
	// 조회 후 에러 메시지
	function psnalWelfareLayerSheet2_OnSearchEnd(Code, Msg, StCode, StMsg) {
		try {
			if (Msg != "") {
				alert(Msg);
			}
			getSheetValue(psnalWelfareLayerSheet2,2);
		} catch (ex) {
			alert("OnSearchEnd Event Error : " + ex);
		}
	}
	...
	// 저장 후 메시지
	function psnalWelfareLayerSheet2_OnSaveEnd(Code, Msg, StCode, StMsg) {
		try {
			if (Msg != "") {
				alert(Msg);
			}
	...
	// 조회 후 에러 메시지
	function psnalWelfareLayerSheet3_OnSearchEnd(Code, Msg, StCode, StMsg) {
		try {
			if (Msg != "") {
				alert(Msg);
			}
			getSheetValue(psnalWelfareLayerSheet3,3);
		} catch (ex) {
			alert("OnSearchEnd Event Error : " + ex);
		}
	}
	...
	// 저장 후 메시지
	function psnalWelfareLayerSheet3_OnSaveEnd(Code, Msg, StCode, StMsg) {
		try {
			if (Msg != "") {
				alert(Msg);
			}
	...
	// 조회 후 에러 메시지
	function psnalWelfareLayerSheet4_OnSearchEnd(Code, Msg, StCode, StMsg) {
		try {
			if (Msg != "") {
				alert(Msg);
			}
			getSheetValue(psnalWelfareLayerSheet4,4);
		} catch (ex) {
			alert("OnSearchEnd Event Error : " + ex);
		}
	}
	...
	// 저장 후 메시지
	function psnalWelfareLayerSheet4_OnSaveEnd(Code, Msg, StCode, StMsg) {
		try {
			if (Msg != "") {
				alert(Msg);
			}
...
<body>
<form id="psnalWelfareLayerSheet1Form" name="psnalWelfareLayerSheet1Form"></form>
<div class="wrapper modal_layer">
	<div class="modal_body">
						...
						<ul>
							...
							<li class="btn _thrm121">
								...
								<c:if test="${authPg == 'A'}">
									...
									<btn:a href="javascript:doAction1('Delete');" css="basic authA enterAuthBtn" mid='110763' mdef="삭제"/>
								</c:if>
							</li>
						</ul>
					</div>
					...
					<div class="sheet_title">
						<ul>
							...
							<li class="btn _thrm132">
								...
								<c:if test="${authPg == 'A'}">
									<btn:a href="javascript:doAction4('Save');" css="basic authA enterAuthBtn" mid='110708' mdef="저장"/>
									<a href="javascript:doAction4('Delete');" class="basic authA enterAuthBtn"><tit:txt mid='113460' mdef='삭제'/></a>
								</c:if>
							</li>
						</ul>
					</div>
						...
						<ul>
							...
							<li class="btn _thrm122">
								...
								<c:if test="${authPg == 'A'}">
									...
									<btn:a href="javascript:doAction2('Delete');" css="basic authA enterAuthBtn" mid='110763' mdef="삭제"/>
								</c:if>
								<span id="filebtn1"><btn:a href="javascript:attachFile('1');" css="basic" mid='attachFile' mdef="첨부"/></span>
							</li>
						</ul>
					</div>
					...
					<div class="sheet_title">
						<ul>
							...
							<li class="btn _thrm120">
								...
								<c:if test="${authPg == 'A'}">
									<btn:a href="javascript:doAction3('Save');" css="basic authA enterAuthBtn" mid='110708' mdef="저장"/>
									<btn:a href="javascript:doAction3('Delete');" css="basic authA enterAuthBtn" mid='110763' mdef="삭제"/>
								</c:if>
								<span id="filebtn2"><btn:a href="javascript:attachFile('2');" css="basic" mid='attachFile' mdef="첨부"/></span>
							</li>
						</ul>
					</div>
		...
		<div class="hide">
<%--			<script type="text/javascript"> createIBSheet("psnalWelfareLayerSheet1", "100%", "50%", "${ssnLocaleCd}"); </script>--%>
<%--			<script type="text/javascript"> createIBSheet("psnalWelfareLayerSheet2", "100%", "50%", "${ssnLocaleCd}"); </script>--%>
<%--			<script type="text/javascript"> createIBSheet("psnalWelfareLayerSheet3", "100%", "50%", "${ssnLocaleCd}"); </script>--%>
<%--			<script type="text/javascript"> createIBSheet("psnalWelfareLayerSheet4", "100%", "50%", "${ssnLocaleCd}"); </script>--%>
			<div id="psnalWelfareLayerSheet1-wrap"></div>
			<div id="psnalWelfareLayerSheet2-wrap"></div>
			<div id="psnalWelfareLayerSheet3-wrap"></div>
			<div id="psnalWelfareLayerSheet4-wrap"></div>
		</div>
	</div>
</div>
</body>
