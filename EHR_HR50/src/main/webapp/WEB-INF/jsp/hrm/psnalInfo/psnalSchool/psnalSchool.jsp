...
<script type="text/javascript">
	...
	$(function() {
		...
		var initdata1 = {};
		initdata1.Cfg = {SearchMode:smLazyLoad,Page:22,FrozenCol:9};
    ...
    function fileMgrPopup(Row, Col) {
        ...
        let layerModal = new window.top.document.LayerModal({
              id : 'fileMgrLayer'
            , url : '/fileuploadJFileUpload.do?cmd=viewIbFileMgrLayer&authPg=${authPg}&uploadType=school'
            , parameters : {
            ...
            , trigger :[
                {
                    ...
                    , callback : function(result){
						...
						if(result.fileCheck == "exist"){
							sheet1.SetCellValue(Row, "btnFile", '<btn:a css="btn outline_gray thinner" mid='110698' mdef="다운로드"/>');
