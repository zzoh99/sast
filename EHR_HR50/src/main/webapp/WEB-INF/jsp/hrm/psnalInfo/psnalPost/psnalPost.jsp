...
<script type="text/javascript">
	$(function() {
		...
		// 발령항목 조회
		var POST_ITEMS = ajaxCall("${ctx}/PsnalPost.do?cmd=getAppmtItemMapMgrList","searchUseYn=Y",false).DATA;
	...
	$(function() {
		sheet1.SetColHidden("applySeq", 1);
		sheet1.SetColHidden("resignReasonNm", 1);
		
//		sheet1.SetColHidden("jikgubNm", 1);
		sheet1.SetColHidden("jikgubYear", 1);	
	...
	function sheet1_OnClick(Row, Col, Value, CellX, CellY, CellW, CellH) {
		try {
			...
			if(sheet1.ColSaveName(Col) == "processNo" && sheet1.GetCellValue(Row,"processNo") != "") {
		    	var applSabun = sheet1.GetCellValue(Row,"applSabun");
	    		var applSeq = sheet1.GetCellValue(Row,"processNo");
	    		var applInSabun = sheet1.GetCellValue(Row,"applSabun");
