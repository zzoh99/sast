...
<script type="text/javascript">
	...
	function init_sheet() {
		...
		var ccrCd 		   = stfConvCode( codeList("/CommonCode.do?cmd=getCommonCodeList","H90009"), "");
	...
	function sheet1_OnSelectCell(OldRow, OldCol, NewRow, NewCol) {
		$(".detilaDiv").show();
		if(sheet1.GetCellValue(NewRow,"convSabun1Yn") == "Y"){
			chkSabun = "1";
		}
		//1차 면담은 삭제 불가
		if(sheet1.GetCellValue(NewRow,"convSabun2Yn") == "Y"){
			chkSabun = "2";
		}
		...
		if(chkSabun == "1") {
			...
			//2차 상담 내역이 있을경우 입력버튼 비활성화
			/*
			if(sheet1.GetCellValue(NewRow,"retInterview2Yn") == "N") {
				$("#insInsertBtn").show();
				$("#insSaveBtn").show();
			} else {
				$("#insInsertBtn").hide();
		...
		if(statusCd == "99"){
			...
			$("#insInsertBtn").addClass("hide");
			$("#insSaveBtn").addClass("hide");
		}
...
<div class="wrapper">
	<form id="sheet1Form" name="sheet1Form" >
		<input id="retInterviewCd" name="retInterviewCd" type="hidden" value="2"/>
	...
	<table style="width:100%;table-layout: fixed;">
		...
		<tr>
			...
			<td class="detilaDiv" style="vertical-align: top;display:none;">
				<div style="position:absolute;top:120px;right:0px;bottom:0;width:540px;height:calc(100vh - 114px); padding:5px; border:1px solid #e3e3e3; overflow-y: auto;">
