...
<script type="text/javascript">
	...
	$(function() {
        ...
        const modal = window.top.document.LayerModalUtility.getModal('recBasicInfoRegIfLayer');
	...
	function getStfApplList() {		
        ...
        const modal = window.top.document.LayerModalUtility.getModal('recBasicInfoRegIfLayer');
        modal.fire('recBasicInfoRegIfTrigger', returnValue).hide();  
...
<body class="bodywrap">
    ...
    <div class="wrapper modal_layer">
        ...
        <div class="modal_footer">
	        ...
	        <a href="javascript:getStfApplList();" class="btn filled">가져오기</a>
        </div>
    </div>
</body>
</html>