...
<script type="text/javascript">
    ...
    $(function() {
        const modal = window.top.document.LayerModalUtility.getModal('recBasicInfoRegUploadLayer');
        ...
        var initdata1 = {};
        initdata1.Cfg = {FrozenCol:3,SearchMode:smLazyLoad,Page:22, AutoFitColWidth:'init|search|resize|rowtransaction'};
        ...
        $(window).smartresize(sheetResize); sheetInit();sheet1.SetSheetHeight(350);
    });
