...
<!DOCTYPE html> <html class="hidden"><head> <title><tit:txt mid='112882' mdef='사우회관리'/></title>
...
var pGubun = "";
	...
	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"직책",				Type:"Text",   	Hidden:0,	Width:60,	Align:"Center",	ColMerge:0,	SaveName:"jikchakNm",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },

			{Header:"가입일",				Type:"Date",	Hidden:0,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"sdate",			KeyField:1,	Format:"Ymd",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:10 },
			{Header:"탈퇴일",				Type:"Date",	Hidden:0,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"edate",			KeyField:0,	Format:"Ymd",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:10 },
			{Header:"사우회직책",			Type:"Combo",	Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"accJikchakCd",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:10 },
			{Header:"임명일",				Type:"Date",	Hidden:0,	Width:90,	Align:"Center",	ColMerge:0,	SaveName:"appointYmd",		KeyField:0,	Format:"Ymd",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:10 },
			{Header:"사우회비\n공제여부",	Type:"CheckBox",Hidden:0,	Width:80,	Align:"Center",	ColMerge:0,	SaveName:"payDeductYn",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:1,	TrueValue:"Y", FalseValue:"N"},
		...
		var userCd1 = convCode( codeList("${ctx}/CommonCode.do?cmd=getCommonCodeList","H90012"), "<tit:txt mid='103895' mdef='전체'/>");
		sheet1.SetColProperty("accJikchakCd", 		{ComboText:"|"+userCd1[0], ComboCode:"|"+userCd1[1]} );
...
//		$("#searchEdate").val("${curSysYyyyMMHyphen}-31") ;
	...
	function doAction1(sAction) {
		...
		case "Search":
			...
			var sXml = sheet1.GetSearchData("${ctx}/EmpAccMgr.do?cmd=getEmpAccMgrList", $("#sheet1Form").serialize() );
		...
		case "Save":
			...
			sheet1.DoSave( "${ctx}/EmpAccMgr.do?cmd=saveEmpAccMgr" ,$("#sheet1Form").serialize());
			break;
		case "Down2Excel":
		...
		case "DownTemplate":
			// 양식다운로드
			sheet1.Down2Excel({ SheetDesign:1, Merge:1, DownRows:"0", DownCols:"4|8|9|10|11|12|13"});
			break;
		case "LoadExcel":
			// 업로드
			var params = {};
...
<div class="wrapper">
	...
	<div class="inner">
		...
		<ul>
			<li class="txt"><tit:txt mid='112882' mdef='사우회관리'/></li>
			<li class="btn">
