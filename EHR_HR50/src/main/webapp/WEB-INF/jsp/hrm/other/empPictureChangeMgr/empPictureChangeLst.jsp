...
<script type="text/javascript">
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"부서명",		Type:"Text",	Hidden:0,   Width:80,   Align:"Center", ColMerge:0, SaveName:"orgNm",   	KeyField:0, Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:100 },			
			...
			{Header:"",				Type:"Text",   	Hidden:1,   Width:10,  	Align:"Center", ColMerge:0, SaveName:"applStatusCdTmp",KeyField:0, Format:"",  PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
			{Header:"",			Type:"Text",	Hidden:1,   Width:50,   Align:"Center", ColMerge:0, SaveName:"imageType",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
			{Header:"",			Type:"Text",	Hidden:1,   Width:50,   Align:"Center", ColMerge:0, SaveName:"fileSeq",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
			{Header:"",			Type:"Text",	Hidden:1,   Width:50,   Align:"Center", ColMerge:0, SaveName:"seqNo",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
			{Header:"",			Type:"Text",	Hidden:1,   Width:50,   Align:"Center", ColMerge:0, SaveName:"fileSeq",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
			{Header:"",			Type:"Text",	Hidden:1,   Width:50,   Align:"Center", ColMerge:0, SaveName:"seqNo",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
			{Header:"",			Type:"Text",	Hidden:1,   Width:50,   Align:"Center", ColMerge:0, SaveName:"curFileSeq",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
			{Header:"",			Type:"Text",	Hidden:1,   Width:50,   Align:"Center", ColMerge:0, SaveName:"curSeqNo",  		KeyField:0, Format:"",  PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
	...
	function setPageDisable(cmd){
		...
		$("._hideArea").hide();
		$("#searchSabun").val("<%=(String)session.getAttribute("ssnSabun")%>");
				...
				<div class="inner">
					<div class="sheet_title">
						<ul>
							...
							<li class="btn _hideArea">
								<table><tr>
								<td><a href="javascript:doAction2('Accept')" class="basic authA">반영</a></td>
								<td><a href="javascript:doAction2('Reject')" 	class="basic authA">반려</a></td>
								</tr></table>
