...
<!DOCTYPE html> <html class="hidden"><head><title>담당직무승인</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#searchApplStatusCd, #searchJobCd").on("change", function(e) {
			doAction1("Search");
		});
	...
	function init_sheet(){ 
		...
		initdata1.HeaderMode = {Sort:1,ColMove:1,ColResize:1,HeaderCheck:0};
  		initdata1.Cols = [
			...
			//신청내용
			{Header:"대표직무|대표직무",				Type:"Combo",	Hidden:0,	Width:120,	Align:"Center",	ColMerge:0,	SaveName:"jobCd",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search":
			var sXml = sheet1.GetSearchData("${ctx}/JobRegApr.do?cmd=getJobRegAprList", $("#sheet1Form").serialize() );
			sXml = replaceAll(sXml,"shtcolEdit", "Edit");
			sheet1.LoadSearchData(sXml);
			break;
		case "Save":
			IBS_SaveName(document.sheet1Form,sheet1);
			sheet1.DoSave( "${ctx}/JobRegApr.do?cmd=saveJobRegApr" ,$("#sheet1Form").serialize());
			break;
        case "Down2Excel":
...
<div class="wrapper">
	...
	<div class="sheet_search outer">
		...
		<tr>
			...
			<th>대표직무</th>
			<td>
				<select id="searchJobCd" name="searchJobCd"></select>
			</td>
			<td>
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li id="txt" class="txt">담당직무승인</li> 
				<li class="btn">
					<a href="javascript:doAction1('Down2Excel');" 	class="btn outline-gray authR">다운로드</a>
					<a href="javascript:doAction1('Save');" 	class="btn filled authR">저장</a>
				</li>
			</ul>
		</div>
	</div>
