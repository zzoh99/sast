...
<script type="text/javascript">
	...
	function doAction1(sAction) {
		switch(sAction){
			case "Search":	//조회
				...
				searchTitleList();
				sheet1.DoSearch("${ctx}/HrmEmpJikgubSta.do?cmd=getHrmEmpJikgubStaList", $("#srchFrm").serialize());
			break;
	...
	function searchTitleList() {
		// 직군별 인원현황 Title 다건 조회
		var titleList     = ajaxCall("${ctx}/HrmEmpJikgubSta.do?cmd=getHrmEmpJikgubStaTitleList", $("#srchFrm").serialize(), false);
		...
		if (titleList != null && titleList.DATA != null) {
			...
			var initdata = {};
			initdata.Cfg = {FrozenCol:5,SearchMode:smLazyLoad,Page:22,MergeSheet:7};
			...
			initdata.Cols[v++] = {Header:"직위|직위",	Type:"Text",	 Hidden:0,					 Width:100,			Align:"Center",	ColMerge:0,	SaveName:"jikweeNm",   KeyField:0,	Format:"", PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 };
			initdata.Cols[v++] = {Header:"직책|직책",	Type:"Text",	 Hidden:0,					 Width:100,			Align:"Center",	ColMerge:0,	SaveName:"jikchakNm",  KeyField:0,	Format:"", PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 };
			initdata.Cols[v++] = {Header:"직급|직급",	Type:"Text",	 Hidden:0,					 Width:100,			Align:"Center",	ColMerge:0,	SaveName:"jikgubNm",   KeyField:0,	Format:"", PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 };
			...
			sheet1.SetMergeCell(lr, 0, 1, 5);
			sheet1.SetCellAlign(lr, 0, "Center");
			
        	//소계 추가
        	var info = [{StdCol:"workTypeNm" , SumCols:sumColsInfo, CaptionCol:"workTypeNm"}];
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt">직군별 인원현황</li>
							<li class="btn">
