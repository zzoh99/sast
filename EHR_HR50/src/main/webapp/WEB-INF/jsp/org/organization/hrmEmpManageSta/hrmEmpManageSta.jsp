...
<script type="text/javascript">
	...
	function doAction1(sAction) {
		switch(sAction){
			case "Search":	//조회
				...
				searchTitleList();
				sheet1.DoSearch("${ctx}/HrmEmpManageSta.do?cmd=getHrmEmpManageStaList", $("#srchFrm").serialize());
			break;
	...
	function searchTitleList() {
		...
		var titleList     = ajaxCall("${ctx}/HrmEmpManageSta.do?cmd=getHrmEmpManageStaTitleList", $("#srchFrm").serialize(), false);
		...
		if (titleList != null && titleList.DATA != null) {
			...
			initdata.Cols[v++] = {Header:"구분|구분",	Type:"Text",	 Hidden:0,					 Width:100,			Align:"Center",	ColMerge:0,	SaveName:"manageNm",   KeyField:0,	Format:"", PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 };
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt">사원구분별 인원현황</li>
							<li class="btn">
