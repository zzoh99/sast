...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"<sht:txt mid='BLANK'       mdef='TRM구분코드'	 />", Type:"Text"     , Hidden:0, Width:15,   Align:"Center", ColMerge:0, SaveName:"trmGubunCd", KeyField:0, CalcLogic:"", Format:"", PointCount:0, UpdateEdit:0, InsertEdit:0, EditLen:1000 },
			{Header:"<sht:txt mid='BLANK'       mdef='TRM구분명'	 />", Type:"Text"     , Hidden:0, Width:100,  Align:"Left"  , ColMerge:0, SaveName:"trmGubunNm", KeyField:0, CalcLogic:"", Format:"", PointCount:0, UpdateEdit:1, InsertEdit:1, EditLen:1000 }
		...
		$("#searchTrmGubunNm").bind("keyup",function(event){
	...
	function doAction1(sAction) {
		switch (sAction) {
			case "Search": //조회
				sheet1.DoSearch("${ctx}/TrmCdMgr.do?cmd=getTrmCdMgrList", $("#srchFrm").serialize());
				break;
			case "Save": //저장
				if(!dupChk(sheet1,"trmGubunCd", true, true)){break;}
				IBS_SaveName(document.srchFrm, sheet1);
				sheet1.DoSave("${ctx}/TrmCdMgr.do?cmd=saveTrmCdMgrList", $("#srchFrm").serialize());
				break;
			case "Insert": //입력
		...
		<div class="sheet_search outer">
			<div>
				<table>
					<tr>
						<th>TRM구분명</th>
						<td>  <input id="searchTrmGubunNm" name ="searchTrmGubunNm" type="text" class="text w100" /> </td>
			...
			<td>
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li id="txt" class="txt"><tit:txt mid='BLANK' mdef='TRM코드'/></li>
							<li class="btn">
