...
<script type="text/javascript">
	...
	$(function(){
		...
		]; IBS_InitSheet(sheet9, initdata);sheet9.SetEditable("${editable}");sheet9.SetVisible(true);sheet9.SetCountPosition(4);sheet9.SetImageList(0,"${ctx}/common/images/icon/icon_popup.png");sheet9.SetImageList(1,"${ctx}/common/images/icon/icon_o.png");sheet9.SetImageList(2,"${ctx}/common/images/icon/icon_x.png");
				...
				<table class="table">
					...
					<tr>
						...
						<td>
							...
							<a onclick="javascript:orgSearchPopup();return false;" href="#" class="button6 authA"><img src="/common/${theme}/images/btn_search2.gif"/></a>
						</td>
					</tr>
					<tr>
