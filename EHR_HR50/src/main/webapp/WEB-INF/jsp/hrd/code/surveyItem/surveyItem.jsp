...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"<sht:txt mid='surveyItemNm'        mdef='항목명'  />" ,Type:"Text"      ,Hidden:0                    ,Width:150           ,Align:"Center" ,ColMerge:0 ,SaveName:"surveyItemNm"   ,KeyField:1 ,UpdateEdit:1 ,InsertEdit:1 ,EditLen:0  ,MultiLineText:0         ,PointCount:0  ,CalcLogic:""         ,Format:""         , },
			...
			{Header:"<sht:txt mid='surveyItemDesc'      mdef='설명'    />" ,Type:"Text"      ,Hidden:0                    ,Width:300           ,Align:"Center" ,ColMerge:0 ,SaveName:"surveyItemDesc" ,KeyField:0 ,UpdateEdit:1 ,InsertEdit:1 ,EditLen:0  ,MultiLineText:0         ,PointCount:0  ,CalcLogic:""         ,Format:""         , },
			{Header:"<sht:txt mid='seq'        			mdef='순번'    />" ,Type:"Int"       ,Hidden:0                    ,Width:50            ,Align:"Center" ,ColMerge:0 ,SaveName:"seq"            ,KeyField:0 ,UpdateEdit:1 ,InsertEdit:1 ,EditLen:0  ,MultiLineText:0         ,PointCount:0  ,CalcLogic:""         ,Format:""         , },
			...
			{Header:"<sht:txt mid='surveyItemCd'        mdef='surveyItemCd'        />" ,Type:"Text"      ,Hidden:1                    ,Width:50            ,Align:"Center" ,ColMerge:0 ,SaveName:"surveyItemCd"   ,KeyField:0 ,UpdateEdit:0 ,InsertEdit:0 ,EditLen:0  ,MultiLineText:0         ,PointCount:0  ,CalcLogic:""         ,Format:""         , },
		];
	...
	function doAction1(sAction){
		switch (sAction) {
			case "Search":
				var params = "searchSurveyItemNm=" + $("#searchSurveyItemNm").val() ;

				sheet1.DoSearch( "${ctx}/SurveyItem.do?cmd=getSurveyItemList", params);

				break;

			case "Save":
				IBS_SaveName(document.sheet1Form,sheet1);
				sheet1.DoSave( "${ctx}/SurveyItem.do?cmd=saveSurveyItem", $("#sheet1Form").serialize());
				break;
...
<div class="wrapper">
			...
			<div>
				<table>
					<tr>
						...
						<td>
							<input id="searchSurveyItemNm" name="searchSurveyItemNm" type="Text" class="text" />
						</td>
						<td>
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				<li id="txt1" class="txt"><tit:txt mid='' mdef='설문항목코드(CDP)'/></li>
				<li class="btn">
