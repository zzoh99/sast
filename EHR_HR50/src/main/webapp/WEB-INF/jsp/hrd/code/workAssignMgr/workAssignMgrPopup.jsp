...
// 			{Header:"<sht:txt mid='sStatus' mdef='상태'/>",		Type:"${sSttTy}",	Hidden:Number("${sSttHdn}"),Width:"${sSttWdt}",	Align:"Center",	ColMerge:0,	SaveName:"sStatus",	Sort:0 },
			{Header:"<sht:txt mid='authScopeCd' mdef='직무코드'/>",		Type:"Text",		Hidden:0,	Width:70,	Align:"Center",	ColMerge:0,	SaveName:"jobCd",		KeyField:0,	Format:"",	CalcLogic:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:10 },
			{Header:"<sht:txt mid='codeNm' mdef='직무명'/>",		Type:"Text",		Hidden:0,	Width:300,	Align:"Left",	ColMerge:0,	SaveName:"jobNm",		KeyField:0,	Format:"",	CalcLogic:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
// 			{Header:"<sht:txt mid='memoV4' mdef='메모'/>",		Type:"Text",		Hidden:1,	Width:130,	Align:"Left",	ColMerge:0,	SaveName:"memo",		KeyField:0,	Format:"",	CalcLogic:"",	PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 }
...
// 		$('#gubun').val(gubun);
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search": //조회
		    sheet1.DoSearch("${ctx}/GetDataList.do?cmd=getWorkAssignMgrPopupList", $("#sheet1Form").serialize());
            break;
	...
	function returnFindUser(Row,Col){
    	...
    	var returnValue = new Array(1);
 		returnValue["jobCd"] = sheet1.GetCellValue(Row,"jobCd");
 		returnValue["jobNm"] = sheet1.GetCellValue(Row,"jobNm");
...
<body class="bodywrap">
    <div class="wrapper">
        <div class="popup_title">
            <ul>
                <li><tit:txt mid='schLic' mdef='직무검색'/></li>
                <li class="close"></li>
            </ul>
        </div>
...
<!-- 				<input id="gubun" name="gubun" type="hidden" value=""> -->
                <div class="sheet_search outer">
                    ...
                    <table>
                    <tr>
						<th><tit:txt mid='104225' mdef='직무명'/></th>
                        <td>
                        	<input id="jobNm" name ="jobNm" type="text" class="text" style="ime-mode:active;" />
                        </td>
                        <td>
	        ...
	        <table border="0" cellspacing="0" cellpadding="0" class="sheet_main">
	            <tr>
	                ...
	                <div class="inner">
	                    ...
	                    <ul>
	                        <li id="txt" class="txt"><tit:txt mid='112832' mdef='직무조회'/></li>
