...
<script type="text/javascript">
	...
	$(function() {
		...
		initdata.Cols = [
			...
			{Header:"<sht:txt mid='activeStartYmd'    mdef='activeStartYmd'		/>", Type:"Date"     , Hidden:1                  , Width:50          , Align:"Center", ColMerge:0, SaveName:"activeStartYmd"   , KeyField:0, UpdateEdit:0, InsertEdit:0, EditLen:0, MultiLineText:0, PointCount:0, CalcLogic:"", Format:"" },
		...
		initdata.Cols = [
			...
			{Header:"<sht:txt mid='useMonth'      mdef='사용개월수'			/>", Type:"Int"      , Hidden:0                   , Width:80          , Align:"Center", ColMerge:0, SaveName:"useMonth"     , KeyField:0, UpdateEdit:1, InsertEdit:0, EditLen:0, MultiLineText:0, PointCount:0, CalcLogic:"", Format:"" },
			{Header:"<sht:txt mid='ratingGrade'   mdef='평가등급'			/>", Type:"Combo"    , Hidden:0                   , Width:100         , Align:"Center", ColMerge:0, SaveName:"ratingGrade"  , KeyField:0, UpdateEdit:1, InsertEdit:0, EditLen:0, MultiLineText:0, PointCount:0, CalcLogic:"", Format:"" },
			{Header:"<sht:txt mid='modifyGrade'   mdef='수정등급'			/>", Type:"Combo"    , Hidden:0                   , Width:100         , Align:"Center", ColMerge:0, SaveName:"modifyGrade"  , KeyField:0, UpdateEdit:0, InsertEdit:0, EditLen:0, MultiLineText:0, PointCount:0, CalcLogic:"", Format:"" },
			{Header:"<sht:txt mid='modifyDesc'    mdef='수정사유'			/>", Type:"Text"     , Hidden:0                   , Width:230         , Align:"Left"  , ColMerge:0, SaveName:"modifyDesc"   , KeyField:0, UpdateEdit:0, InsertEdit:0, EditLen:0, MultiLineText:0, PointCount:0, CalcLogic:"", Format:"" },
		...
		initdata.Cols = [
			...
			{Header:"<sht:txt mid='ratingGrade'      mdef='평가등급'			/>", Type:"Combo"    , Hidden:0                   , Width:50          , Align:"Center", ColMerge:0, SaveName:"ratingGrade"     , KeyField:0, UpdateEdit:1, InsertEdit:0, EditLen:0, MultiLineText:0, PointCount:0, CalcLogic:"", Format:"" },
			{Header:"<sht:txt mid='modifyGrade'      mdef='수정등급'			/>", Type:"Combo"    , Hidden:0                   , Width:50          , Align:"Center", ColMerge:0, SaveName:"modifyGrade"     , KeyField:0, UpdateEdit:0, InsertEdit:0, EditLen:0, MultiLineText:0, PointCount:0, CalcLogic:"", Format:"" },
			{Header:"<sht:txt mid='modifyDesc'       mdef='수정사유'			/>", Type:"Text"     , Hidden:0                   , Width:50          , Align:"Center", ColMerge:0, SaveName:"modifyDesc"      , KeyField:0, UpdateEdit:0, InsertEdit:0, EditLen:0, MultiLineText:0, PointCount:0, CalcLogic:"", Format:"" },
			{Header:"<sht:txt mid='sDelete'          mdef='삭제'				/>", Type:"${sDelTy}", Hidden:Number("${sDelHdn}"), Width:"${sDelWdt}", Align:"Center", ColMerge:0, SaveName:"sDelete"         , Sort:0, HeaderCheck:0},
			{Header:"<sht:txt mid='enterCd'          mdef='회사코드'			/>", Type:"Text"     , Hidden:1                   , Width:50          , Align:"Center", ColMerge:0, SaveName:"enterCd"         , KeyField:0, UpdateEdit:0, InsertEdit:0, EditLen:0, MultiLineText:0, PointCount:0, CalcLogic:"", Format:"" },
			{Header:"<sht:txt mid='priorKnowledgeCd' mdef='priorKnowledgeCd'/>", Type:"Text"     , Hidden:1                   , Width:50          , Align:"Center", ColMerge:0, SaveName:"priorKnowledgeCd", KeyField:0, UpdateEdit:0, InsertEdit:0, EditLen:0, MultiLineText:0, PointCount:0, CalcLogic:"", Format:"" },
			{Header:"<sht:txt mid='knowledgeCd'      mdef='knowledgeCd'		/>", Type:"Text"     , Hidden:1                   , Width:50          , Align:"Center", ColMerge:0, SaveName:"knowledgeCd"     , KeyField:0, UpdateEdit:0, InsertEdit:0, EditLen:0, MultiLineText:0, PointCount:0, CalcLogic:"", Format:"" },
		...
		switch (sAction) {
			case "Search":
				var params = "searchSabun="      + $("#searchUserId").val() +
				             "&searchBeginYear=" + $("#searchBeginYear").val() +
				             "&searchEndYear="   + $("#searchEndYear").val();

				sheet1.DoSearch( "${ctx}/SelfRatingRegist.do?cmd=getSelfRatingRegistList", params);
				break;
			case "Save" :
				IBS_SaveName(document.sheet1Form,sheet1);
				sheet1.DoSave( "${ctx}/SelfRatingRegist.do?cmd=saveSelfRatingRegist", $("#sheet1Form").serialize());
				break;
			case "SaveDetail1":
				for(var r = sheet2.HeaderRows(); r<sheet2.RowCount()+sheet2.HeaderRows(); r++){
					if  ( ( sheet2.GetCellValue(r, "ratingGrade") != "" ) &&
						  ( sheet2.GetCellValue(r, "useMonth"   ) == "" ) ){
						alert("사용개월수를 입력해주세요");
						return;
					}
					if  ( ( sheet2.GetCellValue(r, "ratingGrade") == "" ) &&
				...
				sheet2.DoSave( "${ctx}/SelfRatingRegist.do?cmd=saveSelfRatingRegistDetail1", $("#sheet2Form").serialize());
				break;
			case "SaveDetail2":
				IBS_SaveName(document.sheet3Form,sheet3);
				sheet3.DoSave( "${ctx}/SelfRatingRegist.do?cmd=saveSelfRatingRegistDetail2", $("#sheet3Form").serialize());
				break;
			case "SaveDetail3":
				IBS_SaveName(document.sheet4Form,sheet4);
				sheet4.DoSave( "${ctx}/SelfRatingRegist.do?cmd=saveSelfRatingRegistDetail3", $("#sheet4Form").serialize());
				break;
			case "SearchDetail1":
				sheet2.DoSearch( "${ctx}/SelfRatingRegist.do?cmd=getSelfRatingRegistDetailList1", GetSearchParams());
				break;
			case "SearchDetail2":
				sheet3.DoSearch( "${ctx}/SelfRatingRegist.do?cmd=getSelfRatingRegistDetailList2", GetSearchParams());
				break;
			case "SearchDetail3":
				sheet4.DoSearch( "${ctx}/SelfRatingRegist.do?cmd=getSelfRatingRegistDetailList3", GetSearchParams());
				break;
		}
	}
	...
	var TrySave = function(){
		sheet1.SetCellValue(sheet1.GetSelectRow(), "approvalStatus", "9");
		doAction1("Save");
	}

	var TryRequestApproval = function(){
	...
	var TryCancelApproval = function(){
		sheet1.SetCellValue(sheet1.GetSelectRow(), "approvalStatus", "2");
		doAction1("Save");
	}
	...
	<div class="inner">
		<div class="sheet_title">
			<ul>
				...
				<li class="btn">
					년도 <input id="searchBeginYear" name="searchBeginYear" type="text"  maxlength="4" class="text required center date" value="${curSysYear}"/> ~
					<input id="searchEndYear" name="searchEndYear" type="text"  maxlength="4" class="text required center date" value="${curSysYear}"/>
					<btn:a href="javascript:doAction1('Search');"  id='btnSearch'        mid='110697'           css='btn dark'  mdef="조회"     />
					<btn:a href="javascript:TrySave();"            id='btnSave'          mid='110708'           css='btn soft' mdef="저장"     />
					<btn:a href="javascript:TryRequestApproval();" id='btnRequest'       mid='110787'           css='btn filled' mdef="승인요청" />
					<btn:a href="javascript:TryCancelApproval();"  id='btnCancelRequest' mid='btnCancelRequest' css='btn outline' mdef="요청취소" />
				</li>
			</ul>
		</div>
	</div>
	<script type="text/javascript">createIBSheet("sheet1", "100%", "50%", "${ssnLocaleCd}"); </script>
	<div id="tabs" class="mat20" style="width: 100%;">
			...
			<div>
				...
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li class="btn">
								<btn:a href="javascript:doAction1('SearchDetail1');" id='btnSearchDetail1' mid='110697' css='btn dark' mdef="조회"/>
								<btn:a href="javascript:doAction1('SaveDetail1');"   id='btnSaveDetail1'   mid='110708' css='btn soft' mdef="저장"/>
							</li>
						</ul>
					</div>
				</div>
				<script type="text/javascript">createIBSheet("sheet2", "100%", "48%", "${ssnLocaleCd}"); </script>
			</div>
		</div>
		<div id="tabs-2">
			<div>
				...
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li class="btn">
								<btn:a href="javascript:doAction1('SearchDetail2');" id='btnSearchDetail2' mid='110697' css='btn dark' mdef="조회"/>
								<btn:a href="javascript:doAction1('SaveDetail2');"   id='btnSaveDetail2'   mid='110708' css='btn soft' mdef="저장"/>
							</li>
						</ul>
					</div>
				</div>
			...
			<div>
				...
				<div class="inner">
					<div class="sheet_title">
						<ul>
							<li class="btn">
								<btn:a href="javascript:doAction1('SearchDetail3');" id='btnSearchDetail3' mid='110697' css='btn dark' mdef="조회"/>
								<btn:a href="javascript:doAction1('SaveDetail3');"   id='btnSaveDetail3'   mid='110708' css='btn soft' mdef="저장"/>
							</li>
						</ul>
					</div>
				</div>
