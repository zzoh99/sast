...
<div class="body">
	...
	-->
	<form name="srchFrm" id="srchFrm" action="http://posttestserver.com/post.php" method="post" accept-charset="utf-8">
...
*/
	...
	function resizeEditor() {
		var minusHeight = "<%=request.getParameter("height")%>";
		if(minusHeight !="") {
			var baseHeight = $(document).height()- minusHeight ;
		}else{
			baseHeight = 250;
		}
