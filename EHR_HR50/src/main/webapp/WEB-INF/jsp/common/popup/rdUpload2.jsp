...
<script type="text/javascript">
	...
	function saveEndEvent(szFileName, FileType){
			var success = Rdviewer.UploadDataFileEx (szFileName, szFileName, "<%=baseIP%><%=basePort%>/DataServer/uploadf.jsp");
			if (success==true)   {
			...
			if(_tempCount !=0 && (_tempCount ==_tempLen))
				alert(_tempCount+ "개의 파일이 업로드 되었습니다. ");
	}
        ...
        <div class="popup_main">
			<div class="explain">
				...
				<ul>
					...
					<li><a href="javascript:" id="btnJob" class="button"><tit:txt mid='112940' mdef='작업'/></a> </li>
				</ul>
				</div>
			</div>
