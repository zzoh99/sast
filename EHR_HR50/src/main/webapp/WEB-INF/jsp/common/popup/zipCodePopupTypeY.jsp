...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var wid = p.window.document.body.offsetWidth;
		var hei = p.window.document.body.offsetHeight;        //30 과 40은 넉넉하게 하려는 임의의 값임
		
		// 최초 팝업창 사이즈가 작은 경우 팝업창 크기 조절함.
		if( wid < 1050 || hei < 780 ) {
			p.window.resizeTo(1050, 780);
		}
