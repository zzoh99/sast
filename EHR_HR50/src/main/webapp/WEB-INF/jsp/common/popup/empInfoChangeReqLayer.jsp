...
<script type="text/javascript">
    ...
    $(function() {
        ...
        const modal = window.top.document.LayerModalUtility.getModal('empInfoChangeReqLayer');
        ...
        if(arg.empTable == "thrm124") {
            ...
            && arg.transType!="D") {
                ...
                if(arg.transType == "D") $("#contType").attr('disabled', true);
                ...
                $("select[name='contType']").change(function() {
                    if(this.value == "GP1") { // 연락처의 비상연락망관계
                        ...
                        var selectHtml  = "<select id='contAddress' name='contAddress' style='min-width:150px;'" + disabled + "'>";
...
//                codeLists = null;
    ...
    function empInfoPopup(objid, popuptype){
        ...
        switch(popuptype){
            case "POST":
                ...
                // 영문 주소 입력인 경우
                if(arg.empTable.toUpperCase() === 'THRM123' && $("#addType").val() === '4')
    ...
    function getReturnValue(rv) {
        ...
        if(empInfo.popupType == "POST"){
            ...
            if(arg.empTable.toUpperCase() === 'THRM123') {
                if($("#addType").val() === '4') {
                    // 영문주소 입력인 경우
    ...
    function doEmpInfoChangeReqLayerAction1(sAction){
        switch (sAction) {
            case "Save":
                //1. 필수항목 체크
                var isValid = true;
                ...
                if(isValid){
                    var result = ajaxCall2("${ctx}/PsnalBasicInf.do?cmd=saveEmpInfoReq",$("#empForm").serialize(),true
                            ...
                            ,function(data){
                                ...
                                if(data.Result.Code>0) closeCommonLayer('empInfoChangeReqLayer');
                            }
...
<body class="bodywrap">
    <div class="wrapper modal_layer">
        ...
        <div class="modal_footer">
            <a href="javascript:doEmpInfoChangeReqLayerAction1('Save');" class="btn filled" id="regBtn" ><tit:txt mid='appComLayout' mdef='신청'/></a>
            <a href="javascript:closeCommonLayer('empInfoChangeReqLayer');" class="btn outline_gray"><tit:txt mid='104157' mdef='닫기'/></a>
	    </div>
    </div>
</body>
</html>
