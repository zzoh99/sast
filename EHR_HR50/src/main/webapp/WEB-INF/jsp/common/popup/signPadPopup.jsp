...
<script type="text/javascript" src="/common/js/signpad/signature_pad.min.js"></script>
<style type="text/css">
body {
/*
...
.basic:hover, a.button:hover {
	color: #323232 !important;
	box-shadow: inset 0 0 0 1000px rgba(50, 50, 50, 0.05);
}
	...
	<div id="signature-pad" class="m-signature-pad">
		...
		<div class="m-signature-pad--footer">
			<table>
				...
				<tr>                
					<td>
						<a id="btnClear" class="basic clear">지우기</a>
					</td>
					<td align="center"><div id="description" class="description">서명을 해주세요.</div></td>
					<td align="right"><a id="btnSave" class="button save">저장</a></td>
				</tr>
			</table>
		</div>
	</div>
    ...
    <script>
		...
		$("#btnSave").bind("click", function(){
			if (sign.isEmpty()) {
				...
				$.ajax({
					url : "/Popup.do?cmd=saveSignPadPopup",
					type : "POST",
					dataType : "json",
					data : {
						sign : sign.toDataURL()
						,searchSabun  : parent.$("#sabun").val()
					},
					success : function(r){
