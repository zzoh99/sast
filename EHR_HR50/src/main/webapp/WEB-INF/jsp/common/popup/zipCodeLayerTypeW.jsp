...
<script language="javascript">
	...
	function setParent(){
        ...
        var rv = {
        		zip:rtZipNo,
        		doroAddr:rtAddrPart1+" "+rtAddrPart2,
        		detailAddr:rtAddrDetail,
        		doroFullAddr:doroFullAddr,
        		resDoroFullAddr:resDoroFullAddr,
        		doroFullAddrEng:doroFullAddrEng,
        		resDoroFullAddrEng:resDoroFullAddrEng
               }

        let modal = window.top.document.LayerModalUtility.getModal('zipCodeLayer');
        modal.fire('zipCodeLayerTrigger', rv).hide();
	}
