...
<script type="text/javascript">
	...
	function doAction1(sAction) {
		switch (sAction) {
		case "Search": //조회
		    sheet1.DoSearch( "${ctx}/Popup.do?cmd=getCommonCodePopupList", $("#sheet1Form").serialize());
            break;
        case "Clear":        //Clear
            sheet1.RemoveAll();
            break;
	...
	function returnFindUser(Row,Col){
    	...
    	var returnValue = new Array(1);
 		...
 		returnValue["memo"] = sheet1.GetCellValue(Row,"memo");
 		returnValue["note1"] = sheet1.GetCellValue(Row,"note1");
 		returnValue["note2"] = sheet1.GetCellValue(Row,"note2");
 		returnValue["note3"] = sheet1.GetCellValue(Row,"note3");
...
<body class="bodywrap">
    <div class="wrapper">
        <div class="popup_title">
            <ul>
                <li><tit:txt mid='114485' mdef='코드검색'/></li>
                <li class="close"></li>
            </ul>
        </div>
