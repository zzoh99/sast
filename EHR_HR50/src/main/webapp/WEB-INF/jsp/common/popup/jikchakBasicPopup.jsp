...
<script type="text/javascript">
	...
	$(function() {
		...
		if( arg != undefined ) {
			...
			if( arg["chooseJikchakCds"] != null && arg["chooseJikchakCds"] != undefined ) {
				chooseJikchakCds = arg["chooseJikchakCds"];
			}
	...
	function mySheet_OnDblClick(Row, Col){
		if(multiSelect == "N") {
			var rv = new Array(9);
			rv["jikchakCd"] 		= mySheet.GetCellValue(Row, "jikchakCd");
			rv["jikchakNm"]			= mySheet.GetCellValue(Row, "jikchakNm");
		...
		<form id="mySheetForm" name="mySheetForm" tabindex="1">
			...
			<div class="sheet_search outer">
				...
				<tr>
					...
					<th>직책명</th>
					<td>  <input id="serachJikchakNm" name ="serachJikchakNm" type="text" class="text" /> </td>
