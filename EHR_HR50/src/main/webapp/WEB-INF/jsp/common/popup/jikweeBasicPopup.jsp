...
<script type="text/javascript">
	...
	$(function() {
		...
		if( arg != undefined ) {
			...
			if( arg["chooseJikweeCds"] != null && arg["chooseJikweeCds"] != undefined ) {
				chooseJikweeCds = arg["chooseJikweeCds"];
			}
	...
	function mySheet_OnDblClick(Row, Col){
		if(multiSelect == "N") {
			var rv = new Array(9);
			rv["jikweeCd"] 		= mySheet.GetCellValue(Row, "jikweeCd");
			rv["jikweeNm"]			= mySheet.GetCellValue(Row, "jikweeNm");
		...
		<form id="mySheetForm" name="mySheetForm" tabindex="1">
			...
			<div class="sheet_search outer">
				...
				<tr>
					...
					<th>직위명</th>
					<td>  <input id="serachJikweeNm" name ="serachJikweeNm" type="text" class="text" /> </td>
					<!-- <td> <th>보여주기여부 </th> <select id="chkVisualYn" name="chkVisualYn"></td> -->
					<td>
