...
<script type="text/javascript">
	...
	$(function() {
		...
		if( arg != undefined ) {
			...
			if( arg["chooseJikgubCds"] != null && arg["chooseJikgubCds"] != undefined ) {
				chooseJikgubCds = arg["chooseJikgubCds"];
			}
	...
	function mySheet_OnDblClick(Row, Col){
		if(multiSelect == "N") {
			var rv = new Array(9);
			rv["jikgubCd"] 		= mySheet.GetCellValue(Row, "jikgubCd");
			rv["jikgubNm"]			= mySheet.GetCellValue(Row, "jikgubNm");
		...
		<form id="mySheetForm" name="mySheetForm" tabindex="1">
			...
			<div class="sheet_search outer">
				...
				<tr>
					...
					<th>직급명</th>
					<td>  <input id="serachJikgubNm" name ="serachJikgubNm" type="text" class="text" /> </td>
