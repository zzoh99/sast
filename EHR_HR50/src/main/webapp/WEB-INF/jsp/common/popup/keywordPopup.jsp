...
<style>
#keywordHeader { left:0; top:0; width:100%; min-width:900px; height:50px !important;  background:url("../images/main/top_bg.png") left top repeat-x; font-size:12px; z-index:110; letter-spacing: 0px !important; }
...
#keywordHeader .header_wrap .member_search { float: left; position: relative; margin: 7px 0 7px 10px; width:97%; }
...
<script type="text/javascript">
	...
	function reqFullScreen() {
		// 창 가장 왼쪽 상단으로 이동
		p.self.moveTo(0,0);
		// 폭과 높이 가능한 최대 사이즈로 세팅
		p.self.resizeTo(screen.availWidth, screen.availHeight);
	}
</script>
