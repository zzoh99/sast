...
<div id="fileDiv" class="mat10" style="height: 95%">
					...
					<div class="sheet_title" style="overflow: hidden;">
						<ul>
							...
							<li class="btn">
								...
								<btn:a href="javascript:doIBUAction('downloadAll')"  css="btn outline-gray " mid='' mdef="전체다운로드"/>
								<btn:a href="javascript:doIBUAction('download')"  	 css="btn outline-gray " mid='' mdef="다운로드"/>
								<btn:a href="javascript:doIBUAction('delete');"   	 css="btn outline-gray authA" mid='' mdef="파일삭제"/>
								<btn:a href="javascript:doIBUAction('add')" 	     css="btn filled authA" mid='' mdef="추가"/>
							</li>
						</ul>
					</div>
				</div>
				<div class="ib_product1" style="width: 100%;height:100%;">
					<!--main_content-->
