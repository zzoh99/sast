...
<script type="text/javascript">
	$(function() {
		createIBSheet3(document.getElementById('mysheet_wrap'), "mySheet", "100%", "100%","${ssnLocaleCd}");
	...
	function mySheet_OnDblClick(Row, Col){
		var rv = {
			mapTypeCd: mySheet.GetCellValue(Row, "mapTypeCd"),
			mapCd: mySheet.GetCellValue(Row, "mapCd"),
			mapNm: 	mySheet.GetCellValue(Row, "mapNm")
		}

		var modal = window.top.document.LayerModalUtility.getModal('orgMappingItemLayer');
		modal.fire('orgMappingItemLayerTrigger', rv).hide();
	}
...
<body class="bodywrap">
	<div class="wrapper modal_layer">
		...
		<div class="modal_footer">
			<a href="javascript:closeCommonLayer('orgMappingItemLayer');" class="btn outline_gray"><tit:txt mid='104157' mdef='닫기'/></a>
		</div>
</div>
</body>
</html>
