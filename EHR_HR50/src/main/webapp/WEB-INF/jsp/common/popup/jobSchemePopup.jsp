...
<script type="text/javascript">
	...
	$(function() {
        ...
        if( arg["searchJobType"] && arg["searchJobType"] != null && arg["searchJobType"] != "" ) {
	...
	function jobMgrPopup(Row){
		...
		var args 	= new Array();
		args["jobCd"] 		= mySheet.GetCellValue(Row, "jobCd");
	...
	function findJob(){
	    ...
	    var Row = 0;
	    if(mySheet.GetSelectRow() < mySheet.LastRow()){
	        Row = mySheet.FindText("jobNm", $("#findJob").val(), mySheet.GetSelectRow()+1, 2,false);

	    }else{
	        Row = -1;
	    }

	    mySheet.SelectCell(Row,"jobNm");
