...
var orgObj = {
	            ...
	            onClick : function(evt) {
	            	...
	            	if (evt.isNode || evt.isField || evt.isMember) {
		            	...
		            	var rdPopup = function(pEnterCd, pSabun) {
	            	        ...
	            	        rdParam += "[,('" + pEnterCd + "','" + pSabun + "')]";  // 1.회사코드 및 사번
		            	...
		            	var showUserPopup = function(pDeptcd, pSdate) {
	            		    ...
	            		    openPopup("/SpecificEmpSrch.do?cmd=viewSrchResultPopup&authPg=R", args, "1300", "700");
		            	};
	...
	sheetToOrg : function(Row) {
		...
		var setData = function(obj) {
			...
			obj.memberList.forEach(arg => {
				arg["photo"] = baseURL + "/EmpPhotoOut.do?enterCd=" + arg["enterCd"] + "&searchKeyword=" + arg["sabun"];
				// arg['deptnm'] = arg["deptNm"];
				// arg['deptcd'] = arg["deptCd"];
				arg['deptnm'] = deptNm;
				arg['deptcd'] = deptCd;
				arg['empnm'] = arg["name"];
				arg['position'] = arg["jikweeNm"];
				arg['empcd'] = arg["sabun"];
				arg['title'] = arg["jikchakNm"];
				arg['inline'] = "";
				arg['hp'] = arg["handPhone"];
				arg['email'] = arg["mailId"];
				arg['empnmpos'] = arg["name"] + " " + arg["jikweeNm"];
			})

			var convert = JSON.stringify(obj.memberList);
			var memberlist = convert; 					// 조직원
			...
			orgJson.fields['memberlist'] = memberlist;
			...
			*/
			...
			//console.log('orgJson', orgJson, 'obj', obj);
