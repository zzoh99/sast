...
TrexConfig.addTool(
	"fontfamily", 
	{
		...
		options: [
			...
			{ label: TXMSG('@fontfamily.dotum')+' (<span class="tx-txt">가나다라</span>)', title: TXMSG('@fontfamily.dotum'), data: 'Dotum,돋움 !important', klass: 'tx-dotum' },
...
{ label: ' 맑은고딕 (<span class="tx-txt">가나다라</span>)', title: '맑은고딕', data: '맑은 고딕,Malgun Gothic,AppleGothic,sans-serif', klass: 'tx-malgun-gothic' },
