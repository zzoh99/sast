 ...
 */
@Controller
@RequestMapping(value="/WtmPsnlWeekWorkSta.do", method=RequestMethod.POST )
public class WtmPsnlWeekWorkStaController extends ComController {
	/**
	 * 개인별주근무현황 서비스
	 */
	@Inject
	@Named("WtmPsnlWeekWorkStaService")
	private WtmPsnlWeekWorkStaService wtmPsnlWeekWorkStaService;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params="cmd=viewWtmPsnlWeekWorkSta", method = {RequestMethod.POST, RequestMethod.GET} )
	public String viewPsnlWeekWorkSta() throws Exception {
		return "wtm/stats/wtmPsnlWeekWorkSta/wtmPsnlWeekWorkSta";
	}
