...
public class FrontLoginController {
    ...
    @RequestMapping(value="/getLoginEnterList", method=RequestMethod.POST )
    ...
    public Map<String, Object> menu(
        ...
        Map<String, Object> result = new HashMap<>();
        result.put("mainMajorMenuList", mainMajorMenuList);
        Log.DebugEnd();
        return result;
    }
...
//            //파라미터 정보를 임시로 세션에 담아 놓음.
            ...
            String token = setJwtToken(paramMap.get("loginEnterCd").toString(),ssnSabun, jsonString);
