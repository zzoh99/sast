package com.hr.pap.intern.internAppItemMngr;
 ...
 */
@Controller
@RequestMapping(value="/InternAppItemMngr.do", method=RequestMethod.POST )
public class InternAppItemMngrController extends ComController {
