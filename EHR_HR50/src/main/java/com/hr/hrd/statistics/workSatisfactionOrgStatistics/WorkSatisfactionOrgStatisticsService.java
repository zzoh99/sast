...
@Service("WorkSatisfactionOrgStatisticsService")
public class WorkSatisfactionOrgStatisticsService {
	@Inject
	@Named("Dao")
	private Dao dao;

	public List<?> getWorkSatisfactionOrgStatisticsItem(Map<?, ?> paramMap) throws Exception {
		return (List<?>) dao.getList("getWorkSatisfactionOrgStatisticsItem", paramMap);
	}

	public List<?> getWorkSatisfactionOrgStatisticsSurveyItemList(Map<?, ?> paramMap) throws Exception {
		return (List<?>) dao.getList("getWorkSatisfactionOrgStatisticsSurveyItemList", paramMap);
	}

	public Map<?,?> getWorkSatisfactionOrgStatisticsSurveyItemStr(Map<?, ?> paramMap) throws Exception {
		return (Map<?,?>) dao.getMap("getWorkSatisfactionOrgStatisticsSurveyItemStr", paramMap);
	}

	public List<?> getWorkSatisfactionOrgStatisticsList(Map<?, ?> paramMap) throws Exception {
		return (List<?>) dao.getList("getWorkSatisfactionOrgStatisticsList", paramMap);
	}
...
//	public List<?> getWorkSatisfactionOrgStatisticsList(Map<?, ?> paramMap) throws Exception {
//		List<Map<String, Object>> headerList = (List<Map<String, Object>>)dao.getList("getWorkSatisfactionOrgStatisticsList", paramMap);
//		List<Map<String, Object>> resultList = (List<Map<String, Object>>) dao.getList("getWorkSatisfactionOrgStatisticsList", paramMap);
//
